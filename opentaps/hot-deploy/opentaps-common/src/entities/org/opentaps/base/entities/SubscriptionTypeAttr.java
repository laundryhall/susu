...
/**
 * Auto generated base entity SubscriptionTypeAttr.
 */
@javax.persistence.Entity
@Table(name="SUBSCRIPTION_TYPE_ATTR")
public class SubscriptionTypeAttr extends Entity {
static {
...
fieldMapColumns.put("SubscriptionTypeAttr", fields);
}
  public static enum Fields implements EntityFieldInterface<SubscriptionTypeAttr> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.SubscriptionTypeAttrPkBridge.class)
     private SubscriptionTypeAttrPk id = new SubscriptionTypeAttrPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>SubscriptionTypeAttrPk</code>
     */
      public SubscriptionTypeAttrPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>SubscriptionTypeAttrPk</code> value to set
    */   
      public void setId(SubscriptionTypeAttrPk id) {
         this.id = id;
      }
   ...
   private transient List<SubscriptionAttribute> subscriptionAttributes = null;
  ...
  public SubscriptionTypeAttr() {
      super();
      this.baseEntityName = "SubscriptionTypeAttr";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("subscriptionTypeId");this.primaryKeyNames.add("attrName");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("subscriptionTypeId");this.allFieldsNames.add("attrName");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public SubscriptionTypeAttr(RepositoryInterface repository) {
      this();
    ...
    public void setSubscriptionTypeId(String subscriptionTypeId) {
        id.setSubscriptionTypeId(subscriptionTypeId);
    }
    /**
     * Auto generated value setter.
    ...
    public String getSubscriptionTypeId() {
        return this.id.getSubscriptionTypeId();
    }
    /**
     * Auto generated value accessor.
     * @return <code>String</code>
