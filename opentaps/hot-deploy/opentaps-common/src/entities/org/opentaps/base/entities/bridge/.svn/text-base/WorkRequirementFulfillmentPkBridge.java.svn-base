...
import org.opentaps.base.entities.WorkRequirementFulfillmentPk;

/**
 * A FieldBridge for WorkRequirementFulfillmentPk.
 */
public class WorkRequirementFulfillmentPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkRequirementFulfillmentPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkRequirementFulfillmentPk id = new WorkRequirementFulfillmentPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkRequirementFulfillmentPk id = (WorkRequirementFulfillmentPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkRequirementFulfillmentPk id = (WorkRequirementFulfillmentPk) value;
