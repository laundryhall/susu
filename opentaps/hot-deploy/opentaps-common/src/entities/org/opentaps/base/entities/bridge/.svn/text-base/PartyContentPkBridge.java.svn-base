...
import org.opentaps.base.entities.PartyContentPk;

/**
 * A FieldBridge for PartyContentPk.
 */
public class PartyContentPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyContentPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyContentPk id = new PartyContentPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PartyContentPk id = (PartyContentPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyContentPk id = (PartyContentPk) value;
