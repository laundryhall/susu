...
import org.opentaps.base.entities.ProductStoreGroupMemberPk;

/**
 * A FieldBridge for ProductStoreGroupMemberPk.
 */
public class ProductStoreGroupMemberPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductStoreGroupMemberPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductStoreGroupMemberPk id = new ProductStoreGroupMemberPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductStoreGroupMemberPk id = (ProductStoreGroupMemberPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductStoreGroupMemberPk id = (ProductStoreGroupMemberPk) value;
