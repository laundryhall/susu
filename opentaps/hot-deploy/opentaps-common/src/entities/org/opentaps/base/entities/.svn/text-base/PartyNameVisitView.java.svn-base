...
/**
 * Auto generated base entity PartyNameVisitView.
 */
...
@SqlResultSetMapping(name="PartyNameVisitViewMapping", entities={
@EntityResult(entityClass=PartyNameVisitView.class, fields = {
...
,@FieldResult(name="webappName", column="webappName")
,@FieldResult(name="fromDate", column="fromDate")
})})
@org.hibernate.annotations.Entity(mutable = false)
@org.hibernate.annotations.AccessType("field")
public class PartyNameVisitView extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        ...
        fields.put("webappName", "VISIT.WEBAPP_NAME");
        fields.put("fromDate", "VISIT.FROM_DATE");
fieldMapColumns.put("PartyNameVisitView", fields);
}
  public static enum Fields implements EntityFieldInterface<PartyNameVisitView> {
    partyId("partyId"),
  ...
  public PartyNameVisitView() {
      ...
      this.allFieldsNames.add("partyId");this.allFieldsNames.add("partyTypeId");this.allFieldsNames.add("firstName");this.allFieldsNames.add("middleName");this.allFieldsNames.add("lastName");this.allFieldsNames.add("firstNameLocal");this.allFieldsNames.add("lastNameLocal");this.allFieldsNames.add("personalTitle");this.allFieldsNames.add("suffix");this.allFieldsNames.add("groupName");this.allFieldsNames.add("groupNameLocal");this.allFieldsNames.add("webappName");this.allFieldsNames.add("fromDate");
   ...
   */
  public PartyNameVisitView(RepositoryInterface repository) {
      this();
