...
import org.opentaps.base.entities.AgreementItemPk;

/**
 * A FieldBridge for AgreementItemPk.
 */
public class AgreementItemPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AgreementItemPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AgreementItemPk id = new AgreementItemPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        AgreementItemPk id = (AgreementItemPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AgreementItemPk id = (AgreementItemPk) value;
