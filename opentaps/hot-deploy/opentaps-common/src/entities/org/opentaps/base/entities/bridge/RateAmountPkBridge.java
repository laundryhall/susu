...
import org.opentaps.base.entities.RateAmountPk;

/**
 * A FieldBridge for RateAmountPk.
 */
public class RateAmountPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the RateAmountPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        RateAmountPk id = new RateAmountPk();
        Field field = null;
        field = document.getField(name + ".rateTypeId");
        id.setRateTypeId(field.stringValue());
        field = document.getField(name + ".rateCurrencyUomId");
        id.setRateCurrencyUomId(field.stringValue());
        field = document.getField(name + ".periodTypeId");
        id.setPeriodTypeId(field.stringValue());
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        RateAmountPk id = (RateAmountPk) value;
        ...
        document.add(field);
        field = new Field(name + ".rateCurrencyUomId", id.getRateCurrencyUomId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".periodTypeId", id.getPeriodTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
