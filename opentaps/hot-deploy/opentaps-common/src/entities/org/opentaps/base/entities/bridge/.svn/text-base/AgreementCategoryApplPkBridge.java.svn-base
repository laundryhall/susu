...
import org.opentaps.base.entities.AgreementCategoryApplPk;

/**
 * A FieldBridge for AgreementCategoryApplPk.
 */
public class AgreementCategoryApplPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AgreementCategoryApplPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AgreementCategoryApplPk id = new AgreementCategoryApplPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        AgreementCategoryApplPk id = (AgreementCategoryApplPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AgreementCategoryApplPk id = (AgreementCategoryApplPk) value;
