...
import org.opentaps.base.entities.BudgetRolePk;

/**
 * A FieldBridge for BudgetRolePk.
 */
public class BudgetRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the BudgetRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        BudgetRolePk id = new BudgetRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        BudgetRolePk id = (BudgetRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        BudgetRolePk id = (BudgetRolePk) value;
