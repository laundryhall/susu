...
/**
 * Auto generated base entity SegmentGroupRole.
 */
@javax.persistence.Entity
@Table(name="SEGMENT_GROUP_ROLE")
public class SegmentGroupRole extends Entity {
static {
...
fieldMapColumns.put("SegmentGroupRole", fields);
}
  public static enum Fields implements EntityFieldInterface<SegmentGroupRole> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.SegmentGroupRolePkBridge.class)
     private SegmentGroupRolePk id = new SegmentGroupRolePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>SegmentGroupRolePk</code>
     */
      public SegmentGroupRolePk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>SegmentGroupRolePk</code> value to set
    */   
      public void setId(SegmentGroupRolePk id) {
         this.id = id;
      }
  ...
  public SegmentGroupRole() {
      super();
      this.baseEntityName = "SegmentGroupRole";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("segmentGroupId");this.primaryKeyNames.add("partyId");this.primaryKeyNames.add("roleTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("segmentGroupId");this.allFieldsNames.add("partyId");this.allFieldsNames.add("roleTypeId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public SegmentGroupRole(RepositoryInterface repository) {
      this();
