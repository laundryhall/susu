...
fieldMapColumns.put("AgreementGeographicalApplic", fields);
  ...
  public static enum Fields implements EntityFieldInterface<AgreementGeographicalApplic> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.AgreementGeographicalApplicPkBridge.class)
     private AgreementGeographicalApplicPk id = new AgreementGeographicalApplicPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>AgreementGeographicalApplicPk</code>
     */
      public AgreementGeographicalApplicPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>AgreementGeographicalApplicPk</code> value to set
    */   
      public void setId(AgreementGeographicalApplicPk id) {
         this.id = id;
      }
  ...
  public AgreementGeographicalApplic() {
      ...
      this.allFieldsNames.add("agreementId");this.allFieldsNames.add("agreementItemSeqId");this.allFieldsNames.add("geoId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
