...
/**
 * Auto generated base entity CommunicationEventAndCustRequest.
 */
@javax.persistence.Entity
@NamedNativeQuery(name="selectCommunicationEventAndCustRequests", query="SELECT CR.CUST_REQUEST_ID AS \"custRequestId\",CR.COMMUNICATION_EVENT_ID AS \"communicationEventId\",CE.COMMUNICATION_EVENT_TYPE_ID AS \"communicationEventTypeId\",CE.ORIG_COMM_EVENT_ID AS \"origCommEventId\",CE.PARENT_COMM_EVENT_ID AS \"parentCommEventId\",CE.STATUS_ID AS \"statusId\",CE.CONTACT_MECH_TYPE_ID AS \"contactMechTypeId\",CE.CONTACT_MECH_ID_FROM AS \"contactMechIdFrom\",CE.CONTACT_MECH_ID_TO AS \"contactMechIdTo\",CE.ROLE_TYPE_ID_FROM AS \"roleTypeIdFrom\",CE.ROLE_TYPE_ID_TO AS \"roleTypeIdTo\",CE.PARTY_ID_FROM AS \"partyIdFrom\",CE.PARTY_ID_TO AS \"partyIdTo\",CE.ENTRY_DATE AS \"entryDate\",CE.DATETIME_STARTED AS \"datetimeStarted\",CE.DATETIME_ENDED AS \"datetimeEnded\",CE.SUBJECT AS \"subject\",CE.CONTENT_MIME_TYPE_ID AS \"contentMimeTypeId\",CE.CONTENT AS \"content\",CE.NOTE AS \"note\",CE.REASON_ENUM_ID AS \"reasonEnumId\",CE.CONTACT_LIST_ID AS \"contactListId\",CE.HEADER_STRING AS \"headerString\",CE.FROM_STRING AS \"fromString\",CE.TO_STRING AS \"toString\",CE.CC_STRING AS \"ccString\",CE.BCC_STRING AS \"bccString\",CE.MESSAGE_ID AS \"messageId\" FROM CUST_REQUEST_COMM_EVENT CR INNER JOIN COMMUNICATION_EVENT CE ON CR.COMMUNICATION_EVENT_ID = CE.COMMUNICATION_EVENT_ID", resultSetMapping="CommunicationEventAndCustRequestMapping")
@SqlResultSetMapping(name="CommunicationEventAndCustRequestMapping", entities={
@EntityResult(entityClass=CommunicationEventAndCustRequest.class, fields = {
...
public class CommunicationEventAndCustRequest extends Entity {
static {
...
fieldMapColumns.put("CommunicationEventAndCustRequest", fields);
}
  public static enum Fields implements EntityFieldInterface<CommunicationEventAndCustRequest> {
   ...
   */
  public CommunicationEventAndCustRequest(RepositoryInterface repository) {
      this();
