...
import org.opentaps.base.entities.GlAccountRolePk;

/**
 * A FieldBridge for GlAccountRolePk.
 */
public class GlAccountRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the GlAccountRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        GlAccountRolePk id = new GlAccountRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        GlAccountRolePk id = (GlAccountRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        GlAccountRolePk id = (GlAccountRolePk) value;
