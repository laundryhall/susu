...
import org.opentaps.base.entities.WorkEffortNotePk;

/**
 * A FieldBridge for WorkEffortNotePk.
 */
public class WorkEffortNotePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortNotePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortNotePk id = new WorkEffortNotePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkEffortNotePk id = (WorkEffortNotePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortNotePk id = (WorkEffortNotePk) value;
