...
import org.opentaps.base.entities.CommunicationEventWorkEffPk;

/**
 * A FieldBridge for CommunicationEventWorkEffPk.
 */
public class CommunicationEventWorkEffPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CommunicationEventWorkEffPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CommunicationEventWorkEffPk id = new CommunicationEventWorkEffPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        CommunicationEventWorkEffPk id = (CommunicationEventWorkEffPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CommunicationEventWorkEffPk id = (CommunicationEventWorkEffPk) value;
