...
import org.opentaps.base.entities.ProductGlAccountPk;

/**
 * A FieldBridge for ProductGlAccountPk.
 */
public class ProductGlAccountPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductGlAccountPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductGlAccountPk id = new ProductGlAccountPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductGlAccountPk id = (ProductGlAccountPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductGlAccountPk id = (ProductGlAccountPk) value;
