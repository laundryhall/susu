...
/**
 * Auto generated base entity FixedAssetIdentType.
 */
@javax.persistence.Entity
@Table(name="FIXED_ASSET_IDENT_TYPE")
public class FixedAssetIdentType extends Entity {
static {
...
fieldMapColumns.put("FixedAssetIdentType", fields);
}
  public static enum Fields implements EntityFieldInterface<FixedAssetIdentType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="FixedAssetIdentType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="FixedAssetIdentType_GEN")
   @Id
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="fixedAssetIdentType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="FIXED_ASSET_IDENT_TYPE_ID")
  ...
  public FixedAssetIdentType() {
      super();
      this.baseEntityName = "FixedAssetIdentType";
      this.isView = false;
      this.resourceName = "AccountingEntityLabels";
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("fixedAssetIdentTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("fixedAssetIdentTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public FixedAssetIdentType(RepositoryInterface repository) {
      this();
