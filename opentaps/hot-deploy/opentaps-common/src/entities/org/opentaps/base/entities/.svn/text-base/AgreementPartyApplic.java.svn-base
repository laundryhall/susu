...
fieldMapColumns.put("AgreementPartyApplic", fields);
  ...
  public static enum Fields implements EntityFieldInterface<AgreementPartyApplic> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.AgreementPartyApplicPkBridge.class)
     private AgreementPartyApplicPk id = new AgreementPartyApplicPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>AgreementPartyApplicPk</code>
     */
      public AgreementPartyApplicPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>AgreementPartyApplicPk</code> value to set
    */   
      public void setId(AgreementPartyApplicPk id) {
         this.id = id;
      }
  ...
  public AgreementPartyApplic() {
      ...
      this.allFieldsNames.add("agreementId");this.allFieldsNames.add("agreementItemSeqId");this.allFieldsNames.add("partyId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
