...
import org.opentaps.base.entities.WorkEffortGoodStandardPk;

/**
 * A FieldBridge for WorkEffortGoodStandardPk.
 */
public class WorkEffortGoodStandardPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortGoodStandardPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortGoodStandardPk id = new WorkEffortGoodStandardPk();
        Field field = null;
        ...
        field = document.getField(name + ".workEffortGoodStdTypeId");
        id.setWorkEffortGoodStdTypeId(field.stringValue());
    ...
    public String objectToString(Object object) {
        WorkEffortGoodStandardPk id = (WorkEffortGoodStandardPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getWorkEffortId());
        sb.append("_");
        sb.append(id.getProductId());
        sb.append("_");
        sb.append(id.getWorkEffortGoodStdTypeId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortGoodStandardPk id = (WorkEffortGoodStandardPk) value;
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".workEffortGoodStdTypeId", id.getWorkEffortGoodStdTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
