...
import org.opentaps.base.entities.FinAccountRolePk;

/**
 * A FieldBridge for FinAccountRolePk.
 */
public class FinAccountRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FinAccountRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FinAccountRolePk id = new FinAccountRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        FinAccountRolePk id = (FinAccountRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FinAccountRolePk id = (FinAccountRolePk) value;
