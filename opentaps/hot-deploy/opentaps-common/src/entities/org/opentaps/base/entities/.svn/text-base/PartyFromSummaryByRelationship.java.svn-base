...
public class PartyFromSummaryByRelationship extends Entity {
static {
...
fieldMapColumns.put("PartyFromSummaryByRelationship", fields);
}
  public static enum Fields implements EntityFieldInterface<PartyFromSummaryByRelationship> {
   ...
   * Default constructor.
   */
  public PartyFromSummaryByRelationship() {
      super();
      this.baseEntityName = "PartyFromSummaryByRelationship";
      this.isView = true;
   ...
   */
  public PartyFromSummaryByRelationship(RepositoryInterface repository) {
      this();
