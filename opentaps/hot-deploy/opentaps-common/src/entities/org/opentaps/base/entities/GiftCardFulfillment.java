...
/**
 * Auto generated base entity GiftCardFulfillment.
 */
@javax.persistence.Entity
@Table(name="GIFT_CARD_FULFILLMENT")
public class GiftCardFulfillment extends Entity {
static {
...
fieldMapColumns.put("GiftCardFulfillment", fields);
}
  public static enum Fields implements EntityFieldInterface<GiftCardFulfillment> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="GiftCardFulfillment_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
  ...
  public GiftCardFulfillment() {
      super();
      this.baseEntityName = "GiftCardFulfillment";
      this.isView = false;
   ...
   */
  public GiftCardFulfillment(RepositoryInterface repository) {
      this();
