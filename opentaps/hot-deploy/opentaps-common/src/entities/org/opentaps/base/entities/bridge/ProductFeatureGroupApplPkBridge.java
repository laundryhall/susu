...
import org.opentaps.base.entities.ProductFeatureGroupApplPk;

/**
 * A FieldBridge for ProductFeatureGroupApplPk.
 */
public class ProductFeatureGroupApplPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductFeatureGroupApplPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductFeatureGroupApplPk id = new ProductFeatureGroupApplPk();
        Field field = null;
        field = document.getField(name + ".productFeatureGroupId");
        id.setProductFeatureGroupId(field.stringValue());
    ...
    public String objectToString(Object object) {
        ProductFeatureGroupApplPk id = (ProductFeatureGroupApplPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProductFeatureGroupId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductFeatureGroupApplPk id = (ProductFeatureGroupApplPk) value;
        ...
        Field field = null;
        field = new Field(name + ".productFeatureGroupId", id.getProductFeatureGroupId(), store, index, termVector);
