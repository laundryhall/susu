...
import org.opentaps.base.entities.WorkEffortFixedAssetAssignPk;

/**
 * A FieldBridge for WorkEffortFixedAssetAssignPk.
 */
public class WorkEffortFixedAssetAssignPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortFixedAssetAssignPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortFixedAssetAssignPk id = new WorkEffortFixedAssetAssignPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkEffortFixedAssetAssignPk id = (WorkEffortFixedAssetAssignPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortFixedAssetAssignPk id = (WorkEffortFixedAssetAssignPk) value;
