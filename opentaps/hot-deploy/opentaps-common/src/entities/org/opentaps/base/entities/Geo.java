...
fieldMapColumns.put("Geo", fields);
  ...
  public static enum Fields implements EntityFieldInterface<Geo> {
   ...
   private transient List<InvoiceItem> taxInvoiceItems = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="geo", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="GEO_ID")
   ...
   private transient List<ShipmentCostEstimate> toShipmentCostEstimates = null;
   private transient List<ShipmentCostEstimate> fromShipmentCostEstimates = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="geo", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="GEO_ID")
