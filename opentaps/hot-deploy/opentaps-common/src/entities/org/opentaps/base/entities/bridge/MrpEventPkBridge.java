...
import org.opentaps.base.entities.MrpEventPk;

/**
 * A FieldBridge for MrpEventPk.
 */
public class MrpEventPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the MrpEventPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        MrpEventPk id = new MrpEventPk();
        Field field = null;
        field = document.getField(name + ".mrpId");
        id.setMrpId(field.stringValue());
        ...
        field = document.getField(name + ".mrpEventTypeId");
        id.setMrpEventTypeId(field.stringValue());
        return id;
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        MrpEventPk id = (MrpEventPk) value;
        ...
        Field field = null;
        field = new Field(name + ".mrpId", id.getMrpId(), store, index, termVector);
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".mrpEventTypeId", id.getMrpEventTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
