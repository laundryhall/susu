...
import org.opentaps.base.entities.UserLoginPasswordHistoryPk;

/**
 * A FieldBridge for UserLoginPasswordHistoryPk.
 */
public class UserLoginPasswordHistoryPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the UserLoginPasswordHistoryPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        UserLoginPasswordHistoryPk id = new UserLoginPasswordHistoryPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        UserLoginPasswordHistoryPk id = (UserLoginPasswordHistoryPk) value;
