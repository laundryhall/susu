...
fieldMapColumns.put("Enumeration", fields);
  ...
  public static enum Fields implements EntityFieldInterface<Enumeration> {
   ...
   private transient List<AccountBalanceHistory> balanceTypeAccountBalanceHistorys = null;
   ...
   private transient List<AcctgTransEntry> tag1AcctgTransEntries = null;
   private transient List<AcctgTransEntry> tag2AcctgTransEntries = null;
   private transient List<AcctgTransEntry> tag3AcctgTransEntries = null;
   private transient List<AcctgTransEntry> tag4AcctgTransEntries = null;
   private transient List<AcctgTransEntry> tag5AcctgTransEntries = null;
   private transient List<AcctgTransEntry> tag6AcctgTransEntries = null;
   private transient List<AcctgTransEntry> tag7AcctgTransEntries = null;
   private transient List<AcctgTransEntry> tag8AcctgTransEntries = null;
   private transient List<AcctgTransEntry> tag9AcctgTransEntries = null;
   private transient List<AcctgTransEntry> tag10AcctgTransEntries = null;
   private transient List<AgreementTerm> agreementTerms = null;
   private transient List<CommunicationEvent> communicationEvents = null;
   private transient List<Content> privilegeContents = null;
   private transient List<Content> classificationContents = null;
   private transient List<ContentPurposeOperation> contentPurposeOperations = null;
   private transient List<CustRequest> salesChannelCustRequests = null;
   private transient List<DataWarehouseTransform> dataWarehouseTransforms = null;
   private transient List<EncumbranceDetail> tag1EncumbranceDetails = null;
   private transient List<EncumbranceDetail> tag2EncumbranceDetails = null;
   private transient List<EncumbranceDetail> tag3EncumbranceDetails = null;
   private transient List<EncumbranceDetail> tag4EncumbranceDetails = null;
   private transient List<EncumbranceDetail> tag5EncumbranceDetails = null;
   private transient List<EncumbranceDetail> tag6EncumbranceDetails = null;
   private transient List<EncumbranceDetail> tag7EncumbranceDetails = null;
   private transient List<EncumbranceDetail> tag8EncumbranceDetails = null;
   private transient List<EncumbranceDetail> tag9EncumbranceDetails = null;
   private transient List<EncumbranceDetail> tag10EncumbranceDetails = null;
   private transient List<ExampleFeature> exampleFeatures = null;
   private transient List<Facility> facilitys = null;
   private transient List<FacilityLocation> typeFacilityLocations = null;
   private transient List<FinAccountTrans> reasonFinAccountTranses = null;
   private transient List<FinAccountType> replenishFinAccountTypes = null;
   private transient List<FixedAsset> classFixedAssets = null;
   private transient List<GiftCardFulfillment> giftCardFulfillments = null;
   private transient List<InventoryItem> tag1InventoryItems = null;
   private transient List<InventoryItem> tag2InventoryItems = null;
   private transient List<InventoryItem> tag3InventoryItems = null;
   private transient List<InventoryItem> tag4InventoryItems = null;
   private transient List<InventoryItem> tag5InventoryItems = null;
   private transient List<InventoryItem> tag6InventoryItems = null;
   private transient List<InventoryItem> tag7InventoryItems = null;
   private transient List<InventoryItem> tag8InventoryItems = null;
   private transient List<InventoryItem> tag9InventoryItems = null;
   private transient List<InventoryItem> tag10InventoryItems = null;
   private transient List<InventoryItemDetail> reasonInventoryItemDetails = null;
   private transient List<InvoiceItem> tag1InvoiceItems = null;
   private transient List<InvoiceItem> tag2InvoiceItems = null;
   private transient List<InvoiceItem> tag3InvoiceItems = null;
   private transient List<InvoiceItem> tag4InvoiceItems = null;
   private transient List<InvoiceItem> tag5InvoiceItems = null;
   private transient List<InvoiceItem> tag6InvoiceItems = null;
   private transient List<InvoiceItem> tag7InvoiceItems = null;
   private transient List<InvoiceItem> tag8InvoiceItems = null;
   private transient List<InvoiceItem> tag9InvoiceItems = null;
   private transient List<InvoiceItem> tag10InvoiceItems = null;
   private transient List<KeywordThesaurus> relationshipKeywordThesauruses = null;
   private transient List<OldValueLinkFulfillment> oldValueLinkFulfillments = null;
   private transient List<OrderHeader> salesChannelOrderHeaders = null;
   private transient List<OrderItem> tag1OrderItems = null;
   private transient List<OrderItem> tag2OrderItems = null;
   private transient List<OrderItem> tag3OrderItems = null;
   private transient List<OrderItem> tag4OrderItems = null;
   private transient List<OrderItem> tag5OrderItems = null;
   private transient List<OrderItem> tag6OrderItems = null;
   private transient List<OrderItem> tag7OrderItems = null;
   private transient List<OrderItem> tag8OrderItems = null;
   private transient List<OrderItem> tag9OrderItems = null;
   private transient List<OrderItem> tag10OrderItems = null;
   private transient List<OrderItemChange> orderItemChanges = null;
   private transient List<OrderItemChange> reasonOrderItemChanges = null;
   private transient List<OrderNotification> orderNotifications = null;
   private transient List<PartyAcctgPreference> taxFormPartyAcctgPreferences = null;
   private transient List<PartyAcctgPreference> cogsPartyAcctgPreferences = null;
   private transient List<PartyAcctgPreference> invoiceSequencePartyAcctgPreferences = null;
   private transient List<PartyAcctgPreference> quoteSequencePartyAcctgPreferences = null;
   private transient List<PartyAcctgPreference> orderSequencePartyAcctgPreferences = null;
   private transient List<PartyAcctgPreference> costingMethodPartyAcctgPreferences = null;
   private transient List<PartyContent> partyContents = null;
   private transient List<PartySupplementalData> industryPartySupplementalDatas = null;
   private transient List<PartySupplementalData> ownershipPartySupplementalDatas = null;
   private transient List<Payment> tag1Payments = null;
   private transient List<Payment> tag2Payments = null;
   private transient List<Payment> tag3Payments = null;
   private transient List<Payment> tag4Payments = null;
   private transient List<Payment> tag5Payments = null;
   private transient List<Payment> tag6Payments = null;
   private transient List<Payment> tag7Payments = null;
   private transient List<Payment> tag8Payments = null;
   private transient List<Payment> tag9Payments = null;
   private transient List<Payment> tag10Payments = null;
   private transient List<PaymentApplication> tag1PaymentApplications = null;
   private transient List<PaymentApplication> tag2PaymentApplications = null;
   private transient List<PaymentApplication> tag3PaymentApplications = null;
   private transient List<PaymentApplication> tag4PaymentApplications = null;
   private transient List<PaymentApplication> tag5PaymentApplications = null;
   private transient List<PaymentApplication> tag6PaymentApplications = null;
   private transient List<PaymentApplication> tag7PaymentApplications = null;
   private transient List<PaymentApplication> tag8PaymentApplications = null;
   private transient List<PaymentApplication> tag9PaymentApplications = null;
   private transient List<PaymentApplication> tag10PaymentApplications = null;
   private transient List<PaymentGatewayResponse> serviceTypePaymentGatewayResponses = null;
   private transient List<PaymentGatewayResponse> tranCodePaymentGatewayResponses = null;
   private transient List<Person> employmentStatuspeople = null;
   private transient List<Person> residenceStatuspeople = null;
   private transient List<PosTerminalInternTx> posTerminalInternTxes = null;
   private transient List<Product> vitualVariantMethodProducts = null;
   private transient List<Product> ratingProducts = null;
   private transient List<Product> requirementMethodProducts = null;
   private transient List<ProductCategoryLink> linkTypeProductCategoryLinks = null;
   private transient List<ProductFacility> resplenishMethodProductFacilitys = null;
   private transient List<ProductGeo> productGeos = null;
   private transient List<ProductPriceCond> inputParamProductPriceConds = null;
   private transient List<ProductPriceCond> operatorProductPriceConds = null;
   private transient List<ProductPromoAction> actionProductPromoActions = null;
   private transient List<ProductPromoCategory> applProductPromoCategorys = null;
   private transient List<ProductPromoCond> inputParamProductPromoConds = null;
   private transient List<ProductPromoCond> operatorProductPromoConds = null;
   private transient List<ProductPromoProduct> applProductPromoProducts = null;
   private transient List<ProductStore> reserveOrderProductStores = null;
   private transient List<ProductStore> requirementMethodProductStores = null;
   private transient List<ProductStore> defaultSalesChannelProductStores = null;
   private transient List<ProductStoreEmailSetting> productStoreEmailSettings = null;
   private transient List<ProductStoreFinActSetting> replenishMethodProductStoreFinActSettings = null;
   private transient List<ProductStoreKeywordOvrd> productStoreKeywordOvrds = null;
   private transient List<ProductStorePaymentSetting> productStorePaymentSettings = null;
   private transient List<ProductStoreVendorPayment> creditCardProductStoreVendorPayments = null;
   private transient List<Quote> salesChannelQuotes = null;
   private transient List<SalesOpportunity> typeSalesOpportunitys = null;
   ...
   private transient List<TrackingCodeVisit> trackingCodeVisits = null;
   private transient List<UomConversionDated> purposeUomConversionDateds = null;
   private transient List<ViewPreference> viewPreferences = null;
   private transient List<VisualThemeResource> visualThemeResources = null;
   private transient List<WorkEffort> scopeWorkEfforts = null;
   private transient List<WorkEffortPartyAssignment> expectationWorkEffortPartyAssignments = null;
   private transient List<WorkEffortPartyAssignment> delegateReasonWorkEffortPartyAssignments = null;
