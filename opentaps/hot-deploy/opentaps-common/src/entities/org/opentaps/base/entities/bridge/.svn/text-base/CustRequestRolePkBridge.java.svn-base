...
/**
 * A FieldBridge for CustRequestRolePk.
 */
public class CustRequestRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CustRequestRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CustRequestRolePk id = new CustRequestRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        CustRequestRolePk id = (CustRequestRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CustRequestRolePk id = (CustRequestRolePk) value;
