...
import org.opentaps.base.entities.FixedAssetIdentPk;

/**
 * A FieldBridge for FixedAssetIdentPk.
 */
public class FixedAssetIdentPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FixedAssetIdentPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FixedAssetIdentPk id = new FixedAssetIdentPk();
        Field field = null;
        field = document.getField(name + ".fixedAssetId");
        id.setFixedAssetId(field.stringValue());
        field = document.getField(name + ".fixedAssetIdentTypeId");
        id.setFixedAssetIdentTypeId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        FixedAssetIdentPk id = (FixedAssetIdentPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getFixedAssetId());
        sb.append("_");
        sb.append(id.getFixedAssetIdentTypeId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FixedAssetIdentPk id = (FixedAssetIdentPk) value;
        ...
        document.add(field);
        field = new Field(name + ".fixedAssetIdentTypeId", id.getFixedAssetIdentTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
