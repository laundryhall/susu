...
import org.opentaps.base.entities.DataImportUSZipCodesPk;

/**
 * A FieldBridge for DataImportUSZipCodesPk.
 */
public class DataImportUSZipCodesPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the DataImportUSZipCodesPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        DataImportUSZipCodesPk id = new DataImportUSZipCodesPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        DataImportUSZipCodesPk id = (DataImportUSZipCodesPk) value;
