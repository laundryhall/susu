...
import org.opentaps.base.entities.RequirementRolePk;

/**
 * A FieldBridge for RequirementRolePk.
 */
public class RequirementRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the RequirementRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        RequirementRolePk id = new RequirementRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        RequirementRolePk id = (RequirementRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        RequirementRolePk id = (RequirementRolePk) value;
