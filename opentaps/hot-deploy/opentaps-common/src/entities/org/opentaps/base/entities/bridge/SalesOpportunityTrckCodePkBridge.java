...
import org.opentaps.base.entities.SalesOpportunityTrckCodePk;

/**
 * A FieldBridge for SalesOpportunityTrckCodePk.
 */
public class SalesOpportunityTrckCodePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the SalesOpportunityTrckCodePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        SalesOpportunityTrckCodePk id = new SalesOpportunityTrckCodePk();
        Field field = null;
        field = document.getField(name + ".salesOpportunityId");
        id.setSalesOpportunityId(field.stringValue());
        field = document.getField(name + ".trackingCodeId");
        id.setTrackingCodeId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        SalesOpportunityTrckCodePk id = (SalesOpportunityTrckCodePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getSalesOpportunityId());
        sb.append("_");
        sb.append(id.getTrackingCodeId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        SalesOpportunityTrckCodePk id = (SalesOpportunityTrckCodePk) value;
        ...
        document.add(field);
        field = new Field(name + ".trackingCodeId", id.getTrackingCodeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
