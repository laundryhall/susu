...
import org.opentaps.base.entities.QuoteContentPk;

/**
 * A FieldBridge for QuoteContentPk.
 */
public class QuoteContentPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the QuoteContentPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        QuoteContentPk id = new QuoteContentPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        QuoteContentPk id = (QuoteContentPk) value;
