...
import org.opentaps.base.entities.AmazonProductBulletPointPk;

/**
 * A FieldBridge for AmazonProductBulletPointPk.
 */
public class AmazonProductBulletPointPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AmazonProductBulletPointPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AmazonProductBulletPointPk id = new AmazonProductBulletPointPk();
        Field field = null;
        field = document.getField(name + ".bulletPointId");
        id.setBulletPointId(field.stringValue());
    ...
    public String objectToString(Object object) {
        AmazonProductBulletPointPk id = (AmazonProductBulletPointPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getBulletPointId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AmazonProductBulletPointPk id = (AmazonProductBulletPointPk) value;
        ...
        Field field = null;
        field = new Field(name + ".bulletPointId", id.getBulletPointId(), store, index, termVector);
