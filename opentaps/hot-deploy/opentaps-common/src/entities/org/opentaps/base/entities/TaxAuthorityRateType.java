...
/**
 * Auto generated base entity TaxAuthorityRateType.
 */
@javax.persistence.Entity
@Table(name="TAX_AUTHORITY_RATE_TYPE")
public class TaxAuthorityRateType extends Entity {
static {
...
fieldMapColumns.put("TaxAuthorityRateType", fields);
}
  public static enum Fields implements EntityFieldInterface<TaxAuthorityRateType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="TaxAuthorityRateType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="TaxAuthorityRateType_GEN")
   @Id
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="taxAuthorityRateType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="TAX_AUTHORITY_RATE_TYPE_ID")
  ...
  public TaxAuthorityRateType() {
      super();
      this.baseEntityName = "TaxAuthorityRateType";
      this.isView = false;
      this.resourceName = "AccountingEntityLabels";
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("taxAuthorityRateTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("taxAuthorityRateTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public TaxAuthorityRateType(RepositoryInterface repository) {
      this();
