...
/**
 * Auto generated base entity AgreementDocumentTypeMap.
 */
@javax.persistence.Entity
@Table(name="AGREEMENT_DOCUMENT_TYPE_MAP")
public class AgreementDocumentTypeMap extends Entity {
static {
...
fieldMapColumns.put("AgreementDocumentTypeMap", fields);
}
  public static enum Fields implements EntityFieldInterface<AgreementDocumentTypeMap> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="AgreementDocumentTypeMap_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="AgreementDocumentTypeMap_GEN")
   @Id
  ...
  public AgreementDocumentTypeMap() {
      super();
      this.baseEntityName = "AgreementDocumentTypeMap";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("documentTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("documentTypeId");this.allFieldsNames.add("agreementTypeId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public AgreementDocumentTypeMap(RepositoryInterface repository) {
      this();
