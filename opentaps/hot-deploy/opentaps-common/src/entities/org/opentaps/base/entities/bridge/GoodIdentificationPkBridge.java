...
import org.opentaps.base.entities.GoodIdentificationPk;

/**
 * A FieldBridge for GoodIdentificationPk.
 */
public class GoodIdentificationPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the GoodIdentificationPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        GoodIdentificationPk id = new GoodIdentificationPk();
        Field field = null;
        field = document.getField(name + ".goodIdentificationTypeId");
        id.setGoodIdentificationTypeId(field.stringValue());
    ...
    public String objectToString(Object object) {
        GoodIdentificationPk id = (GoodIdentificationPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getGoodIdentificationTypeId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        GoodIdentificationPk id = (GoodIdentificationPk) value;
        ...
        Field field = null;
        field = new Field(name + ".goodIdentificationTypeId", id.getGoodIdentificationTypeId(), store, index, termVector);
