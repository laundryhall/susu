...
/**
 * Auto generated base entity ProductAndPriceView.
 */
@javax.persistence.Entity
@NamedNativeQuery(name="selectProductAndPriceViews", query="SELECT PR.PRODUCT_ID AS \"productId\",PR.PRODUCT_TYPE_ID AS \"productTypeId\",PR.PRODUCT_NAME AS \"productName\",PR.INTERNAL_NAME AS \"internalName\",PR.DESCRIPTION AS \"description\",PR.PRIMARY_PRODUCT_CATEGORY_ID AS \"primaryProductCategoryId\",PR.IS_VIRTUAL AS \"isVirtual\",PP.PRODUCT_PRICE_TYPE_ID AS \"productPriceTypeId\",PP.PRODUCT_PRICE_PURPOSE_ID AS \"productPricePurposeId\",PP.CURRENCY_UOM_ID AS \"currencyUomId\",PP.FROM_DATE AS \"fromDate\",PP.THRU_DATE AS \"thruDate\",PP.PRICE AS \"price\" FROM PRODUCT PR INNER JOIN PRODUCT_PRICE PP ON PR.PRODUCT_ID = PP.PRODUCT_ID", resultSetMapping="ProductAndPriceViewMapping")
@SqlResultSetMapping(name="ProductAndPriceViewMapping", entities={
@EntityResult(entityClass=ProductAndPriceView.class, fields = {
...
public class ProductAndPriceView extends Entity {
static {
...
fieldMapColumns.put("ProductAndPriceView", fields);
}
  public static enum Fields implements EntityFieldInterface<ProductAndPriceView> {
    productId("productId"),
  ...
  public ProductAndPriceView() {
      super();
      this.baseEntityName = "ProductAndPriceView";
      this.isView = true;
      ...
      this.allFieldsNames.add("productId");this.allFieldsNames.add("productTypeId");this.allFieldsNames.add("productName");this.allFieldsNames.add("internalName");this.allFieldsNames.add("description");this.allFieldsNames.add("primaryProductCategoryId");this.allFieldsNames.add("isVirtual");this.allFieldsNames.add("productPriceTypeId");this.allFieldsNames.add("productPricePurposeId");this.allFieldsNames.add("currencyUomId");this.allFieldsNames.add("fromDate");this.allFieldsNames.add("thruDate");this.allFieldsNames.add("price");
   ...
   */
  public ProductAndPriceView(RepositoryInterface repository) {
      this();
