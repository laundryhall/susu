...
/**
 * Auto generated base entity TaxAuthorityCategory.
 */
@javax.persistence.Entity
@Table(name="TAX_AUTHORITY_CATEGORY")
public class TaxAuthorityCategory extends Entity {
static {
...
fieldMapColumns.put("TaxAuthorityCategory", fields);
}
  public static enum Fields implements EntityFieldInterface<TaxAuthorityCategory> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.TaxAuthorityCategoryPkBridge.class)
     ...
     * @return <code>TaxAuthorityCategoryPk</code>
     */
      public TaxAuthorityCategoryPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>TaxAuthorityCategoryPk</code> value to set
    */   
      public void setId(TaxAuthorityCategoryPk id) {
         this.id = id;
      }
  ...
  public TaxAuthorityCategory() {
      super();
      this.baseEntityName = "TaxAuthorityCategory";
      this.isView = false;
      ...
      this.allFieldsNames.add("taxAuthGeoId");this.allFieldsNames.add("taxAuthPartyId");this.allFieldsNames.add("productCategoryId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public TaxAuthorityCategory(RepositoryInterface repository) {
      this();
