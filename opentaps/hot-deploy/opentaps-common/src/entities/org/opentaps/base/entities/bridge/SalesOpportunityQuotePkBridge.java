...
import org.opentaps.base.entities.SalesOpportunityQuotePk;

/**
 * A FieldBridge for SalesOpportunityQuotePk.
 */
public class SalesOpportunityQuotePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the SalesOpportunityQuotePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        SalesOpportunityQuotePk id = new SalesOpportunityQuotePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        SalesOpportunityQuotePk id = (SalesOpportunityQuotePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        SalesOpportunityQuotePk id = (SalesOpportunityQuotePk) value;
