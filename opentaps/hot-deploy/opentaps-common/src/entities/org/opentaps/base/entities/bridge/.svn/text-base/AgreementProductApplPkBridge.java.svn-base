...
import org.opentaps.base.entities.AgreementProductApplPk;

/**
 * A FieldBridge for AgreementProductApplPk.
 */
public class AgreementProductApplPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AgreementProductApplPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AgreementProductApplPk id = new AgreementProductApplPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        AgreementProductApplPk id = (AgreementProductApplPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AgreementProductApplPk id = (AgreementProductApplPk) value;
