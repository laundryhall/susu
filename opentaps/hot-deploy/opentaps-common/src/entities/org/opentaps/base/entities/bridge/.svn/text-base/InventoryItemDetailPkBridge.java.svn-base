...
import org.opentaps.base.entities.InventoryItemDetailPk;

/**
 * A FieldBridge for InventoryItemDetailPk.
 */
public class InventoryItemDetailPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the InventoryItemDetailPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        InventoryItemDetailPk id = new InventoryItemDetailPk();
        Field field = null;
        field = document.getField(name + ".inventoryItemId");
        id.setInventoryItemId(field.stringValue());
        field = document.getField(name + ".inventoryItemDetailSeqId");
        id.setInventoryItemDetailSeqId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        InventoryItemDetailPk id = (InventoryItemDetailPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getInventoryItemId());
        sb.append("_");
        sb.append(id.getInventoryItemDetailSeqId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        InventoryItemDetailPk id = (InventoryItemDetailPk) value;
        ...
        document.add(field);
        field = new Field(name + ".inventoryItemDetailSeqId", id.getInventoryItemDetailSeqId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
