...
import org.opentaps.base.entities.UomConversionDatedPk;

/**
 * A FieldBridge for UomConversionDatedPk.
 */
public class UomConversionDatedPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the UomConversionDatedPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        UomConversionDatedPk id = new UomConversionDatedPk();
        Field field = null;
        field = document.getField(name + ".uomId");
        id.setUomId(field.stringValue());
        field = document.getField(name + ".uomIdTo");
        id.setUomIdTo(field.stringValue());
    ...
    public String objectToString(Object object) {
        UomConversionDatedPk id = (UomConversionDatedPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getUomId());
        sb.append("_");
        sb.append(id.getUomIdTo());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        UomConversionDatedPk id = (UomConversionDatedPk) value;
        ...
        Field field = null;
        field = new Field(name + ".uomId", id.getUomId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".uomIdTo", id.getUomIdTo(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
