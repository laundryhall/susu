...
import org.opentaps.base.entities.InventoryItemTempResPk;

/**
 * A FieldBridge for InventoryItemTempResPk.
 */
public class InventoryItemTempResPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the InventoryItemTempResPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        InventoryItemTempResPk id = new InventoryItemTempResPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        InventoryItemTempResPk id = (InventoryItemTempResPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        InventoryItemTempResPk id = (InventoryItemTempResPk) value;
