...
import org.opentaps.base.entities.FacilityGroupRollupPk;

/**
 * A FieldBridge for FacilityGroupRollupPk.
 */
public class FacilityGroupRollupPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FacilityGroupRollupPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FacilityGroupRollupPk id = new FacilityGroupRollupPk();
        Field field = null;
        field = document.getField(name + ".facilityGroupId");
        id.setFacilityGroupId(field.stringValue());
        field = document.getField(name + ".parentFacilityGroupId");
        id.setParentFacilityGroupId(field.stringValue());
    ...
    public String objectToString(Object object) {
        FacilityGroupRollupPk id = (FacilityGroupRollupPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getFacilityGroupId());
        sb.append("_");
        sb.append(id.getParentFacilityGroupId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FacilityGroupRollupPk id = (FacilityGroupRollupPk) value;
        ...
        Field field = null;
        field = new Field(name + ".facilityGroupId", id.getFacilityGroupId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".parentFacilityGroupId", id.getParentFacilityGroupId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
