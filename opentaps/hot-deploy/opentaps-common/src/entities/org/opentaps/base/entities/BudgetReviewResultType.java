...
/**
 * Auto generated base entity BudgetReviewResultType.
 */
@javax.persistence.Entity
@Table(name="BUDGET_REVIEW_RESULT_TYPE")
public class BudgetReviewResultType extends Entity {
static {
...
fieldMapColumns.put("BudgetReviewResultType", fields);
}
  public static enum Fields implements EntityFieldInterface<BudgetReviewResultType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="BudgetReviewResultType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="BudgetReviewResultType_GEN")
   @Id
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="budgetReviewResultType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="BUDGET_REVIEW_RESULT_TYPE_ID")
  ...
  public BudgetReviewResultType() {
      super();
      this.baseEntityName = "BudgetReviewResultType";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("budgetReviewResultTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("budgetReviewResultTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("comments");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public BudgetReviewResultType(RepositoryInterface repository) {
      this();
