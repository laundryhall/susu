...
import org.opentaps.base.entities.EmplPositionReportingStructPk;

/**
 * A FieldBridge for EmplPositionReportingStructPk.
 */
public class EmplPositionReportingStructPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the EmplPositionReportingStructPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        EmplPositionReportingStructPk id = new EmplPositionReportingStructPk();
        Field field = null;
        field = document.getField(name + ".emplPositionIdReportingTo");
        id.setEmplPositionIdReportingTo(field.stringValue());
        field = document.getField(name + ".emplPositionIdManagedBy");
        id.setEmplPositionIdManagedBy(field.stringValue());
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        EmplPositionReportingStructPk id = (EmplPositionReportingStructPk) value;
        ...
        Field field = null;
        field = new Field(name + ".emplPositionIdReportingTo", id.getEmplPositionIdReportingTo(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".emplPositionIdManagedBy", id.getEmplPositionIdManagedBy(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
