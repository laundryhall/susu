...
import org.opentaps.base.entities.FacilityLocationPk;

/**
 * A FieldBridge for FacilityLocationPk.
 */
public class FacilityLocationPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FacilityLocationPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FacilityLocationPk id = new FacilityLocationPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        FacilityLocationPk id = (FacilityLocationPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FacilityLocationPk id = (FacilityLocationPk) value;
