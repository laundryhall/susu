...
import org.opentaps.base.entities.UserLoginViewPreferencePk;

/**
 * A FieldBridge for UserLoginViewPreferencePk.
 */
public class UserLoginViewPreferencePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the UserLoginViewPreferencePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        UserLoginViewPreferencePk id = new UserLoginViewPreferencePk();
        Field field = null;
        field = document.getField(name + ".userLoginId");
        id.setUserLoginId(field.stringValue());
        field = document.getField(name + ".applicationName");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        UserLoginViewPreferencePk id = (UserLoginViewPreferencePk) value;
        ...
        document.add(field);
        field = new Field(name + ".applicationName", id.getApplicationName(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
