...
/**
 * Auto generated base entity DataTemplateType.
 */
@javax.persistence.Entity
@Table(name="DATA_TEMPLATE_TYPE")
public class DataTemplateType extends Entity {
static {
...
fieldMapColumns.put("DataTemplateType", fields);
}
  public static enum Fields implements EntityFieldInterface<DataTemplateType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="DataTemplateType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="dataTemplateType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
  ...
  public DataTemplateType() {
      super();
      this.baseEntityName = "DataTemplateType";
      this.isView = false;
      this.resourceName = "ContentEntityLabels";
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("dataTemplateTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("dataTemplateTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("extension");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public DataTemplateType(RepositoryInterface repository) {
      this();
