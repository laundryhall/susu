...
import org.opentaps.base.entities.ProductStoreGroupRollupPk;

/**
 * A FieldBridge for ProductStoreGroupRollupPk.
 */
public class ProductStoreGroupRollupPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductStoreGroupRollupPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductStoreGroupRollupPk id = new ProductStoreGroupRollupPk();
        Field field = null;
        field = document.getField(name + ".productStoreGroupId");
        id.setProductStoreGroupId(field.stringValue());
        field = document.getField(name + ".parentGroupId");
        id.setParentGroupId(field.stringValue());
    ...
    public String objectToString(Object object) {
        ProductStoreGroupRollupPk id = (ProductStoreGroupRollupPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProductStoreGroupId());
        sb.append("_");
        sb.append(id.getParentGroupId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductStoreGroupRollupPk id = (ProductStoreGroupRollupPk) value;
        ...
        document.add(field);
        field = new Field(name + ".parentGroupId", id.getParentGroupId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
