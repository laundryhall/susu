...
import org.opentaps.base.entities.CustRequestContentPk;

/**
 * A FieldBridge for CustRequestContentPk.
 */
public class CustRequestContentPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CustRequestContentPk.
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CustRequestContentPk id = (CustRequestContentPk) value;
