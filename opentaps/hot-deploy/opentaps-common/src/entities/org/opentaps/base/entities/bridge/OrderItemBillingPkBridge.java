...
import org.opentaps.base.entities.OrderItemBillingPk;

/**
 * A FieldBridge for OrderItemBillingPk.
 */
public class OrderItemBillingPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the OrderItemBillingPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        OrderItemBillingPk id = new OrderItemBillingPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        OrderItemBillingPk id = (OrderItemBillingPk) value;
