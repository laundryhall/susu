...
/**
 * Auto generated base entity PriorityType.
 */
@javax.persistence.Entity
@Table(name="PRIORITY_TYPE")
public class PriorityType extends Entity {
static {
...
fieldMapColumns.put("PriorityType", fields);
}
  public static enum Fields implements EntityFieldInterface<PriorityType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="PriorityType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="PriorityType_GEN")
   @Id
  ...
  public PriorityType() {
      super();
      this.baseEntityName = "PriorityType";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("priorityTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("priorityTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public PriorityType(RepositoryInterface repository) {
      this();
