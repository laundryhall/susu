...
public class ProjectAndPhaseAndTask extends Entity {
static {
...
fieldMapColumns.put("ProjectAndPhaseAndTask", fields);
}
  public static enum Fields implements EntityFieldInterface<ProjectAndPhaseAndTask> {
    projectId("projectId"),
   ...
   */
  public ProjectAndPhaseAndTask(RepositoryInterface repository) {
      this();
