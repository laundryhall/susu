...
import org.opentaps.base.entities.PartyNameHistoryPk;

/**
 * A FieldBridge for PartyNameHistoryPk.
 */
public class PartyNameHistoryPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyNameHistoryPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyNameHistoryPk id = new PartyNameHistoryPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PartyNameHistoryPk id = (PartyNameHistoryPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyNameHistoryPk id = (PartyNameHistoryPk) value;
