...
import org.opentaps.base.entities.ProductSubscriptionResourcePk;

/**
 * A FieldBridge for ProductSubscriptionResourcePk.
 */
public class ProductSubscriptionResourcePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductSubscriptionResourcePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductSubscriptionResourcePk id = new ProductSubscriptionResourcePk();
        Field field = null;
        field = document.getField(name + ".productId");
        id.setProductId(field.stringValue());
        field = document.getField(name + ".subscriptionResourceId");
        id.setSubscriptionResourceId(field.stringValue());
    ...
    public String objectToString(Object object) {
        ProductSubscriptionResourcePk id = (ProductSubscriptionResourcePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProductId());
        sb.append("_");
        sb.append(id.getSubscriptionResourceId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductSubscriptionResourcePk id = (ProductSubscriptionResourcePk) value;
        ...
        document.add(field);
        field = new Field(name + ".subscriptionResourceId", id.getSubscriptionResourceId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
