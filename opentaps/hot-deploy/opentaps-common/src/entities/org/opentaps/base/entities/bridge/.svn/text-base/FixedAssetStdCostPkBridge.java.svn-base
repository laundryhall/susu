...
import org.opentaps.base.entities.FixedAssetStdCostPk;

/**
 * A FieldBridge for FixedAssetStdCostPk.
 */
public class FixedAssetStdCostPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FixedAssetStdCostPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FixedAssetStdCostPk id = new FixedAssetStdCostPk();
        Field field = null;
        field = document.getField(name + ".fixedAssetId");
        id.setFixedAssetId(field.stringValue());
        field = document.getField(name + ".fixedAssetStdCostTypeId");
        id.setFixedAssetStdCostTypeId(field.stringValue());
    ...
    public String objectToString(Object object) {
        FixedAssetStdCostPk id = (FixedAssetStdCostPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getFixedAssetId());
        sb.append("_");
        sb.append(id.getFixedAssetStdCostTypeId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FixedAssetStdCostPk id = (FixedAssetStdCostPk) value;
        ...
        document.add(field);
        field = new Field(name + ".fixedAssetStdCostTypeId", id.getFixedAssetStdCostTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
