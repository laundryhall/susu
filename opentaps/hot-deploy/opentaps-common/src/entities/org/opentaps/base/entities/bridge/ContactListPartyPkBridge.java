...
import org.opentaps.base.entities.ContactListPartyPk;

/**
 * A FieldBridge for ContactListPartyPk.
 */
public class ContactListPartyPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ContactListPartyPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ContactListPartyPk id = new ContactListPartyPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ContactListPartyPk id = (ContactListPartyPk) value;
