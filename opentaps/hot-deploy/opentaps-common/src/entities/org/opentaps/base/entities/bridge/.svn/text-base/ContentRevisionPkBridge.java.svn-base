...
import org.opentaps.base.entities.ContentRevisionPk;

/**
 * A FieldBridge for ContentRevisionPk.
 */
public class ContentRevisionPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ContentRevisionPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ContentRevisionPk id = new ContentRevisionPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ContentRevisionPk id = (ContentRevisionPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ContentRevisionPk id = (ContentRevisionPk) value;
