...
import org.opentaps.base.entities.AmazonProductImageAckPk;

/**
 * A FieldBridge for AmazonProductImageAckPk.
 */
public class AmazonProductImageAckPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AmazonProductImageAckPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AmazonProductImageAckPk id = new AmazonProductImageAckPk();
        Field field = null;
        field = document.getField(name + ".productId");
        id.setProductId(field.stringValue());
        field = document.getField(name + ".productContentTypeId");
        id.setProductContentTypeId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        AmazonProductImageAckPk id = (AmazonProductImageAckPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProductId());
        sb.append("_");
        sb.append(id.getProductContentTypeId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AmazonProductImageAckPk id = (AmazonProductImageAckPk) value;
        ...
        document.add(field);
        field = new Field(name + ".productContentTypeId", id.getProductContentTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
