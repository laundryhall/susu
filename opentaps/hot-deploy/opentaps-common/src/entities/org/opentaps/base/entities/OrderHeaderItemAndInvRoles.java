...
/**
 * Auto generated base entity OrderHeaderItemAndInvRoles.
 */
@javax.persistence.Entity
@NamedNativeQuery(name="selectOrderHeaderItemAndInvRoless", query="SELECT OH.ORDER_ID AS \"orderId\",OT.PARTY_ID AS \"partyId\",OT.ROLE_TYPE_ID AS \"roleTypeId\",OH.ORDER_TYPE_ID AS \"orderTypeId\",OH.ORDER_DATE AS \"orderDate\",OH.ENTRY_DATE AS \"entryDate\",OH.VISIT_ID AS \"visitId\",OH.STATUS_ID AS \"statusId\",OH.CREATED_BY AS \"createdBy\",OH.FIRST_ATTEMPT_ORDER_ID AS \"firstAttemptOrderId\",OH.CURRENCY_UOM AS \"currencyUom\",OH.SYNC_STATUS_ID AS \"syncStatusId\",OH.BILLING_ACCOUNT_ID AS \"billingAccountId\",OH.ORIGIN_FACILITY_ID AS \"originFacilityId\",OH.PRODUCT_STORE_ID AS \"productStoreId\",OH.WEB_SITE_ID AS \"webSiteId\",OH.GRAND_TOTAL AS \"grandTotal\",OH.REMAINING_SUB_TOTAL AS \"remainingSubTotal\",OI.PRODUCT_ID AS \"productId\",OI.QUANTITY AS \"quantity\",OI.UNIT_PRICE AS \"unitPrice\",OI.UNIT_LIST_PRICE AS \"unitListPrice\",OI.ESTIMATED_SHIP_DATE AS \"estimatedShipDate\",OI.AUTO_CANCEL_DATE AS \"autoCancelDate\",OI.CORRESPONDING_PO_ID AS \"correspondingPoId\",IV.QUANTITY_NOT_AVAILABLE AS \"quantityNotAvailable\" FROM ORDER_ROLE OT INNER JOIN ORDER_HEADER OH ON OT.ORDER_ID = OH.ORDER_ID INNER JOIN ORDER_ITEM OI ON OH.ORDER_ID = OI.ORDER_ID INNER JOIN ORDER_ITEM_SHIP_GRP_INV_RES IV ON OI.ORDER_ID = IV.ORDER_ID AND OI.ORDER_ITEM_SEQ_ID = IV.ORDER_ITEM_SEQ_ID", resultSetMapping="OrderHeaderItemAndInvRolesMapping")
@SqlResultSetMapping(name="OrderHeaderItemAndInvRolesMapping", entities={
@EntityResult(entityClass=OrderHeaderItemAndInvRoles.class, fields = {
...
public class OrderHeaderItemAndInvRoles extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        ...
        fields.put("quantityNotAvailable", "IV.QUANTITY_NOT_AVAILABLE");
fieldMapColumns.put("OrderHeaderItemAndInvRoles", fields);
}
  public static enum Fields implements EntityFieldInterface<OrderHeaderItemAndInvRoles> {
    orderId("orderId"),
    partyId("partyId"),
   ...
   */
  public OrderHeaderItemAndInvRoles(RepositoryInterface repository) {
      this();
