...
import org.opentaps.base.entities.CommEventContentAssocPk;

/**
 * A FieldBridge for CommEventContentAssocPk.
 */
public class CommEventContentAssocPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CommEventContentAssocPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CommEventContentAssocPk id = new CommEventContentAssocPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        CommEventContentAssocPk id = (CommEventContentAssocPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CommEventContentAssocPk id = (CommEventContentAssocPk) value;
