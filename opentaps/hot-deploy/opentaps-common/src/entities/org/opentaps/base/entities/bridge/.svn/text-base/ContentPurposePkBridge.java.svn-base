...
import org.opentaps.base.entities.ContentPurposePk;

/**
 * A FieldBridge for ContentPurposePk.
 */
public class ContentPurposePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ContentPurposePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ContentPurposePk id = new ContentPurposePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ContentPurposePk id = (ContentPurposePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ContentPurposePk id = (ContentPurposePk) value;
