...
import org.opentaps.base.entities.WorkEffortContentPk;

/**
 * A FieldBridge for WorkEffortContentPk.
 */
public class WorkEffortContentPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortContentPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortContentPk id = new WorkEffortContentPk();
        Field field = null;
        ...
        field = document.getField(name + ".workEffortContentTypeId");
        id.setWorkEffortContentTypeId(field.stringValue());
    ...
    public String objectToString(Object object) {
        WorkEffortContentPk id = (WorkEffortContentPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getWorkEffortId());
        sb.append("_");
        sb.append(id.getContentId());
        sb.append("_");
        sb.append(id.getWorkEffortContentTypeId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortContentPk id = (WorkEffortContentPk) value;
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".workEffortContentTypeId", id.getWorkEffortContentTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
