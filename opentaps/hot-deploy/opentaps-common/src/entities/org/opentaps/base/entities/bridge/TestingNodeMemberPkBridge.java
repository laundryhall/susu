...
import org.opentaps.base.entities.TestingNodeMemberPk;

/**
 * A FieldBridge for TestingNodeMemberPk.
 */
public class TestingNodeMemberPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the TestingNodeMemberPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        TestingNodeMemberPk id = new TestingNodeMemberPk();
        Field field = null;
        field = document.getField(name + ".testingNodeId");
        id.setTestingNodeId(field.stringValue());
        field = document.getField(name + ".testingId");
        id.setTestingId(field.stringValue());
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        TestingNodeMemberPk id = (TestingNodeMemberPk) value;
        ...
        Field field = null;
        field = new Field(name + ".testingNodeId", id.getTestingNodeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".testingId", id.getTestingId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
