...
/**
 * Auto generated base entity DocumentAttribute.
 */
@javax.persistence.Entity
@Table(name="DOCUMENT_ATTRIBUTE")
public class DocumentAttribute extends Entity {
static {
...
fieldMapColumns.put("DocumentAttribute", fields);
}
  public static enum Fields implements EntityFieldInterface<DocumentAttribute> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.DocumentAttributePkBridge.class)
     private DocumentAttributePk id = new DocumentAttributePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>DocumentAttributePk</code>
     */
     ...
     * @param id a <code>DocumentAttributePk</code> value to set
    */   
  ...
  public DocumentAttribute() {
      super();
      this.baseEntityName = "DocumentAttribute";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("documentId");this.primaryKeyNames.add("attrName");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("documentId");this.allFieldsNames.add("attrName");this.allFieldsNames.add("attrValue");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public DocumentAttribute(RepositoryInterface repository) {
      this();
