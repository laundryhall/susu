...
import org.opentaps.base.entities.OldOrderItemInventoryResPk;

/**
 * A FieldBridge for OldOrderItemInventoryResPk.
 */
public class OldOrderItemInventoryResPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the OldOrderItemInventoryResPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        OldOrderItemInventoryResPk id = new OldOrderItemInventoryResPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        OldOrderItemInventoryResPk id = (OldOrderItemInventoryResPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        OldOrderItemInventoryResPk id = (OldOrderItemInventoryResPk) value;
