...
public class ContentDataResourceView extends Entity {
static {
...
fieldMapColumns.put("ContentDataResourceView", fields);
}
  public static enum Fields implements EntityFieldInterface<ContentDataResourceView> {
    contentId("contentId"),
   ...
   * Default constructor.
   */
  public ContentDataResourceView() {
      super();
      this.baseEntityName = "ContentDataResourceView";
      this.isView = true;
   ...
   */
  public ContentDataResourceView(RepositoryInterface repository) {
      this();
