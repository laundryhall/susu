...
fieldMapColumns.put("GlAccountGroup", fields);
  ...
  public static enum Fields implements EntityFieldInterface<GlAccountGroup> {
   ...
   private transient List<GlAccountGroupMember> glAccountGroupMembers = null;
  ...
  public GlAccountGroup() {
      ...
      this.allFieldsNames.add("glAccountGroupId");this.allFieldsNames.add("glAccountGroupTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
