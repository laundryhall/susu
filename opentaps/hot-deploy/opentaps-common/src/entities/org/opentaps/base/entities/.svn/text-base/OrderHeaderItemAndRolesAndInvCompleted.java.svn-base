...
/**
 * Auto generated base entity OrderHeaderItemAndRolesAndInvCompleted.
 */
...
@SqlResultSetMapping(name="OrderHeaderItemAndRolesAndInvCompletedMapping", entities={
@EntityResult(entityClass=OrderHeaderItemAndRolesAndInvCompleted.class, fields = {
...
public class OrderHeaderItemAndRolesAndInvCompleted extends Entity {
static {
...
fieldMapColumns.put("OrderHeaderItemAndRolesAndInvCompleted", fields);
}
  public static enum Fields implements EntityFieldInterface<OrderHeaderItemAndRolesAndInvCompleted> {
    orderName("orderName"),
    orderId("orderId"),
    partyId("partyId"),
   ...
   */
  public OrderHeaderItemAndRolesAndInvCompleted(RepositoryInterface repository) {
      this();
