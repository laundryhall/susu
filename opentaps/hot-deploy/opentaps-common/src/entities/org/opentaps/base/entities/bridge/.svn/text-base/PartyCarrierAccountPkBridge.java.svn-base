...
import org.opentaps.base.entities.PartyCarrierAccountPk;

/**
 * A FieldBridge for PartyCarrierAccountPk.
 */
public class PartyCarrierAccountPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyCarrierAccountPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyCarrierAccountPk id = new PartyCarrierAccountPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PartyCarrierAccountPk id = (PartyCarrierAccountPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyCarrierAccountPk id = (PartyCarrierAccountPk) value;
