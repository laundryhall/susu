...
import org.opentaps.base.entities.ProdCatalogCategoryPk;

/**
 * A FieldBridge for ProdCatalogCategoryPk.
 */
public class ProdCatalogCategoryPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProdCatalogCategoryPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProdCatalogCategoryPk id = new ProdCatalogCategoryPk();
        Field field = null;
        ...
        field = document.getField(name + ".prodCatalogCategoryTypeId");
        id.setProdCatalogCategoryTypeId(field.stringValue());
    ...
    public String objectToString(Object object) {
        ProdCatalogCategoryPk id = (ProdCatalogCategoryPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProdCatalogId());
        sb.append("_");
        sb.append(id.getProductCategoryId());
        sb.append("_");
        sb.append(id.getProdCatalogCategoryTypeId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProdCatalogCategoryPk id = (ProdCatalogCategoryPk) value;
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".prodCatalogCategoryTypeId", id.getProdCatalogCategoryTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
