...
import org.opentaps.base.entities.DataImportUSCountyTaxPk;

/**
 * A FieldBridge for DataImportUSCountyTaxPk.
 */
public class DataImportUSCountyTaxPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the DataImportUSCountyTaxPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        DataImportUSCountyTaxPk id = new DataImportUSCountyTaxPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        DataImportUSCountyTaxPk id = (DataImportUSCountyTaxPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        DataImportUSCountyTaxPk id = (DataImportUSCountyTaxPk) value;
