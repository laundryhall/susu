...
public class ContentAssocViewFrom extends Entity {
static {
...
fieldMapColumns.put("ContentAssocViewFrom", fields);
}
   ...
   * Default constructor.
   */
  public ContentAssocViewFrom() {
      super();
      this.baseEntityName = "ContentAssocViewFrom";
      this.isView = true;
   ...
   */
  public ContentAssocViewFrom(RepositoryInterface repository) {
      this();
