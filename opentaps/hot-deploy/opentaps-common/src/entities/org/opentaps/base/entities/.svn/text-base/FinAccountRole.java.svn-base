...
/**
 * Auto generated base entity FinAccountRole.
 */
@javax.persistence.Entity
@Table(name="FIN_ACCOUNT_ROLE")
public class FinAccountRole extends Entity {
static {
...
fieldMapColumns.put("FinAccountRole", fields);
}
  public static enum Fields implements EntityFieldInterface<FinAccountRole> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.FinAccountRolePkBridge.class)
     private FinAccountRolePk id = new FinAccountRolePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>FinAccountRolePk</code>
     */
      public FinAccountRolePk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>FinAccountRolePk</code> value to set
    */   
      public void setId(FinAccountRolePk id) {
         this.id = id;
      }
   ...
   * Default constructor.
   */
  public FinAccountRole() {
      super();
      this.baseEntityName = "FinAccountRole";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("finAccountId");this.primaryKeyNames.add("partyId");this.primaryKeyNames.add("roleTypeId");this.primaryKeyNames.add("fromDate");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("finAccountId");this.allFieldsNames.add("partyId");this.allFieldsNames.add("roleTypeId");this.allFieldsNames.add("fromDate");this.allFieldsNames.add("thruDate");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public FinAccountRole(RepositoryInterface repository) {
      this();
