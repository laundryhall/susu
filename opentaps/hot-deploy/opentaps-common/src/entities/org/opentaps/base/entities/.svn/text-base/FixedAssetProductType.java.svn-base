...
/**
 * Auto generated base entity FixedAssetProductType.
 */
@javax.persistence.Entity
@Table(name="FIXED_ASSET_PRODUCT_TYPE")
public class FixedAssetProductType extends Entity {
static {
...
fieldMapColumns.put("FixedAssetProductType", fields);
}
  public static enum Fields implements EntityFieldInterface<FixedAssetProductType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="FixedAssetProductType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="FixedAssetProductType_GEN")
   @Id
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="fixedAssetProductType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="FIXED_ASSET_PRODUCT_TYPE_ID")
  ...
  public FixedAssetProductType() {
      super();
      this.baseEntityName = "FixedAssetProductType";
      this.isView = false;
      this.resourceName = "AccountingEntityLabels";
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("fixedAssetProductTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("fixedAssetProductTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public FixedAssetProductType(RepositoryInterface repository) {
      this();
