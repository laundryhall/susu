...
import org.opentaps.base.entities.AgreementRolePk;

/**
 * A FieldBridge for AgreementRolePk.
 */
public class AgreementRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AgreementRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AgreementRolePk id = new AgreementRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        AgreementRolePk id = (AgreementRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AgreementRolePk id = (AgreementRolePk) value;
