...
import org.opentaps.base.entities.PersonTrainingPk;

/**
 * A FieldBridge for PersonTrainingPk.
 */
public class PersonTrainingPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PersonTrainingPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PersonTrainingPk id = new PersonTrainingPk();
        Field field = null;
        field = document.getField(name + ".partyId");
        id.setPartyId(field.stringValue());
        field = document.getField(name + ".trainingClassTypeId");
        id.setTrainingClassTypeId(field.stringValue());
    ...
    public String objectToString(Object object) {
        PersonTrainingPk id = (PersonTrainingPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getPartyId());
        sb.append("_");
        sb.append(id.getTrainingClassTypeId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PersonTrainingPk id = (PersonTrainingPk) value;
        ...
        document.add(field);
        field = new Field(name + ".trainingClassTypeId", id.getTrainingClassTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
