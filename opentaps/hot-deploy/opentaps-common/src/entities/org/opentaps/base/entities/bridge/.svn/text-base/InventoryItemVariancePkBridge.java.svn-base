...
import org.opentaps.base.entities.InventoryItemVariancePk;

/**
 * A FieldBridge for InventoryItemVariancePk.
 */
public class InventoryItemVariancePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the InventoryItemVariancePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        InventoryItemVariancePk id = new InventoryItemVariancePk();
        Field field = null;
        field = document.getField(name + ".inventoryItemId");
        id.setInventoryItemId(field.stringValue());
        field = document.getField(name + ".physicalInventoryId");
        id.setPhysicalInventoryId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        InventoryItemVariancePk id = (InventoryItemVariancePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getInventoryItemId());
        sb.append("_");
        sb.append(id.getPhysicalInventoryId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        InventoryItemVariancePk id = (InventoryItemVariancePk) value;
        ...
        document.add(field);
        field = new Field(name + ".physicalInventoryId", id.getPhysicalInventoryId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
