...
/**
 * Auto generated base entity FixedAssetAttribute.
 */
@javax.persistence.Entity
@Table(name="FIXED_ASSET_ATTRIBUTE")
public class FixedAssetAttribute extends Entity {
static {
...
fieldMapColumns.put("FixedAssetAttribute", fields);
}
  public static enum Fields implements EntityFieldInterface<FixedAssetAttribute> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.FixedAssetAttributePkBridge.class)
     private FixedAssetAttributePk id = new FixedAssetAttributePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>FixedAssetAttributePk</code>
     */
      public FixedAssetAttributePk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>FixedAssetAttributePk</code> value to set
    */   
      public void setId(FixedAssetAttributePk id) {
         this.id = id;
      }
   ...
   private transient List<FixedAssetTypeAttr> fixedAssetTypeAttrs = null;

  /**
   * Default constructor.
   */
  public FixedAssetAttribute() {
      super();
      this.baseEntityName = "FixedAssetAttribute";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("fixedAssetId");this.primaryKeyNames.add("attrName");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("fixedAssetId");this.allFieldsNames.add("attrName");this.allFieldsNames.add("attrValue");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public FixedAssetAttribute(RepositoryInterface repository) {
      this();
