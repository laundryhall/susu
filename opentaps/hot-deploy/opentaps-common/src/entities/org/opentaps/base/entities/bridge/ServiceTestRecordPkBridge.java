...
/**
 * A FieldBridge for ServiceTestRecordPk.
 */
public class ServiceTestRecordPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ServiceTestRecordPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ServiceTestRecordPk id = new ServiceTestRecordPk();
        Field field = null;
        field = document.getField(name + ".key1");
        id.setKey1(field.stringValue());
        field = document.getField(name + ".key2");
        id.setKey2(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        ServiceTestRecordPk id = (ServiceTestRecordPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getKey1());
        sb.append("_");
        sb.append(id.getKey2());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ServiceTestRecordPk id = (ServiceTestRecordPk) value;
        ...
        Field field = null;
        field = new Field(name + ".key1", id.getKey1(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".key2", id.getKey2(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
