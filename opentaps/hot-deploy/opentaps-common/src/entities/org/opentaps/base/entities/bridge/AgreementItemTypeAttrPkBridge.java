...
import org.opentaps.base.entities.AgreementItemTypeAttrPk;

/**
 * A FieldBridge for AgreementItemTypeAttrPk.
 */
public class AgreementItemTypeAttrPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AgreementItemTypeAttrPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AgreementItemTypeAttrPk id = new AgreementItemTypeAttrPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        AgreementItemTypeAttrPk id = (AgreementItemTypeAttrPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AgreementItemTypeAttrPk id = (AgreementItemTypeAttrPk) value;
