...
/**
 * A FieldBridge for RespondingPartyPk.
 */
public class RespondingPartyPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the RespondingPartyPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        RespondingPartyPk id = new RespondingPartyPk();
        Field field = null;
        field = document.getField(name + ".respondingPartySeqId");
        id.setRespondingPartySeqId(field.stringValue());
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        RespondingPartyPk id = (RespondingPartyPk) value;
        ...
        Field field = null;
        field = new Field(name + ".respondingPartySeqId", id.getRespondingPartySeqId(), store, index, termVector);
