...
import org.opentaps.base.entities.AmazonOtherItemAttrValuePk;

/**
 * A FieldBridge for AmazonOtherItemAttrValuePk.
 */
public class AmazonOtherItemAttrValuePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AmazonOtherItemAttrValuePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AmazonOtherItemAttrValuePk id = new AmazonOtherItemAttrValuePk();
        Field field = null;
        field = document.getField(name + ".productId");
        id.setProductId(field.stringValue());
        field = document.getField(name + ".otherItemAttrId");
        id.setOtherItemAttrId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        AmazonOtherItemAttrValuePk id = (AmazonOtherItemAttrValuePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProductId());
        sb.append("_");
        sb.append(id.getOtherItemAttrId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AmazonOtherItemAttrValuePk id = (AmazonOtherItemAttrValuePk) value;
        ...
        document.add(field);
        field = new Field(name + ".otherItemAttrId", id.getOtherItemAttrId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
