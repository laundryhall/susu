...
/**
 * Auto generated base entity UserAgentType.
 */
@javax.persistence.Entity
@Table(name="USER_AGENT_TYPE")
public class UserAgentType extends Entity {
static {
...
fieldMapColumns.put("UserAgentType", fields);
}
  public static enum Fields implements EntityFieldInterface<UserAgentType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="UserAgentType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="UserAgentType_GEN")
   @Id
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="userAgentType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="USER_AGENT_TYPE_ID")
  ...
  public UserAgentType() {
      super();
      this.baseEntityName = "UserAgentType";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("userAgentTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("userAgentTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public UserAgentType(RepositoryInterface repository) {
      this();
