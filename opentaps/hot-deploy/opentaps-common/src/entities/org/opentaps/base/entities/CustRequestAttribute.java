...
/**
 * Auto generated base entity CustRequestAttribute.
 */
@javax.persistence.Entity
@Table(name="CUST_REQUEST_ATTRIBUTE")
public class CustRequestAttribute extends Entity {
static {
...
fieldMapColumns.put("CustRequestAttribute", fields);
}
  public static enum Fields implements EntityFieldInterface<CustRequestAttribute> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.CustRequestAttributePkBridge.class)
     private CustRequestAttributePk id = new CustRequestAttributePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>CustRequestAttributePk</code>
     */
     ...
     * @param id a <code>CustRequestAttributePk</code> value to set
    */   
   ...
   private transient List<CustRequestTypeAttr> custRequestTypeAttrs = null;
  ...
  public CustRequestAttribute() {
      super();
      this.baseEntityName = "CustRequestAttribute";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("custRequestId");this.primaryKeyNames.add("attrName");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("custRequestId");this.allFieldsNames.add("attrName");this.allFieldsNames.add("attrValue");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public CustRequestAttribute(RepositoryInterface repository) {
      this();
