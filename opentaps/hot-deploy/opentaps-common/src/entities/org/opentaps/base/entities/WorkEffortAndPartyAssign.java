...
public class WorkEffortAndPartyAssign extends Entity {
static {
...
fieldMapColumns.put("WorkEffortAndPartyAssign", fields);
}
  public static enum Fields implements EntityFieldInterface<WorkEffortAndPartyAssign> {
   ...
   * Default constructor.
   */
  public WorkEffortAndPartyAssign() {
      super();
      this.baseEntityName = "WorkEffortAndPartyAssign";
      this.isView = true;
   ...
   */
  public WorkEffortAndPartyAssign(RepositoryInterface repository) {
      this();
