...
/**
 * Auto generated base entity SurveyQuestionType.
 */
@javax.persistence.Entity
@Table(name="SURVEY_QUESTION_TYPE")
public class SurveyQuestionType extends Entity {
static {
...
fieldMapColumns.put("SurveyQuestionType", fields);
}
  public static enum Fields implements EntityFieldInterface<SurveyQuestionType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="SurveyQuestionType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="SurveyQuestionType_GEN")
   @Id
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="surveyQuestionType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
  ...
  public SurveyQuestionType() {
      super();
      this.baseEntityName = "SurveyQuestionType";
      this.isView = false;
      this.resourceName = "ContentEntityLabels";
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("surveyQuestionTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("surveyQuestionTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public SurveyQuestionType(RepositoryInterface repository) {
      this();
