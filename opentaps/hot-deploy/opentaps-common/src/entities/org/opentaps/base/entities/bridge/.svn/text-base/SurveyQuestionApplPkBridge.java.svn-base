...
import org.opentaps.base.entities.SurveyQuestionApplPk;

/**
 * A FieldBridge for SurveyQuestionApplPk.
 */
public class SurveyQuestionApplPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the SurveyQuestionApplPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        SurveyQuestionApplPk id = new SurveyQuestionApplPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        SurveyQuestionApplPk id = (SurveyQuestionApplPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        SurveyQuestionApplPk id = (SurveyQuestionApplPk) value;
