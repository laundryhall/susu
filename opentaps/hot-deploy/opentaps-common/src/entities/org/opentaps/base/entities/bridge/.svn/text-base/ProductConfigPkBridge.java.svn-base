...
import org.opentaps.base.entities.ProductConfigPk;

/**
 * A FieldBridge for ProductConfigPk.
 */
public class ProductConfigPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductConfigPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductConfigPk id = new ProductConfigPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductConfigPk id = (ProductConfigPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductConfigPk id = (ProductConfigPk) value;
