...
/**
 * Auto generated base entity AmazonProductUsedFor.
 */
@javax.persistence.Entity
@Table(name="AMAZON_PRODUCT_USED_FOR")
public class AmazonProductUsedFor extends Entity {
static {
...
fieldMapColumns.put("AmazonProductUsedFor", fields);
}
  public static enum Fields implements EntityFieldInterface<AmazonProductUsedFor> {
    usedForId("usedForId"),
   ...
   @org.hibernate.annotations.GenericGenerator(name="AmazonProductUsedFor_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="AmazonProductUsedFor_GEN")
   @Id
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="amazonProductUsedFor", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   ...
   * Default constructor.
   */
  public AmazonProductUsedFor() {
      super();
      this.baseEntityName = "AmazonProductUsedFor";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("usedForId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("usedForId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public AmazonProductUsedFor(RepositoryInterface repository) {
      this();
