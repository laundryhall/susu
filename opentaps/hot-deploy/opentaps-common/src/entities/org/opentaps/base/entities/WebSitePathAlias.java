...
/**
 * Auto generated base entity WebSitePathAlias.
 */
@javax.persistence.Entity
@Table(name="WEB_SITE_PATH_ALIAS")
public class WebSitePathAlias extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        fields.put("webSiteId", "WEB_SITE_ID");
        fields.put("pathAlias", "PATH_ALIAS");
        fields.put("aliasTo", "ALIAS_TO");
...
fieldMapColumns.put("WebSitePathAlias", fields);
}
  public static enum Fields implements EntityFieldInterface<WebSitePathAlias> {
    webSiteId("webSiteId"),
    pathAlias("pathAlias"),
    aliasTo("aliasTo"),
    contentId("contentId"),
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.WebSitePathAliasPkBridge.class)
     ...
     * @return <code>WebSitePathAliasPk</code>
     */
      public WebSitePathAliasPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>WebSitePathAliasPk</code> value to set
    */   
      public void setId(WebSitePathAliasPk id) {
         this.id = id;
      }
  ...
  public WebSitePathAlias() {
      super();
      this.baseEntityName = "WebSitePathAlias";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("webSiteId");this.primaryKeyNames.add("pathAlias");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("webSiteId");this.allFieldsNames.add("pathAlias");this.allFieldsNames.add("aliasTo");this.allFieldsNames.add("contentId");this.allFieldsNames.add("mapKey");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public WebSitePathAlias(RepositoryInterface repository) {
      this();
    ...
    */
    ...
    public void fromMap(Map<String, Object> mapValue) {
        ...
        setPathAlias((String) mapValue.get("pathAlias"));
        setAliasTo((String) mapValue.get("aliasTo"));
    ...
    public Map<String, Object> toMap() {
        ...
        mapValue.put("pathAlias", getPathAlias());
        mapValue.put("aliasTo", getAliasTo());
