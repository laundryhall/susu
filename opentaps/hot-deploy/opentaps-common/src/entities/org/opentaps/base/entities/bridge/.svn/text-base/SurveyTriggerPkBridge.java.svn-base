...
import org.opentaps.base.entities.SurveyTriggerPk;

/**
 * A FieldBridge for SurveyTriggerPk.
 */
public class SurveyTriggerPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the SurveyTriggerPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        SurveyTriggerPk id = new SurveyTriggerPk();
        Field field = null;
        field = document.getField(name + ".surveyId");
        id.setSurveyId(field.stringValue());
        field = document.getField(name + ".surveyApplTypeId");
        id.setSurveyApplTypeId(field.stringValue());
    ...
    public String objectToString(Object object) {
        SurveyTriggerPk id = (SurveyTriggerPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getSurveyId());
        sb.append("_");
        sb.append(id.getSurveyApplTypeId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        SurveyTriggerPk id = (SurveyTriggerPk) value;
        ...
        document.add(field);
        field = new Field(name + ".surveyApplTypeId", id.getSurveyApplTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
