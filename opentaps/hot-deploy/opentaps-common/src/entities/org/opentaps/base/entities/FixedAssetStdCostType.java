...
fieldMapColumns.put("FixedAssetStdCostType", fields);
  ...
  public static enum Fields implements EntityFieldInterface<FixedAssetStdCostType> {
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="parentFixedAssetStdCostType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
  ...
  public FixedAssetStdCostType() {
      ...
      this.allFieldsNames.add("fixedAssetStdCostTypeId");this.allFieldsNames.add("parentTypeId");this.allFieldsNames.add("hasTable");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
