...
/**
 * Auto generated base entity ContentAndQuote.
 */
...
@SqlResultSetMapping(name="ContentAndQuoteMapping", entities={
@EntityResult(entityClass=ContentAndQuote.class, fields = {
...
public class ContentAndQuote extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        fields.put("quoteId", "QC.QUOTE_ID");
        fields.put("fromDate", "QC.FROM_DATE");
        fields.put("thruDate", "QC.THRU_DATE");
...
fieldMapColumns.put("ContentAndQuote", fields);
}
  public static enum Fields implements EntityFieldInterface<ContentAndQuote> {
    quoteId("quoteId"),
    fromDate("fromDate"),
    thruDate("thruDate"),
    contentId("contentId"),
   ...
   */
  public ContentAndQuote(RepositoryInterface repository) {
      this();
