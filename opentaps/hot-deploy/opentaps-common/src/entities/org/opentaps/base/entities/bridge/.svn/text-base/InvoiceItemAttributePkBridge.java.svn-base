...
import org.opentaps.base.entities.InvoiceItemAttributePk;

/**
 * A FieldBridge for InvoiceItemAttributePk.
 */
public class InvoiceItemAttributePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the InvoiceItemAttributePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        InvoiceItemAttributePk id = new InvoiceItemAttributePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        InvoiceItemAttributePk id = (InvoiceItemAttributePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        InvoiceItemAttributePk id = (InvoiceItemAttributePk) value;
