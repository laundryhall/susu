...
import org.opentaps.base.entities.ProductGeoPk;

/**
 * A FieldBridge for ProductGeoPk.
 */
public class ProductGeoPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductGeoPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductGeoPk id = new ProductGeoPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductGeoPk id = (ProductGeoPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductGeoPk id = (ProductGeoPk) value;
