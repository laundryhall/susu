...
/**
 * Auto generated base entity CustRequestInfoAndWorkEffortAndPartyRel.
 */
@javax.persistence.Entity
@NamedNativeQuery(name="selectCustRequestInfoAndWorkEffortAndPartyRels", query="SELECT PR.PARTY_ID_FROM AS \"partyIdFrom\",PR.ROLE_TYPE_ID_FROM AS \"roleTypeIdFrom\",PR.PARTY_ID_TO AS \"partyIdTo\",PR.ROLE_TYPE_ID_TO AS \"roleTypeIdTo\",CR.CUST_REQUEST_ID AS \"custRequestId\",CR.CUST_REQUEST_TYPE_ID AS \"custRequestTypeId\",CR.CUST_REQUEST_CATEGORY_ID AS \"custRequestCategoryId\",CR.STATUS_ID AS \"statusId\",CR.FROM_PARTY_ID AS \"fromPartyId\",CR.PRIORITY AS \"priority\",CR.CUST_REQUEST_DATE AS \"custRequestDate\",CR.RESPONSE_REQUIRED_DATE AS \"responseRequiredDate\",CR.CUST_REQUEST_NAME AS \"custRequestName\",CR.DESCRIPTION AS \"description\",CR.MAXIMUM_AMOUNT_UOM_ID AS \"maximumAmountUomId\",CR.PRODUCT_STORE_ID AS \"productStoreId\",CR.SALES_CHANNEL_ENUM_ID AS \"salesChannelEnumId\",CR.FULFILL_CONTACT_MECH_ID AS \"fulfillContactMechId\",CR.CURRENCY_UOM_ID AS \"currencyUomId\",CR.OPEN_DATE_TIME AS \"openDateTime\",CR.CLOSED_DATE_TIME AS \"closedDateTime\",CR.INTERNAL_COMMENT AS \"internalComment\",CR.REASON AS \"reason\",CR.CREATED_DATE AS \"createdDate\",CR.CREATED_BY_USER_LOGIN AS \"createdByUserLogin\",CR.LAST_MODIFIED_DATE AS \"lastModifiedDate\",CR.LAST_MODIFIED_BY_USER_LOGIN AS \"lastModifiedByUserLogin\",CR.FULFILLED_DATE_TIME AS \"fulfilledDateTime\",CRW.WORK_EFFORT_ID AS \"workEffortId\" FROM CUST_REQUEST CR LEFT JOIN CUST_REQUEST_WORK_EFFORT CRW ON CR.CUST_REQUEST_ID = CRW.CUST_REQUEST_ID LEFT JOIN PARTY_RELATIONSHIP PR ON CR.FROM_PARTY_ID = PR.PARTY_ID_TO", resultSetMapping="CustRequestInfoAndWorkEffortAndPartyRelMapping")
@SqlResultSetMapping(name="CustRequestInfoAndWorkEffortAndPartyRelMapping", entities={
@EntityResult(entityClass=CustRequestInfoAndWorkEffortAndPartyRel.class, fields = {
...
public class CustRequestInfoAndWorkEffortAndPartyRel extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        ...
        fields.put("workEffortId", "CRW.WORK_EFFORT_ID");
fieldMapColumns.put("CustRequestInfoAndWorkEffortAndPartyRel", fields);
}
  public static enum Fields implements EntityFieldInterface<CustRequestInfoAndWorkEffortAndPartyRel> {
   ...
   * Default constructor.
   */
  public CustRequestInfoAndWorkEffortAndPartyRel() {
      super();
      this.baseEntityName = "CustRequestInfoAndWorkEffortAndPartyRel";
      this.isView = true;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("partyIdFrom");this.primaryKeyNames.add("roleTypeIdFrom");this.primaryKeyNames.add("partyIdTo");this.primaryKeyNames.add("roleTypeIdTo");this.primaryKeyNames.add("custRequestId");this.primaryKeyNames.add("workEffortId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("partyIdFrom");this.allFieldsNames.add("roleTypeIdFrom");this.allFieldsNames.add("partyIdTo");this.allFieldsNames.add("roleTypeIdTo");this.allFieldsNames.add("custRequestId");this.allFieldsNames.add("custRequestTypeId");this.allFieldsNames.add("custRequestCategoryId");this.allFieldsNames.add("statusId");this.allFieldsNames.add("fromPartyId");this.allFieldsNames.add("priority");this.allFieldsNames.add("custRequestDate");this.allFieldsNames.add("responseRequiredDate");this.allFieldsNames.add("custRequestName");this.allFieldsNames.add("description");this.allFieldsNames.add("maximumAmountUomId");this.allFieldsNames.add("productStoreId");this.allFieldsNames.add("salesChannelEnumId");this.allFieldsNames.add("fulfillContactMechId");this.allFieldsNames.add("currencyUomId");this.allFieldsNames.add("openDateTime");this.allFieldsNames.add("closedDateTime");this.allFieldsNames.add("internalComment");this.allFieldsNames.add("reason");this.allFieldsNames.add("createdDate");this.allFieldsNames.add("createdByUserLogin");this.allFieldsNames.add("lastModifiedDate");this.allFieldsNames.add("lastModifiedByUserLogin");this.allFieldsNames.add("fulfilledDateTime");this.allFieldsNames.add("workEffortId");
   ...
   */
  public CustRequestInfoAndWorkEffortAndPartyRel(RepositoryInterface repository) {
      this();
