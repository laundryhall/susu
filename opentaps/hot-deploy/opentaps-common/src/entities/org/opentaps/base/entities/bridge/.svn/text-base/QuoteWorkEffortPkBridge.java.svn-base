...
import org.opentaps.base.entities.QuoteWorkEffortPk;

/**
 * A FieldBridge for QuoteWorkEffortPk.
 */
public class QuoteWorkEffortPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the QuoteWorkEffortPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        QuoteWorkEffortPk id = new QuoteWorkEffortPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        QuoteWorkEffortPk id = (QuoteWorkEffortPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        QuoteWorkEffortPk id = (QuoteWorkEffortPk) value;
