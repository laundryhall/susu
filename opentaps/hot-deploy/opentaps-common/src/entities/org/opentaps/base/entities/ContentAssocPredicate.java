...
/**
 * Auto generated base entity ContentAssocPredicate.
 */
@javax.persistence.Entity
@Table(name="CONTENT_ASSOC_PREDICATE")
public class ContentAssocPredicate extends Entity {
static {
...
fieldMapColumns.put("ContentAssocPredicate", fields);
}
  public static enum Fields implements EntityFieldInterface<ContentAssocPredicate> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="ContentAssocPredicate_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="ContentAssocPredicate_GEN")
   @Id
   ...
   private transient List<ContentAssoc> contentAssocs = null;
  ...
  public ContentAssocPredicate() {
      ...
      this.allFieldsNames.add("contentAssocPredicateId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ContentAssocPredicate(RepositoryInterface repository) {
      this();
