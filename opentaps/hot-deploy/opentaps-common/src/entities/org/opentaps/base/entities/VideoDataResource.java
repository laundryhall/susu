...
/**
 * Auto generated base entity VideoDataResource.
 */
@javax.persistence.Entity
@Table(name="VIDEO_DATA_RESOURCE")
public class VideoDataResource extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        fields.put("dataResourceId", "DATA_RESOURCE_ID");
        fields.put("videoData", "VIDEO_DATA");
        fields.put("lastUpdatedStamp", "LAST_UPDATED_STAMP");
        fields.put("lastUpdatedTxStamp", "LAST_UPDATED_TX_STAMP");
        fields.put("createdStamp", "CREATED_STAMP");
        fields.put("createdTxStamp", "CREATED_TX_STAMP");
fieldMapColumns.put("VideoDataResource", fields);
}
  public static enum Fields implements EntityFieldInterface<VideoDataResource> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="VideoDataResource_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="VideoDataResource_GEN")
   @Id
   ...
   * Default constructor.
   */
  public VideoDataResource() {
      super();
      this.baseEntityName = "VideoDataResource";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("dataResourceId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("dataResourceId");this.allFieldsNames.add("videoData");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public VideoDataResource(RepositoryInterface repository) {
      this();
    ...
    */
    ...
    public Map<String, Object> toMap() {
        ...
        mapValue.put("videoData", getVideoData());
