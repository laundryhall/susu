...
/**
 * Auto generated base entity WorkEffortPurposeType.
 */
@javax.persistence.Entity
@Table(name="WORK_EFFORT_PURPOSE_TYPE")
public class WorkEffortPurposeType extends Entity {
static {
...
fieldMapColumns.put("WorkEffortPurposeType", fields);
}
  public static enum Fields implements EntityFieldInterface<WorkEffortPurposeType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="WorkEffortPurposeType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="WorkEffortPurposeType_GEN")
   @Id
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="workEffortPurposeType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
  ...
  public WorkEffortPurposeType() {
      super();
      this.baseEntityName = "WorkEffortPurposeType";
      this.isView = false;
      this.resourceName = "WorkEffortEntityLabels";
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("workEffortPurposeTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("workEffortPurposeTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public WorkEffortPurposeType(RepositoryInterface repository) {
      this();
