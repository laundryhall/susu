...
fieldMapColumns.put("GlAccountClass", fields);
  ...
  public static enum Fields implements EntityFieldInterface<GlAccountClass> {
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="glAccountClass", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="GL_ACCOUNT_CLASS_ID")
   
   private List<GlAccount> glAccounts = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="parentGlAccountClass", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
