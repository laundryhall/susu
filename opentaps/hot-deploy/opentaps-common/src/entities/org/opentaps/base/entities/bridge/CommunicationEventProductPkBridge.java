...
import org.opentaps.base.entities.CommunicationEventProductPk;

/**
 * A FieldBridge for CommunicationEventProductPk.
 */
public class CommunicationEventProductPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CommunicationEventProductPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CommunicationEventProductPk id = new CommunicationEventProductPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        CommunicationEventProductPk id = (CommunicationEventProductPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CommunicationEventProductPk id = (CommunicationEventProductPk) value;
