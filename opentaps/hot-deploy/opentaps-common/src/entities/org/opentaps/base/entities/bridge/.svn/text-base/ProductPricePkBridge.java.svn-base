...
import org.opentaps.base.entities.ProductPricePk;

/**
 * A FieldBridge for ProductPricePk.
 */
public class ProductPricePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductPricePk.
    ...
    public Object get(String name, Document document) {
        ...
        field = document.getField(name + ".productPriceTypeId");
        id.setProductPriceTypeId(field.stringValue());
        field = document.getField(name + ".productPricePurposeId");
        id.setProductPricePurposeId(field.stringValue());
        field = document.getField(name + ".currencyUomId");
        id.setCurrencyUomId(field.stringValue());
        field = document.getField(name + ".productStoreGroupId");
        id.setProductStoreGroupId(field.stringValue());
    ...
    public String objectToString(Object object) {
        ProductPricePk id = (ProductPricePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProductId());
        sb.append("_");
        sb.append(id.getProductPriceTypeId());
        sb.append("_");
        sb.append(id.getProductPricePurposeId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductPricePk id = (ProductPricePk) value;
        ...
        document.add(field);
        field = new Field(name + ".productPriceTypeId", id.getProductPriceTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".productPricePurposeId", id.getProductPricePurposeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".currencyUomId", id.getCurrencyUomId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".productStoreGroupId", id.getProductStoreGroupId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
