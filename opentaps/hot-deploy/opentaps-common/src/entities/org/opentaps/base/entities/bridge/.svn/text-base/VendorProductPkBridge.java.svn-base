...
import org.opentaps.base.entities.VendorProductPk;

/**
 * A FieldBridge for VendorProductPk.
 */
public class VendorProductPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the VendorProductPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        VendorProductPk id = new VendorProductPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        VendorProductPk id = (VendorProductPk) value;
