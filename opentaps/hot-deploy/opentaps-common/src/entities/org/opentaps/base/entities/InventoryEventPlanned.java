...
fieldMapColumns.put("InventoryEventPlanned", fields);
  ...
  public static enum Fields implements EntityFieldInterface<InventoryEventPlanned> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.InventoryEventPlannedPkBridge.class)
     ...
     * @return <code>InventoryEventPlannedPk</code>
     */
     ...
     * @param id a <code>InventoryEventPlannedPk</code> value to set
    */   
      public void setId(InventoryEventPlannedPk id) {
         this.id = id;
      }
  ...
  public InventoryEventPlanned() {
      ...
      this.allFieldsNames.add("productId");this.allFieldsNames.add("eventDate");this.allFieldsNames.add("inventoryEventPlanTypeId");this.allFieldsNames.add("eventQuantity");this.allFieldsNames.add("facilityId");this.allFieldsNames.add("eventName");this.allFieldsNames.add("isLate");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
