...
fieldMapColumns.put("SalesOpportunityRole", fields);
}
  public static enum Fields implements EntityFieldInterface<SalesOpportunityRole> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.SalesOpportunityRolePkBridge.class)
     ...
     * @return <code>SalesOpportunityRolePk</code>
     */
      public SalesOpportunityRolePk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>SalesOpportunityRolePk</code> value to set
    */   
      public void setId(SalesOpportunityRolePk id) {
         this.id = id;
      }
  ...
  public SalesOpportunityRole() {
      super();
      this.baseEntityName = "SalesOpportunityRole";
      this.isView = false;
      ...
      this.allFieldsNames.add("salesOpportunityId");this.allFieldsNames.add("partyId");this.allFieldsNames.add("roleTypeId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public SalesOpportunityRole(RepositoryInterface repository) {
      this();
