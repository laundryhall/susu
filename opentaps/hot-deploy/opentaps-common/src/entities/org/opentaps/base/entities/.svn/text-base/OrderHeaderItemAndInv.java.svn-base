...
public class OrderHeaderItemAndInv extends Entity {
static {
...
fieldMapColumns.put("OrderHeaderItemAndInv", fields);
}
  public static enum Fields implements EntityFieldInterface<OrderHeaderItemAndInv> {
    orderId("orderId"),
   ...
   * Default constructor.
   */
  public OrderHeaderItemAndInv() {
      super();
      this.baseEntityName = "OrderHeaderItemAndInv";
      this.isView = true;
   ...
   */
  public OrderHeaderItemAndInv(RepositoryInterface repository) {
      this();
