...
import org.opentaps.base.entities.FacilityContactMechPk;

/**
 * A FieldBridge for FacilityContactMechPk.
 */
public class FacilityContactMechPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FacilityContactMechPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FacilityContactMechPk id = new FacilityContactMechPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FacilityContactMechPk id = (FacilityContactMechPk) value;
