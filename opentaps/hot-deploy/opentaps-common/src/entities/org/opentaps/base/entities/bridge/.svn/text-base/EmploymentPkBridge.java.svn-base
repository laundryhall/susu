...
import org.opentaps.base.entities.EmploymentPk;

/**
 * A FieldBridge for EmploymentPk.
 */
public class EmploymentPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the EmploymentPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        EmploymentPk id = new EmploymentPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        EmploymentPk id = (EmploymentPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        EmploymentPk id = (EmploymentPk) value;
