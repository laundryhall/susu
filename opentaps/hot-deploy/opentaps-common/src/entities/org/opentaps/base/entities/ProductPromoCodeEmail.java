...
/**
 * Auto generated base entity ProductPromoCodeEmail.
 */
@javax.persistence.Entity
@Table(name="PRODUCT_PROMO_CODE_EMAIL")
public class ProductPromoCodeEmail extends Entity {
static {
...
fieldMapColumns.put("ProductPromoCodeEmail", fields);
}
  public static enum Fields implements EntityFieldInterface<ProductPromoCodeEmail> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.ProductPromoCodeEmailPkBridge.class)
     private ProductPromoCodeEmailPk id = new ProductPromoCodeEmailPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>ProductPromoCodeEmailPk</code>
     */
      public ProductPromoCodeEmailPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>ProductPromoCodeEmailPk</code> value to set
    */   
      public void setId(ProductPromoCodeEmailPk id) {
         this.id = id;
      }
  ...
  public ProductPromoCodeEmail() {
      super();
      this.baseEntityName = "ProductPromoCodeEmail";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("productPromoCodeId");this.primaryKeyNames.add("emailAddress");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("productPromoCodeId");this.allFieldsNames.add("emailAddress");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ProductPromoCodeEmail(RepositoryInterface repository) {
      this();
    ...
    public String getEmailAddress() {
        return this.id.getEmailAddress();
    }
    /**
     * Auto generated value accessor.
