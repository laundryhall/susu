...
public class ProductStoreGroupAndProductStore extends Entity {
static {
...
fieldMapColumns.put("ProductStoreGroupAndProductStore", fields);
}
  public static enum Fields implements EntityFieldInterface<ProductStoreGroupAndProductStore> {
   ...
   * Default constructor.
   */
  public ProductStoreGroupAndProductStore() {
      super();
      this.baseEntityName = "ProductStoreGroupAndProductStore";
      this.isView = true;
   ...
   */
  public ProductStoreGroupAndProductStore(RepositoryInterface repository) {
      this();
