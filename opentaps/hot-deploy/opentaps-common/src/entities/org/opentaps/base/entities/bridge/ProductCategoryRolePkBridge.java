...
import org.opentaps.base.entities.ProductCategoryRolePk;

/**
 * A FieldBridge for ProductCategoryRolePk.
 */
public class ProductCategoryRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductCategoryRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductCategoryRolePk id = new ProductCategoryRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductCategoryRolePk id = (ProductCategoryRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductCategoryRolePk id = (ProductCategoryRolePk) value;
