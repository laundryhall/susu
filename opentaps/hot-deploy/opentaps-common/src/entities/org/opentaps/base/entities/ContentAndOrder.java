...
public class ContentAndOrder extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        fields.put("orderId", "OC.ORDER_ID");
        fields.put("fromDate", "OC.FROM_DATE");
        fields.put("thruDate", "OC.THRU_DATE");
...
fieldMapColumns.put("ContentAndOrder", fields);
}
  public static enum Fields implements EntityFieldInterface<ContentAndOrder> {
    orderId("orderId"),
    fromDate("fromDate"),
    thruDate("thruDate"),
    contentId("contentId"),
   ...
   */
  public ContentAndOrder(RepositoryInterface repository) {
      this();
