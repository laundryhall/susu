...
import org.opentaps.base.entities.ProductFeatureApplPk;

/**
 * A FieldBridge for ProductFeatureApplPk.
 */
public class ProductFeatureApplPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductFeatureApplPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductFeatureApplPk id = new ProductFeatureApplPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductFeatureApplPk id = (ProductFeatureApplPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductFeatureApplPk id = (ProductFeatureApplPk) value;
