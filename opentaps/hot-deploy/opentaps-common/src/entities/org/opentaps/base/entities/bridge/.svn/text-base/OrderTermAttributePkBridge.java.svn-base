...
import org.opentaps.base.entities.OrderTermAttributePk;

/**
 * A FieldBridge for OrderTermAttributePk.
 */
public class OrderTermAttributePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the OrderTermAttributePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        OrderTermAttributePk id = new OrderTermAttributePk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        OrderTermAttributePk id = (OrderTermAttributePk) value;
