...
/**
 * Auto generated base entity RoleTypeAttr.
 */
@javax.persistence.Entity
@Table(name="ROLE_TYPE_ATTR")
public class RoleTypeAttr extends Entity {
static {
...
fieldMapColumns.put("RoleTypeAttr", fields);
}
  public static enum Fields implements EntityFieldInterface<RoleTypeAttr> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.RoleTypeAttrPkBridge.class)
     private RoleTypeAttrPk id = new RoleTypeAttrPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>RoleTypeAttrPk</code>
     */
      public RoleTypeAttrPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>RoleTypeAttrPk</code> value to set
    */   
      public void setId(RoleTypeAttrPk id) {
         this.id = id;
      }
   ...
   private transient List<PartyRole> partyRoles = null;
   private transient List<PartyRelationshipType> validFromPartyRelationshipTypes = null;
   private transient List<PartyRelationshipType> validToPartyRelationshipTypes = null;
  ...
  public RoleTypeAttr() {
      super();
      this.baseEntityName = "RoleTypeAttr";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("roleTypeId");this.primaryKeyNames.add("attrName");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("roleTypeId");this.allFieldsNames.add("attrName");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public RoleTypeAttr(RepositoryInterface repository) {
      this();
