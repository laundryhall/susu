...
public class WorkEffortAndSalesOpportunity extends Entity {
static {
...
fieldMapColumns.put("WorkEffortAndSalesOpportunity", fields);
}
  public static enum Fields implements EntityFieldInterface<WorkEffortAndSalesOpportunity> {
   ...
   * Default constructor.
   */
  public WorkEffortAndSalesOpportunity() {
      super();
      this.baseEntityName = "WorkEffortAndSalesOpportunity";
      this.isView = true;
   ...
   */
  public WorkEffortAndSalesOpportunity(RepositoryInterface repository) {
      this();
