...
fieldMapColumns.put("GlAccount", fields);
  ...
  public static enum Fields implements EntityFieldInterface<GlAccount> {
   ...
   private transient List<FinAccountTypeGlAccount> finAccountTypeGlAccounts = null;
   ...
   private transient List<GlAccountTypeDefault> glAccountTypeDefaults = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="glAccount", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="GL_ACCOUNT_ID")
   ...
   private transient List<InvoiceItem> overrideInvoiceItems = null;
   ...
   private transient List<InvoiceItemTypeGlAccount> invoiceItemTypeGlAccounts = null;
   ...
   private transient List<OrderItem> overrideOrderItems = null;
   private transient List<PartyGlAccount> partyGlAccounts = null;
   private transient List<PaycheckItemTypeGlAccount> debitPaycheckItemTypeGlAccounts = null;
   private transient List<PaycheckItemTypeGlAccount> creditPaycheckItemTypeGlAccounts = null;
   ...
   private transient List<PaymentMethodTypeGlAccount> paymentMethodTypeGlAccounts = null;
   ...
   private transient List<VarianceReasonGlAccount> varianceReasonGlAccounts = null;
