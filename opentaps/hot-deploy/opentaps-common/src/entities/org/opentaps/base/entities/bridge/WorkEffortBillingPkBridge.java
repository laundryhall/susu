...
import org.opentaps.base.entities.WorkEffortBillingPk;

/**
 * A FieldBridge for WorkEffortBillingPk.
 */
public class WorkEffortBillingPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortBillingPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortBillingPk id = new WorkEffortBillingPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkEffortBillingPk id = (WorkEffortBillingPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortBillingPk id = (WorkEffortBillingPk) value;
