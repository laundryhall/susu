...
/**
 * Auto generated base entity BillingAccountRole.
 */
@javax.persistence.Entity
@Table(name="BILLING_ACCOUNT_ROLE")
public class BillingAccountRole extends Entity {
static {
...
fieldMapColumns.put("BillingAccountRole", fields);
}
  public static enum Fields implements EntityFieldInterface<BillingAccountRole> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.BillingAccountRolePkBridge.class)
     private BillingAccountRolePk id = new BillingAccountRolePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>BillingAccountRolePk</code>
     */
      public BillingAccountRolePk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>BillingAccountRolePk</code> value to set
    */   
      public void setId(BillingAccountRolePk id) {
         this.id = id;
      }
  ...
  public BillingAccountRole() {
      super();
      this.baseEntityName = "BillingAccountRole";
      this.isView = false;
      ...
      this.allFieldsNames.add("billingAccountId");this.allFieldsNames.add("partyId");this.allFieldsNames.add("roleTypeId");this.allFieldsNames.add("fromDate");this.allFieldsNames.add("thruDate");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public BillingAccountRole(RepositoryInterface repository) {
      this();
    ...
    public void setBillingAccountId(String billingAccountId) {
        id.setBillingAccountId(billingAccountId);
    }
    /**
     * Auto generated value setter.
    ...
    public String getBillingAccountId() {
        return this.id.getBillingAccountId();
    }
    /**
     * Auto generated value accessor.
     * @return <code>String</code>
