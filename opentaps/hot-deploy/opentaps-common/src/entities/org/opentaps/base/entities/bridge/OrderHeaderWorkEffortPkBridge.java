...
import org.opentaps.base.entities.OrderHeaderWorkEffortPk;

/**
 * A FieldBridge for OrderHeaderWorkEffortPk.
 */
public class OrderHeaderWorkEffortPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the OrderHeaderWorkEffortPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        OrderHeaderWorkEffortPk id = new OrderHeaderWorkEffortPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        OrderHeaderWorkEffortPk id = (OrderHeaderWorkEffortPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        OrderHeaderWorkEffortPk id = (OrderHeaderWorkEffortPk) value;
