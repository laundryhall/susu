...
import org.opentaps.base.entities.CustRequestCommEventPk;

/**
 * A FieldBridge for CustRequestCommEventPk.
 */
public class CustRequestCommEventPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CustRequestCommEventPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CustRequestCommEventPk id = new CustRequestCommEventPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        CustRequestCommEventPk id = (CustRequestCommEventPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CustRequestCommEventPk id = (CustRequestCommEventPk) value;
