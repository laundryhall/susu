...
import org.opentaps.base.entities.ProductCategoryLinkPk;

/**
 * A FieldBridge for ProductCategoryLinkPk.
 */
public class ProductCategoryLinkPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductCategoryLinkPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductCategoryLinkPk id = new ProductCategoryLinkPk();
        Field field = null;
        field = document.getField(name + ".productCategoryId");
        id.setProductCategoryId(field.stringValue());
        field = document.getField(name + ".linkSeqId");
        id.setLinkSeqId(field.stringValue());
    ...
    public String objectToString(Object object) {
        ProductCategoryLinkPk id = (ProductCategoryLinkPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProductCategoryId());
        sb.append("_");
        sb.append(id.getLinkSeqId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductCategoryLinkPk id = (ProductCategoryLinkPk) value;
        ...
        document.add(field);
        field = new Field(name + ".linkSeqId", id.getLinkSeqId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
