...
import org.opentaps.base.entities.ProductCategoryRollupPk;

/**
 * A FieldBridge for ProductCategoryRollupPk.
 */
public class ProductCategoryRollupPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductCategoryRollupPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductCategoryRollupPk id = new ProductCategoryRollupPk();
        Field field = null;
        field = document.getField(name + ".productCategoryId");
        id.setProductCategoryId(field.stringValue());
        field = document.getField(name + ".parentProductCategoryId");
        id.setParentProductCategoryId(field.stringValue());
    ...
    public String objectToString(Object object) {
        ProductCategoryRollupPk id = (ProductCategoryRollupPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProductCategoryId());
        sb.append("_");
        sb.append(id.getParentProductCategoryId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductCategoryRollupPk id = (ProductCategoryRollupPk) value;
        ...
        document.add(field);
        field = new Field(name + ".parentProductCategoryId", id.getParentProductCategoryId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
