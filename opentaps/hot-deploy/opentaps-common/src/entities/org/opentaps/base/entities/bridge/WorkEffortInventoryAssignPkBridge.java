...
import org.opentaps.base.entities.WorkEffortInventoryAssignPk;

/**
 * A FieldBridge for WorkEffortInventoryAssignPk.
 */
public class WorkEffortInventoryAssignPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortInventoryAssignPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortInventoryAssignPk id = new WorkEffortInventoryAssignPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkEffortInventoryAssignPk id = (WorkEffortInventoryAssignPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortInventoryAssignPk id = (WorkEffortInventoryAssignPk) value;
