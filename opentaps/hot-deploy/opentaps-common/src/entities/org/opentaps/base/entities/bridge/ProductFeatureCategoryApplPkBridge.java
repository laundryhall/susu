...
import org.opentaps.base.entities.ProductFeatureCategoryApplPk;

/**
 * A FieldBridge for ProductFeatureCategoryApplPk.
 */
public class ProductFeatureCategoryApplPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductFeatureCategoryApplPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductFeatureCategoryApplPk id = new ProductFeatureCategoryApplPk();
        Field field = null;
        field = document.getField(name + ".productCategoryId");
        id.setProductCategoryId(field.stringValue());
        field = document.getField(name + ".productFeatureCategoryId");
        id.setProductFeatureCategoryId(field.stringValue());
    ...
    public String objectToString(Object object) {
        ProductFeatureCategoryApplPk id = (ProductFeatureCategoryApplPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProductCategoryId());
        sb.append("_");
        sb.append(id.getProductFeatureCategoryId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductFeatureCategoryApplPk id = (ProductFeatureCategoryApplPk) value;
        ...
        document.add(field);
        field = new Field(name + ".productFeatureCategoryId", id.getProductFeatureCategoryId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
