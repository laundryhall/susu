...
/**
 * Auto generated base entity ProductPriceActionType.
 */
@javax.persistence.Entity
@Table(name="PRODUCT_PRICE_ACTION_TYPE")
public class ProductPriceActionType extends Entity {
static {
...
fieldMapColumns.put("ProductPriceActionType", fields);
}
  public static enum Fields implements EntityFieldInterface<ProductPriceActionType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="ProductPriceActionType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="ProductPriceActionType_GEN")
   @Id
   ...
   private transient List<ProductPriceAction> productPriceActions = null;
  ...
  public ProductPriceActionType() {
      super();
      this.baseEntityName = "ProductPriceActionType";
      this.isView = false;
      this.resourceName = "ProductEntityLabels";
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("productPriceActionTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("productPriceActionTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ProductPriceActionType(RepositoryInterface repository) {
      this();
