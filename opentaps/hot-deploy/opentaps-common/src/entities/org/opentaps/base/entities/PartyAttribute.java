...
/**
 * Auto generated base entity PartyAttribute.
 */
@javax.persistence.Entity
@Table(name="PARTY_ATTRIBUTE")
public class PartyAttribute extends Entity {
static {
...
fieldMapColumns.put("PartyAttribute", fields);
}
  public static enum Fields implements EntityFieldInterface<PartyAttribute> {
    partyId("partyId"),
    attrName("attrName"),
    attrValue("attrValue"),
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.PartyAttributePkBridge.class)
     private PartyAttributePk id = new PartyAttributePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>PartyAttributePk</code>
     */
      public PartyAttributePk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>PartyAttributePk</code> value to set
    */   
      public void setId(PartyAttributePk id) {
         this.id = id;
      }
  ...
  public PartyAttribute() {
      super();
      this.baseEntityName = "PartyAttribute";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("partyId");this.primaryKeyNames.add("attrName");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("partyId");this.allFieldsNames.add("attrName");this.allFieldsNames.add("attrValue");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public PartyAttribute(RepositoryInterface repository) {
      this();
