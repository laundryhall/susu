...
import org.opentaps.base.entities.TermTypeToEnumTypeMapPk;

/**
 * A FieldBridge for TermTypeToEnumTypeMapPk.
 */
public class TermTypeToEnumTypeMapPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the TermTypeToEnumTypeMapPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        TermTypeToEnumTypeMapPk id = new TermTypeToEnumTypeMapPk();
        Field field = null;
        field = document.getField(name + ".termTypeId");
        id.setTermTypeId(field.stringValue());
        field = document.getField(name + ".enumTypeId");
        id.setEnumTypeId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        TermTypeToEnumTypeMapPk id = (TermTypeToEnumTypeMapPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getTermTypeId());
        sb.append("_");
        sb.append(id.getEnumTypeId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        TermTypeToEnumTypeMapPk id = (TermTypeToEnumTypeMapPk) value;
        ...
        document.add(field);
        field = new Field(name + ".enumTypeId", id.getEnumTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
