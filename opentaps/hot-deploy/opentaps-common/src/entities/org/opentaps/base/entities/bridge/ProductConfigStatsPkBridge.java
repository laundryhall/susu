...
import org.opentaps.base.entities.ProductConfigStatsPk;

/**
 * A FieldBridge for ProductConfigStatsPk.
 */
public class ProductConfigStatsPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductConfigStatsPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductConfigStatsPk id = new ProductConfigStatsPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductConfigStatsPk id = (ProductConfigStatsPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductConfigStatsPk id = (ProductConfigStatsPk) value;
