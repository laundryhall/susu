...
import org.opentaps.base.entities.InventoryItemLabelApplPk;

/**
 * A FieldBridge for InventoryItemLabelApplPk.
 */
public class InventoryItemLabelApplPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the InventoryItemLabelApplPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        InventoryItemLabelApplPk id = new InventoryItemLabelApplPk();
        Field field = null;
        field = document.getField(name + ".inventoryItemId");
        id.setInventoryItemId(field.stringValue());
        field = document.getField(name + ".inventoryItemLabelTypeId");
        id.setInventoryItemLabelTypeId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        InventoryItemLabelApplPk id = (InventoryItemLabelApplPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getInventoryItemId());
        sb.append("_");
        sb.append(id.getInventoryItemLabelTypeId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        InventoryItemLabelApplPk id = (InventoryItemLabelApplPk) value;
        ...
        document.add(field);
        field = new Field(name + ".inventoryItemLabelTypeId", id.getInventoryItemLabelTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
