...
import org.opentaps.base.entities.WorkEffortSkillStandardPk;

/**
 * A FieldBridge for WorkEffortSkillStandardPk.
 */
public class WorkEffortSkillStandardPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortSkillStandardPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortSkillStandardPk id = new WorkEffortSkillStandardPk();
        Field field = null;
        field = document.getField(name + ".workEffortId");
        id.setWorkEffortId(field.stringValue());
        field = document.getField(name + ".skillTypeId");
        id.setSkillTypeId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        WorkEffortSkillStandardPk id = (WorkEffortSkillStandardPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getWorkEffortId());
        sb.append("_");
        sb.append(id.getSkillTypeId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortSkillStandardPk id = (WorkEffortSkillStandardPk) value;
        ...
        document.add(field);
        field = new Field(name + ".skillTypeId", id.getSkillTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
