...
public class ProjectAndPhaseAndTaskParty extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        ...
        fields.put("workEffortId", "WET.WORK_EFFORT_ID");
        fields.put("workEffortTypeId", "WET.WORK_EFFORT_TYPE_ID");
        fields.put("currentStatusId", "WET.CURRENT_STATUS_ID");
        fields.put("lastStatusUpdate", "WET.LAST_STATUS_UPDATE");
        fields.put("workEffortPurposeTypeId", "WET.WORK_EFFORT_PURPOSE_TYPE_ID");
        fields.put("workEffortParentId", "WET.WORK_EFFORT_PARENT_ID");
        fields.put("scopeEnumId", "WET.SCOPE_ENUM_ID");
        fields.put("priority", "WET.PRIORITY");
        fields.put("percentComplete", "WET.PERCENT_COMPLETE");
        fields.put("workEffortName", "WET.WORK_EFFORT_NAME");
        fields.put("showAsEnumId", "WET.SHOW_AS_ENUM_ID");
        fields.put("sendNotificationEmail", "WET.SEND_NOTIFICATION_EMAIL");
        fields.put("description", "WET.DESCRIPTION");
        fields.put("locationDesc", "WET.LOCATION_DESC");
        fields.put("estimatedStartDate", "WET.ESTIMATED_START_DATE");
        fields.put("estimatedCompletionDate", "WET.ESTIMATED_COMPLETION_DATE");
        fields.put("actualStartDate", "WET.ACTUAL_START_DATE");
        fields.put("actualCompletionDate", "WET.ACTUAL_COMPLETION_DATE");
        fields.put("estimatedMilliSeconds", "WET.ESTIMATED_MILLI_SECONDS");
        fields.put("estimatedSetupMillis", "WET.ESTIMATED_SETUP_MILLIS");
        fields.put("estimateCalcMethod", "WET.ESTIMATE_CALC_METHOD");
        fields.put("actualMilliSeconds", "WET.ACTUAL_MILLI_SECONDS");
        fields.put("actualSetupMillis", "WET.ACTUAL_SETUP_MILLIS");
        fields.put("totalMilliSecondsAllowed", "WET.TOTAL_MILLI_SECONDS_ALLOWED");
        fields.put("totalMoneyAllowed", "WET.TOTAL_MONEY_ALLOWED");
        fields.put("moneyUomId", "WET.MONEY_UOM_ID");
        fields.put("specialTerms", "WET.SPECIAL_TERMS");
        fields.put("timeTransparency", "WET.TIME_TRANSPARENCY");
        fields.put("universalId", "WET.UNIVERSAL_ID");
        fields.put("sourceReferenceId", "WET.SOURCE_REFERENCE_ID");
        fields.put("fixedAssetId", "WET.FIXED_ASSET_ID");
        fields.put("facilityId", "WET.FACILITY_ID");
        fields.put("infoUrl", "WET.INFO_URL");
        fields.put("recurrenceInfoId", "WET.RECURRENCE_INFO_ID");
        fields.put("tempExprId", "WET.TEMP_EXPR_ID");
        fields.put("runtimeDataId", "WET.RUNTIME_DATA_ID");
        fields.put("noteId", "WET.NOTE_ID");
        fields.put("serviceLoaderName", "WET.SERVICE_LOADER_NAME");
        fields.put("quantityToProduce", "WET.QUANTITY_TO_PRODUCE");
        fields.put("quantityProduced", "WET.QUANTITY_PRODUCED");
        fields.put("quantityRejected", "WET.QUANTITY_REJECTED");
        fields.put("reservPersons", "WET.RESERV_PERSONS");
        fields.put("reserv2ndPPPerc", "WET.RESERV2ND_P_P_PERC");
        fields.put("reservNthPPPerc", "WET.RESERV_NTH_P_P_PERC");
        fields.put("accommodationMapId", "WET.ACCOMMODATION_MAP_ID");
        fields.put("accommodationSpotId", "WET.ACCOMMODATION_SPOT_ID");
        fields.put("revisionNumber", "WET.REVISION_NUMBER");
        fields.put("createdDate", "WET.CREATED_DATE");
...
fieldMapColumns.put("ProjectAndPhaseAndTaskParty", fields);
}
  public static enum Fields implements EntityFieldInterface<ProjectAndPhaseAndTaskParty> {
    projectId("projectId"),
   ...
   */
  public ProjectAndPhaseAndTaskParty(RepositoryInterface repository) {
      this();
