...
/**
 * Auto generated base entity UomConversionDated.
 */
@javax.persistence.Entity
@Table(name="UOM_CONVERSION_DATED")
public class UomConversionDated extends Entity {
static {
...
fieldMapColumns.put("UomConversionDated", fields);
}
  public static enum Fields implements EntityFieldInterface<UomConversionDated> {
    uomId("uomId"),
    uomIdTo("uomIdTo"),
    fromDate("fromDate"),
    thruDate("thruDate"),
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.UomConversionDatedPkBridge.class)
     ...
     * @return <code>UomConversionDatedPk</code>
     */
     ...
     * @param id a <code>UomConversionDatedPk</code> value to set
    */   
      public void setId(UomConversionDatedPk id) {
         this.id = id;
      }
   ...
   */
  public UomConversionDated(RepositoryInterface repository) {
      this();
    ...
    /**
     * Auto generated method that gets the related <code>Uom</code> by the relation named <code>DatedMainUom</code>.
    ...
    /**
     * Auto generated method that gets the related <code>Uom</code> by the relation named <code>DatedConvToUom</code>.
     * @return the <code>Uom</code>
     * @throws RepositoryException if an error occurs
     */
    ...
    /**
     * Auto generated value setter.
     * @param datedMainUom the datedMainUom to set
    */
    public void setDatedMainUom(Uom datedMainUom) {
        this.datedMainUom = datedMainUom;
    }
    /**
     * Auto generated value setter.
     * @param datedConvToUom the datedConvToUom to set
    */
    public void setDatedConvToUom(Uom datedConvToUom) {
        this.datedConvToUom = datedConvToUom;
    }
    /**
     * Auto generated value setter.
