...
import org.opentaps.base.entities.ExampleFeatureApplPk;

/**
 * A FieldBridge for ExampleFeatureApplPk.
 */
public class ExampleFeatureApplPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ExampleFeatureApplPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ExampleFeatureApplPk id = new ExampleFeatureApplPk();
        Field field = null;
        field = document.getField(name + ".exampleId");
        id.setExampleId(field.stringValue());
        field = document.getField(name + ".exampleFeatureId");
        id.setExampleFeatureId(field.stringValue());
    ...
    public String objectToString(Object object) {
        ExampleFeatureApplPk id = (ExampleFeatureApplPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getExampleId());
        sb.append("_");
        sb.append(id.getExampleFeatureId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ExampleFeatureApplPk id = (ExampleFeatureApplPk) value;
        ...
        document.add(field);
        field = new Field(name + ".exampleFeatureId", id.getExampleFeatureId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
