...
fieldMapColumns.put("CustomMethodType", fields);
  ...
  public static enum Fields implements EntityFieldInterface<CustomMethodType> {
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="customMethodType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="CUSTOM_METHOD_TYPE_ID")
   
   private List<CustomMethod> customMethods = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="parentCustomMethodType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
