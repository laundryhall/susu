...
import org.opentaps.base.entities.SalesOpportunityCompetitorPk;

/**
 * A FieldBridge for SalesOpportunityCompetitorPk.
 */
public class SalesOpportunityCompetitorPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the SalesOpportunityCompetitorPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        SalesOpportunityCompetitorPk id = new SalesOpportunityCompetitorPk();
        Field field = null;
        field = document.getField(name + ".salesOpportunityId");
        id.setSalesOpportunityId(field.stringValue());
        field = document.getField(name + ".competitorPartyId");
        id.setCompetitorPartyId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        SalesOpportunityCompetitorPk id = (SalesOpportunityCompetitorPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getSalesOpportunityId());
        sb.append("_");
        sb.append(id.getCompetitorPartyId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        SalesOpportunityCompetitorPk id = (SalesOpportunityCompetitorPk) value;
        ...
        document.add(field);
        field = new Field(name + ".competitorPartyId", id.getCompetitorPartyId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
