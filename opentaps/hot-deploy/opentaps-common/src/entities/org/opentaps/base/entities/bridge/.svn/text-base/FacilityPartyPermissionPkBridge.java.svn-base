...
import org.opentaps.base.entities.FacilityPartyPermissionPk;

/**
 * A FieldBridge for FacilityPartyPermissionPk.
 */
public class FacilityPartyPermissionPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FacilityPartyPermissionPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FacilityPartyPermissionPk id = new FacilityPartyPermissionPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        FacilityPartyPermissionPk id = (FacilityPartyPermissionPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FacilityPartyPermissionPk id = (FacilityPartyPermissionPk) value;
