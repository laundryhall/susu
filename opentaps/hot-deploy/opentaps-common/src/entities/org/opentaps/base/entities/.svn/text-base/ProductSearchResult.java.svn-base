...
/**
 * Auto generated base entity ProductSearchResult.
 */
@javax.persistence.Entity
@Table(name="PRODUCT_SEARCH_RESULT")
public class ProductSearchResult extends Entity {
static {
...
fieldMapColumns.put("ProductSearchResult", fields);
}
  public static enum Fields implements EntityFieldInterface<ProductSearchResult> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="ProductSearchResult_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
  ...
  public ProductSearchResult() {
      ...
      this.allFieldsNames.add("productSearchResultId");this.allFieldsNames.add("visitId");this.allFieldsNames.add("orderByName");this.allFieldsNames.add("isAscending");this.allFieldsNames.add("numResults");this.allFieldsNames.add("secondsTotal");this.allFieldsNames.add("searchDate");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ProductSearchResult(RepositoryInterface repository) {
      this();
    ...
    /**
     * Auto generated method that gets the related <code>ProductSearchConstraint</code> by the relation named <code>ProductSearchConstraint</code>.
     * @return the list of <code>ProductSearchConstraint</code>
     * @throws RepositoryException if an error occurs
     */
    ...
    */
    ...
    /**
     * Auto generated value setter.
     * @param productSearchConstraints the productSearchConstraints to set
    */
    ...
    public void addProductSearchConstraint(ProductSearchConstraint productSearchConstraint) {
        if (this.productSearchConstraints == null) {
            this.productSearchConstraints = new ArrayList<ProductSearchConstraint>();
        }
