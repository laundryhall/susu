...
import org.opentaps.base.entities.WorkEffortReviewPk;

/**
 * A FieldBridge for WorkEffortReviewPk.
 */
public class WorkEffortReviewPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortReviewPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortReviewPk id = new WorkEffortReviewPk();
        Field field = null;
        ...
        field = document.getField(name + ".reviewDate");
        if (field.stringValue() != null && !field.stringValue().equals("")) {
            id.setReviewDate(new Timestamp(((Date) (new DateBridge(Resolution.DAY)).stringToObject(field.stringValue())).getTime()));
        }
        return id;
    }
    ...
    public String objectToString(Object object) {
        WorkEffortReviewPk id = (WorkEffortReviewPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getWorkEffortId());
        sb.append("_");
        sb.append(id.getUserLoginId());
        sb.append("_");
        sb.append(id.getReviewDate());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortReviewPk id = (WorkEffortReviewPk) value;
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".reviewDate", (new DateBridge(Resolution.DAY)).objectToString(id.getReviewDate()), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
