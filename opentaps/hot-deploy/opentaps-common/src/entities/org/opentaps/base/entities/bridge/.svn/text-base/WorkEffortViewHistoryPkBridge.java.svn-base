...
import org.opentaps.base.entities.WorkEffortViewHistoryPk;

/**
 * A FieldBridge for WorkEffortViewHistoryPk.
 */
public class WorkEffortViewHistoryPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortViewHistoryPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortViewHistoryPk id = new WorkEffortViewHistoryPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkEffortViewHistoryPk id = (WorkEffortViewHistoryPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortViewHistoryPk id = (WorkEffortViewHistoryPk) value;
