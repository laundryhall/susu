...
import org.opentaps.base.entities.WorkEffortAttributePk;

/**
 * A FieldBridge for WorkEffortAttributePk.
 */
public class WorkEffortAttributePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortAttributePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortAttributePk id = new WorkEffortAttributePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkEffortAttributePk id = (WorkEffortAttributePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortAttributePk id = (WorkEffortAttributePk) value;
