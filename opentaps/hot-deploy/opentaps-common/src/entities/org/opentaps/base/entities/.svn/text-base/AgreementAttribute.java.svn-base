...
/**
 * Auto generated base entity AgreementAttribute.
 */
@javax.persistence.Entity
@Table(name="AGREEMENT_ATTRIBUTE")
public class AgreementAttribute extends Entity {
static {
...
fieldMapColumns.put("AgreementAttribute", fields);
}
  public static enum Fields implements EntityFieldInterface<AgreementAttribute> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.AgreementAttributePkBridge.class)
     private AgreementAttributePk id = new AgreementAttributePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>AgreementAttributePk</code>
     */
      public AgreementAttributePk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>AgreementAttributePk</code> value to set
    */   
      public void setId(AgreementAttributePk id) {
         this.id = id;
      }
   ...
   private transient List<AgreementTypeAttr> agreementTypeAttrs = null;
  ...
  public AgreementAttribute() {
      super();
      this.baseEntityName = "AgreementAttribute";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("agreementId");this.primaryKeyNames.add("attrName");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("agreementId");this.allFieldsNames.add("attrName");this.allFieldsNames.add("attrValue");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public AgreementAttribute(RepositoryInterface repository) {
      this();
