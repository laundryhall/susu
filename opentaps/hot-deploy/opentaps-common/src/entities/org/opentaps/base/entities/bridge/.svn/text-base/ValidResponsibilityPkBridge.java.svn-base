...
import org.opentaps.base.entities.ValidResponsibilityPk;

/**
 * A FieldBridge for ValidResponsibilityPk.
 */
public class ValidResponsibilityPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ValidResponsibilityPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ValidResponsibilityPk id = new ValidResponsibilityPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ValidResponsibilityPk id = (ValidResponsibilityPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ValidResponsibilityPk id = (ValidResponsibilityPk) value;
