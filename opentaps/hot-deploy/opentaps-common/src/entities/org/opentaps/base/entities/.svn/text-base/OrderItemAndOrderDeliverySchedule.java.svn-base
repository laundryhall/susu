...
public class OrderItemAndOrderDeliverySchedule extends Entity {
static {
...
fieldMapColumns.put("OrderItemAndOrderDeliverySchedule", fields);
}
  public static enum Fields implements EntityFieldInterface<OrderItemAndOrderDeliverySchedule> {
   ...
   * Default constructor.
   */
  public OrderItemAndOrderDeliverySchedule() {
      super();
      this.baseEntityName = "OrderItemAndOrderDeliverySchedule";
      this.isView = true;
   ...
   */
  public OrderItemAndOrderDeliverySchedule(RepositoryInterface repository) {
      this();
