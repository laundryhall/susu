...
import org.opentaps.base.entities.TaxAuthorityCategoryPk;

/**
 * A FieldBridge for TaxAuthorityCategoryPk.
 */
public class TaxAuthorityCategoryPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the TaxAuthorityCategoryPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        TaxAuthorityCategoryPk id = new TaxAuthorityCategoryPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        TaxAuthorityCategoryPk id = (TaxAuthorityCategoryPk) value;
