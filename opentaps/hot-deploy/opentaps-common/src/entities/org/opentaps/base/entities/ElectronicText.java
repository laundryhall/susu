...
/**
 * Auto generated base entity ElectronicText.
 */
@javax.persistence.Entity
@Table(name="ELECTRONIC_TEXT")
public class ElectronicText extends Entity {
static {
...
fieldMapColumns.put("ElectronicText", fields);
}
  public static enum Fields implements EntityFieldInterface<ElectronicText> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="ElectronicText_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="ElectronicText_GEN")
   @Id
  ...
  public ElectronicText() {
      super();
      this.baseEntityName = "ElectronicText";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("dataResourceId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("dataResourceId");this.allFieldsNames.add("textData");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ElectronicText(RepositoryInterface repository) {
      this();
