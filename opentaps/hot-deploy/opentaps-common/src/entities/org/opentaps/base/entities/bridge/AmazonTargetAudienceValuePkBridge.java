...
import org.opentaps.base.entities.AmazonTargetAudienceValuePk;

/**
 * A FieldBridge for AmazonTargetAudienceValuePk.
 */
public class AmazonTargetAudienceValuePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AmazonTargetAudienceValuePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AmazonTargetAudienceValuePk id = new AmazonTargetAudienceValuePk();
        Field field = null;
        field = document.getField(name + ".productId");
        id.setProductId(field.stringValue());
        field = document.getField(name + ".targetAudienceId");
        id.setTargetAudienceId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        AmazonTargetAudienceValuePk id = (AmazonTargetAudienceValuePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProductId());
        sb.append("_");
        sb.append(id.getTargetAudienceId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AmazonTargetAudienceValuePk id = (AmazonTargetAudienceValuePk) value;
        ...
        document.add(field);
        field = new Field(name + ".targetAudienceId", id.getTargetAudienceId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
