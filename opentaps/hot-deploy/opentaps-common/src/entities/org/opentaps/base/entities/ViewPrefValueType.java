...
/**
 * Auto generated base entity ViewPrefValueType.
 */
@javax.persistence.Entity
@Table(name="VIEW_PREF_VALUE_TYPE")
public class ViewPrefValueType extends Entity {
static {
...
fieldMapColumns.put("ViewPrefValueType", fields);
}
  public static enum Fields implements EntityFieldInterface<ViewPrefValueType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="ViewPrefValueType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="ViewPrefValueType_GEN")
   @Id
  ...
  public ViewPrefValueType() {
      super();
      this.baseEntityName = "ViewPrefValueType";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("viewPrefValueTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("viewPrefValueTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ViewPrefValueType(RepositoryInterface repository) {
      this();
