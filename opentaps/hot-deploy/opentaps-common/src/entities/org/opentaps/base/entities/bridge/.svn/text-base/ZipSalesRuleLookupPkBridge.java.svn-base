...
import org.opentaps.base.entities.ZipSalesRuleLookupPk;

/**
 * A FieldBridge for ZipSalesRuleLookupPk.
 */
public class ZipSalesRuleLookupPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ZipSalesRuleLookupPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ZipSalesRuleLookupPk id = new ZipSalesRuleLookupPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ZipSalesRuleLookupPk id = (ZipSalesRuleLookupPk) value;
