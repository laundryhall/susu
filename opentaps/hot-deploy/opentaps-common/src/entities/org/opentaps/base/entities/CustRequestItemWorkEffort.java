...
/**
 * Auto generated base entity CustRequestItemWorkEffort.
 */
@javax.persistence.Entity
@Table(name="CUST_REQUEST_ITEM_WORK_EFFORT")
public class CustRequestItemWorkEffort extends Entity {
static {
...
fieldMapColumns.put("CustRequestItemWorkEffort", fields);
}
  public static enum Fields implements EntityFieldInterface<CustRequestItemWorkEffort> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.CustRequestItemWorkEffortPkBridge.class)
     ...
     * @return <code>CustRequestItemWorkEffortPk</code>
     */
     ...
     * @param id a <code>CustRequestItemWorkEffortPk</code> value to set
    */   
  ...
  public CustRequestItemWorkEffort() {
      super();
      this.baseEntityName = "CustRequestItemWorkEffort";
      this.isView = false;
      ...
      this.allFieldsNames.add("custRequestId");this.allFieldsNames.add("custRequestItemSeqId");this.allFieldsNames.add("workEffortId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public CustRequestItemWorkEffort(RepositoryInterface repository) {
      this();
