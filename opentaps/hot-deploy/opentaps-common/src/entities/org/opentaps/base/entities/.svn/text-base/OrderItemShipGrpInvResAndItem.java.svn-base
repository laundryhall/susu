...
/**
 * Auto generated base entity OrderItemShipGrpInvResAndItem.
 */
...
@SqlResultSetMapping(name="OrderItemShipGrpInvResAndItemMapping", entities={
@EntityResult(entityClass=OrderItemShipGrpInvResAndItem.class, fields = {
...
public class OrderItemShipGrpInvResAndItem extends Entity {
static {
...
fieldMapColumns.put("OrderItemShipGrpInvResAndItem", fields);
}
  public static enum Fields implements EntityFieldInterface<OrderItemShipGrpInvResAndItem> {
    orderId("orderId"),
   ...
   */
  public OrderItemShipGrpInvResAndItem(RepositoryInterface repository) {
      this();
