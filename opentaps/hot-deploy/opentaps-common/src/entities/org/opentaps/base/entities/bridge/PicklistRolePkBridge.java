...
import org.opentaps.base.entities.PicklistRolePk;

/**
 * A FieldBridge for PicklistRolePk.
 */
public class PicklistRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PicklistRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PicklistRolePk id = new PicklistRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PicklistRolePk id = (PicklistRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PicklistRolePk id = (PicklistRolePk) value;
