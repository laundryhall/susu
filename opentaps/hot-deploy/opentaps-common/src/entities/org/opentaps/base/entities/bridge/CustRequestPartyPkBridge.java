...
import org.opentaps.base.entities.CustRequestPartyPk;

/**
 * A FieldBridge for CustRequestPartyPk.
 */
public class CustRequestPartyPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CustRequestPartyPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CustRequestPartyPk id = new CustRequestPartyPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        CustRequestPartyPk id = (CustRequestPartyPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CustRequestPartyPk id = (CustRequestPartyPk) value;
