...
import org.opentaps.base.entities.CustRequestItemWorkEffortPk;

/**
 * A FieldBridge for CustRequestItemWorkEffortPk.
 */
public class CustRequestItemWorkEffortPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CustRequestItemWorkEffortPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CustRequestItemWorkEffortPk id = new CustRequestItemWorkEffortPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        CustRequestItemWorkEffortPk id = (CustRequestItemWorkEffortPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CustRequestItemWorkEffortPk id = (CustRequestItemWorkEffortPk) value;
