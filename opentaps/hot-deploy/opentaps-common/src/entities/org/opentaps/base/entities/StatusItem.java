...
fieldMapColumns.put("StatusItem", fields);
  ...
  public static enum Fields implements EntityFieldInterface<StatusItem> {
   ...
   private transient List<ContactListCommStatus> contactListCommStatuses = null;
   private transient List<ContactListParty> contactListPartys = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="statusItem", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="STATUS_ID")
   
   private List<Content> contents = null;
   private transient List<ContentApproval> approvalContentApprovals = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="statusItem", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="STATUS_ID")
   ...
   private transient List<ExampleStatus> exampleStatuses = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="statusItem", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="STATUS_ID")
   
   private List<FinAccountStatus> finAccountStatuses = null;
   private transient List<FixedAssetMaint> fixedAssetMaints = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="statusItem", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="STATUS_ID")
   ...
   private transient List<InventoryStatusGlAccountType> fromInventoryStatusGlAccountTypes = null;
   private transient List<InventoryStatusGlAccountType> toInventoryStatusGlAccountTypes = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="statusItem", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="STATUS_ID")
   ...
   private transient List<OagisMessageInfo> processingOagisMessageInfoes = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="statusItem", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="STATUS_ID")
   
   private List<OpentapsDbUpdate> opentapsDbUpdates = null;
   private transient List<OrderDeliverySchedule> orderDeliverySchedules = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="statusItem", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="STATUS_ID")
   ...
   private transient List<OrderItem> syncOrderItems = null;
   ...
   private transient List<PartyQual> partyQuals = null;
   private transient List<PartyQual> verificationPartyQuals = null;
   ...
   private transient List<PicklistStatusHistory> toPicklistStatusHistorys = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="statusItem", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="STATUS_ID")
   ...
   private transient List<ProductStore> headerApprovedProductStores = null;
   private transient List<ProductStore> itemApprovedProductStores = null;
   private transient List<ProductStore> digitalItemApprovedProductStores = null;
   private transient List<ProductStore> headerDeclinedProductStores = null;
   private transient List<ProductStore> itemDeclinedProductStores = null;
   private transient List<ProductStore> headerCancelProductStores = null;
   private transient List<ProductStore> itemCancelProductStores = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="statusItem", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="STATUS_ID")
   ...
   private transient List<ReturnItem> inventoryReturnItems = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="statusItem", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="STATUS_ID")
   ...
   private transient List<ShipmentRouteSegment> carrierServiceShipmentRouteSegments = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="statusItem", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="STATUS_ID")
   ...
   private transient List<WorkEffort> currentWorkEfforts = null;
   private transient List<WorkEffortFixedAssetAssign> workEffortFixedAssetAssigns = null;
   private transient List<WorkEffortFixedAssetAssign> availabilityWorkEffortFixedAssetAssigns = null;
   ...
   private transient List<WorkEffortPartyAssignment> assignmentWorkEffortPartyAssignments = null;
   private transient List<WorkEffortPartyAssignment> availabilityWorkEffortPartyAssignments = null;
   private transient List<WorkEffortReview> workEffortReviews = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="statusItem", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="STATUS_ID")
  ...
  public StatusItem(RepositoryInterface repository) {
    ...
    /**
     * Auto generated method that gets the related <code>OpentapsDbUpdate</code> by the relation named <code>OpentapsDbUpdate</code>.
     * @return the list of <code>OpentapsDbUpdate</code>
     * @throws RepositoryException if an error occurs
     */
    public List<? extends OpentapsDbUpdate> getOpentapsDbUpdates() throws RepositoryException {
        if (this.opentapsDbUpdates == null) {
            this.opentapsDbUpdates = getRelated(OpentapsDbUpdate.class, "OpentapsDbUpdate");
        }
        return this.opentapsDbUpdates;
    }
    /**
    ...
    */
    ...
    /**
     * Auto generated value setter.
     * @param opentapsDbUpdates the opentapsDbUpdates to set
    */
    public void setOpentapsDbUpdates(List<OpentapsDbUpdate> opentapsDbUpdates) {
        this.opentapsDbUpdates = opentapsDbUpdates;
    }
    /**
     * Auto generated value setter.
