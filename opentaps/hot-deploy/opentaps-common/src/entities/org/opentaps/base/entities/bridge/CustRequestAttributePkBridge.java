...
import org.opentaps.base.entities.CustRequestAttributePk;

/**
 * A FieldBridge for CustRequestAttributePk.
 */
public class CustRequestAttributePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CustRequestAttributePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CustRequestAttributePk id = new CustRequestAttributePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        CustRequestAttributePk id = (CustRequestAttributePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CustRequestAttributePk id = (CustRequestAttributePk) value;
