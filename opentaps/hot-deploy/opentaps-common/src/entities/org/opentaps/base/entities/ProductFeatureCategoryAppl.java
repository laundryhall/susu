...
/**
 * Auto generated base entity ProductFeatureCategoryAppl.
 */
@javax.persistence.Entity
@Table(name="PRODUCT_FEATURE_CATEGORY_APPL")
public class ProductFeatureCategoryAppl extends Entity {
static {
...
fieldMapColumns.put("ProductFeatureCategoryAppl", fields);
}
  public static enum Fields implements EntityFieldInterface<ProductFeatureCategoryAppl> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.ProductFeatureCategoryApplPkBridge.class)
     private ProductFeatureCategoryApplPk id = new ProductFeatureCategoryApplPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>ProductFeatureCategoryApplPk</code>
     */
      public ProductFeatureCategoryApplPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>ProductFeatureCategoryApplPk</code> value to set
    */   
      public void setId(ProductFeatureCategoryApplPk id) {
         this.id = id;
      }
  ...
  public ProductFeatureCategoryAppl() {
      super();
      this.baseEntityName = "ProductFeatureCategoryAppl";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("productCategoryId");this.primaryKeyNames.add("productFeatureCategoryId");this.primaryKeyNames.add("fromDate");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("productCategoryId");this.allFieldsNames.add("productFeatureCategoryId");this.allFieldsNames.add("fromDate");this.allFieldsNames.add("thruDate");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ProductFeatureCategoryAppl(RepositoryInterface repository) {
      this();
    ...
    public void setProductFeatureCategoryId(String productFeatureCategoryId) {
        id.setProductFeatureCategoryId(productFeatureCategoryId);
    }
    /**
     * Auto generated value setter.
    ...
    public String getProductFeatureCategoryId() {
        return this.id.getProductFeatureCategoryId();
    }
    /**
     * Auto generated value accessor.
