...
import org.opentaps.base.entities.ProductAttributePk;

/**
 * A FieldBridge for ProductAttributePk.
 */
public class ProductAttributePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductAttributePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductAttributePk id = new ProductAttributePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductAttributePk id = (ProductAttributePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductAttributePk id = (ProductAttributePk) value;
