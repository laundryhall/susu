...
import org.opentaps.base.entities.ContainerGeoPointPk;

/**
 * A FieldBridge for ContainerGeoPointPk.
 */
public class ContainerGeoPointPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ContainerGeoPointPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ContainerGeoPointPk id = new ContainerGeoPointPk();
        Field field = null;
        field = document.getField(name + ".containerId");
        id.setContainerId(field.stringValue());
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ContainerGeoPointPk id = (ContainerGeoPointPk) value;
        ...
        Field field = null;
        field = new Field(name + ".containerId", id.getContainerId(), store, index, termVector);
