...
import org.opentaps.base.entities.ShoppingListWorkEffortPk;

/**
 * A FieldBridge for ShoppingListWorkEffortPk.
 */
public class ShoppingListWorkEffortPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ShoppingListWorkEffortPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ShoppingListWorkEffortPk id = new ShoppingListWorkEffortPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ShoppingListWorkEffortPk id = (ShoppingListWorkEffortPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ShoppingListWorkEffortPk id = (ShoppingListWorkEffortPk) value;
