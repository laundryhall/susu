...
/**
 * Auto generated base entity GlBudgetXref.
 */
@javax.persistence.Entity
@Table(name="GL_BUDGET_XREF")
public class GlBudgetXref extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        ...
        fields.put("allocationPercentage", "ALLOCATION_PERCENTAGE");
        fields.put("lastUpdatedStamp", "LAST_UPDATED_STAMP");
        fields.put("lastUpdatedTxStamp", "LAST_UPDATED_TX_STAMP");
        fields.put("createdStamp", "CREATED_STAMP");
        fields.put("createdTxStamp", "CREATED_TX_STAMP");
fieldMapColumns.put("GlBudgetXref", fields);
}
  public static enum Fields implements EntityFieldInterface<GlBudgetXref> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.GlBudgetXrefPkBridge.class)
     private GlBudgetXrefPk id = new GlBudgetXrefPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>GlBudgetXrefPk</code>
     */
      public GlBudgetXrefPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>GlBudgetXrefPk</code> value to set
    */   
      public void setId(GlBudgetXrefPk id) {
         this.id = id;
      }
  ...
  public GlBudgetXref() {
      super();
      this.baseEntityName = "GlBudgetXref";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("glAccountId");this.primaryKeyNames.add("budgetItemTypeId");this.primaryKeyNames.add("fromDate");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("glAccountId");this.allFieldsNames.add("budgetItemTypeId");this.allFieldsNames.add("fromDate");this.allFieldsNames.add("thruDate");this.allFieldsNames.add("allocationPercentage");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public GlBudgetXref(RepositoryInterface repository) {
      this();
    ...
    */
    ...
    public void fromMap(Map<String, Object> mapValue) {
        ...
        setAllocationPercentage(convertToBigDecimal(mapValue.get("allocationPercentage")));
    ...
    public Map<String, Object> toMap() {
        ...
        mapValue.put("allocationPercentage", getAllocationPercentage());
