...
import org.opentaps.base.entities.InvoiceAttributePk;

/**
 * A FieldBridge for InvoiceAttributePk.
 */
public class InvoiceAttributePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the InvoiceAttributePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        InvoiceAttributePk id = new InvoiceAttributePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        InvoiceAttributePk id = (InvoiceAttributePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        InvoiceAttributePk id = (InvoiceAttributePk) value;
