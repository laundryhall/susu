...
import org.opentaps.base.entities.AgreementItemAttributePk;

/**
 * A FieldBridge for AgreementItemAttributePk.
 */
public class AgreementItemAttributePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AgreementItemAttributePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AgreementItemAttributePk id = new AgreementItemAttributePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        AgreementItemAttributePk id = (AgreementItemAttributePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AgreementItemAttributePk id = (AgreementItemAttributePk) value;
