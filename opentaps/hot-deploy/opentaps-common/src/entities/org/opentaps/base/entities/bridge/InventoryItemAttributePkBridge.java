...
import org.opentaps.base.entities.InventoryItemAttributePk;

/**
 * A FieldBridge for InventoryItemAttributePk.
 */
public class InventoryItemAttributePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the InventoryItemAttributePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        InventoryItemAttributePk id = new InventoryItemAttributePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        InventoryItemAttributePk id = (InventoryItemAttributePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        InventoryItemAttributePk id = (InventoryItemAttributePk) value;
