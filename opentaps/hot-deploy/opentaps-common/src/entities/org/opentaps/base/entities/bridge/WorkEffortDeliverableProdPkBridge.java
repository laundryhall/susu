...
import org.opentaps.base.entities.WorkEffortDeliverableProdPk;

/**
 * A FieldBridge for WorkEffortDeliverableProdPk.
 */
public class WorkEffortDeliverableProdPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortDeliverableProdPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortDeliverableProdPk id = new WorkEffortDeliverableProdPk();
        Field field = null;
        field = document.getField(name + ".workEffortId");
        id.setWorkEffortId(field.stringValue());
        field = document.getField(name + ".deliverableId");
        id.setDeliverableId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        WorkEffortDeliverableProdPk id = (WorkEffortDeliverableProdPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getWorkEffortId());
        sb.append("_");
        sb.append(id.getDeliverableId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortDeliverableProdPk id = (WorkEffortDeliverableProdPk) value;
        ...
        document.add(field);
        field = new Field(name + ".deliverableId", id.getDeliverableId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
