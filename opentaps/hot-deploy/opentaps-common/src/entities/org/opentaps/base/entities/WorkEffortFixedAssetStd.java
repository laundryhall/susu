...
/**
 * Auto generated base entity WorkEffortFixedAssetStd.
 */
@javax.persistence.Entity
@Table(name="WORK_EFFORT_FIXED_ASSET_STD")
public class WorkEffortFixedAssetStd extends Entity {
static {
...
fieldMapColumns.put("WorkEffortFixedAssetStd", fields);
}
  public static enum Fields implements EntityFieldInterface<WorkEffortFixedAssetStd> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.WorkEffortFixedAssetStdPkBridge.class)
     private WorkEffortFixedAssetStdPk id = new WorkEffortFixedAssetStdPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>WorkEffortFixedAssetStdPk</code>
     */
      public WorkEffortFixedAssetStdPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>WorkEffortFixedAssetStdPk</code> value to set
    */   
      public void setId(WorkEffortFixedAssetStdPk id) {
         this.id = id;
      }
  ...
  public WorkEffortFixedAssetStd() {
      super();
      this.baseEntityName = "WorkEffortFixedAssetStd";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("workEffortId");this.primaryKeyNames.add("fixedAssetTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("workEffortId");this.allFieldsNames.add("fixedAssetTypeId");this.allFieldsNames.add("estimatedQuantity");this.allFieldsNames.add("estimatedDuration");this.allFieldsNames.add("estimatedCost");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public WorkEffortFixedAssetStd(RepositoryInterface repository) {
      this();
