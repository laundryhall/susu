...
import org.opentaps.base.entities.ReturnItemBillingPk;

/**
 * A FieldBridge for ReturnItemBillingPk.
 */
public class ReturnItemBillingPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ReturnItemBillingPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ReturnItemBillingPk id = new ReturnItemBillingPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ReturnItemBillingPk id = (ReturnItemBillingPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ReturnItemBillingPk id = (ReturnItemBillingPk) value;
