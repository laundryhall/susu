...
import org.opentaps.base.entities.ItemIssuanceRolePk;

/**
 * A FieldBridge for ItemIssuanceRolePk.
 */
public class ItemIssuanceRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ItemIssuanceRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ItemIssuanceRolePk id = new ItemIssuanceRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ItemIssuanceRolePk id = (ItemIssuanceRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ItemIssuanceRolePk id = (ItemIssuanceRolePk) value;
