...
/**
 * Auto generated base entity AgreementTermAttribute.
 */
@javax.persistence.Entity
@Table(name="AGREEMENT_TERM_ATTRIBUTE")
public class AgreementTermAttribute extends Entity {
static {
...
fieldMapColumns.put("AgreementTermAttribute", fields);
}
  public static enum Fields implements EntityFieldInterface<AgreementTermAttribute> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.AgreementTermAttributePkBridge.class)
     private AgreementTermAttributePk id = new AgreementTermAttributePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>AgreementTermAttributePk</code>
     */
      public AgreementTermAttributePk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>AgreementTermAttributePk</code> value to set
    */   
      public void setId(AgreementTermAttributePk id) {
         this.id = id;
      }
  ...
  public AgreementTermAttribute() {
      super();
      this.baseEntityName = "AgreementTermAttribute";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("agreementTermId");this.primaryKeyNames.add("attrName");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("agreementTermId");this.allFieldsNames.add("attrName");this.allFieldsNames.add("attrValue");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public AgreementTermAttribute(RepositoryInterface repository) {
      this();
    ...
    public void setAgreementTermId(String agreementTermId) {
        id.setAgreementTermId(agreementTermId);
    }
    /**
     * Auto generated value setter.
    ...
    public String getAgreementTermId() {
        return this.id.getAgreementTermId();
    }
    /**
     * Auto generated value accessor.
     * @return <code>String</code>
