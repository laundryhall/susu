...
import org.opentaps.base.entities.WebSiteRolePk;

/**
 * A FieldBridge for WebSiteRolePk.
 */
public class WebSiteRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WebSiteRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WebSiteRolePk id = new WebSiteRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WebSiteRolePk id = (WebSiteRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WebSiteRolePk id = (WebSiteRolePk) value;
