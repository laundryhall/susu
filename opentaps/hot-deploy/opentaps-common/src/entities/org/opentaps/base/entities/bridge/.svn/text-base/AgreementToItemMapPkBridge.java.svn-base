...
import org.opentaps.base.entities.AgreementToItemMapPk;

/**
 * A FieldBridge for AgreementToItemMapPk.
 */
public class AgreementToItemMapPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AgreementToItemMapPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AgreementToItemMapPk id = new AgreementToItemMapPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AgreementToItemMapPk id = (AgreementToItemMapPk) value;
