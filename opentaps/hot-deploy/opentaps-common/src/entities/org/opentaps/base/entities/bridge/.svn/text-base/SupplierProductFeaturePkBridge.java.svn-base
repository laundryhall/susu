...
import org.opentaps.base.entities.SupplierProductFeaturePk;

/**
 * A FieldBridge for SupplierProductFeaturePk.
 */
public class SupplierProductFeaturePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the SupplierProductFeaturePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        SupplierProductFeaturePk id = new SupplierProductFeaturePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        SupplierProductFeaturePk id = (SupplierProductFeaturePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        SupplierProductFeaturePk id = (SupplierProductFeaturePk) value;
