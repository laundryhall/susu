...
import org.opentaps.base.entities.UserLoginHistoryPk;

/**
 * A FieldBridge for UserLoginHistoryPk.
 */
public class UserLoginHistoryPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the UserLoginHistoryPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        UserLoginHistoryPk id = new UserLoginHistoryPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        UserLoginHistoryPk id = (UserLoginHistoryPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        UserLoginHistoryPk id = (UserLoginHistoryPk) value;
