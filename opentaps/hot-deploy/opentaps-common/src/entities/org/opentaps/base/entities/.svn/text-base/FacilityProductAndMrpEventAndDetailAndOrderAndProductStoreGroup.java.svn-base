...
/**
 * Auto generated base entity FacilityProductAndMrpEventAndDetailAndOrderAndProductStoreGroup.
 */
...
public class FacilityProductAndMrpEventAndDetailAndOrderAndProductStoreGroup extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        ...
        fields.put("fromDate", "PSGM.FROM_DATE");
        fields.put("thruDate", "PSGM.THRU_DATE");
        fields.put("sequenceNum", "PSGM.SEQUENCE_NUM");
fieldMapColumns.put("FacilityProductAndMrpEventAndDetailAndOrderAndProductStoreGroup", fields);
}
  public static enum Fields implements EntityFieldInterface<FacilityProductAndMrpEventAndDetailAndOrderAndProductStoreGroup> {
  ...
  public FacilityProductAndMrpEventAndDetailAndOrderAndProductStoreGroup() {
      ...
      this.primaryKeyNames.add("productStoreGroupId");this.primaryKeyNames.add("productId");this.primaryKeyNames.add("facilityId");this.primaryKeyNames.add("eventDate");this.primaryKeyNames.add("inventoryEventPlanTypeId");this.primaryKeyNames.add("fromDate");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("billOfMaterialLevel");this.allFieldsNames.add("introductionDate");this.allFieldsNames.add("salesDiscontinuationDate");this.allFieldsNames.add("inOut");this.allFieldsNames.add("orderId");this.allFieldsNames.add("productStoreId");this.allFieldsNames.add("productStoreGroupId");this.allFieldsNames.add("productId");this.allFieldsNames.add("facilityId");this.allFieldsNames.add("minimumStock");this.allFieldsNames.add("reorderQuantity");this.allFieldsNames.add("daysToShip");this.allFieldsNames.add("replenishMethodEnumId");this.allFieldsNames.add("replenishFromFacilityId");this.allFieldsNames.add("eventDate");this.allFieldsNames.add("inventoryEventPlanTypeId");this.allFieldsNames.add("eventQuantity");this.allFieldsNames.add("netQoh");this.allFieldsNames.add("eventName");this.allFieldsNames.add("isLate");this.allFieldsNames.add("fromDate");this.allFieldsNames.add("thruDate");this.allFieldsNames.add("sequenceNum");
   ...
   */
  public FacilityProductAndMrpEventAndDetailAndOrderAndProductStoreGroup(RepositoryInterface repository) {
      this();
