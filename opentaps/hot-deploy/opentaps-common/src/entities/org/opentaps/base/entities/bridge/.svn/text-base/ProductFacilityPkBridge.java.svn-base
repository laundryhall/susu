...
import org.opentaps.base.entities.ProductFacilityPk;

/**
 * A FieldBridge for ProductFacilityPk.
 */
public class ProductFacilityPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductFacilityPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductFacilityPk id = new ProductFacilityPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductFacilityPk id = (ProductFacilityPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductFacilityPk id = (ProductFacilityPk) value;
