...
/**
 * Auto generated base entity ProductPaymentMethodType.
 */
@javax.persistence.Entity
@Table(name="PRODUCT_PAYMENT_METHOD_TYPE")
public class ProductPaymentMethodType extends Entity {
static {
...
fieldMapColumns.put("ProductPaymentMethodType", fields);
}
  public static enum Fields implements EntityFieldInterface<ProductPaymentMethodType> {
    productId("productId"),
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.ProductPaymentMethodTypePkBridge.class)
     private ProductPaymentMethodTypePk id = new ProductPaymentMethodTypePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>ProductPaymentMethodTypePk</code>
     */
      public ProductPaymentMethodTypePk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>ProductPaymentMethodTypePk</code> value to set
    */   
      public void setId(ProductPaymentMethodTypePk id) {
         this.id = id;
      }
  ...
  public ProductPaymentMethodType() {
      super();
      this.baseEntityName = "ProductPaymentMethodType";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("productId");this.primaryKeyNames.add("paymentMethodTypeId");this.primaryKeyNames.add("productPricePurposeId");this.primaryKeyNames.add("fromDate");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("productId");this.allFieldsNames.add("paymentMethodTypeId");this.allFieldsNames.add("productPricePurposeId");this.allFieldsNames.add("fromDate");this.allFieldsNames.add("thruDate");this.allFieldsNames.add("sequenceNum");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ProductPaymentMethodType(RepositoryInterface repository) {
      this();
