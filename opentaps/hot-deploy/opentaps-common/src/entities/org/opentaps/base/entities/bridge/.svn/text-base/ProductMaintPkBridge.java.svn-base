...
import org.opentaps.base.entities.ProductMaintPk;

/**
 * A FieldBridge for ProductMaintPk.
 */
public class ProductMaintPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductMaintPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductMaintPk id = new ProductMaintPk();
        Field field = null;
        field = document.getField(name + ".productId");
        id.setProductId(field.stringValue());
        field = document.getField(name + ".productMaintSeqId");
        id.setProductMaintSeqId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        ProductMaintPk id = (ProductMaintPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProductId());
        sb.append("_");
        sb.append(id.getProductMaintSeqId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductMaintPk id = (ProductMaintPk) value;
        ...
        document.add(field);
        field = new Field(name + ".productMaintSeqId", id.getProductMaintSeqId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
