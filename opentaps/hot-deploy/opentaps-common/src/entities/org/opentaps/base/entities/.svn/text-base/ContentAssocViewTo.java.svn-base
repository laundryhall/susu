...
public class ContentAssocViewTo extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        fields.put("contentIdStart", "CA.CONTENT_ID");
...
fieldMapColumns.put("ContentAssocViewTo", fields);
}
  public static enum Fields implements EntityFieldInterface<ContentAssocViewTo> {
  ...
  public ContentAssocViewTo() {
      super();
      this.baseEntityName = "ContentAssocViewTo";
      this.isView = true;
   ...
   */
  public ContentAssocViewTo(RepositoryInterface repository) {
      this();
