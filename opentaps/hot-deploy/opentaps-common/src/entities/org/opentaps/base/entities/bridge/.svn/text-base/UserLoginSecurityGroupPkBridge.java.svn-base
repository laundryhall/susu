...
import org.opentaps.base.entities.UserLoginSecurityGroupPk;

/**
 * A FieldBridge for UserLoginSecurityGroupPk.
 */
public class UserLoginSecurityGroupPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the UserLoginSecurityGroupPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        UserLoginSecurityGroupPk id = new UserLoginSecurityGroupPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        UserLoginSecurityGroupPk id = (UserLoginSecurityGroupPk) value;
