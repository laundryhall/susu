...
/**
 * Auto generated base entity InvoiceItemProductSummary.
 */
...
@SqlResultSetMapping(name="InvoiceItemProductSummaryMapping", entities={
@EntityResult(entityClass=InvoiceItemProductSummary.class, fields = {
...
public class InvoiceItemProductSummary extends Entity {
static {
...
fieldMapColumns.put("InvoiceItemProductSummary", fields);
}
  public static enum Fields implements EntityFieldInterface<InvoiceItemProductSummary> {
    statusId("statusId"),
   ...
   */
  public InvoiceItemProductSummary(RepositoryInterface repository) {
      this();
