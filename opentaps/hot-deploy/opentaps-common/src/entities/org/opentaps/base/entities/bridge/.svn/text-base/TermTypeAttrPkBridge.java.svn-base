...
import org.opentaps.base.entities.TermTypeAttrPk;

/**
 * A FieldBridge for TermTypeAttrPk.
 */
public class TermTypeAttrPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the TermTypeAttrPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        TermTypeAttrPk id = new TermTypeAttrPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        TermTypeAttrPk id = (TermTypeAttrPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        TermTypeAttrPk id = (TermTypeAttrPk) value;
