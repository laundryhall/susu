...
/**
 * Auto generated base entity SubscriptionAttribute.
 */
@javax.persistence.Entity
@Table(name="SUBSCRIPTION_ATTRIBUTE")
public class SubscriptionAttribute extends Entity {
static {
...
fieldMapColumns.put("SubscriptionAttribute", fields);
}
  public static enum Fields implements EntityFieldInterface<SubscriptionAttribute> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.SubscriptionAttributePkBridge.class)
     private SubscriptionAttributePk id = new SubscriptionAttributePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>SubscriptionAttributePk</code>
     */
     ...
     * @param id a <code>SubscriptionAttributePk</code> value to set
    */   
   ...
   private transient List<SubscriptionTypeAttr> subscriptionTypeAttrs = null;
  ...
  public SubscriptionAttribute() {
      super();
      this.baseEntityName = "SubscriptionAttribute";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("subscriptionId");this.primaryKeyNames.add("attrName");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("subscriptionId");this.allFieldsNames.add("attrName");this.allFieldsNames.add("attrValue");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public SubscriptionAttribute(RepositoryInterface repository) {
      this();
