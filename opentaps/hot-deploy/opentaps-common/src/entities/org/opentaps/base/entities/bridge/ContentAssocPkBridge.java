...
import org.opentaps.base.entities.ContentAssocPk;

/**
 * A FieldBridge for ContentAssocPk.
 */
public class ContentAssocPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ContentAssocPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ContentAssocPk id = new ContentAssocPk();
        Field field = null;
        field = document.getField(name + ".contentId");
        id.setContentId(field.stringValue());
        field = document.getField(name + ".contentIdTo");
        id.setContentIdTo(field.stringValue());
        field = document.getField(name + ".contentAssocTypeId");
        id.setContentAssocTypeId(field.stringValue());
    ...
    public String objectToString(Object object) {
        ContentAssocPk id = (ContentAssocPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getContentId());
        sb.append("_");
        sb.append(id.getContentIdTo());
        sb.append("_");
        sb.append(id.getContentAssocTypeId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ContentAssocPk id = (ContentAssocPk) value;
        ...
        document.add(field);
        field = new Field(name + ".contentIdTo", id.getContentIdTo(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".contentAssocTypeId", id.getContentAssocTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
