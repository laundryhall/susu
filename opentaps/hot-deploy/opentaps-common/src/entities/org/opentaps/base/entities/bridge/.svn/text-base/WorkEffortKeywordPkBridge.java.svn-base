...
import org.opentaps.base.entities.WorkEffortKeywordPk;

/**
 * A FieldBridge for WorkEffortKeywordPk.
 */
public class WorkEffortKeywordPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortKeywordPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortKeywordPk id = new WorkEffortKeywordPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkEffortKeywordPk id = (WorkEffortKeywordPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortKeywordPk id = (WorkEffortKeywordPk) value;
