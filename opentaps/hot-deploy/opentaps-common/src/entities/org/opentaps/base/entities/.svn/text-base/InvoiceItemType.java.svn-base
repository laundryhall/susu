...
fieldMapColumns.put("InvoiceItemType", fields);
  ...
  public static enum Fields implements EntityFieldInterface<InvoiceItemType> {
   ...
   private transient List<AgreementInvoiceItemType> fromAgreementInvoiceItemTypes = null;
   private transient List<AgreementInvoiceItemType> toAgreementInvoiceItemTypes = null;
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="parentInvoiceItemType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   ...
   private transient List<InvoiceItemTypeMap> invoiceItemTypeMaps = null;
