...
import org.opentaps.base.entities.GlBudgetXrefPk;

/**
 * A FieldBridge for GlBudgetXrefPk.
 */
public class GlBudgetXrefPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the GlBudgetXrefPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        GlBudgetXrefPk id = new GlBudgetXrefPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        GlBudgetXrefPk id = (GlBudgetXrefPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        GlBudgetXrefPk id = (GlBudgetXrefPk) value;
