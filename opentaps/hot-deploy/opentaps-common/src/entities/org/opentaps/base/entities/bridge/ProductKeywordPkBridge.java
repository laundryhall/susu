...
import org.opentaps.base.entities.ProductKeywordPk;

/**
 * A FieldBridge for ProductKeywordPk.
 */
public class ProductKeywordPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductKeywordPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductKeywordPk id = new ProductKeywordPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductKeywordPk id = (ProductKeywordPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductKeywordPk id = (ProductKeywordPk) value;
