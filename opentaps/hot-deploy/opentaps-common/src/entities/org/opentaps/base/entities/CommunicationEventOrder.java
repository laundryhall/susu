...
/**
 * Auto generated base entity CommunicationEventOrder.
 */
@javax.persistence.Entity
@Table(name="COMMUNICATION_EVENT_ORDER")
public class CommunicationEventOrder extends Entity {
static {
...
fieldMapColumns.put("CommunicationEventOrder", fields);
}
  public static enum Fields implements EntityFieldInterface<CommunicationEventOrder> {
    orderId("orderId"),
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.CommunicationEventOrderPkBridge.class)
     private CommunicationEventOrderPk id = new CommunicationEventOrderPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>CommunicationEventOrderPk</code>
     */
     ...
     * @param id a <code>CommunicationEventOrderPk</code> value to set
    */   
  ...
  public CommunicationEventOrder() {
      super();
      this.baseEntityName = "CommunicationEventOrder";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("orderId");this.primaryKeyNames.add("communicationEventId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("orderId");this.allFieldsNames.add("communicationEventId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public CommunicationEventOrder(RepositoryInterface repository) {
      this();
