...
import org.opentaps.base.entities.FixedAssetProductPk;

/**
 * A FieldBridge for FixedAssetProductPk.
 */
public class FixedAssetProductPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FixedAssetProductPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FixedAssetProductPk id = new FixedAssetProductPk();
        Field field = null;
        ...
        field = document.getField(name + ".fixedAssetProductTypeId");
        id.setFixedAssetProductTypeId(field.stringValue());
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FixedAssetProductPk id = (FixedAssetProductPk) value;
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".fixedAssetProductTypeId", id.getFixedAssetProductTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
