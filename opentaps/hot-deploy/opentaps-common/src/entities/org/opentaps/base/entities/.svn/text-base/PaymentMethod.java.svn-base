...
fieldMapColumns.put("PaymentMethod", fields);
  ...
  public static enum Fields implements EntityFieldInterface<PaymentMethod> {
   ...
   private transient List<FinAccount> replenishFinAccounts = null;
   @OneToOne(cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch=FetchType.LAZY)
   @JoinColumn(name="PAYMENT_METHOD_ID", insertable=false, updatable=false)
   @org.hibernate.annotations.Generated(
      org.hibernate.annotations.GenerationTime.ALWAYS
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="paymentMethod", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
