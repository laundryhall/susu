...
public class QuoteWorkEffortView extends Entity {
static {
...
fieldMapColumns.put("QuoteWorkEffortView", fields);
}
  public static enum Fields implements EntityFieldInterface<QuoteWorkEffortView> {
   ...
   */
  public QuoteWorkEffortView(RepositoryInterface repository) {
      this();
