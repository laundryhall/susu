...
/**
 * Auto generated base entity ProductStoreFacility.
 */
@javax.persistence.Entity
@Table(name="PRODUCT_STORE_FACILITY")
public class ProductStoreFacility extends Entity {
static {
...
fieldMapColumns.put("ProductStoreFacility", fields);
}
  public static enum Fields implements EntityFieldInterface<ProductStoreFacility> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.ProductStoreFacilityPkBridge.class)
     private ProductStoreFacilityPk id = new ProductStoreFacilityPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>ProductStoreFacilityPk</code>
     */
      public ProductStoreFacilityPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>ProductStoreFacilityPk</code> value to set
    */   
      public void setId(ProductStoreFacilityPk id) {
         this.id = id;
      }
  ...
  public ProductStoreFacility() {
      super();
      this.baseEntityName = "ProductStoreFacility";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("productStoreId");this.primaryKeyNames.add("facilityId");this.primaryKeyNames.add("fromDate");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("productStoreId");this.allFieldsNames.add("facilityId");this.allFieldsNames.add("fromDate");this.allFieldsNames.add("thruDate");this.allFieldsNames.add("sequenceNum");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ProductStoreFacility(RepositoryInterface repository) {
      this();
