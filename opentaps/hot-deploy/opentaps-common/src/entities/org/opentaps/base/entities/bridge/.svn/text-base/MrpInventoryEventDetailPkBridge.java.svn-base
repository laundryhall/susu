...
/**
 * A FieldBridge for MrpInventoryEventDetailPk.
 */
public class MrpInventoryEventDetailPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the MrpInventoryEventDetailPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        MrpInventoryEventDetailPk id = new MrpInventoryEventDetailPk();
        Field field = null;
        field = document.getField(name + ".productId");
        id.setProductId(field.stringValue());
        field = document.getField(name + ".eventDate");
        if (field.stringValue() != null && !field.stringValue().equals("")) {
            id.setEventDate(new Timestamp(((Date) (new DateBridge(Resolution.DAY)).stringToObject(field.stringValue())).getTime()));
        }
        field = document.getField(name + ".inventoryEventPlanTypeId");
        id.setInventoryEventPlanTypeId(field.stringValue());
        field = document.getField(name + ".facilityId");
        id.setFacilityId(field.stringValue());
        field = document.getField(name + ".mrpInvEvtDetSeqId");
        id.setMrpInvEvtDetSeqId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        MrpInventoryEventDetailPk id = (MrpInventoryEventDetailPk) object;
        ...
        sb.append("_");
        sb.append(id.getMrpInvEvtDetSeqId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        MrpInventoryEventDetailPk id = (MrpInventoryEventDetailPk) value;
        ...
        document.add(field);
        field = new Field(name + ".eventDate", (new DateBridge(Resolution.DAY)).objectToString(id.getEventDate()), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".inventoryEventPlanTypeId", id.getInventoryEventPlanTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".facilityId", id.getFacilityId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".mrpInvEvtDetSeqId", id.getMrpInvEvtDetSeqId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
