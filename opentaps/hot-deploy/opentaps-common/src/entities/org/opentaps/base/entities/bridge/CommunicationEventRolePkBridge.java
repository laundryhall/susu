...
import org.opentaps.base.entities.CommunicationEventRolePk;

/**
 * A FieldBridge for CommunicationEventRolePk.
 */
public class CommunicationEventRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CommunicationEventRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CommunicationEventRolePk id = new CommunicationEventRolePk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CommunicationEventRolePk id = (CommunicationEventRolePk) value;
