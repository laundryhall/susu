...
/**
 * Auto generated base entity SupplierRatingType.
 */
@javax.persistence.Entity
@Table(name="SUPPLIER_RATING_TYPE")
public class SupplierRatingType extends Entity {
static {
...
fieldMapColumns.put("SupplierRatingType", fields);
}
  public static enum Fields implements EntityFieldInterface<SupplierRatingType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="SupplierRatingType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="SupplierRatingType_GEN")
   @Id
  ...
  public SupplierRatingType() {
      super();
      this.baseEntityName = "SupplierRatingType";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("supplierRatingTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("supplierRatingTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public SupplierRatingType(RepositoryInterface repository) {
      this();
