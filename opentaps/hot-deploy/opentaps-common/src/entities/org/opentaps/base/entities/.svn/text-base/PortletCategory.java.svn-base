...
/**
 * Auto generated base entity PortletCategory.
 */
@javax.persistence.Entity
@Table(name="PORTLET_CATEGORY")
public class PortletCategory extends Entity {
static {
...
fieldMapColumns.put("PortletCategory", fields);
}
  public static enum Fields implements EntityFieldInterface<PortletCategory> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="PortletCategory_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="PortletCategory_GEN")
   @Id
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="portletCategory", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="PORTLET_CATEGORY_ID")
  ...
  public PortletCategory() {
      super();
      this.baseEntityName = "PortletCategory";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("portletCategoryId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("portletCategoryId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public PortletCategory(RepositoryInterface repository) {
      this();
