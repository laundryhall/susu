...
import org.opentaps.base.entities.ContentMetaDataPk;

/**
 * A FieldBridge for ContentMetaDataPk.
 */
public class ContentMetaDataPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ContentMetaDataPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ContentMetaDataPk id = new ContentMetaDataPk();
        Field field = null;
        field = document.getField(name + ".contentId");
        id.setContentId(field.stringValue());
        field = document.getField(name + ".metaDataPredicateId");
        id.setMetaDataPredicateId(field.stringValue());
        field = document.getField(name + ".metaDataValue");
        id.setMetaDataValue(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        ContentMetaDataPk id = (ContentMetaDataPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ContentMetaDataPk id = (ContentMetaDataPk) value;
        ...
        document.add(field);
        field = new Field(name + ".metaDataPredicateId", id.getMetaDataPredicateId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".metaDataValue", id.getMetaDataValue(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
