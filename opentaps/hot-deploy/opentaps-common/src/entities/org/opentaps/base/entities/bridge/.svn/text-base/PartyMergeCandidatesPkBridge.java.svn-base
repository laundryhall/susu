...
import org.opentaps.base.entities.PartyMergeCandidatesPk;

/**
 * A FieldBridge for PartyMergeCandidatesPk.
 */
public class PartyMergeCandidatesPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyMergeCandidatesPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyMergeCandidatesPk id = new PartyMergeCandidatesPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PartyMergeCandidatesPk id = (PartyMergeCandidatesPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyMergeCandidatesPk id = (PartyMergeCandidatesPk) value;
