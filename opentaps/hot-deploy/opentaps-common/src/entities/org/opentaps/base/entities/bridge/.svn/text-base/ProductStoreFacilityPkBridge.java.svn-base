...
import org.opentaps.base.entities.ProductStoreFacilityPk;

/**
 * A FieldBridge for ProductStoreFacilityPk.
 */
public class ProductStoreFacilityPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductStoreFacilityPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductStoreFacilityPk id = new ProductStoreFacilityPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductStoreFacilityPk id = (ProductStoreFacilityPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductStoreFacilityPk id = (ProductStoreFacilityPk) value;
