...
import org.opentaps.base.entities.WorkOrderItemFulfillmentPk;

/**
 * A FieldBridge for WorkOrderItemFulfillmentPk.
 */
public class WorkOrderItemFulfillmentPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkOrderItemFulfillmentPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkOrderItemFulfillmentPk id = new WorkOrderItemFulfillmentPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkOrderItemFulfillmentPk id = (WorkOrderItemFulfillmentPk) value;
