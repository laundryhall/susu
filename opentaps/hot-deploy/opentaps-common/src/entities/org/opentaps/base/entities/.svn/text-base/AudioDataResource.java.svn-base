...
/**
 * Auto generated base entity AudioDataResource.
 */
@javax.persistence.Entity
@Table(name="AUDIO_DATA_RESOURCE")
public class AudioDataResource extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        fields.put("dataResourceId", "DATA_RESOURCE_ID");
        fields.put("audioData", "AUDIO_DATA");
        fields.put("lastUpdatedStamp", "LAST_UPDATED_STAMP");
        fields.put("lastUpdatedTxStamp", "LAST_UPDATED_TX_STAMP");
        fields.put("createdStamp", "CREATED_STAMP");
        fields.put("createdTxStamp", "CREATED_TX_STAMP");
fieldMapColumns.put("AudioDataResource", fields);
}
  public static enum Fields implements EntityFieldInterface<AudioDataResource> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="AudioDataResource_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="AudioDataResource_GEN")
   @Id
   ...
   * Default constructor.
   */
  public AudioDataResource() {
      super();
      this.baseEntityName = "AudioDataResource";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("dataResourceId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("dataResourceId");this.allFieldsNames.add("audioData");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public AudioDataResource(RepositoryInterface repository) {
      this();
    ...
    */
    ...
    public Map<String, Object> toMap() {
        ...
        mapValue.put("audioData", getAudioData());
