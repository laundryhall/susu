...
fieldMapColumns.put("CustRequestWorkEffort", fields);
  ...
  public static enum Fields implements EntityFieldInterface<CustRequestWorkEffort> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.CustRequestWorkEffortPkBridge.class)
     private CustRequestWorkEffortPk id = new CustRequestWorkEffortPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>CustRequestWorkEffortPk</code>
     */
     ...
     * @param id a <code>CustRequestWorkEffortPk</code> value to set
    */   
  ...
  public CustRequestWorkEffort() {
      ...
      this.allFieldsNames.add("custRequestId");this.allFieldsNames.add("workEffortId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
