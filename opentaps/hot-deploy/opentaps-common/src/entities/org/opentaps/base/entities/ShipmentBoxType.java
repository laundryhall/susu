...
fieldMapColumns.put("ShipmentBoxType", fields);
  ...
  public static enum Fields implements EntityFieldInterface<ShipmentBoxType> {
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="defaultShipmentBoxType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="DEFAULT_SHIPMENT_BOX_TYPE_ID")
   
   private List<Product> defaultProducts = null;
   private transient List<ShipmentPackage> shipmentPackages = null;
