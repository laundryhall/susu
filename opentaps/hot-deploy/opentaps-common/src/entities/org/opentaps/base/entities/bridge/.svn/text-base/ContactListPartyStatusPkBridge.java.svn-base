...
import org.opentaps.base.entities.ContactListPartyStatusPk;

/**
 * A FieldBridge for ContactListPartyStatusPk.
 */
public class ContactListPartyStatusPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ContactListPartyStatusPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ContactListPartyStatusPk id = new ContactListPartyStatusPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ContactListPartyStatusPk id = (ContactListPartyStatusPk) value;
