...
import org.opentaps.base.entities.PartyTaxAuthInfoPk;

/**
 * A FieldBridge for PartyTaxAuthInfoPk.
 */
public class PartyTaxAuthInfoPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyTaxAuthInfoPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyTaxAuthInfoPk id = new PartyTaxAuthInfoPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PartyTaxAuthInfoPk id = (PartyTaxAuthInfoPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyTaxAuthInfoPk id = (PartyTaxAuthInfoPk) value;
