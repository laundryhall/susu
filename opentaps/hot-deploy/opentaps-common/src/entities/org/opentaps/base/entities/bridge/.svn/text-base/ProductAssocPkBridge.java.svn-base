...
import org.opentaps.base.entities.ProductAssocPk;

/**
 * A FieldBridge for ProductAssocPk.
 */
public class ProductAssocPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductAssocPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductAssocPk id = new ProductAssocPk();
        Field field = null;
        field = document.getField(name + ".productId");
        id.setProductId(field.stringValue());
        field = document.getField(name + ".productIdTo");
        id.setProductIdTo(field.stringValue());
        field = document.getField(name + ".productAssocTypeId");
        id.setProductAssocTypeId(field.stringValue());
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductAssocPk id = (ProductAssocPk) value;
        ...
        document.add(field);
        field = new Field(name + ".productIdTo", id.getProductIdTo(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".productAssocTypeId", id.getProductAssocTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
