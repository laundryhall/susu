...
/**
 * A FieldBridge for ViewPreferencePk.
 */
public class ViewPreferencePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ViewPreferencePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ViewPreferencePk id = new ViewPreferencePk();
        Field field = null;
        field = document.getField(name + ".viewPrefTypeId");
        id.setViewPrefTypeId(field.stringValue());
    ...
    public String objectToString(Object object) {
        ViewPreferencePk id = (ViewPreferencePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getViewPrefTypeId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ViewPreferencePk id = (ViewPreferencePk) value;
        ...
        Field field = null;
        field = new Field(name + ".viewPrefTypeId", id.getViewPrefTypeId(), store, index, termVector);
