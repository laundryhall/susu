...
import org.opentaps.base.entities.OldWorkEffortAssignmentRatePk;

/**
 * A FieldBridge for OldWorkEffortAssignmentRatePk.
 */
public class OldWorkEffortAssignmentRatePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the OldWorkEffortAssignmentRatePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        OldWorkEffortAssignmentRatePk id = new OldWorkEffortAssignmentRatePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        OldWorkEffortAssignmentRatePk id = (OldWorkEffortAssignmentRatePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        OldWorkEffortAssignmentRatePk id = (OldWorkEffortAssignmentRatePk) value;
