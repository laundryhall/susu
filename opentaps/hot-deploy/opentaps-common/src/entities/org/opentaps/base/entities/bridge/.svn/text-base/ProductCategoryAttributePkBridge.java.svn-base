...
import org.opentaps.base.entities.ProductCategoryAttributePk;

/**
 * A FieldBridge for ProductCategoryAttributePk.
 */
public class ProductCategoryAttributePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductCategoryAttributePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductCategoryAttributePk id = new ProductCategoryAttributePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductCategoryAttributePk id = (ProductCategoryAttributePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductCategoryAttributePk id = (ProductCategoryAttributePk) value;
