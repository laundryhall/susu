...
import org.opentaps.base.entities.FacilityPartyPk;

/**
 * A FieldBridge for FacilityPartyPk.
 */
public class FacilityPartyPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FacilityPartyPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FacilityPartyPk id = new FacilityPartyPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        FacilityPartyPk id = (FacilityPartyPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FacilityPartyPk id = (FacilityPartyPk) value;
