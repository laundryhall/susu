...
public class WorkEffortPartyAssignByRole extends Entity {
static {
...
fieldMapColumns.put("WorkEffortPartyAssignByRole", fields);
}
  public static enum Fields implements EntityFieldInterface<WorkEffortPartyAssignByRole> {
   ...
   * Default constructor.
   */
  public WorkEffortPartyAssignByRole() {
      super();
      this.baseEntityName = "WorkEffortPartyAssignByRole";
      this.isView = true;
   ...
   */
  public WorkEffortPartyAssignByRole(RepositoryInterface repository) {
      this();
