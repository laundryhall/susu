...
import org.opentaps.base.entities.WarehouseDefaultBoxTypePk;

/**
 * A FieldBridge for WarehouseDefaultBoxTypePk.
 */
public class WarehouseDefaultBoxTypePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WarehouseDefaultBoxTypePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WarehouseDefaultBoxTypePk id = new WarehouseDefaultBoxTypePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WarehouseDefaultBoxTypePk id = (WarehouseDefaultBoxTypePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WarehouseDefaultBoxTypePk id = (WarehouseDefaultBoxTypePk) value;
