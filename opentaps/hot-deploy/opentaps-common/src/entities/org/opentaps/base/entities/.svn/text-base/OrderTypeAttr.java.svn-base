...
fieldMapColumns.put("OrderTypeAttr", fields);
  ...
  public static enum Fields implements EntityFieldInterface<OrderTypeAttr> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.OrderTypeAttrPkBridge.class)
     private OrderTypeAttrPk id = new OrderTypeAttrPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>OrderTypeAttrPk</code>
     */
     ...
     * @param id a <code>OrderTypeAttrPk</code> value to set
    */   
  ...
  public OrderTypeAttr() {
      ...
      this.allFieldsNames.add("orderTypeId");this.allFieldsNames.add("attrName");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
