...
import org.opentaps.base.entities.PartyRelationshipPk;

/**
 * A FieldBridge for PartyRelationshipPk.
 */
public class PartyRelationshipPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyRelationshipPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyRelationshipPk id = new PartyRelationshipPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PartyRelationshipPk id = (PartyRelationshipPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyRelationshipPk id = (PartyRelationshipPk) value;
