...
/**
 * Auto generated base entity ContactListType.
 */
@javax.persistence.Entity
@Table(name="CONTACT_LIST_TYPE")
public class ContactListType extends Entity {
static {
...
fieldMapColumns.put("ContactListType", fields);
}
  public static enum Fields implements EntityFieldInterface<ContactListType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="ContactListType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="ContactListType_GEN")
   @Id
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="contactListType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="CONTACT_LIST_TYPE_ID")
  ...
  public ContactListType() {
      super();
      this.baseEntityName = "ContactListType";
      this.isView = false;
      this.resourceName = "MarketingEntityLabels";
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("contactListTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("contactListTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ContactListType(RepositoryInterface repository) {
      this();
