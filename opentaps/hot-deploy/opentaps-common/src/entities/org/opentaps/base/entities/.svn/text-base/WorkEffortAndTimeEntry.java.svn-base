...
public class WorkEffortAndTimeEntry extends Entity {
static {
...
fieldMapColumns.put("WorkEffortAndTimeEntry", fields);
}
  public static enum Fields implements EntityFieldInterface<WorkEffortAndTimeEntry> {
   ...
   * Default constructor.
   */
  public WorkEffortAndTimeEntry() {
      super();
      this.baseEntityName = "WorkEffortAndTimeEntry";
      this.isView = true;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("workEffortId");this.primaryKeyNames.add("timeEntryId");
   ...
   */
  public WorkEffortAndTimeEntry(RepositoryInterface repository) {
      this();
