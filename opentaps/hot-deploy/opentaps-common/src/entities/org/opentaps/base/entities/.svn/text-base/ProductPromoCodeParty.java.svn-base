...
/**
 * Auto generated base entity ProductPromoCodeParty.
 */
@javax.persistence.Entity
@Table(name="PRODUCT_PROMO_CODE_PARTY")
public class ProductPromoCodeParty extends Entity {
static {
...
fieldMapColumns.put("ProductPromoCodeParty", fields);
}
  public static enum Fields implements EntityFieldInterface<ProductPromoCodeParty> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.ProductPromoCodePartyPkBridge.class)
     private ProductPromoCodePartyPk id = new ProductPromoCodePartyPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>ProductPromoCodePartyPk</code>
     */
      public ProductPromoCodePartyPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>ProductPromoCodePartyPk</code> value to set
    */   
      public void setId(ProductPromoCodePartyPk id) {
         this.id = id;
      }
  ...
  public ProductPromoCodeParty() {
      super();
      this.baseEntityName = "ProductPromoCodeParty";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("productPromoCodeId");this.primaryKeyNames.add("partyId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("productPromoCodeId");this.allFieldsNames.add("partyId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ProductPromoCodeParty(RepositoryInterface repository) {
      this();
