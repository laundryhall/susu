...
/**
 * Auto generated base entity ReservedItemOrderCount.
 */
@javax.persistence.Entity
@NamedNativeQuery(name="selectReservedItemOrderCounts", query="SELECT OH.ORDER_ID AS \"orderId\",OH.ORDER_TYPE_ID AS \"orderTypeId\",OH.STATUS_ID AS \"statusId\",OI.STATUS_ID AS \"statusId\",RES.QUANTITY_NOT_AVAILABLE AS \"quantityNotAvailable\",II.FACILITY_ID AS \"facilityId\" FROM ORDER_HEADER OH INNER JOIN ORDER_ITEM_SHIP_GRP_INV_RES RES ON RES.ORDER_ID = OH.ORDER_ID INNER JOIN ORDER_ITEM_SHIP_GRP_INV_RES RES ON RES.ORDER_ID = OI.ORDER_ID AND RES.ORDER_ITEM_SEQ_ID = OI.ORDER_ITEM_SEQ_ID INNER JOIN INVENTORY_ITEM II ON RES.INVENTORY_ITEM_ID = II.INVENTORY_ITEM_ID", resultSetMapping="ReservedItemOrderCountMapping")
@SqlResultSetMapping(name="ReservedItemOrderCountMapping", entities={
@EntityResult(entityClass=ReservedItemOrderCount.class, fields = {
...
public class ReservedItemOrderCount extends Entity {
static {
...
fieldMapColumns.put("ReservedItemOrderCount", fields);
}
  public static enum Fields implements EntityFieldInterface<ReservedItemOrderCount> {
    orderId("orderId"),
   ...
   * Default constructor.
   */
  public ReservedItemOrderCount() {
      super();
      this.baseEntityName = "ReservedItemOrderCount";
      this.isView = true;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("orderId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("orderId");this.allFieldsNames.add("orderTypeId");this.allFieldsNames.add("orderStatusId");this.allFieldsNames.add("orderItemStatusId");this.allFieldsNames.add("quantityNotAvailable");this.allFieldsNames.add("facilityId");
   ...
   */
  public ReservedItemOrderCount(RepositoryInterface repository) {
      this();
