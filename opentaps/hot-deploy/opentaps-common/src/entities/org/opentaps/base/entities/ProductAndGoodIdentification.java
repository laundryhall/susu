...
,@FieldResult(name="relevancyWeight", column="relevancyWeight")
})})
@org.hibernate.annotations.Entity(mutable = false)
@org.hibernate.annotations.AccessType("field")
public class ProductAndGoodIdentification extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        ...
        fields.put("keyword", "PK.KEYWORD");
        fields.put("relevancyWeight", "PK.RELEVANCY_WEIGHT");
fieldMapColumns.put("ProductAndGoodIdentification", fields);
}
  public static enum Fields implements EntityFieldInterface<ProductAndGoodIdentification> {
    productId("productId"),
   ...
   */
  public ProductAndGoodIdentification(RepositoryInterface repository) {
      this();
