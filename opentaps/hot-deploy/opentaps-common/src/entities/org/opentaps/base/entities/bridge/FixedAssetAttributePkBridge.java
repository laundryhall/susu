...
import org.opentaps.base.entities.FixedAssetAttributePk;

/**
 * A FieldBridge for FixedAssetAttributePk.
 */
public class FixedAssetAttributePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FixedAssetAttributePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FixedAssetAttributePk id = new FixedAssetAttributePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        FixedAssetAttributePk id = (FixedAssetAttributePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FixedAssetAttributePk id = (FixedAssetAttributePk) value;
