...
/**
 * Auto generated base entity UspsContactListCountBmc.
 */
@javax.persistence.Entity
@NamedNativeQuery(name="selectUspsContactListCountBmcs", query="SELECT UCLS.CONTACT_LIST_ID AS \"contactListId\",UCLS.CONTACT_MECH_ID AS \"contactMechId\",UCLS.BMC_CODE AS \"bmcCode\",UCLS.PROCESSED_TIMESTAMP AS \"processedTimestamp\" FROM USPS_CONTACT_LIST_SORT UCLS", resultSetMapping="UspsContactListCountBmcMapping")
@SqlResultSetMapping(name="UspsContactListCountBmcMapping", entities={
@EntityResult(entityClass=UspsContactListCountBmc.class, fields = {
...
public class UspsContactListCountBmc extends Entity {
static {
...
fieldMapColumns.put("UspsContactListCountBmc", fields);
}
  public static enum Fields implements EntityFieldInterface<UspsContactListCountBmc> {
   ...
   * Default constructor.
   */
  public UspsContactListCountBmc() {
      super();
      this.baseEntityName = "UspsContactListCountBmc";
      this.isView = true;
      
      this.primaryKeyNames = new ArrayList<String>();
      
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("contactListId");this.allFieldsNames.add("contactMechId");this.allFieldsNames.add("bmcCode");this.allFieldsNames.add("processedTimestamp");
   ...
   */
  public UspsContactListCountBmc(RepositoryInterface repository) {
      this();
