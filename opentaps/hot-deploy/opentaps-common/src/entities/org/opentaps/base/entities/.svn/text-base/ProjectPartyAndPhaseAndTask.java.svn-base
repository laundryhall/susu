...
public class ProjectPartyAndPhaseAndTask extends Entity {
static {
...
fieldMapColumns.put("ProjectPartyAndPhaseAndTask", fields);
}
  public static enum Fields implements EntityFieldInterface<ProjectPartyAndPhaseAndTask> {
    projectId("projectId"),
   ...
   * Default constructor.
   */
  public ProjectPartyAndPhaseAndTask() {
      super();
      this.baseEntityName = "ProjectPartyAndPhaseAndTask";
      this.isView = true;
   ...
   */
  public ProjectPartyAndPhaseAndTask(RepositoryInterface repository) {
      this();
