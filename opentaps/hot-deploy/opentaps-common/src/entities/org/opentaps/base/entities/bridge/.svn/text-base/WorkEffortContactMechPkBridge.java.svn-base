...
import org.opentaps.base.entities.WorkEffortContactMechPk;

/**
 * A FieldBridge for WorkEffortContactMechPk.
 */
public class WorkEffortContactMechPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortContactMechPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortContactMechPk id = new WorkEffortContactMechPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkEffortContactMechPk id = (WorkEffortContactMechPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortContactMechPk id = (WorkEffortContactMechPk) value;
