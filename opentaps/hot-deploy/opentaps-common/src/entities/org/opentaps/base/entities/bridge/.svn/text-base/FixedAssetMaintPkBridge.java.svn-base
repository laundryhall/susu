...
import org.opentaps.base.entities.FixedAssetMaintPk;

/**
 * A FieldBridge for FixedAssetMaintPk.
 */
public class FixedAssetMaintPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FixedAssetMaintPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FixedAssetMaintPk id = new FixedAssetMaintPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        FixedAssetMaintPk id = (FixedAssetMaintPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FixedAssetMaintPk id = (FixedAssetMaintPk) value;
