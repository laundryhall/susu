...
/**
 * Auto generated base entity InvoiceItemTypeMap.
 */
@javax.persistence.Entity
@Table(name="INVOICE_ITEM_TYPE_MAP")
public class InvoiceItemTypeMap extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        fields.put("invoiceItemMapKey", "INVOICE_ITEM_MAP_KEY");
...
fieldMapColumns.put("InvoiceItemTypeMap", fields);
}
  public static enum Fields implements EntityFieldInterface<InvoiceItemTypeMap> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.InvoiceItemTypeMapPkBridge.class)
     ...
     * @return <code>InvoiceItemTypeMapPk</code>
     */
      public InvoiceItemTypeMapPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>InvoiceItemTypeMapPk</code> value to set
    */   
      public void setId(InvoiceItemTypeMapPk id) {
         this.id = id;
      }
  ...
  public InvoiceItemTypeMap() {
      super();
      this.baseEntityName = "InvoiceItemTypeMap";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("invoiceItemMapKey");this.primaryKeyNames.add("invoiceTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("invoiceItemMapKey");this.allFieldsNames.add("invoiceTypeId");this.allFieldsNames.add("invoiceItemTypeId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public InvoiceItemTypeMap(RepositoryInterface repository) {
      this();
    ...
    public void setInvoiceItemMapKey(String invoiceItemMapKey) {
        id.setInvoiceItemMapKey(invoiceItemMapKey);
    }
    /**
     * Auto generated value setter.
    ...
    public String getInvoiceItemMapKey() {
        return this.id.getInvoiceItemMapKey();
    }
    /**
     * Auto generated value accessor.
     * @return <code>String</code>
