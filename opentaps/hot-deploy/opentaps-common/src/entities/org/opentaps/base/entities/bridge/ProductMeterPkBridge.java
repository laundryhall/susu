...
import org.opentaps.base.entities.ProductMeterPk;

/**
 * A FieldBridge for ProductMeterPk.
 */
public class ProductMeterPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductMeterPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductMeterPk id = new ProductMeterPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductMeterPk id = (ProductMeterPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductMeterPk id = (ProductMeterPk) value;
