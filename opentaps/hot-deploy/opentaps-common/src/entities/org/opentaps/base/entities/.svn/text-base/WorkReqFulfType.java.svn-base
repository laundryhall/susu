...
/**
 * Auto generated base entity WorkReqFulfType.
 */
@javax.persistence.Entity
@Table(name="WORK_REQ_FULF_TYPE")
public class WorkReqFulfType extends Entity {
static {
...
fieldMapColumns.put("WorkReqFulfType", fields);
}
  public static enum Fields implements EntityFieldInterface<WorkReqFulfType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="WorkReqFulfType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="WorkReqFulfType_GEN")
   @Id
  ...
  public WorkReqFulfType() {
      super();
      this.baseEntityName = "WorkReqFulfType";
      this.isView = false;
      this.resourceName = "OrderEntityLabels";
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("workReqFulfTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("workReqFulfTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public WorkReqFulfType(RepositoryInterface repository) {
      this();
