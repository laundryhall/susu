...
public class ProductInventoryItem extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        fields.put("productFacilityId", "PR.FACILITY_ID");
        fields.put("inventoryComments", "II.COMMENTS");
...
fieldMapColumns.put("ProductInventoryItem", fields);
}
  public static enum Fields implements EntityFieldInterface<ProductInventoryItem> {
   ...
   */
  public ProductInventoryItem(RepositoryInterface repository) {
      this();
