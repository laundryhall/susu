...
public class ContentAssocDataResourceViewTo extends Entity {
static {
...
fieldMapColumns.put("ContentAssocDataResourceViewTo", fields);
}
  public static enum Fields implements EntityFieldInterface<ContentAssocDataResourceViewTo> {
  ...
  public ContentAssocDataResourceViewTo() {
      super();
      this.baseEntityName = "ContentAssocDataResourceViewTo";
      this.isView = true;
   ...
   */
  public ContentAssocDataResourceViewTo(RepositoryInterface repository) {
      this();
