...
import org.opentaps.base.entities.AmazonProductSearchTermsPk;

/**
 * A FieldBridge for AmazonProductSearchTermsPk.
 */
public class AmazonProductSearchTermsPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AmazonProductSearchTermsPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AmazonProductSearchTermsPk id = new AmazonProductSearchTermsPk();
        Field field = null;
        field = document.getField(name + ".searchTermId");
        id.setSearchTermId(field.stringValue());
    ...
    public String objectToString(Object object) {
        AmazonProductSearchTermsPk id = (AmazonProductSearchTermsPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getSearchTermId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AmazonProductSearchTermsPk id = (AmazonProductSearchTermsPk) value;
        ...
        Field field = null;
        field = new Field(name + ".searchTermId", id.getSearchTermId(), store, index, termVector);
