...
/**
 * Auto generated base entity AmazonProductOtherItemAttr.
 */
@javax.persistence.Entity
@Table(name="AMAZON_PRODUCT_OTHER_ITEM_ATTR")
public class AmazonProductOtherItemAttr extends Entity {
static {
...
fieldMapColumns.put("AmazonProductOtherItemAttr", fields);
}
  public static enum Fields implements EntityFieldInterface<AmazonProductOtherItemAttr> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="AmazonProductOtherItemAttr_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="AmazonProductOtherItemAttr_GEN")
   @Id
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="amazonProductOtherItemAttr", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="OTHER_ITEM_ATTR_ID")
   ...
   * Default constructor.
   */
  public AmazonProductOtherItemAttr() {
      super();
      this.baseEntityName = "AmazonProductOtherItemAttr";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("otherItemAttrId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("otherItemAttrId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public AmazonProductOtherItemAttr(RepositoryInterface repository) {
      this();
