...
/**
 * Auto generated base entity AmazonProductInventory.
 */
@javax.persistence.Entity
@Table(name="AMAZON_PRODUCT_INVENTORY")
public class AmazonProductInventory extends Entity {
static {
...
fieldMapColumns.put("AmazonProductInventory", fields);
}
  public static enum Fields implements EntityFieldInterface<AmazonProductInventory> {
    productId("productId"),
    statusId("statusId"),
   ...
   @org.hibernate.annotations.GenericGenerator(name="AmazonProductInventory_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="AmazonProductInventory_GEN")
   @Id
   ...
   * Default constructor.
   */
  public AmazonProductInventory() {
      super();
      this.baseEntityName = "AmazonProductInventory";
      this.isView = false;
   ...
   */
  public AmazonProductInventory(RepositoryInterface repository) {
      this();
