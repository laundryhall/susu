...
public class ProductInventoryItemAndItemIssuance extends Entity {
static {
...
fieldMapColumns.put("ProductInventoryItemAndItemIssuance", fields);
}
  public static enum Fields implements EntityFieldInterface<ProductInventoryItemAndItemIssuance> {
    productId("productId"),
  ...
  public ProductInventoryItemAndItemIssuance() {
      super();
      this.baseEntityName = "ProductInventoryItemAndItemIssuance";
      this.isView = true;
   ...
   */
  public ProductInventoryItemAndItemIssuance(RepositoryInterface repository) {
      this();
