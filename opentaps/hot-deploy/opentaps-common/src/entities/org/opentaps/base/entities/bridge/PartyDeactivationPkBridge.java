...
import org.opentaps.base.entities.PartyDeactivationPk;

/**
 * A FieldBridge for PartyDeactivationPk.
 */
public class PartyDeactivationPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyDeactivationPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyDeactivationPk id = new PartyDeactivationPk();
        Field field = null;
        field = document.getField(name + ".partyId");
        id.setPartyId(field.stringValue());
        field = document.getField(name + ".deactivationTimestamp");
        if (field.stringValue() != null && !field.stringValue().equals("")) {
            id.setDeactivationTimestamp(new Timestamp(((Date) (new DateBridge(Resolution.DAY)).stringToObject(field.stringValue())).getTime()));
        }
        return id;
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyDeactivationPk id = (PartyDeactivationPk) value;
        ...
        document.add(field);
        field = new Field(name + ".deactivationTimestamp", (new DateBridge(Resolution.DAY)).objectToString(id.getDeactivationTimestamp()), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
