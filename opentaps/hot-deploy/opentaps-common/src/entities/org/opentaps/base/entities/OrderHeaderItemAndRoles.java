...
public class OrderHeaderItemAndRoles extends Entity {
static {
...
fieldMapColumns.put("OrderHeaderItemAndRoles", fields);
  ...
  public OrderHeaderItemAndRoles() {
      super();
      this.baseEntityName = "OrderHeaderItemAndRoles";
      this.isView = true;
   ...
   */
  public OrderHeaderItemAndRoles(RepositoryInterface repository) {
      this();
