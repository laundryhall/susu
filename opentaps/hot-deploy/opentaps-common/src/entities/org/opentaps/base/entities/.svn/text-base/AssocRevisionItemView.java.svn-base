...
public class AssocRevisionItemView extends Entity {
static {
...
fieldMapColumns.put("AssocRevisionItemView", fields);
}
  public static enum Fields implements EntityFieldInterface<AssocRevisionItemView> {
    contentId("contentId"),
   ...
   * Default constructor.
   */
  public AssocRevisionItemView() {
      super();
      this.baseEntityName = "AssocRevisionItemView";
      this.isView = true;
      ...
      this.allFieldsNames.add("contentId");this.allFieldsNames.add("contentIdTo");this.allFieldsNames.add("contentAssocTypeId");this.allFieldsNames.add("thruDate");this.allFieldsNames.add("fromDate");this.allFieldsNames.add("sequenceNum");this.allFieldsNames.add("rootRevisionContentId");this.allFieldsNames.add("itemContentId");this.allFieldsNames.add("contentRevisionSeqId");this.allFieldsNames.add("maxRevisionSeqId");
   ...
   */
  public AssocRevisionItemView(RepositoryInterface repository) {
      this();
