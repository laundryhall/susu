...
import org.opentaps.base.entities.ProductStoreRolePk;

/**
 * A FieldBridge for ProductStoreRolePk.
 */
public class ProductStoreRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductStoreRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductStoreRolePk id = new ProductStoreRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductStoreRolePk id = (ProductStoreRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductStoreRolePk id = (ProductStoreRolePk) value;
