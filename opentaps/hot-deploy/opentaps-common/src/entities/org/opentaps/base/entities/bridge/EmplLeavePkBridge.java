...
import org.opentaps.base.entities.EmplLeavePk;

/**
 * A FieldBridge for EmplLeavePk.
 */
public class EmplLeavePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the EmplLeavePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        EmplLeavePk id = new EmplLeavePk();
        Field field = null;
        field = document.getField(name + ".partyId");
        id.setPartyId(field.stringValue());
        field = document.getField(name + ".leaveTypeId");
        id.setLeaveTypeId(field.stringValue());
    ...
    public String objectToString(Object object) {
        EmplLeavePk id = (EmplLeavePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getPartyId());
        sb.append("_");
        sb.append(id.getLeaveTypeId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        EmplLeavePk id = (EmplLeavePk) value;
        ...
        document.add(field);
        field = new Field(name + ".leaveTypeId", id.getLeaveTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
