...
import org.opentaps.base.entities.EmplPositionTypeClassPk;

/**
 * A FieldBridge for EmplPositionTypeClassPk.
 */
public class EmplPositionTypeClassPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the EmplPositionTypeClassPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        EmplPositionTypeClassPk id = new EmplPositionTypeClassPk();
        Field field = null;
        field = document.getField(name + ".emplPositionTypeId");
        id.setEmplPositionTypeId(field.stringValue());
        field = document.getField(name + ".emplPositionClassTypeId");
        id.setEmplPositionClassTypeId(field.stringValue());
    ...
    public String objectToString(Object object) {
        EmplPositionTypeClassPk id = (EmplPositionTypeClassPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getEmplPositionTypeId());
        sb.append("_");
        sb.append(id.getEmplPositionClassTypeId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        EmplPositionTypeClassPk id = (EmplPositionTypeClassPk) value;
        ...
        document.add(field);
        field = new Field(name + ".emplPositionClassTypeId", id.getEmplPositionClassTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
