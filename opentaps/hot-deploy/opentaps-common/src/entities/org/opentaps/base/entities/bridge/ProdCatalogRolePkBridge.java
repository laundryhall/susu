...
import org.opentaps.base.entities.ProdCatalogRolePk;

/**
 * A FieldBridge for ProdCatalogRolePk.
 */
public class ProdCatalogRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProdCatalogRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProdCatalogRolePk id = new ProdCatalogRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProdCatalogRolePk id = (ProdCatalogRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProdCatalogRolePk id = (ProdCatalogRolePk) value;
