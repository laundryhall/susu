...
/**
 * Auto generated base entity EntitySyncIncludeGroup.
 */
@javax.persistence.Entity
@Table(name="ENTITY_SYNC_INCLUDE_GROUP")
public class EntitySyncIncludeGroup extends Entity {
static {
...
fieldMapColumns.put("EntitySyncIncludeGroup", fields);
}
  public static enum Fields implements EntityFieldInterface<EntitySyncIncludeGroup> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.EntitySyncIncludeGroupPkBridge.class)
     private EntitySyncIncludeGroupPk id = new EntitySyncIncludeGroupPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>EntitySyncIncludeGroupPk</code>
     */
      public EntitySyncIncludeGroupPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>EntitySyncIncludeGroupPk</code> value to set
    */   
      public void setId(EntitySyncIncludeGroupPk id) {
         this.id = id;
      }
  ...
  public EntitySyncIncludeGroup() {
      super();
      this.baseEntityName = "EntitySyncIncludeGroup";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("entitySyncId");this.primaryKeyNames.add("entityGroupId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("entitySyncId");this.allFieldsNames.add("entityGroupId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public EntitySyncIncludeGroup(RepositoryInterface repository) {
      this();
    ...
    public void setEntityGroupId(String entityGroupId) {
        id.setEntityGroupId(entityGroupId);
    }
    /**
     * Auto generated value setter.
    ...
    public String getEntityGroupId() {
        return this.id.getEntityGroupId();
    }
    /**
     * Auto generated value accessor.
    ...
    /**
     * Auto generated method that gets the related <code>EntityGroup</code> by the relation named <code>EntityGroup</code>.
     * @return the <code>EntityGroup</code>
     * @throws RepositoryException if an error occurs
     */
    public EntityGroup getEntityGroup() throws RepositoryException {
        if (this.entityGroup == null) {
            this.entityGroup = getRelatedOne(EntityGroup.class, "EntityGroup");
        }
