...
import org.opentaps.base.entities.ContentRevisionItemPk;

/**
 * A FieldBridge for ContentRevisionItemPk.
 */
public class ContentRevisionItemPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ContentRevisionItemPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ContentRevisionItemPk id = new ContentRevisionItemPk();
        Field field = null;
        field = document.getField(name + ".contentId");
        id.setContentId(field.stringValue());
        field = document.getField(name + ".contentRevisionSeqId");
        id.setContentRevisionSeqId(field.stringValue());
        field = document.getField(name + ".itemContentId");
        id.setItemContentId(field.stringValue());
        return id;
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ContentRevisionItemPk id = (ContentRevisionItemPk) value;
        ...
        document.add(field);
        field = new Field(name + ".contentRevisionSeqId", id.getContentRevisionSeqId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".itemContentId", id.getItemContentId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
