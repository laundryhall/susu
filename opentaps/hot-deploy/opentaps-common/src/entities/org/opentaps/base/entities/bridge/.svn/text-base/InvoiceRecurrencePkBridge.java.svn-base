...
import org.opentaps.base.entities.InvoiceRecurrencePk;

/**
 * A FieldBridge for InvoiceRecurrencePk.
 */
public class InvoiceRecurrencePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the InvoiceRecurrencePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        InvoiceRecurrencePk id = new InvoiceRecurrencePk();
        Field field = null;
        field = document.getField(name + ".invoiceId");
        id.setInvoiceId(field.stringValue());
        field = document.getField(name + ".recurrenceInfoId");
        id.setRecurrenceInfoId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        InvoiceRecurrencePk id = (InvoiceRecurrencePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getInvoiceId());
        sb.append("_");
        sb.append(id.getRecurrenceInfoId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        InvoiceRecurrencePk id = (InvoiceRecurrencePk) value;
        ...
        document.add(field);
        field = new Field(name + ".recurrenceInfoId", id.getRecurrenceInfoId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
