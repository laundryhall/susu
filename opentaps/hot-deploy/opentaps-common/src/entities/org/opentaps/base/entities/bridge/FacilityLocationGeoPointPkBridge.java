...
import org.opentaps.base.entities.FacilityLocationGeoPointPk;

/**
 * A FieldBridge for FacilityLocationGeoPointPk.
 */
public class FacilityLocationGeoPointPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FacilityLocationGeoPointPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FacilityLocationGeoPointPk id = new FacilityLocationGeoPointPk();
        Field field = null;
        field = document.getField(name + ".facilityId");
        id.setFacilityId(field.stringValue());
        field = document.getField(name + ".locationSeqId");
        id.setLocationSeqId(field.stringValue());
        field = document.getField(name + ".geoPointId");
        id.setGeoPointId(field.stringValue());
    ...
    public String objectToString(Object object) {
        FacilityLocationGeoPointPk id = (FacilityLocationGeoPointPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getFacilityId());
        sb.append("_");
        sb.append(id.getLocationSeqId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FacilityLocationGeoPointPk id = (FacilityLocationGeoPointPk) value;
        ...
        document.add(field);
        field = new Field(name + ".locationSeqId", id.getLocationSeqId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".geoPointId", id.getGeoPointId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
