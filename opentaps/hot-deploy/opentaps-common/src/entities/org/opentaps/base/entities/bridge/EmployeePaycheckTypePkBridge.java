...
import org.opentaps.base.entities.EmployeePaycheckTypePk;

/**
 * A FieldBridge for EmployeePaycheckTypePk.
 */
public class EmployeePaycheckTypePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the EmployeePaycheckTypePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        EmployeePaycheckTypePk id = new EmployeePaycheckTypePk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        EmployeePaycheckTypePk id = (EmployeePaycheckTypePk) value;
