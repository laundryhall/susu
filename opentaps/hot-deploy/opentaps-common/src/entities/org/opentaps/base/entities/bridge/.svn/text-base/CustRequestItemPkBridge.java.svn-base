...
import org.opentaps.base.entities.CustRequestItemPk;

/**
 * A FieldBridge for CustRequestItemPk.
 */
public class CustRequestItemPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CustRequestItemPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CustRequestItemPk id = new CustRequestItemPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        CustRequestItemPk id = (CustRequestItemPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CustRequestItemPk id = (CustRequestItemPk) value;
