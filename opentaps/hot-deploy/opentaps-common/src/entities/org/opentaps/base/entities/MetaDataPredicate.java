...
/**
 * Auto generated base entity MetaDataPredicate.
 */
@javax.persistence.Entity
@Table(name="META_DATA_PREDICATE")
public class MetaDataPredicate extends Entity {
static {
...
fieldMapColumns.put("MetaDataPredicate", fields);
}
  public static enum Fields implements EntityFieldInterface<MetaDataPredicate> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="MetaDataPredicate_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
  ...
  public MetaDataPredicate() {
      super();
      this.baseEntityName = "MetaDataPredicate";
      this.isView = false;
      this.resourceName = "ContentEntityLabels";
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("metaDataPredicateId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("metaDataPredicateId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public MetaDataPredicate(RepositoryInterface repository) {
      this();
