...
import org.opentaps.base.entities.DataImportShoppingListItemPk;

/**
 * A FieldBridge for DataImportShoppingListItemPk.
 */
public class DataImportShoppingListItemPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the DataImportShoppingListItemPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        DataImportShoppingListItemPk id = new DataImportShoppingListItemPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        DataImportShoppingListItemPk id = (DataImportShoppingListItemPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        DataImportShoppingListItemPk id = (DataImportShoppingListItemPk) value;
