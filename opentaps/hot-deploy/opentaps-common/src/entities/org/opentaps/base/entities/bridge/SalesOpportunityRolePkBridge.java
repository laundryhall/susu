...
/**
 * A FieldBridge for SalesOpportunityRolePk.
 */
public class SalesOpportunityRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the SalesOpportunityRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        SalesOpportunityRolePk id = new SalesOpportunityRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        SalesOpportunityRolePk id = (SalesOpportunityRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        SalesOpportunityRolePk id = (SalesOpportunityRolePk) value;
