...
import org.opentaps.base.entities.WebSiteContentPk;

/**
 * A FieldBridge for WebSiteContentPk.
 */
public class WebSiteContentPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WebSiteContentPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WebSiteContentPk id = new WebSiteContentPk();
        Field field = null;
        field = document.getField(name + ".webSiteId");
        id.setWebSiteId(field.stringValue());
        field = document.getField(name + ".contentId");
        id.setContentId(field.stringValue());
        field = document.getField(name + ".webSiteContentTypeId");
        id.setWebSiteContentTypeId(field.stringValue());
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WebSiteContentPk id = (WebSiteContentPk) value;
        ...
        Field field = null;
        field = new Field(name + ".webSiteId", id.getWebSiteId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".contentId", id.getContentId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".webSiteContentTypeId", id.getWebSiteContentTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
