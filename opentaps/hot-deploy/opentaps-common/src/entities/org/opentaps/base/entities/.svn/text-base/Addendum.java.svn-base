...
/**
 * Auto generated base entity Addendum.
 */
@javax.persistence.Entity
@Table(name="ADDENDUM")
public class Addendum extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        fields.put("addendumId", "ADDENDUM_ID");
        fields.put("agreementId", "AGREEMENT_ID");
        fields.put("agreementItemSeqId", "AGREEMENT_ITEM_SEQ_ID");
        fields.put("addendumCreationDate", "ADDENDUM_CREATION_DATE");
        fields.put("addendumEffectiveDate", "ADDENDUM_EFFECTIVE_DATE");
        fields.put("addendumText", "ADDENDUM_TEXT");
        fields.put("lastUpdatedStamp", "LAST_UPDATED_STAMP");
        fields.put("lastUpdatedTxStamp", "LAST_UPDATED_TX_STAMP");
        fields.put("createdStamp", "CREATED_STAMP");
        fields.put("createdTxStamp", "CREATED_TX_STAMP");
fieldMapColumns.put("Addendum", fields);
}
  public static enum Fields implements EntityFieldInterface<Addendum> {
    addendumId("addendumId"),
    agreementId("agreementId"),
    agreementItemSeqId("agreementItemSeqId"),
    addendumCreationDate("addendumCreationDate"),
    addendumEffectiveDate("addendumEffectiveDate"),
   ...
   @org.hibernate.annotations.GenericGenerator(name="Addendum_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
  ...
  public Addendum() {
      super();
      this.baseEntityName = "Addendum";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("addendumId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("addendumId");this.allFieldsNames.add("agreementId");this.allFieldsNames.add("agreementItemSeqId");this.allFieldsNames.add("addendumCreationDate");this.allFieldsNames.add("addendumEffectiveDate");this.allFieldsNames.add("addendumText");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public Addendum(RepositoryInterface repository) {
      this();
    ...
    /**
     * Auto generated value setter.
     * @param addendumCreationDate the addendumCreationDate to set
     */
    ...
    /**
     * Auto generated value setter.
     * @param addendumEffectiveDate the addendumEffectiveDate to set
     */
    ...
    public Timestamp getAddendumCreationDate() {
        return this.addendumCreationDate;
    }
    /**
     * Auto generated value accessor.
     * @return <code>Timestamp</code>
    ...
    public Timestamp getAddendumEffectiveDate() {
        return this.addendumEffectiveDate;
    }
    /**
     * Auto generated value accessor.
     * @return <code>String</code>
    ...
    */
    ...
    public void fromMap(Map<String, Object> mapValue) {
        preInit();
        setAddendumId((String) mapValue.get("addendumId"));
        setAgreementId((String) mapValue.get("agreementId"));
        setAgreementItemSeqId((String) mapValue.get("agreementItemSeqId"));
        setAddendumCreationDate((Timestamp) mapValue.get("addendumCreationDate"));
        setAddendumEffectiveDate((Timestamp) mapValue.get("addendumEffectiveDate"));
        setAddendumText((String) mapValue.get("addendumText"));
    ...
    public Map<String, Object> toMap() {
        ...
        mapValue.put("addendumId", getAddendumId());
        mapValue.put("agreementId", getAgreementId());
        mapValue.put("agreementItemSeqId", getAgreementItemSeqId());
        mapValue.put("addendumCreationDate", getAddendumCreationDate());
        mapValue.put("addendumEffectiveDate", getAddendumEffectiveDate());
        mapValue.put("addendumText", getAddendumText());
