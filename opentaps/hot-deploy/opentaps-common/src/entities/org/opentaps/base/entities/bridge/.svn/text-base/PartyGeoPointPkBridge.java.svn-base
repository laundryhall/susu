...
import org.opentaps.base.entities.PartyGeoPointPk;

/**
 * A FieldBridge for PartyGeoPointPk.
 */
public class PartyGeoPointPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyGeoPointPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyGeoPointPk id = new PartyGeoPointPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PartyGeoPointPk id = (PartyGeoPointPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyGeoPointPk id = (PartyGeoPointPk) value;
