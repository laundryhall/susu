...
import org.opentaps.base.entities.PartyDataSourcePk;

/**
 * A FieldBridge for PartyDataSourcePk.
 */
public class PartyDataSourcePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyDataSourcePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyDataSourcePk id = new PartyDataSourcePk();
        Field field = null;
        field = document.getField(name + ".partyId");
        id.setPartyId(field.stringValue());
        field = document.getField(name + ".dataSourceId");
        id.setDataSourceId(field.stringValue());
    ...
    public String objectToString(Object object) {
        PartyDataSourcePk id = (PartyDataSourcePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getPartyId());
        sb.append("_");
        sb.append(id.getDataSourceId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyDataSourcePk id = (PartyDataSourcePk) value;
        ...
        document.add(field);
        field = new Field(name + ".dataSourceId", id.getDataSourceId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
