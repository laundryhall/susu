...
import org.opentaps.base.entities.MarketInterestPk;

/**
 * A FieldBridge for MarketInterestPk.
 */
public class MarketInterestPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the MarketInterestPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        MarketInterestPk id = new MarketInterestPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        MarketInterestPk id = (MarketInterestPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        MarketInterestPk id = (MarketInterestPk) value;
