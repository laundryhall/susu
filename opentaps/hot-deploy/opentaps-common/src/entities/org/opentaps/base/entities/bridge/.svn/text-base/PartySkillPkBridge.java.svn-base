...
import org.opentaps.base.entities.PartySkillPk;

/**
 * A FieldBridge for PartySkillPk.
 */
public class PartySkillPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartySkillPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartySkillPk id = new PartySkillPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PartySkillPk id = (PartySkillPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartySkillPk id = (PartySkillPk) value;
