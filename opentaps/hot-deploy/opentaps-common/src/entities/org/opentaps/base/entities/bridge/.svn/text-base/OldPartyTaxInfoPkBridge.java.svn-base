...
import org.opentaps.base.entities.OldPartyTaxInfoPk;

/**
 * A FieldBridge for OldPartyTaxInfoPk.
 */
public class OldPartyTaxInfoPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the OldPartyTaxInfoPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        OldPartyTaxInfoPk id = new OldPartyTaxInfoPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        OldPartyTaxInfoPk id = (OldPartyTaxInfoPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        OldPartyTaxInfoPk id = (OldPartyTaxInfoPk) value;
