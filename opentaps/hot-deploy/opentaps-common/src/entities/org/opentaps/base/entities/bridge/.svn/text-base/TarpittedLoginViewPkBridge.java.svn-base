...
import org.opentaps.base.entities.TarpittedLoginViewPk;

/**
 * A FieldBridge for TarpittedLoginViewPk.
 */
public class TarpittedLoginViewPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the TarpittedLoginViewPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        TarpittedLoginViewPk id = new TarpittedLoginViewPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        TarpittedLoginViewPk id = (TarpittedLoginViewPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        TarpittedLoginViewPk id = (TarpittedLoginViewPk) value;
