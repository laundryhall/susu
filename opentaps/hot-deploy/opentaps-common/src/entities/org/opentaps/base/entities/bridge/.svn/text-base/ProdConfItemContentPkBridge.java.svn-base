...
import org.opentaps.base.entities.ProdConfItemContentPk;

/**
 * A FieldBridge for ProdConfItemContentPk.
 */
public class ProdConfItemContentPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProdConfItemContentPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProdConfItemContentPk id = new ProdConfItemContentPk();
        Field field = null;
        ...
        field = document.getField(name + ".confItemContentTypeId");
        id.setConfItemContentTypeId(field.stringValue());
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProdConfItemContentPk id = (ProdConfItemContentPk) value;
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".confItemContentTypeId", id.getConfItemContentTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
