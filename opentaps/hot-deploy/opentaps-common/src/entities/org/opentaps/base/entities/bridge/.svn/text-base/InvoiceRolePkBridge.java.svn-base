...
import org.opentaps.base.entities.InvoiceRolePk;

/**
 * A FieldBridge for InvoiceRolePk.
 */
public class InvoiceRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the InvoiceRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        InvoiceRolePk id = new InvoiceRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        InvoiceRolePk id = (InvoiceRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        InvoiceRolePk id = (InvoiceRolePk) value;
