...
import org.opentaps.base.entities.FixedAssetRegistrationPk;

/**
 * A FieldBridge for FixedAssetRegistrationPk.
 */
public class FixedAssetRegistrationPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FixedAssetRegistrationPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FixedAssetRegistrationPk id = new FixedAssetRegistrationPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        FixedAssetRegistrationPk id = (FixedAssetRegistrationPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FixedAssetRegistrationPk id = (FixedAssetRegistrationPk) value;
