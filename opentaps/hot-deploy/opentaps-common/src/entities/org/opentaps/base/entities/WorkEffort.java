...
fieldMapColumns.put("WorkEffort", fields);
  ...
  public static enum Fields implements EntityFieldInterface<WorkEffort> {
   ...
   private transient List<FixedAssetMaint> scheduleFixedAssetMaints = null;
   ...
   private transient List<ProductAssoc> routingProductAssocs = null;
   private transient List<ProductAssoc> productAssocs = null;
   private transient List<ProductMaint> maintTemplateProductMaints = null;
   ...
   private transient List<Shipment> estimatedShipShipments = null;
   private transient List<Shipment> estimatedArrivalShipments = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="workEffort", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="WORK_EFFORT_ID")
   ...
   private transient List<WorkEffortTransBox> workEffortTransBoxes = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="workEffort", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="WORK_EFFORT_ID")
