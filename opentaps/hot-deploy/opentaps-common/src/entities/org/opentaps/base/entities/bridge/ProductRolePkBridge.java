...
import org.opentaps.base.entities.ProductRolePk;

/**
 * A FieldBridge for ProductRolePk.
 */
public class ProductRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductRolePk id = new ProductRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductRolePk id = (ProductRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductRolePk id = (ProductRolePk) value;
