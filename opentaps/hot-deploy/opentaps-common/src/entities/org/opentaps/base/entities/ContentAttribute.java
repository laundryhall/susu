...
/**
 * Auto generated base entity ContentAttribute.
 */
...
fieldMapColumns.put("ContentAttribute", fields);
}
  public static enum Fields implements EntityFieldInterface<ContentAttribute> {
    contentId("contentId"),
    attrName("attrName"),
    attrValue("attrValue"),
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.ContentAttributePkBridge.class)
     private ContentAttributePk id = new ContentAttributePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>ContentAttributePk</code>
     */
      public ContentAttributePk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>ContentAttributePk</code> value to set
    */   
      public void setId(ContentAttributePk id) {
         this.id = id;
      }
   ...
   private transient List<ContentTypeAttr> contentTypeAttrs = null;
  ...
  public ContentAttribute() {
      super();
      this.baseEntityName = "ContentAttribute";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("contentId");this.primaryKeyNames.add("attrName");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("contentId");this.allFieldsNames.add("attrName");this.allFieldsNames.add("attrValue");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ContentAttribute(RepositoryInterface repository) {
      this();
