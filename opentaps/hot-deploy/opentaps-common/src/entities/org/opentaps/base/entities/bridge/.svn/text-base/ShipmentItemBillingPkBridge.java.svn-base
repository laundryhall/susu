...
import org.opentaps.base.entities.ShipmentItemBillingPk;

/**
 * A FieldBridge for ShipmentItemBillingPk.
 */
public class ShipmentItemBillingPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ShipmentItemBillingPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ShipmentItemBillingPk id = new ShipmentItemBillingPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ShipmentItemBillingPk id = (ShipmentItemBillingPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ShipmentItemBillingPk id = (ShipmentItemBillingPk) value;
