...
import org.opentaps.base.entities.OldPartyRatePk;

/**
 * A FieldBridge for OldPartyRatePk.
 */
public class OldPartyRatePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the OldPartyRatePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        OldPartyRatePk id = new OldPartyRatePk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        OldPartyRatePk id = (OldPartyRatePk) value;
