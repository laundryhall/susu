...
import org.opentaps.base.entities.CartAbandonedLinePk;

/**
 * A FieldBridge for CartAbandonedLinePk.
 */
public class CartAbandonedLinePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CartAbandonedLinePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CartAbandonedLinePk id = new CartAbandonedLinePk();
        Field field = null;
        field = document.getField(name + ".visitId");
        id.setVisitId(field.stringValue());
        field = document.getField(name + ".cartAbandonedLineSeqId");
        id.setCartAbandonedLineSeqId(field.stringValue());
        return id;
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CartAbandonedLinePk id = (CartAbandonedLinePk) value;
        ...
        document.add(field);
        field = new Field(name + ".cartAbandonedLineSeqId", id.getCartAbandonedLineSeqId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
