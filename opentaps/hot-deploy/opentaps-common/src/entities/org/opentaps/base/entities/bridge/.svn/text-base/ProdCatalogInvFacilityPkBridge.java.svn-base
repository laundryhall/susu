...
import org.opentaps.base.entities.ProdCatalogInvFacilityPk;

/**
 * A FieldBridge for ProdCatalogInvFacilityPk.
 */
public class ProdCatalogInvFacilityPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProdCatalogInvFacilityPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProdCatalogInvFacilityPk id = new ProdCatalogInvFacilityPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProdCatalogInvFacilityPk id = (ProdCatalogInvFacilityPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProdCatalogInvFacilityPk id = (ProdCatalogInvFacilityPk) value;
