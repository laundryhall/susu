...
import org.opentaps.base.entities.AgreementGeographicalApplicPk;

/**
 * A FieldBridge for AgreementGeographicalApplicPk.
 */
public class AgreementGeographicalApplicPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AgreementGeographicalApplicPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AgreementGeographicalApplicPk id = new AgreementGeographicalApplicPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AgreementGeographicalApplicPk id = (AgreementGeographicalApplicPk) value;
