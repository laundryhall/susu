...
/**
 * A FieldBridge for EntityViewHistoryPk.
 */
public class EntityViewHistoryPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the EntityViewHistoryPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        EntityViewHistoryPk id = new EntityViewHistoryPk();
        Field field = null;
        field = document.getField(name + ".entityName");
        id.setEntityName(field.stringValue());
        field = document.getField(name + ".userLoginId");
        id.setUserLoginId(field.stringValue());
        field = document.getField(name + ".primaryKeyId");
        id.setPrimaryKeyId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        EntityViewHistoryPk id = (EntityViewHistoryPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getEntityName());
        sb.append("_");
        sb.append(id.getUserLoginId());
        sb.append("_");
        sb.append(id.getPrimaryKeyId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        EntityViewHistoryPk id = (EntityViewHistoryPk) value;
        ...
        Field field = null;
        field = new Field(name + ".entityName", id.getEntityName(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".userLoginId", id.getUserLoginId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".primaryKeyId", id.getPrimaryKeyId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
