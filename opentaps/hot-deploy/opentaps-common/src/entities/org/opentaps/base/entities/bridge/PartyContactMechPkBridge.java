...
import org.opentaps.base.entities.PartyContactMechPk;

/**
 * A FieldBridge for PartyContactMechPk.
 */
public class PartyContactMechPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyContactMechPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyContactMechPk id = new PartyContactMechPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PartyContactMechPk id = (PartyContactMechPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyContactMechPk id = (PartyContactMechPk) value;
