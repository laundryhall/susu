...
import org.opentaps.base.entities.AgreementAttributePk;

/**
 * A FieldBridge for AgreementAttributePk.
 */
public class AgreementAttributePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AgreementAttributePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AgreementAttributePk id = new AgreementAttributePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        AgreementAttributePk id = (AgreementAttributePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AgreementAttributePk id = (AgreementAttributePk) value;
