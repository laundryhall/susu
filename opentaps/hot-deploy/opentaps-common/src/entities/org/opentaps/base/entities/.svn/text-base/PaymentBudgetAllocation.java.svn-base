...
/**
 * Auto generated base entity PaymentBudgetAllocation.
 */
@javax.persistence.Entity
@Table(name="PAYMENT_BUDGET_ALLOCATION")
public class PaymentBudgetAllocation extends Entity {
static {
...
fieldMapColumns.put("PaymentBudgetAllocation", fields);
}
  public static enum Fields implements EntityFieldInterface<PaymentBudgetAllocation> {
    budgetId("budgetId"),
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.PaymentBudgetAllocationPkBridge.class)
     private PaymentBudgetAllocationPk id = new PaymentBudgetAllocationPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>PaymentBudgetAllocationPk</code>
     */
      public PaymentBudgetAllocationPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>PaymentBudgetAllocationPk</code> value to set
    */   
      public void setId(PaymentBudgetAllocationPk id) {
         this.id = id;
      }
   @Column(name="AMOUNT")
  ...
  public PaymentBudgetAllocation() {
      super();
      this.baseEntityName = "PaymentBudgetAllocation";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("budgetId");this.primaryKeyNames.add("budgetItemSeqId");this.primaryKeyNames.add("paymentId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("budgetId");this.allFieldsNames.add("budgetItemSeqId");this.allFieldsNames.add("paymentId");this.allFieldsNames.add("amount");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public PaymentBudgetAllocation(RepositoryInterface repository) {
      this();
