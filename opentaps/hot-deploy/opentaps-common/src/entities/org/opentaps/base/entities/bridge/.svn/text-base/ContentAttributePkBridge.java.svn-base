...
import org.opentaps.base.entities.ContentAttributePk;

/**
 * A FieldBridge for ContentAttributePk.
 */
public class ContentAttributePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ContentAttributePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ContentAttributePk id = new ContentAttributePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ContentAttributePk id = (ContentAttributePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ContentAttributePk id = (ContentAttributePk) value;
