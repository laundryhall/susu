...
import org.opentaps.base.entities.CustRequestWorkEffortPk;

/**
 * A FieldBridge for CustRequestWorkEffortPk.
 */
public class CustRequestWorkEffortPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CustRequestWorkEffortPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CustRequestWorkEffortPk id = new CustRequestWorkEffortPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        CustRequestWorkEffortPk id = (CustRequestWorkEffortPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CustRequestWorkEffortPk id = (CustRequestWorkEffortPk) value;
