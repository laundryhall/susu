...
import org.opentaps.base.entities.ProductPromoCodePartyPk;

/**
 * A FieldBridge for ProductPromoCodePartyPk.
 */
public class ProductPromoCodePartyPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductPromoCodePartyPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductPromoCodePartyPk id = new ProductPromoCodePartyPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductPromoCodePartyPk id = (ProductPromoCodePartyPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductPromoCodePartyPk id = (ProductPromoCodePartyPk) value;
