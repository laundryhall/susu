...
import org.opentaps.base.entities.PartyProfileDefaultPk;

/**
 * A FieldBridge for PartyProfileDefaultPk.
 */
public class PartyProfileDefaultPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyProfileDefaultPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyProfileDefaultPk id = new PartyProfileDefaultPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PartyProfileDefaultPk id = (PartyProfileDefaultPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyProfileDefaultPk id = (PartyProfileDefaultPk) value;
