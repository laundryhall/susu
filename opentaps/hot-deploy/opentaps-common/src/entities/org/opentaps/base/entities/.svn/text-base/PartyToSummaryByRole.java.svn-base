...
public class PartyToSummaryByRole extends Entity {
static {
...
fieldMapColumns.put("PartyToSummaryByRole", fields);
}
  public static enum Fields implements EntityFieldInterface<PartyToSummaryByRole> {
   ...
   */
  public PartyToSummaryByRole(RepositoryInterface repository) {
      this();
