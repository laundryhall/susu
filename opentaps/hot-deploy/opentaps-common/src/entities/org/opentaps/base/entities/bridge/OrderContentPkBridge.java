...
import org.opentaps.base.entities.OrderContentPk;

/**
 * A FieldBridge for OrderContentPk.
 */
public class OrderContentPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the OrderContentPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        OrderContentPk id = new OrderContentPk();
        Field field = null;
        ...
        field = document.getField(name + ".orderContentTypeId");
        id.setOrderContentTypeId(field.stringValue());
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        OrderContentPk id = (OrderContentPk) value;
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".orderContentTypeId", id.getOrderContentTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
