...
import org.opentaps.base.entities.OrderItemPk;

/**
 * A FieldBridge for OrderItemPk.
 */
public class OrderItemPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the OrderItemPk.
    ...
    public String objectToString(Object object) {
        OrderItemPk id = (OrderItemPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        OrderItemPk id = (OrderItemPk) value;
