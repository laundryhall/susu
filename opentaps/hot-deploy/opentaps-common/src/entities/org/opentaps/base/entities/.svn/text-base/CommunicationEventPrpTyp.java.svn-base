...
fieldMapColumns.put("CommunicationEventPrpTyp", fields);
  ...
  public static enum Fields implements EntityFieldInterface<CommunicationEventPrpTyp> {
   ...
   private CommunicationEventPrpTyp parentCommunicationEventPrpTyp = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="parentCommunicationEventPrpTyp", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="PARENT_TYPE_ID")
   
   private List<CommunicationEventPrpTyp> childCommunicationEventPrpTyps = null;
