...
/**
 * A FieldBridge for InvoiceTermAttributePk.
 */
public class InvoiceTermAttributePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the InvoiceTermAttributePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        InvoiceTermAttributePk id = new InvoiceTermAttributePk();
        Field field = null;
        field = document.getField(name + ".invoiceTermId");
        id.setInvoiceTermId(field.stringValue());
    ...
    public String objectToString(Object object) {
        InvoiceTermAttributePk id = (InvoiceTermAttributePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getInvoiceTermId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        InvoiceTermAttributePk id = (InvoiceTermAttributePk) value;
        ...
        Field field = null;
        field = new Field(name + ".invoiceTermId", id.getInvoiceTermId(), store, index, termVector);
