...
import org.opentaps.base.entities.ProductCategoryGlAccountPk;

/**
 * A FieldBridge for ProductCategoryGlAccountPk.
 */
public class ProductCategoryGlAccountPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductCategoryGlAccountPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductCategoryGlAccountPk id = new ProductCategoryGlAccountPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductCategoryGlAccountPk id = (ProductCategoryGlAccountPk) value;
