...
import org.opentaps.base.entities.ProductFeatureApplAttrPk;

/**
 * A FieldBridge for ProductFeatureApplAttrPk.
 */
public class ProductFeatureApplAttrPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductFeatureApplAttrPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductFeatureApplAttrPk id = new ProductFeatureApplAttrPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductFeatureApplAttrPk id = (ProductFeatureApplAttrPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductFeatureApplAttrPk id = (ProductFeatureApplAttrPk) value;
