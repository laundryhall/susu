...
import org.opentaps.base.entities.TrackingCodeVisitPk;

/**
 * A FieldBridge for TrackingCodeVisitPk.
 */
public class TrackingCodeVisitPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the TrackingCodeVisitPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        TrackingCodeVisitPk id = new TrackingCodeVisitPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        TrackingCodeVisitPk id = (TrackingCodeVisitPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        TrackingCodeVisitPk id = (TrackingCodeVisitPk) value;
