...
public class PartyRoleNameDetail extends Entity {
static {
...
fieldMapColumns.put("PartyRoleNameDetail", fields);
}
  public static enum Fields implements EntityFieldInterface<PartyRoleNameDetail> {
    partyId("partyId"),
  ...
  public PartyRoleNameDetail() {
      super();
      this.baseEntityName = "PartyRoleNameDetail";
      this.isView = true;
   ...
   */
  public PartyRoleNameDetail(RepositoryInterface repository) {
      this();
