...
import org.opentaps.base.entities.ServerHitPk;

/**
 * A FieldBridge for ServerHitPk.
 */
public class ServerHitPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ServerHitPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ServerHitPk id = new ServerHitPk();
        Field field = null;
        ...
        field = document.getField(name + ".hitStartDateTime");
        if (field.stringValue() != null && !field.stringValue().equals("")) {
            id.setHitStartDateTime(new Timestamp(((Date) (new DateBridge(Resolution.DAY)).stringToObject(field.stringValue())).getTime()));
        }
        field = document.getField(name + ".hitTypeId");
        id.setHitTypeId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        ServerHitPk id = (ServerHitPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getVisitId());
        sb.append("_");
        sb.append(id.getContentId());
        sb.append("_");
        sb.append(id.getHitStartDateTime());
        sb.append("_");
        sb.append(id.getHitTypeId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ServerHitPk id = (ServerHitPk) value;
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".hitStartDateTime", (new DateBridge(Resolution.DAY)).objectToString(id.getHitStartDateTime()), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".hitTypeId", id.getHitTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
