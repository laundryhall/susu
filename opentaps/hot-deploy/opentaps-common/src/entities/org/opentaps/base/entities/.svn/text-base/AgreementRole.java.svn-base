...
/**
 * Auto generated base entity AgreementRole.
 */
@javax.persistence.Entity
@Table(name="AGREEMENT_ROLE")
public class AgreementRole extends Entity {
static {
...
fieldMapColumns.put("AgreementRole", fields);
}
  public static enum Fields implements EntityFieldInterface<AgreementRole> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.AgreementRolePkBridge.class)
     private AgreementRolePk id = new AgreementRolePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>AgreementRolePk</code>
     */
      public AgreementRolePk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>AgreementRolePk</code> value to set
    */   
      public void setId(AgreementRolePk id) {
         this.id = id;
      }
  ...
  public AgreementRole() {
      super();
      this.baseEntityName = "AgreementRole";
      this.isView = false;
      ...
      this.allFieldsNames.add("agreementId");this.allFieldsNames.add("partyId");this.allFieldsNames.add("roleTypeId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public AgreementRole(RepositoryInterface repository) {
      this();
