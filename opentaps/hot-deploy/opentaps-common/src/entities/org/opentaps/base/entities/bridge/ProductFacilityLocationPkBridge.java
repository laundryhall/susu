...
import org.opentaps.base.entities.ProductFacilityLocationPk;

/**
 * A FieldBridge for ProductFacilityLocationPk.
 */
public class ProductFacilityLocationPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductFacilityLocationPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductFacilityLocationPk id = new ProductFacilityLocationPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductFacilityLocationPk id = (ProductFacilityLocationPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductFacilityLocationPk id = (ProductFacilityLocationPk) value;
