...
fieldMapColumns.put("ContactMech", fields);
  ...
  public static enum Fields implements EntityFieldInterface<ContactMech> {
   ...
   private transient List<ContactMechTypeAttr> contactMechTypeAttrs = null;
   ...
   private transient List<ContactListParty> preferredContactListPartys = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="contactMech", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="CONTACT_MECH_ID")
   
   private List<ContactMechAttribute> contactMechAttributes = null;
   private transient List<ContactMechLink> fromContactMechLinks = null;
   private transient List<ContactMechLink> toContactMechLinks = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="contactMech", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="CONTACT_MECH_ID")
   ...
   private transient List<OrderItemShipGroup> telecomOrderItemShipGroups = null;
   @OneToMany(fetch=FetchType.LAZY, mappedBy="contactMech", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="CONTACT_MECH_ID")
   ...
   private transient List<PartySupplementalData> contactMechPostalAddressPartySupplementalDatas = null;
   private transient List<PartySupplementalData> contactMechTelecomNumberPartySupplementalDatas = null;
   private transient List<PartySupplementalData> contactMechEmailPartySupplementalDatas = null;
   ...
   private transient List<RespondingParty> respondingPartys = null;
   ...
   private transient List<ServerHit> idByIpServerHits = null;
   private transient List<ServerHit> refByWebServerHits = null;
   ...
   private transient List<Shipment> destShipments = null;
   private transient List<ShipmentContactMech> shipmentContactMeches = null;
   ...
   private transient List<WorkEffortEventReminder> workEffortEventReminders = null;
