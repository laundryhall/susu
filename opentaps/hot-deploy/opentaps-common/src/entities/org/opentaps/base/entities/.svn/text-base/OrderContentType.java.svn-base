...
fieldMapColumns.put("OrderContentType", fields);
  ...
  public static enum Fields implements EntityFieldInterface<OrderContentType> {
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="parentOrderContentType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
  ...
  public OrderContentType() {
      ...
      this.allFieldsNames.add("orderContentTypeId");this.allFieldsNames.add("parentTypeId");this.allFieldsNames.add("hasTable");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
