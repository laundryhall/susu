...
import org.opentaps.base.entities.OrderSummaryEntryPk;

/**
 * A FieldBridge for OrderSummaryEntryPk.
 */
public class OrderSummaryEntryPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the OrderSummaryEntryPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        OrderSummaryEntryPk id = new OrderSummaryEntryPk();
        Field field = null;
        field = document.getField(name + ".entryDate");
        if (field.stringValue() != null && !field.stringValue().equals("")) {
            id.setEntryDate(new java.sql.Date(((Date) (new DateBridge(Resolution.DAY)).stringToObject(field.stringValue())).getTime()));
        }
    ...
    public String objectToString(Object object) {
        OrderSummaryEntryPk id = (OrderSummaryEntryPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getEntryDate());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        OrderSummaryEntryPk id = (OrderSummaryEntryPk) value;
        ...
        Field field = null;
        field = new Field(name + ".entryDate", (new DateBridge(Resolution.DAY)).objectToString(id.getEntryDate()), store, index, termVector);
