...
/**
 * Auto generated base entity ProductStorePromoAppl.
 */
@javax.persistence.Entity
@Table(name="PRODUCT_STORE_PROMO_APPL")
public class ProductStorePromoAppl extends Entity {
static {
...
fieldMapColumns.put("ProductStorePromoAppl", fields);
}
  public static enum Fields implements EntityFieldInterface<ProductStorePromoAppl> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.ProductStorePromoApplPkBridge.class)
     private ProductStorePromoApplPk id = new ProductStorePromoApplPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>ProductStorePromoApplPk</code>
     */
      public ProductStorePromoApplPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>ProductStorePromoApplPk</code> value to set
    */   
      public void setId(ProductStorePromoApplPk id) {
         this.id = id;
      }
  ...
  public ProductStorePromoAppl() {
      super();
      this.baseEntityName = "ProductStorePromoAppl";
      this.isView = false;
   ...
   */
  public ProductStorePromoAppl(RepositoryInterface repository) {
      this();
