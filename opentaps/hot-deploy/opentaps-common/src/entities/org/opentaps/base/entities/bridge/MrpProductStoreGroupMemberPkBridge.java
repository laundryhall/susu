...
import org.opentaps.base.entities.MrpProductStoreGroupMemberPk;

/**
 * A FieldBridge for MrpProductStoreGroupMemberPk.
 */
public class MrpProductStoreGroupMemberPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the MrpProductStoreGroupMemberPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        MrpProductStoreGroupMemberPk id = new MrpProductStoreGroupMemberPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        MrpProductStoreGroupMemberPk id = (MrpProductStoreGroupMemberPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        MrpProductStoreGroupMemberPk id = (MrpProductStoreGroupMemberPk) value;
