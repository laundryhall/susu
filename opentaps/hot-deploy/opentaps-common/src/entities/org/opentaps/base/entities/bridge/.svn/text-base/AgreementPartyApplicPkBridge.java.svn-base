...
import org.opentaps.base.entities.AgreementPartyApplicPk;

/**
 * A FieldBridge for AgreementPartyApplicPk.
 */
public class AgreementPartyApplicPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AgreementPartyApplicPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AgreementPartyApplicPk id = new AgreementPartyApplicPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        AgreementPartyApplicPk id = (AgreementPartyApplicPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AgreementPartyApplicPk id = (AgreementPartyApplicPk) value;
