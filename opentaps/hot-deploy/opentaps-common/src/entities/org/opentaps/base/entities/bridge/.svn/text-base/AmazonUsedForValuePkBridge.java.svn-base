...
import org.opentaps.base.entities.AmazonUsedForValuePk;

/**
 * A FieldBridge for AmazonUsedForValuePk.
 */
public class AmazonUsedForValuePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AmazonUsedForValuePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AmazonUsedForValuePk id = new AmazonUsedForValuePk();
        Field field = null;
        field = document.getField(name + ".productId");
        id.setProductId(field.stringValue());
        field = document.getField(name + ".usedForId");
        id.setUsedForId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        AmazonUsedForValuePk id = (AmazonUsedForValuePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProductId());
        sb.append("_");
        sb.append(id.getUsedForId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AmazonUsedForValuePk id = (AmazonUsedForValuePk) value;
        ...
        document.add(field);
        field = new Field(name + ".usedForId", id.getUsedForId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
