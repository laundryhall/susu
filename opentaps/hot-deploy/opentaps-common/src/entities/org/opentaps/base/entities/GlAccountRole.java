...
/**
 * Auto generated base entity GlAccountRole.
 */
@javax.persistence.Entity
@Table(name="GL_ACCOUNT_ROLE")
public class GlAccountRole extends Entity {
static {
...
fieldMapColumns.put("GlAccountRole", fields);
}
  public static enum Fields implements EntityFieldInterface<GlAccountRole> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.GlAccountRolePkBridge.class)
     private GlAccountRolePk id = new GlAccountRolePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>GlAccountRolePk</code>
     */
      public GlAccountRolePk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>GlAccountRolePk</code> value to set
    */   
      public void setId(GlAccountRolePk id) {
         this.id = id;
      }
  ...
  public GlAccountRole() {
      super();
      this.baseEntityName = "GlAccountRole";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("glAccountId");this.primaryKeyNames.add("partyId");this.primaryKeyNames.add("roleTypeId");this.primaryKeyNames.add("fromDate");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("glAccountId");this.allFieldsNames.add("partyId");this.allFieldsNames.add("roleTypeId");this.allFieldsNames.add("fromDate");this.allFieldsNames.add("thruDate");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public GlAccountRole(RepositoryInterface repository) {
      this();
