...
import org.opentaps.base.entities.CarrierShipmentBoxTypePk;

/**
 * A FieldBridge for CarrierShipmentBoxTypePk.
 */
public class CarrierShipmentBoxTypePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CarrierShipmentBoxTypePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CarrierShipmentBoxTypePk id = new CarrierShipmentBoxTypePk();
        Field field = null;
        field = document.getField(name + ".shipmentBoxTypeId");
        id.setShipmentBoxTypeId(field.stringValue());
    ...
    public String objectToString(Object object) {
        CarrierShipmentBoxTypePk id = (CarrierShipmentBoxTypePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getShipmentBoxTypeId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CarrierShipmentBoxTypePk id = (CarrierShipmentBoxTypePk) value;
        ...
        Field field = null;
        field = new Field(name + ".shipmentBoxTypeId", id.getShipmentBoxTypeId(), store, index, termVector);
