...
fieldMapColumns.put("OrderContent", fields);
  ...
  public static enum Fields implements EntityFieldInterface<OrderContent> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.OrderContentPkBridge.class)
     private OrderContentPk id = new OrderContentPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>OrderContentPk</code>
     */
     ...
     * @param id a <code>OrderContentPk</code> value to set
    */   
  ...
  public OrderContent() {
      ...
      this.allFieldsNames.add("orderId");this.allFieldsNames.add("orderItemSeqId");this.allFieldsNames.add("contentId");this.allFieldsNames.add("orderContentTypeId");this.allFieldsNames.add("fromDate");this.allFieldsNames.add("thruDate");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
  ...
  public OrderContent(RepositoryInterface repository) {
    ...
    public void setOrderContentTypeId(String orderContentTypeId) {
        id.setOrderContentTypeId(orderContentTypeId);
    }
    /**
     * Auto generated value setter.
    ...
    public String getOrderContentTypeId() {
        return this.id.getOrderContentTypeId();
    }
    /**
     * Auto generated value accessor.
