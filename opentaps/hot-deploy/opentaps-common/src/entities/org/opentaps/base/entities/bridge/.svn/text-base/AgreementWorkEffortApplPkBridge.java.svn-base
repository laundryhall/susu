...
import org.opentaps.base.entities.AgreementWorkEffortApplPk;

/**
 * A FieldBridge for AgreementWorkEffortApplPk.
 */
public class AgreementWorkEffortApplPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AgreementWorkEffortApplPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AgreementWorkEffortApplPk id = new AgreementWorkEffortApplPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AgreementWorkEffortApplPk id = (AgreementWorkEffortApplPk) value;
