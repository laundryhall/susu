...
/**
 * Auto generated base entity ExampleType.
 */
@javax.persistence.Entity
@Table(name="EXAMPLE_TYPE")
public class ExampleType extends Entity {
static {
...
fieldMapColumns.put("ExampleType", fields);
}
  public static enum Fields implements EntityFieldInterface<ExampleType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="ExampleType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="exampleType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
  ...
  public ExampleType() {
      super();
      this.baseEntityName = "ExampleType";
      this.isView = false;
      this.resourceName = "ExampleEntityLabels";
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("exampleTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("exampleTypeId");this.allFieldsNames.add("parentTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ExampleType(RepositoryInterface repository) {
      this();
