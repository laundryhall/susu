...
import org.opentaps.base.entities.FacilityGroupMemberPk;

/**
 * A FieldBridge for FacilityGroupMemberPk.
 */
public class FacilityGroupMemberPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FacilityGroupMemberPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FacilityGroupMemberPk id = new FacilityGroupMemberPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        FacilityGroupMemberPk id = (FacilityGroupMemberPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FacilityGroupMemberPk id = (FacilityGroupMemberPk) value;
