...
import org.opentaps.base.entities.PayHistoryPk;

/**
 * A FieldBridge for PayHistoryPk.
 */
public class PayHistoryPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PayHistoryPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PayHistoryPk id = new PayHistoryPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PayHistoryPk id = (PayHistoryPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PayHistoryPk id = (PayHistoryPk) value;
