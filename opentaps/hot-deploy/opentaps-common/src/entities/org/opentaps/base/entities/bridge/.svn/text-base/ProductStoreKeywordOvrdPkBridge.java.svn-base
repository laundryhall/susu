...
import org.opentaps.base.entities.ProductStoreKeywordOvrdPk;

/**
 * A FieldBridge for ProductStoreKeywordOvrdPk.
 */
public class ProductStoreKeywordOvrdPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductStoreKeywordOvrdPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductStoreKeywordOvrdPk id = new ProductStoreKeywordOvrdPk();
        Field field = null;
        field = document.getField(name + ".productStoreId");
        id.setProductStoreId(field.stringValue());
        field = document.getField(name + ".keyword");
        id.setKeyword(field.stringValue());
    ...
    public String objectToString(Object object) {
        ProductStoreKeywordOvrdPk id = (ProductStoreKeywordOvrdPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getProductStoreId());
        sb.append("_");
        sb.append(id.getKeyword());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductStoreKeywordOvrdPk id = (ProductStoreKeywordOvrdPk) value;
        ...
        document.add(field);
        field = new Field(name + ".keyword", id.getKeyword(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
