...
/**
 * Auto generated base entity SupplierPrefOrder.
 */
@javax.persistence.Entity
@Table(name="SUPPLIER_PREF_ORDER")
public class SupplierPrefOrder extends Entity {
static {
...
fieldMapColumns.put("SupplierPrefOrder", fields);
}
  public static enum Fields implements EntityFieldInterface<SupplierPrefOrder> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="SupplierPrefOrder_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="SupplierPrefOrder_GEN")
   @Id
  ...
  public SupplierPrefOrder() {
      super();
      this.baseEntityName = "SupplierPrefOrder";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("supplierPrefOrderId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("supplierPrefOrderId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public SupplierPrefOrder(RepositoryInterface repository) {
      this();
