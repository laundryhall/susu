...
import org.opentaps.base.entities.TermTypeToUomTypeMapPk;

/**
 * A FieldBridge for TermTypeToUomTypeMapPk.
 */
public class TermTypeToUomTypeMapPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the TermTypeToUomTypeMapPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        TermTypeToUomTypeMapPk id = new TermTypeToUomTypeMapPk();
        Field field = null;
        field = document.getField(name + ".termTypeId");
        id.setTermTypeId(field.stringValue());
        field = document.getField(name + ".uomTypeId");
        id.setUomTypeId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        TermTypeToUomTypeMapPk id = (TermTypeToUomTypeMapPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getTermTypeId());
        sb.append("_");
        sb.append(id.getUomTypeId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        TermTypeToUomTypeMapPk id = (TermTypeToUomTypeMapPk) value;
        ...
        document.add(field);
        field = new Field(name + ".uomTypeId", id.getUomTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
