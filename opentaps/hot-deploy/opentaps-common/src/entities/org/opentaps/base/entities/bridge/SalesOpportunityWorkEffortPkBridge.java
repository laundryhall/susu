...
import org.opentaps.base.entities.SalesOpportunityWorkEffortPk;

/**
 * A FieldBridge for SalesOpportunityWorkEffortPk.
 */
public class SalesOpportunityWorkEffortPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the SalesOpportunityWorkEffortPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        SalesOpportunityWorkEffortPk id = new SalesOpportunityWorkEffortPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        SalesOpportunityWorkEffortPk id = (SalesOpportunityWorkEffortPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        SalesOpportunityWorkEffortPk id = (SalesOpportunityWorkEffortPk) value;
