...
import org.opentaps.base.entities.PartyStatusPk;

/**
 * A FieldBridge for PartyStatusPk.
 */
public class PartyStatusPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyStatusPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyStatusPk id = new PartyStatusPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PartyStatusPk id = (PartyStatusPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyStatusPk id = (PartyStatusPk) value;
