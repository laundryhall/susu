...
import org.opentaps.base.entities.InventoryEventPlannedPk;

/**
 * A FieldBridge for InventoryEventPlannedPk.
 */
public class InventoryEventPlannedPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the InventoryEventPlannedPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        InventoryEventPlannedPk id = new InventoryEventPlannedPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        InventoryEventPlannedPk id = (InventoryEventPlannedPk) value;
