...
import org.opentaps.base.entities.ProductContentPk;

/**
 * A FieldBridge for ProductContentPk.
 */
public class ProductContentPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductContentPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductContentPk id = new ProductContentPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ProductContentPk id = (ProductContentPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductContentPk id = (ProductContentPk) value;
