...
import org.opentaps.base.entities.ProductConfigProductPk;

/**
 * A FieldBridge for ProductConfigProductPk.
 */
public class ProductConfigProductPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ProductConfigProductPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ProductConfigProductPk id = new ProductConfigProductPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ProductConfigProductPk id = (ProductConfigProductPk) value;
