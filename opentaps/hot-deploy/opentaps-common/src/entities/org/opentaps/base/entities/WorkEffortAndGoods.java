...
public class WorkEffortAndGoods extends Entity {
static {
...
fieldMapColumns.put("WorkEffortAndGoods", fields);
   ...
   * Default constructor.
   */
  public WorkEffortAndGoods() {
      super();
      this.baseEntityName = "WorkEffortAndGoods";
      this.isView = true;
   ...
   */
  public WorkEffortAndGoods(RepositoryInterface repository) {
      this();
