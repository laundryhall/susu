...
import org.opentaps.base.entities.PaginationPreferencePk;

/**
 * A FieldBridge for PaginationPreferencePk.
 */
public class PaginationPreferencePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PaginationPreferencePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PaginationPreferencePk id = new PaginationPreferencePk();
        Field field = null;
        field = document.getField(name + ".userLoginId");
        id.setUserLoginId(field.stringValue());
        field = document.getField(name + ".paginatorName");
        id.setPaginatorName(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        PaginationPreferencePk id = (PaginationPreferencePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getUserLoginId());
        sb.append("_");
        sb.append(id.getPaginatorName());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PaginationPreferencePk id = (PaginationPreferencePk) value;
        ...
        document.add(field);
        field = new Field(name + ".paginatorName", id.getPaginatorName(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
