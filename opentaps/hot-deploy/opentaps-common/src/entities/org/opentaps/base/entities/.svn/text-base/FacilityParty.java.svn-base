...
/**
 * Auto generated base entity FacilityParty.
 */
@javax.persistence.Entity
@Table(name="FACILITY_PARTY")
public class FacilityParty extends Entity {
static {
...
fieldMapColumns.put("FacilityParty", fields);
}
  public static enum Fields implements EntityFieldInterface<FacilityParty> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.FacilityPartyPkBridge.class)
     private FacilityPartyPk id = new FacilityPartyPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>FacilityPartyPk</code>
     */
      public FacilityPartyPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>FacilityPartyPk</code> value to set
    */   
      public void setId(FacilityPartyPk id) {
         this.id = id;
      }
  ...
  public FacilityParty() {
      super();
      this.baseEntityName = "FacilityParty";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("facilityId");this.primaryKeyNames.add("partyId");this.primaryKeyNames.add("roleTypeId");this.primaryKeyNames.add("fromDate");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("facilityId");this.allFieldsNames.add("partyId");this.allFieldsNames.add("roleTypeId");this.allFieldsNames.add("fromDate");this.allFieldsNames.add("thruDate");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public FacilityParty(RepositoryInterface repository) {
      this();
