...
/**
 * Auto generated base entity GlFiscalType.
 */
@javax.persistence.Entity
@Table(name="GL_FISCAL_TYPE")
public class GlFiscalType extends Entity {
static {
...
fieldMapColumns.put("GlFiscalType", fields);
}
  public static enum Fields implements EntityFieldInterface<GlFiscalType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="GlFiscalType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="GlFiscalType_GEN")
   @Id
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="glFiscalType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="GL_FISCAL_TYPE_ID")
  ...
  public GlFiscalType() {
      super();
      this.baseEntityName = "GlFiscalType";
      this.isView = false;
      this.resourceName = "AccountingEntityLabels";
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("glFiscalTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("glFiscalTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public GlFiscalType(RepositoryInterface repository) {
      this();
