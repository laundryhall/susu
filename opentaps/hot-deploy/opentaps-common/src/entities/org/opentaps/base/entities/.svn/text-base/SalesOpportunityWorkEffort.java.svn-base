...
/**
 * Auto generated base entity SalesOpportunityWorkEffort.
 */
@javax.persistence.Entity
@Table(name="SALES_OPPORTUNITY_WORK_EFFORT")
public class SalesOpportunityWorkEffort extends Entity {
static {
...
fieldMapColumns.put("SalesOpportunityWorkEffort", fields);
}
  public static enum Fields implements EntityFieldInterface<SalesOpportunityWorkEffort> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.SalesOpportunityWorkEffortPkBridge.class)
     private SalesOpportunityWorkEffortPk id = new SalesOpportunityWorkEffortPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>SalesOpportunityWorkEffortPk</code>
     */
      public SalesOpportunityWorkEffortPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>SalesOpportunityWorkEffortPk</code> value to set
    */   
      public void setId(SalesOpportunityWorkEffortPk id) {
         this.id = id;
      }
  ...
  public SalesOpportunityWorkEffort() {
      super();
      this.baseEntityName = "SalesOpportunityWorkEffort";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("salesOpportunityId");this.primaryKeyNames.add("workEffortId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("salesOpportunityId");this.allFieldsNames.add("workEffortId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public SalesOpportunityWorkEffort(RepositoryInterface repository) {
      this();
