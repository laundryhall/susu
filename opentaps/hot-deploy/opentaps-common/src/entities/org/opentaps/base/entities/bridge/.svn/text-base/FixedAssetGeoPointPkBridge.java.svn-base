...
import org.opentaps.base.entities.FixedAssetGeoPointPk;

/**
 * A FieldBridge for FixedAssetGeoPointPk.
 */
public class FixedAssetGeoPointPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the FixedAssetGeoPointPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        FixedAssetGeoPointPk id = new FixedAssetGeoPointPk();
        Field field = null;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        FixedAssetGeoPointPk id = (FixedAssetGeoPointPk) value;
