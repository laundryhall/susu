...
import org.opentaps.base.entities.InvoiceStatusPk;

/**
 * A FieldBridge for InvoiceStatusPk.
 */
public class InvoiceStatusPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the InvoiceStatusPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        InvoiceStatusPk id = new InvoiceStatusPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        InvoiceStatusPk id = (InvoiceStatusPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        InvoiceStatusPk id = (InvoiceStatusPk) value;
