...
import org.opentaps.base.entities.TimesheetRolePk;

/**
 * A FieldBridge for TimesheetRolePk.
 */
public class TimesheetRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the TimesheetRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        TimesheetRolePk id = new TimesheetRolePk();
        Field field = null;
        field = document.getField(name + ".timesheetId");
        id.setTimesheetId(field.stringValue());
    ...
    public String objectToString(Object object) {
        TimesheetRolePk id = (TimesheetRolePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getTimesheetId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        TimesheetRolePk id = (TimesheetRolePk) value;
        ...
        Field field = null;
        field = new Field(name + ".timesheetId", id.getTimesheetId(), store, index, termVector);
