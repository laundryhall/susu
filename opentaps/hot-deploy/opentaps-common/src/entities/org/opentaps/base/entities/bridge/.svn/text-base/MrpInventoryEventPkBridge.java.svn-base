...
import org.opentaps.base.entities.MrpInventoryEventPk;

/**
 * A FieldBridge for MrpInventoryEventPk.
 */
public class MrpInventoryEventPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the MrpInventoryEventPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        MrpInventoryEventPk id = new MrpInventoryEventPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        MrpInventoryEventPk id = (MrpInventoryEventPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        MrpInventoryEventPk id = (MrpInventoryEventPk) value;
