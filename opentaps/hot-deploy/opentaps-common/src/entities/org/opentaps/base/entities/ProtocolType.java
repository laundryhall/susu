...
/**
 * Auto generated base entity ProtocolType.
 */
@javax.persistence.Entity
@Table(name="PROTOCOL_TYPE")
public class ProtocolType extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        fields.put("protocolTypeId", "PROTOCOL_TYPE_ID");
        fields.put("protocolName", "PROTOCOL_NAME");
        fields.put("lastUpdatedStamp", "LAST_UPDATED_STAMP");
        fields.put("lastUpdatedTxStamp", "LAST_UPDATED_TX_STAMP");
        fields.put("createdStamp", "CREATED_STAMP");
        fields.put("createdTxStamp", "CREATED_TX_STAMP");
fieldMapColumns.put("ProtocolType", fields);
}
  public static enum Fields implements EntityFieldInterface<ProtocolType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="ProtocolType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="protocolType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
  ...
  public ProtocolType() {
      super();
      this.baseEntityName = "ProtocolType";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("protocolTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("protocolTypeId");this.allFieldsNames.add("protocolName");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public ProtocolType(RepositoryInterface repository) {
      this();
    ...
    */
    ...
    public void fromMap(Map<String, Object> mapValue) {
        ...
        setProtocolName((String) mapValue.get("protocolName"));
    ...
    public Map<String, Object> toMap() {
        ...
        mapValue.put("protocolName", getProtocolName());
