...
import org.opentaps.base.entities.ContentRolePk;

/**
 * A FieldBridge for ContentRolePk.
 */
public class ContentRolePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the ContentRolePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        ContentRolePk id = new ContentRolePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        ContentRolePk id = (ContentRolePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        ContentRolePk id = (ContentRolePk) value;
