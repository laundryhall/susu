...
/**
 * Auto generated base entity SubscriptionAndCommEvent.
 */
@javax.persistence.Entity
@NamedNativeQuery(name="selectSubscriptionAndCommEvents", query="SELECT SC.SUBSCRIPTION_ID AS \"subscriptionId\",SC.COMMUNICATION_EVENT_ID AS \"communicationEventId\",CE.COMMUNICATION_EVENT_TYPE_ID AS \"communicationEventTypeId\",CE.ORIG_COMM_EVENT_ID AS \"origCommEventId\",CE.PARENT_COMM_EVENT_ID AS \"parentCommEventId\",CE.STATUS_ID AS \"statusId\",CE.CONTACT_MECH_TYPE_ID AS \"contactMechTypeId\",CE.CONTACT_MECH_ID_FROM AS \"contactMechIdFrom\",CE.CONTACT_MECH_ID_TO AS \"contactMechIdTo\",CE.ROLE_TYPE_ID_FROM AS \"roleTypeIdFrom\",CE.ROLE_TYPE_ID_TO AS \"roleTypeIdTo\",CE.PARTY_ID_FROM AS \"partyIdFrom\",CE.PARTY_ID_TO AS \"partyIdTo\",CE.ENTRY_DATE AS \"entryDate\",CE.DATETIME_STARTED AS \"datetimeStarted\",CE.DATETIME_ENDED AS \"datetimeEnded\",CE.SUBJECT AS \"subject\",CE.CONTENT_MIME_TYPE_ID AS \"contentMimeTypeId\",CE.CONTENT AS \"content\",CE.NOTE AS \"note\",CE.REASON_ENUM_ID AS \"reasonEnumId\",CE.CONTACT_LIST_ID AS \"contactListId\",CE.HEADER_STRING AS \"headerString\",CE.FROM_STRING AS \"fromString\",CE.TO_STRING AS \"toString\",CE.CC_STRING AS \"ccString\",CE.BCC_STRING AS \"bccString\",CE.MESSAGE_ID AS \"messageId\" FROM SUBSCRIPTION_COMM_EVENT SC INNER JOIN COMMUNICATION_EVENT CE ON SC.COMMUNICATION_EVENT_ID = CE.COMMUNICATION_EVENT_ID", resultSetMapping="SubscriptionAndCommEventMapping")
@SqlResultSetMapping(name="SubscriptionAndCommEventMapping", entities={
@EntityResult(entityClass=SubscriptionAndCommEvent.class, fields = {
...
public class SubscriptionAndCommEvent extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        fields.put("subscriptionId", "SC.SUBSCRIPTION_ID");
        fields.put("communicationEventId", "SC.COMMUNICATION_EVENT_ID");
...
fieldMapColumns.put("SubscriptionAndCommEvent", fields);
}
  public static enum Fields implements EntityFieldInterface<SubscriptionAndCommEvent> {
   ...
   */
  public SubscriptionAndCommEvent(RepositoryInterface repository) {
      this();
