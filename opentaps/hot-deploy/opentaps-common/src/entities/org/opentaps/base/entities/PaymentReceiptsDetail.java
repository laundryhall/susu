...
/**
 * Auto generated base entity PaymentReceiptsDetail.
 */
@javax.persistence.Entity
@NamedNativeQuery(name="selectPaymentReceiptsDetails", query="SELECT P.PAYMENT_ID AS \"paymentId\",P.PAYMENT_METHOD_TYPE_ID AS \"paymentMethodTypeId\",P.PAYMENT_REF_NUM AS \"paymentRefNum\",P.PARTY_ID_TO AS \"partyIdTo\",P.PARTY_ID_FROM AS \"partyIdFrom\",P.AMOUNT AS \"amount\",P.CURRENCY_UOM_ID AS \"currencyUomId\",A.ACCTG_TRANS_ID AS \"acctgTransId\",A.TRANSACTION_DATE AS \"transactionDate\",ATE.GL_ACCOUNT_ID AS \"glAccountId\",ATE.DEBIT_CREDIT_FLAG AS \"debitCreditFlag\" FROM PAYMENT P INNER JOIN ACCTG_TRANS A ON A.PAYMENT_ID = P.PAYMENT_ID INNER JOIN ACCTG_TRANS_ENTRY ATE ON A.ACCTG_TRANS_ID = ATE.ACCTG_TRANS_ID", resultSetMapping="PaymentReceiptsDetailMapping")
@SqlResultSetMapping(name="PaymentReceiptsDetailMapping", entities={
@EntityResult(entityClass=PaymentReceiptsDetail.class, fields = {
...
public class PaymentReceiptsDetail extends Entity {
static {
...
fieldMapColumns.put("PaymentReceiptsDetail", fields);
}
  public static enum Fields implements EntityFieldInterface<PaymentReceiptsDetail> {
    paymentId("paymentId"),
   ...
   * Default constructor.
   */
  public PaymentReceiptsDetail() {
      super();
      this.baseEntityName = "PaymentReceiptsDetail";
      this.isView = true;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("paymentId");this.primaryKeyNames.add("acctgTransId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("paymentId");this.allFieldsNames.add("paymentMethodTypeId");this.allFieldsNames.add("paymentRefNum");this.allFieldsNames.add("partyIdTo");this.allFieldsNames.add("partyIdFrom");this.allFieldsNames.add("amount");this.allFieldsNames.add("currencyUomId");this.allFieldsNames.add("acctgTransId");this.allFieldsNames.add("transactionDate");this.allFieldsNames.add("glAccountId");this.allFieldsNames.add("debitCreditFlag");
   ...
   */
  public PaymentReceiptsDetail(RepositoryInterface repository) {
      this();
