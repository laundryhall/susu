...
/**
 * Auto generated base entity MrpEventType.
 */
@javax.persistence.Entity
@Table(name="MRP_EVENT_TYPE")
public class MrpEventType extends Entity {
static {
...
fieldMapColumns.put("MrpEventType", fields);
}
  public static enum Fields implements EntityFieldInterface<MrpEventType> {
   ...
   @org.hibernate.annotations.GenericGenerator(name="MrpEventType_GEN",  strategy="org.opentaps.foundation.entity.hibernate.OpentapsIdentifierGenerator")
   @GeneratedValue(generator="MrpEventType_GEN")
   @Id
   ...
   @OneToMany(fetch=FetchType.LAZY, mappedBy="mrpEventType", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
   @JoinColumn(name="MRP_EVENT_TYPE_ID")
  ...
  public MrpEventType() {
      super();
      this.baseEntityName = "MrpEventType";
      this.isView = false;
      this.resourceName = "ManufacturingEntityLabels";
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("mrpEventTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("mrpEventTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public MrpEventType(RepositoryInterface repository) {
      this();
