...
import org.opentaps.base.entities.UserPreferencePk;

/**
 * A FieldBridge for UserPreferencePk.
 */
public class UserPreferencePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the UserPreferencePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        UserPreferencePk id = new UserPreferencePk();
        Field field = null;
        field = document.getField(name + ".userLoginId");
        id.setUserLoginId(field.stringValue());
        field = document.getField(name + ".userPrefTypeId");
        id.setUserPrefTypeId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        UserPreferencePk id = (UserPreferencePk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getUserLoginId());
        sb.append("_");
        sb.append(id.getUserPrefTypeId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        UserPreferencePk id = (UserPreferencePk) value;
        ...
        document.add(field);
        field = new Field(name + ".userPrefTypeId", id.getUserPrefTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
