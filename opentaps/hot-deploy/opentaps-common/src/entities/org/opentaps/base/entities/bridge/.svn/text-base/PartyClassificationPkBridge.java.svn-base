...
import org.opentaps.base.entities.PartyClassificationPk;

/**
 * A FieldBridge for PartyClassificationPk.
 */
public class PartyClassificationPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyClassificationPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyClassificationPk id = new PartyClassificationPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        PartyClassificationPk id = (PartyClassificationPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyClassificationPk id = (PartyClassificationPk) value;
