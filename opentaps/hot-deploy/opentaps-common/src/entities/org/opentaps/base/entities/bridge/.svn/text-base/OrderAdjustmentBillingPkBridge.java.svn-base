...
import org.opentaps.base.entities.OrderAdjustmentBillingPk;

/**
 * A FieldBridge for OrderAdjustmentBillingPk.
 */
public class OrderAdjustmentBillingPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the OrderAdjustmentBillingPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        OrderAdjustmentBillingPk id = new OrderAdjustmentBillingPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        OrderAdjustmentBillingPk id = (OrderAdjustmentBillingPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        OrderAdjustmentBillingPk id = (OrderAdjustmentBillingPk) value;
