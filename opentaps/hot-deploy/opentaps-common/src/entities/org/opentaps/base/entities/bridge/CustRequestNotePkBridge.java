...
import org.opentaps.base.entities.CustRequestNotePk;

/**
 * A FieldBridge for CustRequestNotePk.
 */
public class CustRequestNotePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the CustRequestNotePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        CustRequestNotePk id = new CustRequestNotePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        CustRequestNotePk id = (CustRequestNotePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        CustRequestNotePk id = (CustRequestNotePk) value;
