...
import org.opentaps.base.entities.PartyNeedPk;

/**
 * A FieldBridge for PartyNeedPk.
 */
public class PartyNeedPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the PartyNeedPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        PartyNeedPk id = new PartyNeedPk();
        Field field = null;
        field = document.getField(name + ".partyNeedId");
        id.setPartyNeedId(field.stringValue());
    ...
    public String objectToString(Object object) {
        PartyNeedPk id = (PartyNeedPk) object;
        StringBuilder sb = new StringBuilder();
        sb.append(id.getPartyNeedId());
        sb.append("_");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        PartyNeedPk id = (PartyNeedPk) value;
        ...
        Field field = null;
        field = new Field(name + ".partyNeedId", id.getPartyNeedId(), store, index, termVector);
