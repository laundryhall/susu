...
import org.opentaps.base.entities.DataImportOrderItemPk;

/**
 * A FieldBridge for DataImportOrderItemPk.
 */
public class DataImportOrderItemPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the DataImportOrderItemPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        DataImportOrderItemPk id = new DataImportOrderItemPk();
        Field field = null;
        ...
        field = document.getField(name + ".quantity");
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        DataImportOrderItemPk id = (DataImportOrderItemPk) value;
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".quantity", id.getQuantity().toString(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
