...
import org.opentaps.base.entities.OrderHeaderContentPk;

/**
 * A FieldBridge for OrderHeaderContentPk.
 */
public class OrderHeaderContentPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the OrderHeaderContentPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        OrderHeaderContentPk id = new OrderHeaderContentPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        OrderHeaderContentPk id = (OrderHeaderContentPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        OrderHeaderContentPk id = (OrderHeaderContentPk) value;
