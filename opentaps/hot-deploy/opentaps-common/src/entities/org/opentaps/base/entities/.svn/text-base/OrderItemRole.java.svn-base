...
/**
 * Auto generated base entity OrderItemRole.
 */
@javax.persistence.Entity
@Table(name="ORDER_ITEM_ROLE")
public class OrderItemRole extends Entity {
static {
...
fieldMapColumns.put("OrderItemRole", fields);
}
  public static enum Fields implements EntityFieldInterface<OrderItemRole> {
    orderId("orderId"),
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.OrderItemRolePkBridge.class)
     private OrderItemRolePk id = new OrderItemRolePk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>OrderItemRolePk</code>
     */
     ...
     * @param id a <code>OrderItemRolePk</code> value to set
    */   
  ...
  public OrderItemRole() {
      super();
      this.baseEntityName = "OrderItemRole";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("orderId");this.primaryKeyNames.add("orderItemSeqId");this.primaryKeyNames.add("partyId");this.primaryKeyNames.add("roleTypeId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("orderId");this.allFieldsNames.add("orderItemSeqId");this.allFieldsNames.add("partyId");this.allFieldsNames.add("roleTypeId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public OrderItemRole(RepositoryInterface repository) {
      this();
