...
/**
 * Auto generated base entity PaycheckItemAndType.
 */
@javax.persistence.Entity
@NamedNativeQuery(name="selectPaycheckItemAndTypes", query="SELECT PCKITM.PAYMENT_ID AS \"paymentId\",PCKITM.PAYCHECK_ITEM_SEQ_ID AS \"paycheckItemSeqId\",PCKITM.PAYCHECK_ITEM_TYPE_ID AS \"paycheckItemTypeId\",PCKITMTYP.PAYCHECK_ITEM_CLASS_ID AS \"paycheckItemClassId\",PCKITM.AMOUNT AS \"amount\",PCKITM.PARTY_ID AS \"partyId\" FROM PAYCHECK_ITEM PCKITM INNER JOIN PAYCHECK_ITEM_TYPE PCKITMTYP ON PCKITM.PAYCHECK_ITEM_TYPE_ID = PCKITMTYP.PAYCHECK_ITEM_TYPE_ID", resultSetMapping="PaycheckItemAndTypeMapping")
@SqlResultSetMapping(name="PaycheckItemAndTypeMapping", entities={
@EntityResult(entityClass=PaycheckItemAndType.class, fields = {
@FieldResult(name="paymentId", column="paymentId")
,@FieldResult(name="paycheckItemSeqId", column="paycheckItemSeqId")
...
public class PaycheckItemAndType extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        fields.put("paymentId", "PCKITM.PAYMENT_ID");
        fields.put("paycheckItemSeqId", "PCKITM.PAYCHECK_ITEM_SEQ_ID");
...
fieldMapColumns.put("PaycheckItemAndType", fields);
}
  public static enum Fields implements EntityFieldInterface<PaycheckItemAndType> {
    paymentId("paymentId"),
   ...
   * Default constructor.
   */
  public PaycheckItemAndType() {
      super();
      this.baseEntityName = "PaycheckItemAndType";
      this.isView = true;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("paymentId");this.primaryKeyNames.add("paycheckItemSeqId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("paymentId");this.allFieldsNames.add("paycheckItemSeqId");this.allFieldsNames.add("paycheckItemTypeId");this.allFieldsNames.add("paycheckItemClassId");this.allFieldsNames.add("amount");this.allFieldsNames.add("partyId");
   ...
   */
  public PaycheckItemAndType(RepositoryInterface repository) {
      this();
