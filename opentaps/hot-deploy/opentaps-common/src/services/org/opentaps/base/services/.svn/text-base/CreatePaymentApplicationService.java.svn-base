 ...
 * 
        ...
        .
 * Auto generated base service entity createPaymentApplication.
 *
 * Engine: java
...
public class CreatePaymentApplicationService extends ServiceWrapper {
    ...
    public static final String NAME = "createPaymentApplication";
    ...
    public static enum In {
        ...
        checkForOverApplication("checkForOverApplication"),
        invoiceId("invoiceId"),
    ...
    /**
     * Creates a new <code>CreatePaymentApplicationService</code> instance.
     */
     ...
     */
    public CreatePaymentApplicationService(User user) {
        super(user);
    }
    ...
    private Boolean inCheckForOverApplication;
    ...
    private String outPaymentApplicationId;
     ...
     */
    public Boolean getInCheckForOverApplication() {
        return this.inCheckForOverApplication;
    }
    /**
     * Auto generated value accessor.
     * This parameter is optional.
     ...
     * @return <code>String</code>
     */
    public String getOutPaymentApplicationId() {
        return this.outPaymentApplicationId;
    }
    /**
     * Auto generated value accessor.
     * This parameter is optional.
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is optional.
     * @param inCheckForOverApplication the inCheckForOverApplication to set
    */
    public void setInCheckForOverApplication(Boolean inCheckForOverApplication) {
        this.inParameters.add("checkForOverApplication");
        this.inCheckForOverApplication = inCheckForOverApplication;
    }
    /**
     * Auto generated value setter.
     * This parameter is optional.
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is required.
     * @param outPaymentApplicationId the outPaymentApplicationId to set
    */
    public void setOutPaymentApplicationId(String outPaymentApplicationId) {
        this.outParameters.add("paymentApplicationId");
        this.outPaymentApplicationId = outPaymentApplicationId;
    }
    /**
     * Auto generated value setter.
     * This parameter is optional.
    ...
    */
    ...
    public Map<String, Object> inputMap() {
        ...
        if (inParameters.contains("checkForOverApplication")) mapValue.put("checkForOverApplication", getInCheckForOverApplication());
    ...
    public Map<String, Object> outputMap() {
        ...
        if (outParameters.contains("paymentApplicationId")) mapValue.put("paymentApplicationId", getOutPaymentApplicationId());
    ...
    public void putAllInput(Map<String, Object> mapValue) {
        ...
        if (mapValue.containsKey("checkForOverApplication")) setInCheckForOverApplication((Boolean) mapValue.get("checkForOverApplication"));
    ...
    public void putAllOutput(Map<String, Object> mapValue) {
        ...
        if (mapValue.containsKey("paymentApplicationId")) setOutPaymentApplicationId((String) mapValue.get("paymentApplicationId"));
    ...
    /**
     * Construct a <code>CreatePaymentApplicationService</code> from the input values of the given <code>CreatePaymentApplicationService</code>.
     * @param input a <code>CreatePaymentApplicationService</code>
     */
    public static CreatePaymentApplicationService fromInput(CreatePaymentApplicationService input) {
        CreatePaymentApplicationService service = new CreatePaymentApplicationService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreatePaymentApplicationService</code> from the output values of the given <code>CreatePaymentApplicationService</code>.
     * @param output a <code>CreatePaymentApplicationService</code>
     */
    public static CreatePaymentApplicationService fromOutput(CreatePaymentApplicationService output) {
        CreatePaymentApplicationService service = new CreatePaymentApplicationService();
    ...
    /**
     * Construct a <code>CreatePaymentApplicationService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePaymentApplicationService fromInput(Map<String, Object> mapValue) {
        CreatePaymentApplicationService service = new CreatePaymentApplicationService();
    ...
    /**
     * Construct a <code>CreatePaymentApplicationService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePaymentApplicationService fromOutput(Map<String, Object> mapValue) {
        CreatePaymentApplicationService service = new CreatePaymentApplicationService();
