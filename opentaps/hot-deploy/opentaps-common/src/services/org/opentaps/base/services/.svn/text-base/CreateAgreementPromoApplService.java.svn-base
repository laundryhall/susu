 ...
 * Auto generated base service entity createAgreementPromoAppl.
 *
 * Engine: simple
 ...
 */
public class CreateAgreementPromoApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createAgreementPromoAppl";
    ...
    /**
     * Creates a new <code>CreateAgreementPromoApplService</code> instance.
     */
    public CreateAgreementPromoApplService() {
        super();
    }
     ...
     */
    public CreateAgreementPromoApplService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateAgreementPromoApplService</code> from the input values of the given <code>CreateAgreementPromoApplService</code>.
     * @param input a <code>CreateAgreementPromoApplService</code>
     */
    public static CreateAgreementPromoApplService fromInput(CreateAgreementPromoApplService input) {
        CreateAgreementPromoApplService service = new CreateAgreementPromoApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateAgreementPromoApplService</code> from the output values of the given <code>CreateAgreementPromoApplService</code>.
     * @param output a <code>CreateAgreementPromoApplService</code>
     */
    public static CreateAgreementPromoApplService fromOutput(CreateAgreementPromoApplService output) {
        CreateAgreementPromoApplService service = new CreateAgreementPromoApplService();
    ...
    /**
     * Construct a <code>CreateAgreementPromoApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateAgreementPromoApplService fromInput(Map<String, Object> mapValue) {
        CreateAgreementPromoApplService service = new CreateAgreementPromoApplService();
    ...
    /**
     * Construct a <code>CreateAgreementPromoApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateAgreementPromoApplService fromOutput(Map<String, Object> mapValue) {
        CreateAgreementPromoApplService service = new CreateAgreementPromoApplService();
