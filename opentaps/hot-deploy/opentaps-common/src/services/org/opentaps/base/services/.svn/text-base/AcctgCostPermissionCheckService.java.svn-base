 ...
 * Auto generated base service entity acctgCostPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class AcctgCostPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "acctgCostPermissionCheck";
    ...
    /**
     * Creates a new <code>AcctgCostPermissionCheckService</code> instance.
     */
    public AcctgCostPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AcctgCostPermissionCheckService</code> from the input values of the given <code>AcctgCostPermissionCheckService</code>.
     * @param input a <code>AcctgCostPermissionCheckService</code>
     */
    public static AcctgCostPermissionCheckService fromInput(AcctgCostPermissionCheckService input) {
        AcctgCostPermissionCheckService service = new AcctgCostPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AcctgCostPermissionCheckService</code> from the output values of the given <code>AcctgCostPermissionCheckService</code>.
     * @param output a <code>AcctgCostPermissionCheckService</code>
     */
    public static AcctgCostPermissionCheckService fromOutput(AcctgCostPermissionCheckService output) {
        AcctgCostPermissionCheckService service = new AcctgCostPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgCostPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AcctgCostPermissionCheckService fromInput(Map<String, Object> mapValue) {
        AcctgCostPermissionCheckService service = new AcctgCostPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgCostPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AcctgCostPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        AcctgCostPermissionCheckService service = new AcctgCostPermissionCheckService();
