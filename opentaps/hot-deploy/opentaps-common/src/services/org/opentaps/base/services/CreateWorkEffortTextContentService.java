 ...
 * Auto generated base service entity createWorkEffortTextContent.
 *
 * Engine: group
 * Location: 
 * Invoke: _createWorkEffortTextContent.group
 * Defined in: applications/workeffort/servicedef/services.xml
 */
public class CreateWorkEffortTextContentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createWorkEffortTextContent";
    ...
    /**
     * Creates a new <code>CreateWorkEffortTextContentService</code> instance.
     */
    public CreateWorkEffortTextContentService() {
        super();
    }
     ...
     */
    public CreateWorkEffortTextContentService(User user) {
        super(user);
    }
    ...
    private String inWorkEffortContentTypeId;
     ...
     * @return <code>String</code>
     */
    public String getInWorkEffortContentTypeId() {
        return this.inWorkEffortContentTypeId;
    }
    /**
     * Auto generated value accessor.
     * This parameter is required.
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is required.
     * @param inWorkEffortContentTypeId the inWorkEffortContentTypeId to set
    */
    public void setInWorkEffortContentTypeId(String inWorkEffortContentTypeId) {
        this.inParameters.add("workEffortContentTypeId");
        this.inWorkEffortContentTypeId = inWorkEffortContentTypeId;
    }
    /**
     * Auto generated value setter.
     * This parameter is required.
    ...
    */
    ...
    public void putAllInput(Map<String, Object> mapValue) {
        ...
        if (mapValue.containsKey("workEffortContentTypeId")) setInWorkEffortContentTypeId((String) mapValue.get("workEffortContentTypeId"));
    ...
    /**
     * Construct a <code>CreateWorkEffortTextContentService</code> from the input values of the given <code>CreateWorkEffortTextContentService</code>.
     * @param input a <code>CreateWorkEffortTextContentService</code>
     */
    public static CreateWorkEffortTextContentService fromInput(CreateWorkEffortTextContentService input) {
        CreateWorkEffortTextContentService service = new CreateWorkEffortTextContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateWorkEffortTextContentService</code> from the output values of the given <code>CreateWorkEffortTextContentService</code>.
     * @param output a <code>CreateWorkEffortTextContentService</code>
     */
    public static CreateWorkEffortTextContentService fromOutput(CreateWorkEffortTextContentService output) {
        CreateWorkEffortTextContentService service = new CreateWorkEffortTextContentService();
    ...
    /**
     * Construct a <code>CreateWorkEffortTextContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateWorkEffortTextContentService fromInput(Map<String, Object> mapValue) {
        CreateWorkEffortTextContentService service = new CreateWorkEffortTextContentService();
    ...
    /**
     * Construct a <code>CreateWorkEffortTextContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateWorkEffortTextContentService fromOutput(Map<String, Object> mapValue) {
        CreateWorkEffortTextContentService service = new CreateWorkEffortTextContentService();
