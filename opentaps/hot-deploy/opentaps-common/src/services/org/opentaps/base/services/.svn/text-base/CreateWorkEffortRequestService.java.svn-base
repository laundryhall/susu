 ...
 * Auto generated base service entity createWorkEffortRequest.
 *
 * Engine: simple
 ...
 */
public class CreateWorkEffortRequestService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createWorkEffortRequest";
    ...
    /**
     * Creates a new <code>CreateWorkEffortRequestService</code> instance.
     */
    public CreateWorkEffortRequestService() {
        super();
    }
     ...
     */
    public CreateWorkEffortRequestService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateWorkEffortRequestService</code> from the input values of the given <code>CreateWorkEffortRequestService</code>.
     * @param input a <code>CreateWorkEffortRequestService</code>
     */
    public static CreateWorkEffortRequestService fromInput(CreateWorkEffortRequestService input) {
        CreateWorkEffortRequestService service = new CreateWorkEffortRequestService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateWorkEffortRequestService</code> from the output values of the given <code>CreateWorkEffortRequestService</code>.
     * @param output a <code>CreateWorkEffortRequestService</code>
     */
    public static CreateWorkEffortRequestService fromOutput(CreateWorkEffortRequestService output) {
        CreateWorkEffortRequestService service = new CreateWorkEffortRequestService();
    ...
    /**
     * Construct a <code>CreateWorkEffortRequestService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateWorkEffortRequestService fromInput(Map<String, Object> mapValue) {
        CreateWorkEffortRequestService service = new CreateWorkEffortRequestService();
    ...
    /**
     * Construct a <code>CreateWorkEffortRequestService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateWorkEffortRequestService fromOutput(Map<String, Object> mapValue) {
        CreateWorkEffortRequestService service = new CreateWorkEffortRequestService();
