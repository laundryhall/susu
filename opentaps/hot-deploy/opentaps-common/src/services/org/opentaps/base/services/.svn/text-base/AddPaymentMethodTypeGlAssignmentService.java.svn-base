 ...
 * Auto generated base service entity addPaymentMethodTypeGlAssignment.
 *
 * Engine: entity-auto
 * Location: 
 * Invoke: create
 ...
 */
public class AddPaymentMethodTypeGlAssignmentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "addPaymentMethodTypeGlAssignment";
    ...
    /**
     * Creates a new <code>AddPaymentMethodTypeGlAssignmentService</code> instance.
     */
    public AddPaymentMethodTypeGlAssignmentService() {
        super();
    }
     ...
     */
    public AddPaymentMethodTypeGlAssignmentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>AddPaymentMethodTypeGlAssignmentService</code> from the input values of the given <code>AddPaymentMethodTypeGlAssignmentService</code>.
     * @param input a <code>AddPaymentMethodTypeGlAssignmentService</code>
     */
    public static AddPaymentMethodTypeGlAssignmentService fromInput(AddPaymentMethodTypeGlAssignmentService input) {
        AddPaymentMethodTypeGlAssignmentService service = new AddPaymentMethodTypeGlAssignmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AddPaymentMethodTypeGlAssignmentService</code> from the output values of the given <code>AddPaymentMethodTypeGlAssignmentService</code>.
     * @param output a <code>AddPaymentMethodTypeGlAssignmentService</code>
     */
    public static AddPaymentMethodTypeGlAssignmentService fromOutput(AddPaymentMethodTypeGlAssignmentService output) {
        AddPaymentMethodTypeGlAssignmentService service = new AddPaymentMethodTypeGlAssignmentService();
    ...
    /**
     * Construct a <code>AddPaymentMethodTypeGlAssignmentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AddPaymentMethodTypeGlAssignmentService fromInput(Map<String, Object> mapValue) {
        AddPaymentMethodTypeGlAssignmentService service = new AddPaymentMethodTypeGlAssignmentService();
    ...
    /**
     * Construct a <code>AddPaymentMethodTypeGlAssignmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AddPaymentMethodTypeGlAssignmentService fromOutput(Map<String, Object> mapValue) {
        AddPaymentMethodTypeGlAssignmentService service = new AddPaymentMethodTypeGlAssignmentService();
