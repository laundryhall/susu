 ...
 * Auto generated base service entity updateCommEventContentAssoc.
 *
 * Engine: simple
 ...
 */
public class UpdateCommEventContentAssocService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateCommEventContentAssoc";
    ...
    /**
     * Creates a new <code>UpdateCommEventContentAssocService</code> instance.
     */
    public UpdateCommEventContentAssocService() {
        super();
    }
     ...
     */
    public UpdateCommEventContentAssocService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateCommEventContentAssocService</code> from the input values of the given <code>UpdateCommEventContentAssocService</code>.
     * @param input a <code>UpdateCommEventContentAssocService</code>
     */
    public static UpdateCommEventContentAssocService fromInput(UpdateCommEventContentAssocService input) {
        UpdateCommEventContentAssocService service = new UpdateCommEventContentAssocService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateCommEventContentAssocService</code> from the output values of the given <code>UpdateCommEventContentAssocService</code>.
     * @param output a <code>UpdateCommEventContentAssocService</code>
     */
    public static UpdateCommEventContentAssocService fromOutput(UpdateCommEventContentAssocService output) {
        UpdateCommEventContentAssocService service = new UpdateCommEventContentAssocService();
    ...
    /**
     * Construct a <code>UpdateCommEventContentAssocService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateCommEventContentAssocService fromInput(Map<String, Object> mapValue) {
        UpdateCommEventContentAssocService service = new UpdateCommEventContentAssocService();
    ...
    /**
     * Construct a <code>UpdateCommEventContentAssocService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateCommEventContentAssocService fromOutput(Map<String, Object> mapValue) {
        UpdateCommEventContentAssocService service = new UpdateCommEventContentAssocService();
