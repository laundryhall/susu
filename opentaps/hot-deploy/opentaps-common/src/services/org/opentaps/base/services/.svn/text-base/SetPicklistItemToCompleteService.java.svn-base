 ...
 * Auto generated base service entity setPicklistItemToComplete.
 *
 * Engine: simple
 ...
 */
public class SetPicklistItemToCompleteService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "setPicklistItemToComplete";
    ...
    /**
     * Creates a new <code>SetPicklistItemToCompleteService</code> instance.
     */
    public SetPicklistItemToCompleteService() {
        super();
    }
     ...
     */
    public SetPicklistItemToCompleteService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>SetPicklistItemToCompleteService</code> from the input values of the given <code>SetPicklistItemToCompleteService</code>.
     * @param input a <code>SetPicklistItemToCompleteService</code>
     */
    public static SetPicklistItemToCompleteService fromInput(SetPicklistItemToCompleteService input) {
        SetPicklistItemToCompleteService service = new SetPicklistItemToCompleteService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>SetPicklistItemToCompleteService</code> from the output values of the given <code>SetPicklistItemToCompleteService</code>.
     * @param output a <code>SetPicklistItemToCompleteService</code>
     */
    public static SetPicklistItemToCompleteService fromOutput(SetPicklistItemToCompleteService output) {
        SetPicklistItemToCompleteService service = new SetPicklistItemToCompleteService();
    ...
    /**
     * Construct a <code>SetPicklistItemToCompleteService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SetPicklistItemToCompleteService fromInput(Map<String, Object> mapValue) {
        SetPicklistItemToCompleteService service = new SetPicklistItemToCompleteService();
    ...
    /**
     * Construct a <code>SetPicklistItemToCompleteService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SetPicklistItemToCompleteService fromOutput(Map<String, Object> mapValue) {
        SetPicklistItemToCompleteService service = new SetPicklistItemToCompleteService();
