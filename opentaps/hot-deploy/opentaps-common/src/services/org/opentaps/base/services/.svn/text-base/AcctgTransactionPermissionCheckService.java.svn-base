 ...
 * Auto generated base service entity acctgTransactionPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class AcctgTransactionPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "acctgTransactionPermissionCheck";
    ...
    /**
     * Creates a new <code>AcctgTransactionPermissionCheckService</code> instance.
     */
    public AcctgTransactionPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AcctgTransactionPermissionCheckService</code> from the input values of the given <code>AcctgTransactionPermissionCheckService</code>.
     * @param input a <code>AcctgTransactionPermissionCheckService</code>
     */
    public static AcctgTransactionPermissionCheckService fromInput(AcctgTransactionPermissionCheckService input) {
        AcctgTransactionPermissionCheckService service = new AcctgTransactionPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AcctgTransactionPermissionCheckService</code> from the output values of the given <code>AcctgTransactionPermissionCheckService</code>.
     * @param output a <code>AcctgTransactionPermissionCheckService</code>
     */
    public static AcctgTransactionPermissionCheckService fromOutput(AcctgTransactionPermissionCheckService output) {
        AcctgTransactionPermissionCheckService service = new AcctgTransactionPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgTransactionPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AcctgTransactionPermissionCheckService fromInput(Map<String, Object> mapValue) {
        AcctgTransactionPermissionCheckService service = new AcctgTransactionPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgTransactionPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AcctgTransactionPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        AcctgTransactionPermissionCheckService service = new AcctgTransactionPermissionCheckService();
