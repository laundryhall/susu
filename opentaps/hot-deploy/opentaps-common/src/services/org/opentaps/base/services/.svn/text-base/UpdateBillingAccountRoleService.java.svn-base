 ...
 * Auto generated base service entity updateBillingAccountRole.
 *
 * Engine: simple
 ...
 */
public class UpdateBillingAccountRoleService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateBillingAccountRole";
    ...
    /**
     * Creates a new <code>UpdateBillingAccountRoleService</code> instance.
     */
    public UpdateBillingAccountRoleService() {
        super();
    }
     ...
     */
    public UpdateBillingAccountRoleService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateBillingAccountRoleService</code> from the input values of the given <code>UpdateBillingAccountRoleService</code>.
     * @param input a <code>UpdateBillingAccountRoleService</code>
     */
    public static UpdateBillingAccountRoleService fromInput(UpdateBillingAccountRoleService input) {
        UpdateBillingAccountRoleService service = new UpdateBillingAccountRoleService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateBillingAccountRoleService</code> from the output values of the given <code>UpdateBillingAccountRoleService</code>.
     * @param output a <code>UpdateBillingAccountRoleService</code>
     */
    public static UpdateBillingAccountRoleService fromOutput(UpdateBillingAccountRoleService output) {
        UpdateBillingAccountRoleService service = new UpdateBillingAccountRoleService();
    ...
    /**
     * Construct a <code>UpdateBillingAccountRoleService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateBillingAccountRoleService fromInput(Map<String, Object> mapValue) {
        UpdateBillingAccountRoleService service = new UpdateBillingAccountRoleService();
    ...
    /**
     * Construct a <code>UpdateBillingAccountRoleService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateBillingAccountRoleService fromOutput(Map<String, Object> mapValue) {
        UpdateBillingAccountRoleService service = new UpdateBillingAccountRoleService();
