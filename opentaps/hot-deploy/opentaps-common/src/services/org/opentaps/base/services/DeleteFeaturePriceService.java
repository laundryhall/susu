 ...
 * Auto generated base service entity deleteFeaturePrice.
 *
 * Engine: simple
 * Location: component://product/script/org/ofbiz/product/feature/ProductFeatureServices.xml
 * Invoke: deleteFeaturePrice
 * Defined in: applications/product/servicedef/services_feature.xml
 */
public class DeleteFeaturePriceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteFeaturePrice";
    ...
    /**
     * Creates a new <code>DeleteFeaturePriceService</code> instance.
     */
    public DeleteFeaturePriceService() {
        super();
    }
     ...
     */
    public DeleteFeaturePriceService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteFeaturePriceService</code> from the input values of the given <code>DeleteFeaturePriceService</code>.
     * @param input a <code>DeleteFeaturePriceService</code>
     */
    public static DeleteFeaturePriceService fromInput(DeleteFeaturePriceService input) {
        DeleteFeaturePriceService service = new DeleteFeaturePriceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteFeaturePriceService</code> from the output values of the given <code>DeleteFeaturePriceService</code>.
     * @param output a <code>DeleteFeaturePriceService</code>
     */
    public static DeleteFeaturePriceService fromOutput(DeleteFeaturePriceService output) {
        DeleteFeaturePriceService service = new DeleteFeaturePriceService();
    ...
    /**
     * Construct a <code>DeleteFeaturePriceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteFeaturePriceService fromInput(Map<String, Object> mapValue) {
        DeleteFeaturePriceService service = new DeleteFeaturePriceService();
    ...
    /**
     * Construct a <code>DeleteFeaturePriceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteFeaturePriceService fromOutput(Map<String, Object> mapValue) {
        DeleteFeaturePriceService service = new DeleteFeaturePriceService();
