 ...
 * Auto generated base service entity alwaysBadExpireCCProcessor.
 *
 * Engine: java
 ...
 */
public class AlwaysBadExpireCCProcessorService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "alwaysBadExpireCCProcessor";
    ...
    /**
     * Creates a new <code>AlwaysBadExpireCCProcessorService</code> instance.
     */
    public AlwaysBadExpireCCProcessorService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AlwaysBadExpireCCProcessorService</code> from the input values of the given <code>AlwaysBadExpireCCProcessorService</code>.
     * @param input a <code>AlwaysBadExpireCCProcessorService</code>
     */
    public static AlwaysBadExpireCCProcessorService fromInput(AlwaysBadExpireCCProcessorService input) {
        AlwaysBadExpireCCProcessorService service = new AlwaysBadExpireCCProcessorService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AlwaysBadExpireCCProcessorService</code> from the output values of the given <code>AlwaysBadExpireCCProcessorService</code>.
     * @param output a <code>AlwaysBadExpireCCProcessorService</code>
     */
    public static AlwaysBadExpireCCProcessorService fromOutput(AlwaysBadExpireCCProcessorService output) {
        AlwaysBadExpireCCProcessorService service = new AlwaysBadExpireCCProcessorService();
    ...
    /**
     * Construct a <code>AlwaysBadExpireCCProcessorService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AlwaysBadExpireCCProcessorService fromInput(Map<String, Object> mapValue) {
        AlwaysBadExpireCCProcessorService service = new AlwaysBadExpireCCProcessorService();
    ...
    /**
     * Construct a <code>AlwaysBadExpireCCProcessorService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AlwaysBadExpireCCProcessorService fromOutput(Map<String, Object> mapValue) {
        AlwaysBadExpireCCProcessorService service = new AlwaysBadExpireCCProcessorService();
