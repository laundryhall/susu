 ...
 * Auto generated base service entity acctgAgreementPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class AcctgAgreementPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "acctgAgreementPermissionCheck";
    ...
    /**
     * Creates a new <code>AcctgAgreementPermissionCheckService</code> instance.
     */
    public AcctgAgreementPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AcctgAgreementPermissionCheckService</code> from the input values of the given <code>AcctgAgreementPermissionCheckService</code>.
     * @param input a <code>AcctgAgreementPermissionCheckService</code>
     */
    public static AcctgAgreementPermissionCheckService fromInput(AcctgAgreementPermissionCheckService input) {
        AcctgAgreementPermissionCheckService service = new AcctgAgreementPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AcctgAgreementPermissionCheckService</code> from the output values of the given <code>AcctgAgreementPermissionCheckService</code>.
     * @param output a <code>AcctgAgreementPermissionCheckService</code>
     */
    public static AcctgAgreementPermissionCheckService fromOutput(AcctgAgreementPermissionCheckService output) {
        AcctgAgreementPermissionCheckService service = new AcctgAgreementPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgAgreementPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AcctgAgreementPermissionCheckService fromInput(Map<String, Object> mapValue) {
        AcctgAgreementPermissionCheckService service = new AcctgAgreementPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgAgreementPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AcctgAgreementPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        AcctgAgreementPermissionCheckService service = new AcctgAgreementPermissionCheckService();
