 ...
 * Auto generated base service entity createTextAndUploadedContent.
 *
 * Engine: simple
 ...
 */
public class CreateTextAndUploadedContentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createTextAndUploadedContent";
    ...
    /**
     * Creates a new <code>CreateTextAndUploadedContentService</code> instance.
     */
    public CreateTextAndUploadedContentService() {
        super();
    }
     ...
     */
    public CreateTextAndUploadedContentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateTextAndUploadedContentService</code> from the input values of the given <code>CreateTextAndUploadedContentService</code>.
     * @param input a <code>CreateTextAndUploadedContentService</code>
     */
    public static CreateTextAndUploadedContentService fromInput(CreateTextAndUploadedContentService input) {
        CreateTextAndUploadedContentService service = new CreateTextAndUploadedContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateTextAndUploadedContentService</code> from the output values of the given <code>CreateTextAndUploadedContentService</code>.
     * @param output a <code>CreateTextAndUploadedContentService</code>
     */
    public static CreateTextAndUploadedContentService fromOutput(CreateTextAndUploadedContentService output) {
        CreateTextAndUploadedContentService service = new CreateTextAndUploadedContentService();
    ...
    /**
     * Construct a <code>CreateTextAndUploadedContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateTextAndUploadedContentService fromInput(Map<String, Object> mapValue) {
        CreateTextAndUploadedContentService service = new CreateTextAndUploadedContentService();
    ...
    /**
     * Construct a <code>CreateTextAndUploadedContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateTextAndUploadedContentService fromOutput(Map<String, Object> mapValue) {
        CreateTextAndUploadedContentService service = new CreateTextAndUploadedContentService();
