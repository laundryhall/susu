 ...
 * Auto generated base service entity createCommEventContentAssoc.
 *
 * Engine: simple
 ...
 */
public class CreateCommEventContentAssocService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createCommEventContentAssoc";
    ...
    /**
     * Creates a new <code>CreateCommEventContentAssocService</code> instance.
     */
    public CreateCommEventContentAssocService() {
        super();
    }
     ...
     */
    public CreateCommEventContentAssocService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateCommEventContentAssocService</code> from the input values of the given <code>CreateCommEventContentAssocService</code>.
     * @param input a <code>CreateCommEventContentAssocService</code>
     */
    public static CreateCommEventContentAssocService fromInput(CreateCommEventContentAssocService input) {
        CreateCommEventContentAssocService service = new CreateCommEventContentAssocService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateCommEventContentAssocService</code> from the output values of the given <code>CreateCommEventContentAssocService</code>.
     * @param output a <code>CreateCommEventContentAssocService</code>
     */
    public static CreateCommEventContentAssocService fromOutput(CreateCommEventContentAssocService output) {
        CreateCommEventContentAssocService service = new CreateCommEventContentAssocService();
    ...
    /**
     * Construct a <code>CreateCommEventContentAssocService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCommEventContentAssocService fromInput(Map<String, Object> mapValue) {
        CreateCommEventContentAssocService service = new CreateCommEventContentAssocService();
    ...
    /**
     * Construct a <code>CreateCommEventContentAssocService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCommEventContentAssocService fromOutput(Map<String, Object> mapValue) {
        CreateCommEventContentAssocService service = new CreateCommEventContentAssocService();
