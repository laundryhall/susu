 ...
 * Auto generated base service entity crmsfa.prepareQuoteEmail.
 *
 * Engine: java
...
public class CrmsfaPrepareQuoteEmailService extends ServiceWrapper {
    ...
    public static final String NAME = "crmsfa.prepareQuoteEmail";
    ...
    /**
     * Creates a new <code>CrmsfaPrepareQuoteEmailService</code> instance.
     */
    public CrmsfaPrepareQuoteEmailService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaPrepareQuoteEmailService</code> from the input values of the given <code>CrmsfaPrepareQuoteEmailService</code>.
     * @param input a <code>CrmsfaPrepareQuoteEmailService</code>
     */
    public static CrmsfaPrepareQuoteEmailService fromInput(CrmsfaPrepareQuoteEmailService input) {
        CrmsfaPrepareQuoteEmailService service = new CrmsfaPrepareQuoteEmailService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaPrepareQuoteEmailService</code> from the output values of the given <code>CrmsfaPrepareQuoteEmailService</code>.
     * @param output a <code>CrmsfaPrepareQuoteEmailService</code>
     */
    public static CrmsfaPrepareQuoteEmailService fromOutput(CrmsfaPrepareQuoteEmailService output) {
        CrmsfaPrepareQuoteEmailService service = new CrmsfaPrepareQuoteEmailService();
    ...
    /**
     * Construct a <code>CrmsfaPrepareQuoteEmailService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaPrepareQuoteEmailService fromInput(Map<String, Object> mapValue) {
        CrmsfaPrepareQuoteEmailService service = new CrmsfaPrepareQuoteEmailService();
    ...
    /**
     * Construct a <code>CrmsfaPrepareQuoteEmailService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaPrepareQuoteEmailService fromOutput(Map<String, Object> mapValue) {
        CrmsfaPrepareQuoteEmailService service = new CrmsfaPrepareQuoteEmailService();
