 ...
 * Auto generated base service entity alwaysApproveEFTProcessor.
 *
 * Engine: java
 ...
 */
public class AlwaysApproveEFTProcessorService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "alwaysApproveEFTProcessor";
    ...
    /**
     * Creates a new <code>AlwaysApproveEFTProcessorService</code> instance.
     */
    public AlwaysApproveEFTProcessorService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AlwaysApproveEFTProcessorService</code> from the input values of the given <code>AlwaysApproveEFTProcessorService</code>.
     * @param input a <code>AlwaysApproveEFTProcessorService</code>
     */
    public static AlwaysApproveEFTProcessorService fromInput(AlwaysApproveEFTProcessorService input) {
        AlwaysApproveEFTProcessorService service = new AlwaysApproveEFTProcessorService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AlwaysApproveEFTProcessorService</code> from the output values of the given <code>AlwaysApproveEFTProcessorService</code>.
     * @param output a <code>AlwaysApproveEFTProcessorService</code>
     */
    public static AlwaysApproveEFTProcessorService fromOutput(AlwaysApproveEFTProcessorService output) {
        AlwaysApproveEFTProcessorService service = new AlwaysApproveEFTProcessorService();
    ...
    /**
     * Construct a <code>AlwaysApproveEFTProcessorService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AlwaysApproveEFTProcessorService fromInput(Map<String, Object> mapValue) {
        AlwaysApproveEFTProcessorService service = new AlwaysApproveEFTProcessorService();
    ...
    /**
     * Construct a <code>AlwaysApproveEFTProcessorService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AlwaysApproveEFTProcessorService fromOutput(Map<String, Object> mapValue) {
        AlwaysApproveEFTProcessorService service = new AlwaysApproveEFTProcessorService();
