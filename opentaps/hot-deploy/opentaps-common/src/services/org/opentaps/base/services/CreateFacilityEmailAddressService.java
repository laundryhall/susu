 ...
 * Auto generated base service entity createFacilityEmailAddress.
 *
 * Engine: simple
 ...
 */
public class CreateFacilityEmailAddressService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createFacilityEmailAddress";
    ...
    /**
     * Creates a new <code>CreateFacilityEmailAddressService</code> instance.
     */
    public CreateFacilityEmailAddressService() {
        super();
    }
     ...
     */
    public CreateFacilityEmailAddressService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateFacilityEmailAddressService</code> from the input values of the given <code>CreateFacilityEmailAddressService</code>.
     * @param input a <code>CreateFacilityEmailAddressService</code>
     */
    public static CreateFacilityEmailAddressService fromInput(CreateFacilityEmailAddressService input) {
        CreateFacilityEmailAddressService service = new CreateFacilityEmailAddressService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateFacilityEmailAddressService</code> from the output values of the given <code>CreateFacilityEmailAddressService</code>.
     * @param output a <code>CreateFacilityEmailAddressService</code>
     */
    public static CreateFacilityEmailAddressService fromOutput(CreateFacilityEmailAddressService output) {
        CreateFacilityEmailAddressService service = new CreateFacilityEmailAddressService();
    ...
    /**
     * Construct a <code>CreateFacilityEmailAddressService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFacilityEmailAddressService fromInput(Map<String, Object> mapValue) {
        CreateFacilityEmailAddressService service = new CreateFacilityEmailAddressService();
    ...
    /**
     * Construct a <code>CreateFacilityEmailAddressService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFacilityEmailAddressService fromOutput(Map<String, Object> mapValue) {
        CreateFacilityEmailAddressService service = new CreateFacilityEmailAddressService();
