 ...
 * Auto generated base service entity prodCatalogToPartyPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class ProdCatalogToPartyPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "prodCatalogToPartyPermissionCheck";
    ...
    /**
     * Creates a new <code>ProdCatalogToPartyPermissionCheckService</code> instance.
     */
    public ProdCatalogToPartyPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>ProdCatalogToPartyPermissionCheckService</code> from the input values of the given <code>ProdCatalogToPartyPermissionCheckService</code>.
     * @param input a <code>ProdCatalogToPartyPermissionCheckService</code>
     */
    public static ProdCatalogToPartyPermissionCheckService fromInput(ProdCatalogToPartyPermissionCheckService input) {
        ProdCatalogToPartyPermissionCheckService service = new ProdCatalogToPartyPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>ProdCatalogToPartyPermissionCheckService</code> from the output values of the given <code>ProdCatalogToPartyPermissionCheckService</code>.
     * @param output a <code>ProdCatalogToPartyPermissionCheckService</code>
     */
    public static ProdCatalogToPartyPermissionCheckService fromOutput(ProdCatalogToPartyPermissionCheckService output) {
        ProdCatalogToPartyPermissionCheckService service = new ProdCatalogToPartyPermissionCheckService();
    ...
    /**
     * Construct a <code>ProdCatalogToPartyPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ProdCatalogToPartyPermissionCheckService fromInput(Map<String, Object> mapValue) {
        ProdCatalogToPartyPermissionCheckService service = new ProdCatalogToPartyPermissionCheckService();
    ...
    /**
     * Construct a <code>ProdCatalogToPartyPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ProdCatalogToPartyPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        ProdCatalogToPartyPermissionCheckService service = new ProdCatalogToPartyPermissionCheckService();
