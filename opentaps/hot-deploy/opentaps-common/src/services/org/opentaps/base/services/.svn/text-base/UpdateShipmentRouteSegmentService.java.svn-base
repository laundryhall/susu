 ...
 * Auto generated base service entity updateShipmentRouteSegment.
 *
 * Engine: simple
 ...
 */
public class UpdateShipmentRouteSegmentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateShipmentRouteSegment";
    ...
    /**
     * Creates a new <code>UpdateShipmentRouteSegmentService</code> instance.
     */
    public UpdateShipmentRouteSegmentService() {
        super();
    }
     ...
     */
    public UpdateShipmentRouteSegmentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateShipmentRouteSegmentService</code> from the input values of the given <code>UpdateShipmentRouteSegmentService</code>.
     * @param input a <code>UpdateShipmentRouteSegmentService</code>
     */
    public static UpdateShipmentRouteSegmentService fromInput(UpdateShipmentRouteSegmentService input) {
        UpdateShipmentRouteSegmentService service = new UpdateShipmentRouteSegmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateShipmentRouteSegmentService</code> from the output values of the given <code>UpdateShipmentRouteSegmentService</code>.
     * @param output a <code>UpdateShipmentRouteSegmentService</code>
     */
    public static UpdateShipmentRouteSegmentService fromOutput(UpdateShipmentRouteSegmentService output) {
        UpdateShipmentRouteSegmentService service = new UpdateShipmentRouteSegmentService();
    ...
    /**
     * Construct a <code>UpdateShipmentRouteSegmentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateShipmentRouteSegmentService fromInput(Map<String, Object> mapValue) {
        UpdateShipmentRouteSegmentService service = new UpdateShipmentRouteSegmentService();
    ...
    /**
     * Construct a <code>UpdateShipmentRouteSegmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateShipmentRouteSegmentService fromOutput(Map<String, Object> mapValue) {
        UpdateShipmentRouteSegmentService service = new UpdateShipmentRouteSegmentService();
