 ...
 * Auto generated base service entity updateTaxAuthorityCategory.
 *
 * Engine: simple
 ...
 */
public class UpdateTaxAuthorityCategoryService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateTaxAuthorityCategory";
    ...
    /**
     * Creates a new <code>UpdateTaxAuthorityCategoryService</code> instance.
     */
    public UpdateTaxAuthorityCategoryService() {
        super();
    }
     ...
     */
    public UpdateTaxAuthorityCategoryService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityCategoryService</code> from the input values of the given <code>UpdateTaxAuthorityCategoryService</code>.
     * @param input a <code>UpdateTaxAuthorityCategoryService</code>
     */
    public static UpdateTaxAuthorityCategoryService fromInput(UpdateTaxAuthorityCategoryService input) {
        UpdateTaxAuthorityCategoryService service = new UpdateTaxAuthorityCategoryService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateTaxAuthorityCategoryService</code> from the output values of the given <code>UpdateTaxAuthorityCategoryService</code>.
     * @param output a <code>UpdateTaxAuthorityCategoryService</code>
     */
    public static UpdateTaxAuthorityCategoryService fromOutput(UpdateTaxAuthorityCategoryService output) {
        UpdateTaxAuthorityCategoryService service = new UpdateTaxAuthorityCategoryService();
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityCategoryService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateTaxAuthorityCategoryService fromInput(Map<String, Object> mapValue) {
        UpdateTaxAuthorityCategoryService service = new UpdateTaxAuthorityCategoryService();
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityCategoryService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateTaxAuthorityCategoryService fromOutput(Map<String, Object> mapValue) {
        UpdateTaxAuthorityCategoryService service = new UpdateTaxAuthorityCategoryService();
