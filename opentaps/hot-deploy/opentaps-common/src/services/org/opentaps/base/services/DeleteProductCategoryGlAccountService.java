 ...
 * Auto generated base service entity deleteProductCategoryGlAccount.
 *
 * Engine: simple
 ...
 */
public class DeleteProductCategoryGlAccountService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteProductCategoryGlAccount";
    ...
    /**
     * Creates a new <code>DeleteProductCategoryGlAccountService</code> instance.
     */
    public DeleteProductCategoryGlAccountService() {
        super();
    }
     ...
     */
    public DeleteProductCategoryGlAccountService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductCategoryGlAccountService</code> from the input values of the given <code>DeleteProductCategoryGlAccountService</code>.
     * @param input a <code>DeleteProductCategoryGlAccountService</code>
     */
    public static DeleteProductCategoryGlAccountService fromInput(DeleteProductCategoryGlAccountService input) {
        DeleteProductCategoryGlAccountService service = new DeleteProductCategoryGlAccountService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteProductCategoryGlAccountService</code> from the output values of the given <code>DeleteProductCategoryGlAccountService</code>.
     * @param output a <code>DeleteProductCategoryGlAccountService</code>
     */
    public static DeleteProductCategoryGlAccountService fromOutput(DeleteProductCategoryGlAccountService output) {
        DeleteProductCategoryGlAccountService service = new DeleteProductCategoryGlAccountService();
    ...
    /**
     * Construct a <code>DeleteProductCategoryGlAccountService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductCategoryGlAccountService fromInput(Map<String, Object> mapValue) {
        DeleteProductCategoryGlAccountService service = new DeleteProductCategoryGlAccountService();
    ...
    /**
     * Construct a <code>DeleteProductCategoryGlAccountService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductCategoryGlAccountService fromOutput(Map<String, Object> mapValue) {
        DeleteProductCategoryGlAccountService service = new DeleteProductCategoryGlAccountService();
