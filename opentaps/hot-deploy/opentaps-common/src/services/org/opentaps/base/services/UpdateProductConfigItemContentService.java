 ...
 * Auto generated base service entity updateProductConfigItemContent.
 *
 * Engine: simple
 ...
 */
public class UpdateProductConfigItemContentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateProductConfigItemContent";
    ...
    /**
     * Creates a new <code>UpdateProductConfigItemContentService</code> instance.
     */
    public UpdateProductConfigItemContentService() {
        super();
    }
     ...
     */
    public UpdateProductConfigItemContentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateProductConfigItemContentService</code> from the input values of the given <code>UpdateProductConfigItemContentService</code>.
     * @param input a <code>UpdateProductConfigItemContentService</code>
     */
    public static UpdateProductConfigItemContentService fromInput(UpdateProductConfigItemContentService input) {
        UpdateProductConfigItemContentService service = new UpdateProductConfigItemContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateProductConfigItemContentService</code> from the output values of the given <code>UpdateProductConfigItemContentService</code>.
     * @param output a <code>UpdateProductConfigItemContentService</code>
     */
    public static UpdateProductConfigItemContentService fromOutput(UpdateProductConfigItemContentService output) {
        UpdateProductConfigItemContentService service = new UpdateProductConfigItemContentService();
    ...
    /**
     * Construct a <code>UpdateProductConfigItemContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateProductConfigItemContentService fromInput(Map<String, Object> mapValue) {
        UpdateProductConfigItemContentService service = new UpdateProductConfigItemContentService();
    ...
    /**
     * Construct a <code>UpdateProductConfigItemContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateProductConfigItemContentService fromOutput(Map<String, Object> mapValue) {
        UpdateProductConfigItemContentService service = new UpdateProductConfigItemContentService();
