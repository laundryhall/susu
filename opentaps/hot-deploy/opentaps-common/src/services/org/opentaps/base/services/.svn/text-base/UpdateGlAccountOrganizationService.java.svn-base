 ...
 * Auto generated base service entity updateGlAccountOrganization.
 *
 * Engine: simple
 ...
 */
public class UpdateGlAccountOrganizationService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateGlAccountOrganization";
    ...
    /**
     * Creates a new <code>UpdateGlAccountOrganizationService</code> instance.
     */
    public UpdateGlAccountOrganizationService() {
        super();
    }
     ...
     */
    public UpdateGlAccountOrganizationService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateGlAccountOrganizationService</code> from the input values of the given <code>UpdateGlAccountOrganizationService</code>.
     * @param input a <code>UpdateGlAccountOrganizationService</code>
     */
    public static UpdateGlAccountOrganizationService fromInput(UpdateGlAccountOrganizationService input) {
        UpdateGlAccountOrganizationService service = new UpdateGlAccountOrganizationService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateGlAccountOrganizationService</code> from the output values of the given <code>UpdateGlAccountOrganizationService</code>.
     * @param output a <code>UpdateGlAccountOrganizationService</code>
     */
    public static UpdateGlAccountOrganizationService fromOutput(UpdateGlAccountOrganizationService output) {
        UpdateGlAccountOrganizationService service = new UpdateGlAccountOrganizationService();
    ...
    /**
     * Construct a <code>UpdateGlAccountOrganizationService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateGlAccountOrganizationService fromInput(Map<String, Object> mapValue) {
        UpdateGlAccountOrganizationService service = new UpdateGlAccountOrganizationService();
    ...
    /**
     * Construct a <code>UpdateGlAccountOrganizationService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateGlAccountOrganizationService fromOutput(Map<String, Object> mapValue) {
        UpdateGlAccountOrganizationService service = new UpdateGlAccountOrganizationService();
