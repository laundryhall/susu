 ...
 * Auto generated base service entity createReturnItemBilling.
 *
 * Engine: simple
 ...
 */
public class CreateReturnItemBillingService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createReturnItemBilling";
    ...
    /**
     * Creates a new <code>CreateReturnItemBillingService</code> instance.
     */
    public CreateReturnItemBillingService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateReturnItemBillingService</code> from the input values of the given <code>CreateReturnItemBillingService</code>.
     * @param input a <code>CreateReturnItemBillingService</code>
     */
    public static CreateReturnItemBillingService fromInput(CreateReturnItemBillingService input) {
        CreateReturnItemBillingService service = new CreateReturnItemBillingService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateReturnItemBillingService</code> from the output values of the given <code>CreateReturnItemBillingService</code>.
     * @param output a <code>CreateReturnItemBillingService</code>
     */
    public static CreateReturnItemBillingService fromOutput(CreateReturnItemBillingService output) {
        CreateReturnItemBillingService service = new CreateReturnItemBillingService();
    ...
    /**
     * Construct a <code>CreateReturnItemBillingService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>CreateReturnItemBillingService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateReturnItemBillingService fromOutput(Map<String, Object> mapValue) {
        CreateReturnItemBillingService service = new CreateReturnItemBillingService();
