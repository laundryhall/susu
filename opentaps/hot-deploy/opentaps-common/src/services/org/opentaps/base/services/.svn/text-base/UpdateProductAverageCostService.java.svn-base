 ...
 * Auto generated base service entity updateProductAverageCost.
 *
 * Engine: java
...
public class UpdateProductAverageCostService extends ServiceWrapper {
    ...
    public static final String NAME = "updateProductAverageCost";
    ...
    /**
     * Creates a new <code>UpdateProductAverageCostService</code> instance.
     */
    public UpdateProductAverageCostService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateProductAverageCostService</code> from the input values of the given <code>UpdateProductAverageCostService</code>.
     * @param input a <code>UpdateProductAverageCostService</code>
     */
    public static UpdateProductAverageCostService fromInput(UpdateProductAverageCostService input) {
        UpdateProductAverageCostService service = new UpdateProductAverageCostService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateProductAverageCostService</code> from the output values of the given <code>UpdateProductAverageCostService</code>.
     * @param output a <code>UpdateProductAverageCostService</code>
     */
    public static UpdateProductAverageCostService fromOutput(UpdateProductAverageCostService output) {
        UpdateProductAverageCostService service = new UpdateProductAverageCostService();
    ...
    /**
     * Construct a <code>UpdateProductAverageCostService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateProductAverageCostService fromInput(Map<String, Object> mapValue) {
        UpdateProductAverageCostService service = new UpdateProductAverageCostService();
    ...
    /**
     * Construct a <code>UpdateProductAverageCostService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateProductAverageCostService fromOutput(Map<String, Object> mapValue) {
        UpdateProductAverageCostService service = new UpdateProductAverageCostService();
