 ...
 * Auto generated base service entity opentaps.prepareSalesOrderEmail.
 *
 * Engine: java
 * Location: org.opentaps.common.content.EmailServices
 * Invoke: prepareSalesOrderEmail
 * Defined in: hot-deploy/opentaps-common/servicedef/services_email.xml
 */
public class OpentapsPrepareSalesOrderEmailService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "opentaps.prepareSalesOrderEmail";
    ...
    /**
     * Creates a new <code>OpentapsPrepareSalesOrderEmailService</code> instance.
     */
    public OpentapsPrepareSalesOrderEmailService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsPrepareSalesOrderEmailService</code> from the input values of the given <code>OpentapsPrepareSalesOrderEmailService</code>.
     * @param input a <code>OpentapsPrepareSalesOrderEmailService</code>
     */
    public static OpentapsPrepareSalesOrderEmailService fromInput(OpentapsPrepareSalesOrderEmailService input) {
        OpentapsPrepareSalesOrderEmailService service = new OpentapsPrepareSalesOrderEmailService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>OpentapsPrepareSalesOrderEmailService</code> from the output values of the given <code>OpentapsPrepareSalesOrderEmailService</code>.
     * @param output a <code>OpentapsPrepareSalesOrderEmailService</code>
     */
    public static OpentapsPrepareSalesOrderEmailService fromOutput(OpentapsPrepareSalesOrderEmailService output) {
        OpentapsPrepareSalesOrderEmailService service = new OpentapsPrepareSalesOrderEmailService();
    ...
    /**
     * Construct a <code>OpentapsPrepareSalesOrderEmailService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsPrepareSalesOrderEmailService fromInput(Map<String, Object> mapValue) {
        OpentapsPrepareSalesOrderEmailService service = new OpentapsPrepareSalesOrderEmailService();
    ...
    /**
     * Construct a <code>OpentapsPrepareSalesOrderEmailService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsPrepareSalesOrderEmailService fromOutput(Map<String, Object> mapValue) {
        OpentapsPrepareSalesOrderEmailService service = new OpentapsPrepareSalesOrderEmailService();
