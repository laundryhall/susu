...
/**
 * .
 * Auto generated base service entity facilityGenericPermission.
 *
 * Engine: simple
 ...
 */
public class FacilityGenericPermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "facilityGenericPermission";
    ...
    /**
     * Creates a new <code>FacilityGenericPermissionService</code> instance.
     */
    public FacilityGenericPermissionService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>FacilityGenericPermissionService</code> from the input values of the given <code>FacilityGenericPermissionService</code>.
     * @param input a <code>FacilityGenericPermissionService</code>
     */
    public static FacilityGenericPermissionService fromInput(FacilityGenericPermissionService input) {
        FacilityGenericPermissionService service = new FacilityGenericPermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>FacilityGenericPermissionService</code> from the output values of the given <code>FacilityGenericPermissionService</code>.
     * @param output a <code>FacilityGenericPermissionService</code>
     */
    public static FacilityGenericPermissionService fromOutput(FacilityGenericPermissionService output) {
        FacilityGenericPermissionService service = new FacilityGenericPermissionService();
    ...
    /**
     * Construct a <code>FacilityGenericPermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static FacilityGenericPermissionService fromInput(Map<String, Object> mapValue) {
        FacilityGenericPermissionService service = new FacilityGenericPermissionService();
    ...
    /**
     * Construct a <code>FacilityGenericPermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static FacilityGenericPermissionService fromOutput(Map<String, Object> mapValue) {
        FacilityGenericPermissionService service = new FacilityGenericPermissionService();
