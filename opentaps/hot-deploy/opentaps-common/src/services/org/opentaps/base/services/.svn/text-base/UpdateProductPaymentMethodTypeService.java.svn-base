 ...
 * Auto generated base service entity updateProductPaymentMethodType.
 *
 * Engine: simple
 ...
 */
public class UpdateProductPaymentMethodTypeService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateProductPaymentMethodType";
    ...
    /**
     * Creates a new <code>UpdateProductPaymentMethodTypeService</code> instance.
     */
    public UpdateProductPaymentMethodTypeService() {
        super();
    }
     ...
     */
    public UpdateProductPaymentMethodTypeService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateProductPaymentMethodTypeService</code> from the input values of the given <code>UpdateProductPaymentMethodTypeService</code>.
     * @param input a <code>UpdateProductPaymentMethodTypeService</code>
     */
    public static UpdateProductPaymentMethodTypeService fromInput(UpdateProductPaymentMethodTypeService input) {
        UpdateProductPaymentMethodTypeService service = new UpdateProductPaymentMethodTypeService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateProductPaymentMethodTypeService</code> from the output values of the given <code>UpdateProductPaymentMethodTypeService</code>.
     * @param output a <code>UpdateProductPaymentMethodTypeService</code>
     */
    public static UpdateProductPaymentMethodTypeService fromOutput(UpdateProductPaymentMethodTypeService output) {
        UpdateProductPaymentMethodTypeService service = new UpdateProductPaymentMethodTypeService();
    ...
    /**
     * Construct a <code>UpdateProductPaymentMethodTypeService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateProductPaymentMethodTypeService fromInput(Map<String, Object> mapValue) {
        UpdateProductPaymentMethodTypeService service = new UpdateProductPaymentMethodTypeService();
    ...
    /**
     * Construct a <code>UpdateProductPaymentMethodTypeService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateProductPaymentMethodTypeService fromOutput(Map<String, Object> mapValue) {
        UpdateProductPaymentMethodTypeService service = new UpdateProductPaymentMethodTypeService();
