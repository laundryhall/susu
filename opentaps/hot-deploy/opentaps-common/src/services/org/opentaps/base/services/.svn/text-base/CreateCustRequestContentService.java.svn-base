 ...
 * Auto generated base service entity createCustRequestContent.
 *
 * Engine: simple
 ...
 */
public class CreateCustRequestContentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createCustRequestContent";
    ...
    /**
     * Creates a new <code>CreateCustRequestContentService</code> instance.
     */
    public CreateCustRequestContentService() {
        super();
    }
     ...
     */
    public CreateCustRequestContentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateCustRequestContentService</code> from the input values of the given <code>CreateCustRequestContentService</code>.
     * @param input a <code>CreateCustRequestContentService</code>
     */
    public static CreateCustRequestContentService fromInput(CreateCustRequestContentService input) {
        CreateCustRequestContentService service = new CreateCustRequestContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateCustRequestContentService</code> from the output values of the given <code>CreateCustRequestContentService</code>.
     * @param output a <code>CreateCustRequestContentService</code>
     */
    public static CreateCustRequestContentService fromOutput(CreateCustRequestContentService output) {
        CreateCustRequestContentService service = new CreateCustRequestContentService();
    ...
    /**
     * Construct a <code>CreateCustRequestContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCustRequestContentService fromInput(Map<String, Object> mapValue) {
        CreateCustRequestContentService service = new CreateCustRequestContentService();
    ...
    /**
     * Construct a <code>CreateCustRequestContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCustRequestContentService fromOutput(Map<String, Object> mapValue) {
        CreateCustRequestContentService service = new CreateCustRequestContentService();
