 ...
 * Auto generated base service entity updateReturnItemsStatus.
 *
 * Engine: simple
 ...
 */
public class UpdateReturnItemsStatusService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateReturnItemsStatus";
    ...
    /**
     * Creates a new <code>UpdateReturnItemsStatusService</code> instance.
     */
    public UpdateReturnItemsStatusService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateReturnItemsStatusService</code> from the input values of the given <code>UpdateReturnItemsStatusService</code>.
     * @param input a <code>UpdateReturnItemsStatusService</code>
     */
    public static UpdateReturnItemsStatusService fromInput(UpdateReturnItemsStatusService input) {
        UpdateReturnItemsStatusService service = new UpdateReturnItemsStatusService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateReturnItemsStatusService</code> from the output values of the given <code>UpdateReturnItemsStatusService</code>.
     * @param output a <code>UpdateReturnItemsStatusService</code>
     */
    public static UpdateReturnItemsStatusService fromOutput(UpdateReturnItemsStatusService output) {
        UpdateReturnItemsStatusService service = new UpdateReturnItemsStatusService();
    ...
    /**
     * Construct a <code>UpdateReturnItemsStatusService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateReturnItemsStatusService fromInput(Map<String, Object> mapValue) {
        UpdateReturnItemsStatusService service = new UpdateReturnItemsStatusService();
    ...
    /**
     * Construct a <code>UpdateReturnItemsStatusService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateReturnItemsStatusService fromOutput(Map<String, Object> mapValue) {
        UpdateReturnItemsStatusService service = new UpdateReturnItemsStatusService();
