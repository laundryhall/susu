 ...
 * Auto generated base service entity unassignPartyFromWorkEffort.
 *
 * Engine: simple
 ...
 */
public class UnassignPartyFromWorkEffortService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "unassignPartyFromWorkEffort";
    ...
    /**
     * Creates a new <code>UnassignPartyFromWorkEffortService</code> instance.
     */
    public UnassignPartyFromWorkEffortService() {
        super();
    }
     ...
     */
    public UnassignPartyFromWorkEffortService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UnassignPartyFromWorkEffortService</code> from the input values of the given <code>UnassignPartyFromWorkEffortService</code>.
     * @param input a <code>UnassignPartyFromWorkEffortService</code>
     */
    public static UnassignPartyFromWorkEffortService fromInput(UnassignPartyFromWorkEffortService input) {
        UnassignPartyFromWorkEffortService service = new UnassignPartyFromWorkEffortService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UnassignPartyFromWorkEffortService</code> from the output values of the given <code>UnassignPartyFromWorkEffortService</code>.
     * @param output a <code>UnassignPartyFromWorkEffortService</code>
     */
    public static UnassignPartyFromWorkEffortService fromOutput(UnassignPartyFromWorkEffortService output) {
        UnassignPartyFromWorkEffortService service = new UnassignPartyFromWorkEffortService();
    ...
    /**
     * Construct a <code>UnassignPartyFromWorkEffortService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UnassignPartyFromWorkEffortService fromInput(Map<String, Object> mapValue) {
        UnassignPartyFromWorkEffortService service = new UnassignPartyFromWorkEffortService();
    ...
    /**
     * Construct a <code>UnassignPartyFromWorkEffortService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UnassignPartyFromWorkEffortService fromOutput(Map<String, Object> mapValue) {
        UnassignPartyFromWorkEffortService service = new UnassignPartyFromWorkEffortService();
