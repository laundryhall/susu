...
/**
 * Create Pay History.
 * Auto generated base service entity createPayHistory.
 *
 * Engine: simple
 * Location: component://humanres/script/org/ofbiz/humanres/HumanResServices.xml
 * Invoke: createPayHistory
 * Defined in: applications/humanres/servicedef/services.xml
 */
public class CreatePayHistoryService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createPayHistory";
    ...
    /**
     * Creates a new <code>CreatePayHistoryService</code> instance.
     */
    public CreatePayHistoryService() {
        super();
    }
     ...
     */
    public CreatePayHistoryService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreatePayHistoryService</code> from the input values of the given <code>CreatePayHistoryService</code>.
     * @param input a <code>CreatePayHistoryService</code>
     */
    public static CreatePayHistoryService fromInput(CreatePayHistoryService input) {
        CreatePayHistoryService service = new CreatePayHistoryService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreatePayHistoryService</code> from the output values of the given <code>CreatePayHistoryService</code>.
     * @param output a <code>CreatePayHistoryService</code>
     */
    public static CreatePayHistoryService fromOutput(CreatePayHistoryService output) {
        CreatePayHistoryService service = new CreatePayHistoryService();
    ...
    /**
     * Construct a <code>CreatePayHistoryService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePayHistoryService fromInput(Map<String, Object> mapValue) {
        CreatePayHistoryService service = new CreatePayHistoryService();
    ...
    /**
     * Construct a <code>CreatePayHistoryService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePayHistoryService fromOutput(Map<String, Object> mapValue) {
        CreatePayHistoryService service = new CreatePayHistoryService();
