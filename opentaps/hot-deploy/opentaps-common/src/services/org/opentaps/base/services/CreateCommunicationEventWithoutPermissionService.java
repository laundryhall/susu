 ...
 * Auto generated base service entity createCommunicationEventWithoutPermission.
 *
 * Engine: simple
 ...
 */
public class CreateCommunicationEventWithoutPermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createCommunicationEventWithoutPermission";
    ...
    /**
     * Creates a new <code>CreateCommunicationEventWithoutPermissionService</code> instance.
     */
    public CreateCommunicationEventWithoutPermissionService() {
        super();
    }
     ...
     */
    public CreateCommunicationEventWithoutPermissionService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateCommunicationEventWithoutPermissionService</code> from the input values of the given <code>CreateCommunicationEventWithoutPermissionService</code>.
     * @param input a <code>CreateCommunicationEventWithoutPermissionService</code>
     */
    public static CreateCommunicationEventWithoutPermissionService fromInput(CreateCommunicationEventWithoutPermissionService input) {
        CreateCommunicationEventWithoutPermissionService service = new CreateCommunicationEventWithoutPermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateCommunicationEventWithoutPermissionService</code> from the output values of the given <code>CreateCommunicationEventWithoutPermissionService</code>.
     * @param output a <code>CreateCommunicationEventWithoutPermissionService</code>
     */
    public static CreateCommunicationEventWithoutPermissionService fromOutput(CreateCommunicationEventWithoutPermissionService output) {
        CreateCommunicationEventWithoutPermissionService service = new CreateCommunicationEventWithoutPermissionService();
    ...
    /**
     * Construct a <code>CreateCommunicationEventWithoutPermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCommunicationEventWithoutPermissionService fromInput(Map<String, Object> mapValue) {
        CreateCommunicationEventWithoutPermissionService service = new CreateCommunicationEventWithoutPermissionService();
    ...
    /**
     * Construct a <code>CreateCommunicationEventWithoutPermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCommunicationEventWithoutPermissionService fromOutput(Map<String, Object> mapValue) {
        CreateCommunicationEventWithoutPermissionService service = new CreateCommunicationEventWithoutPermissionService();
