 ...
 * Auto generated base service entity updateGlAccountTypeDefault.
 *
 * Engine: simple
...
public class UpdateGlAccountTypeDefaultService extends ServiceWrapper {
    ...
    public static final String NAME = "updateGlAccountTypeDefault";
    ...
    /**
     * Creates a new <code>UpdateGlAccountTypeDefaultService</code> instance.
     */
    public UpdateGlAccountTypeDefaultService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateGlAccountTypeDefaultService</code> from the input values of the given <code>UpdateGlAccountTypeDefaultService</code>.
     * @param input a <code>UpdateGlAccountTypeDefaultService</code>
     */
    public static UpdateGlAccountTypeDefaultService fromInput(UpdateGlAccountTypeDefaultService input) {
        UpdateGlAccountTypeDefaultService service = new UpdateGlAccountTypeDefaultService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateGlAccountTypeDefaultService</code> from the output values of the given <code>UpdateGlAccountTypeDefaultService</code>.
     * @param output a <code>UpdateGlAccountTypeDefaultService</code>
     */
    public static UpdateGlAccountTypeDefaultService fromOutput(UpdateGlAccountTypeDefaultService output) {
        UpdateGlAccountTypeDefaultService service = new UpdateGlAccountTypeDefaultService();
    ...
    /**
     * Construct a <code>UpdateGlAccountTypeDefaultService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateGlAccountTypeDefaultService fromInput(Map<String, Object> mapValue) {
        UpdateGlAccountTypeDefaultService service = new UpdateGlAccountTypeDefaultService();
    ...
    /**
     * Construct a <code>UpdateGlAccountTypeDefaultService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateGlAccountTypeDefaultService fromOutput(Map<String, Object> mapValue) {
        UpdateGlAccountTypeDefaultService service = new UpdateGlAccountTypeDefaultService();
