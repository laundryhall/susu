...
/**
 * Computes a forecast for a given time period from the opportunities in that time period using a supplied quota amount. 
            ...
            it will be updated with the computed values, otherwise a new forecast will be created..
 * Auto generated base service entity crmsfa.computeForecastPeriod.
 *
 * Engine: java
...
public class CrmsfaComputeForecastPeriodService extends ServiceWrapper {
    ...
    public static final String NAME = "crmsfa.computeForecastPeriod";
    ...
    /**
     * Creates a new <code>CrmsfaComputeForecastPeriodService</code> instance.
     */
    public CrmsfaComputeForecastPeriodService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaComputeForecastPeriodService</code> from the input values of the given <code>CrmsfaComputeForecastPeriodService</code>.
     * @param input a <code>CrmsfaComputeForecastPeriodService</code>
     */
    public static CrmsfaComputeForecastPeriodService fromInput(CrmsfaComputeForecastPeriodService input) {
        CrmsfaComputeForecastPeriodService service = new CrmsfaComputeForecastPeriodService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaComputeForecastPeriodService</code> from the output values of the given <code>CrmsfaComputeForecastPeriodService</code>.
     * @param output a <code>CrmsfaComputeForecastPeriodService</code>
     */
    public static CrmsfaComputeForecastPeriodService fromOutput(CrmsfaComputeForecastPeriodService output) {
        CrmsfaComputeForecastPeriodService service = new CrmsfaComputeForecastPeriodService();
    ...
    /**
     * Construct a <code>CrmsfaComputeForecastPeriodService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaComputeForecastPeriodService fromInput(Map<String, Object> mapValue) {
        CrmsfaComputeForecastPeriodService service = new CrmsfaComputeForecastPeriodService();
    ...
    /**
     * Construct a <code>CrmsfaComputeForecastPeriodService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaComputeForecastPeriodService fromOutput(Map<String, Object> mapValue) {
        CrmsfaComputeForecastPeriodService service = new CrmsfaComputeForecastPeriodService();
