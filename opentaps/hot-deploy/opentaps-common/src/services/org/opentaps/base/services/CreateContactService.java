 ...
 * Auto generated base service entity createContact.
 *
 * Engine: simple
...
public class CreateContactService extends ServiceWrapper {
    ...
    public static final String NAME = "createContact";
    ...
    /**
     * Creates a new <code>CreateContactService</code> instance.
     */
    ...
    */
    ...
    /**
     * Construct a <code>CreateContactService</code> from the input values of the given <code>CreateContactService</code>.
     * @param input a <code>CreateContactService</code>
     */
    public static CreateContactService fromInput(CreateContactService input) {
        CreateContactService service = new CreateContactService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateContactService</code> from the output values of the given <code>CreateContactService</code>.
     * @param output a <code>CreateContactService</code>
     */
    public static CreateContactService fromOutput(CreateContactService output) {
        CreateContactService service = new CreateContactService();
    ...
    /**
     * Construct a <code>CreateContactService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>CreateContactService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateContactService fromOutput(Map<String, Object> mapValue) {
        CreateContactService service = new CreateContactService();
