...
/**
 * Totals package weights and retrieves a shipping estimate via the PackingSession.
...
public class WarehouseCalcPackSessionAdditionalShippingChargeService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>WarehouseCalcPackSessionAdditionalShippingChargeService</code> instance.
     */
    public WarehouseCalcPackSessionAdditionalShippingChargeService() {
        super();
    }
     ...
     */
    public WarehouseCalcPackSessionAdditionalShippingChargeService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>WarehouseCalcPackSessionAdditionalShippingChargeService</code> from the input values of the given <code>WarehouseCalcPackSessionAdditionalShippingChargeService</code>.
     * @param input a <code>WarehouseCalcPackSessionAdditionalShippingChargeService</code>
     */
    public static WarehouseCalcPackSessionAdditionalShippingChargeService fromInput(WarehouseCalcPackSessionAdditionalShippingChargeService input) {
        WarehouseCalcPackSessionAdditionalShippingChargeService service = new WarehouseCalcPackSessionAdditionalShippingChargeService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>WarehouseCalcPackSessionAdditionalShippingChargeService</code> from the output values of the given <code>WarehouseCalcPackSessionAdditionalShippingChargeService</code>.
     * @param output a <code>WarehouseCalcPackSessionAdditionalShippingChargeService</code>
     */
    public static WarehouseCalcPackSessionAdditionalShippingChargeService fromOutput(WarehouseCalcPackSessionAdditionalShippingChargeService output) {
        WarehouseCalcPackSessionAdditionalShippingChargeService service = new WarehouseCalcPackSessionAdditionalShippingChargeService();
    ...
    /**
     * Construct a <code>WarehouseCalcPackSessionAdditionalShippingChargeService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static WarehouseCalcPackSessionAdditionalShippingChargeService fromInput(Map<String, Object> mapValue) {
        WarehouseCalcPackSessionAdditionalShippingChargeService service = new WarehouseCalcPackSessionAdditionalShippingChargeService();
    ...
    /**
     * Construct a <code>WarehouseCalcPackSessionAdditionalShippingChargeService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static WarehouseCalcPackSessionAdditionalShippingChargeService fromOutput(Map<String, Object> mapValue) {
        WarehouseCalcPackSessionAdditionalShippingChargeService service = new WarehouseCalcPackSessionAdditionalShippingChargeService();
