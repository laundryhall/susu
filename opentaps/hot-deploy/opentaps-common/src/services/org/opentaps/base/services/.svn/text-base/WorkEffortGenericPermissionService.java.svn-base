...
/**
 * .
 * Auto generated base service entity workEffortGenericPermission.
 *
 * Engine: simple
 ...
 */
public class WorkEffortGenericPermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "workEffortGenericPermission";
    ...
    /**
     * Creates a new <code>WorkEffortGenericPermissionService</code> instance.
     */
    public WorkEffortGenericPermissionService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>WorkEffortGenericPermissionService</code> from the input values of the given <code>WorkEffortGenericPermissionService</code>.
     * @param input a <code>WorkEffortGenericPermissionService</code>
     */
    public static WorkEffortGenericPermissionService fromInput(WorkEffortGenericPermissionService input) {
        WorkEffortGenericPermissionService service = new WorkEffortGenericPermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>WorkEffortGenericPermissionService</code> from the output values of the given <code>WorkEffortGenericPermissionService</code>.
     * @param output a <code>WorkEffortGenericPermissionService</code>
     */
    public static WorkEffortGenericPermissionService fromOutput(WorkEffortGenericPermissionService output) {
        WorkEffortGenericPermissionService service = new WorkEffortGenericPermissionService();
    ...
    /**
     * Construct a <code>WorkEffortGenericPermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static WorkEffortGenericPermissionService fromInput(Map<String, Object> mapValue) {
        WorkEffortGenericPermissionService service = new WorkEffortGenericPermissionService();
    ...
    /**
     * Construct a <code>WorkEffortGenericPermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static WorkEffortGenericPermissionService fromOutput(Map<String, Object> mapValue) {
        WorkEffortGenericPermissionService service = new WorkEffortGenericPermissionService();
