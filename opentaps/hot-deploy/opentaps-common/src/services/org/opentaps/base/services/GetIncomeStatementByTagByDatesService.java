 ...
 * Auto generated base service entity getIncomeStatementByTagByDates.
 *
 * Engine: java
 * Location: com.opensourcestrategies.financials.financials.FinancialServices
 * Invoke: getIncomeStatementByTagByDates
 * Defined in: hot-deploy/financials/servicedef/services_financials.xml
 */
public class GetIncomeStatementByTagByDatesService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "getIncomeStatementByTagByDates";
    ...
    /**
     * Creates a new <code>GetIncomeStatementByTagByDatesService</code> instance.
     */
    public GetIncomeStatementByTagByDatesService() {
        super();
    }
     ...
     */
    public GetIncomeStatementByTagByDatesService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>GetIncomeStatementByTagByDatesService</code> from the input values of the given <code>GetIncomeStatementByTagByDatesService</code>.
     * @param input a <code>GetIncomeStatementByTagByDatesService</code>
     */
    public static GetIncomeStatementByTagByDatesService fromInput(GetIncomeStatementByTagByDatesService input) {
        GetIncomeStatementByTagByDatesService service = new GetIncomeStatementByTagByDatesService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>GetIncomeStatementByTagByDatesService</code> from the output values of the given <code>GetIncomeStatementByTagByDatesService</code>.
     * @param output a <code>GetIncomeStatementByTagByDatesService</code>
     */
    public static GetIncomeStatementByTagByDatesService fromOutput(GetIncomeStatementByTagByDatesService output) {
        GetIncomeStatementByTagByDatesService service = new GetIncomeStatementByTagByDatesService();
    ...
    /**
     * Construct a <code>GetIncomeStatementByTagByDatesService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetIncomeStatementByTagByDatesService fromInput(Map<String, Object> mapValue) {
        GetIncomeStatementByTagByDatesService service = new GetIncomeStatementByTagByDatesService();
    ...
    /**
     * Construct a <code>GetIncomeStatementByTagByDatesService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetIncomeStatementByTagByDatesService fromOutput(Map<String, Object> mapValue) {
        GetIncomeStatementByTagByDatesService service = new GetIncomeStatementByTagByDatesService();
