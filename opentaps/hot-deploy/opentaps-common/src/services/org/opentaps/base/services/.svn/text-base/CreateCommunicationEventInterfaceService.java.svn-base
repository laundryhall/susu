 ...
 * Auto generated base service entity createCommunicationEventInterface.
 *
 * Engine: interface
 * Location: 
 * Invoke: 
 ...
 */
public class CreateCommunicationEventInterfaceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createCommunicationEventInterface";
    ...
    /**
     * Creates a new <code>CreateCommunicationEventInterfaceService</code> instance.
     */
    public CreateCommunicationEventInterfaceService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateCommunicationEventInterfaceService</code> from the input values of the given <code>CreateCommunicationEventInterfaceService</code>.
     * @param input a <code>CreateCommunicationEventInterfaceService</code>
     */
    public static CreateCommunicationEventInterfaceService fromInput(CreateCommunicationEventInterfaceService input) {
        CreateCommunicationEventInterfaceService service = new CreateCommunicationEventInterfaceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateCommunicationEventInterfaceService</code> from the output values of the given <code>CreateCommunicationEventInterfaceService</code>.
     * @param output a <code>CreateCommunicationEventInterfaceService</code>
     */
    public static CreateCommunicationEventInterfaceService fromOutput(CreateCommunicationEventInterfaceService output) {
        CreateCommunicationEventInterfaceService service = new CreateCommunicationEventInterfaceService();
    ...
    /**
     * Construct a <code>CreateCommunicationEventInterfaceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCommunicationEventInterfaceService fromInput(Map<String, Object> mapValue) {
        CreateCommunicationEventInterfaceService service = new CreateCommunicationEventInterfaceService();
    ...
    /**
     * Construct a <code>CreateCommunicationEventInterfaceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCommunicationEventInterfaceService fromOutput(Map<String, Object> mapValue) {
        CreateCommunicationEventInterfaceService service = new CreateCommunicationEventInterfaceService();
