 ...
 * Auto generated base service entity updateAgreementPromoAppl.
 *
 * Engine: simple
 ...
 */
public class UpdateAgreementPromoApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateAgreementPromoAppl";
    ...
    /**
     * Creates a new <code>UpdateAgreementPromoApplService</code> instance.
     */
    public UpdateAgreementPromoApplService() {
        super();
    }
     ...
     */
    public UpdateAgreementPromoApplService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateAgreementPromoApplService</code> from the input values of the given <code>UpdateAgreementPromoApplService</code>.
     * @param input a <code>UpdateAgreementPromoApplService</code>
     */
    public static UpdateAgreementPromoApplService fromInput(UpdateAgreementPromoApplService input) {
        UpdateAgreementPromoApplService service = new UpdateAgreementPromoApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateAgreementPromoApplService</code> from the output values of the given <code>UpdateAgreementPromoApplService</code>.
     * @param output a <code>UpdateAgreementPromoApplService</code>
     */
    public static UpdateAgreementPromoApplService fromOutput(UpdateAgreementPromoApplService output) {
        UpdateAgreementPromoApplService service = new UpdateAgreementPromoApplService();
    ...
    /**
     * Construct a <code>UpdateAgreementPromoApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateAgreementPromoApplService fromInput(Map<String, Object> mapValue) {
        UpdateAgreementPromoApplService service = new UpdateAgreementPromoApplService();
    ...
    /**
     * Construct a <code>UpdateAgreementPromoApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateAgreementPromoApplService fromOutput(Map<String, Object> mapValue) {
        UpdateAgreementPromoApplService service = new UpdateAgreementPromoApplService();
