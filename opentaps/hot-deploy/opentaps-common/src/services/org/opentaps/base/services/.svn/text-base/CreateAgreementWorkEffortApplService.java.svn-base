...
/**
 *  Create AgreementWorkEffortAppl .
 * Auto generated base service entity createAgreementWorkEffortAppl.
 *
 * Engine: simple
 ...
 */
public class CreateAgreementWorkEffortApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createAgreementWorkEffortAppl";
    ...
    /**
     * Creates a new <code>CreateAgreementWorkEffortApplService</code> instance.
     */
    public CreateAgreementWorkEffortApplService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateAgreementWorkEffortApplService</code> from the input values of the given <code>CreateAgreementWorkEffortApplService</code>.
     * @param input a <code>CreateAgreementWorkEffortApplService</code>
     */
    public static CreateAgreementWorkEffortApplService fromInput(CreateAgreementWorkEffortApplService input) {
        CreateAgreementWorkEffortApplService service = new CreateAgreementWorkEffortApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateAgreementWorkEffortApplService</code> from the output values of the given <code>CreateAgreementWorkEffortApplService</code>.
     * @param output a <code>CreateAgreementWorkEffortApplService</code>
     */
    public static CreateAgreementWorkEffortApplService fromOutput(CreateAgreementWorkEffortApplService output) {
        CreateAgreementWorkEffortApplService service = new CreateAgreementWorkEffortApplService();
    ...
    /**
     * Construct a <code>CreateAgreementWorkEffortApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateAgreementWorkEffortApplService fromInput(Map<String, Object> mapValue) {
        CreateAgreementWorkEffortApplService service = new CreateAgreementWorkEffortApplService();
    ...
    /**
     * Construct a <code>CreateAgreementWorkEffortApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateAgreementWorkEffortApplService fromOutput(Map<String, Object> mapValue) {
        CreateAgreementWorkEffortApplService service = new CreateAgreementWorkEffortApplService();
