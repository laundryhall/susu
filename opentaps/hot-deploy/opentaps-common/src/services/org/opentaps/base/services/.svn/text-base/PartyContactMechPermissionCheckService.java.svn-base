 ...
 * 
        ...
        .
 * Auto generated base service entity partyContactMechPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class PartyContactMechPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "partyContactMechPermissionCheck";
    ...
    /**
     * Creates a new <code>PartyContactMechPermissionCheckService</code> instance.
     */
    public PartyContactMechPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>PartyContactMechPermissionCheckService</code> from the input values of the given <code>PartyContactMechPermissionCheckService</code>.
     * @param input a <code>PartyContactMechPermissionCheckService</code>
     */
    public static PartyContactMechPermissionCheckService fromInput(PartyContactMechPermissionCheckService input) {
        PartyContactMechPermissionCheckService service = new PartyContactMechPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>PartyContactMechPermissionCheckService</code> from the output values of the given <code>PartyContactMechPermissionCheckService</code>.
     * @param output a <code>PartyContactMechPermissionCheckService</code>
     */
    public static PartyContactMechPermissionCheckService fromOutput(PartyContactMechPermissionCheckService output) {
        PartyContactMechPermissionCheckService service = new PartyContactMechPermissionCheckService();
    ...
    /**
     * Construct a <code>PartyContactMechPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PartyContactMechPermissionCheckService fromInput(Map<String, Object> mapValue) {
        PartyContactMechPermissionCheckService service = new PartyContactMechPermissionCheckService();
    ...
    /**
     * Construct a <code>PartyContactMechPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PartyContactMechPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        PartyContactMechPermissionCheckService service = new PartyContactMechPermissionCheckService();
