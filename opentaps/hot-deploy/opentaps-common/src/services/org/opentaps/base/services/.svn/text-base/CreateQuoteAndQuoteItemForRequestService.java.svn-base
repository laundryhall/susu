 ...
 * Auto generated base service entity createQuoteAndQuoteItemForRequest.
 *
 * Engine: simple
 ...
 */
public class CreateQuoteAndQuoteItemForRequestService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createQuoteAndQuoteItemForRequest";
    ...
    /**
     * Creates a new <code>CreateQuoteAndQuoteItemForRequestService</code> instance.
     */
    public CreateQuoteAndQuoteItemForRequestService() {
        super();
    }
     ...
     */
    public CreateQuoteAndQuoteItemForRequestService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateQuoteAndQuoteItemForRequestService</code> from the input values of the given <code>CreateQuoteAndQuoteItemForRequestService</code>.
     * @param input a <code>CreateQuoteAndQuoteItemForRequestService</code>
     */
    public static CreateQuoteAndQuoteItemForRequestService fromInput(CreateQuoteAndQuoteItemForRequestService input) {
        CreateQuoteAndQuoteItemForRequestService service = new CreateQuoteAndQuoteItemForRequestService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateQuoteAndQuoteItemForRequestService</code> from the output values of the given <code>CreateQuoteAndQuoteItemForRequestService</code>.
     * @param output a <code>CreateQuoteAndQuoteItemForRequestService</code>
     */
    public static CreateQuoteAndQuoteItemForRequestService fromOutput(CreateQuoteAndQuoteItemForRequestService output) {
        CreateQuoteAndQuoteItemForRequestService service = new CreateQuoteAndQuoteItemForRequestService();
    ...
    /**
     * Construct a <code>CreateQuoteAndQuoteItemForRequestService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateQuoteAndQuoteItemForRequestService fromInput(Map<String, Object> mapValue) {
        CreateQuoteAndQuoteItemForRequestService service = new CreateQuoteAndQuoteItemForRequestService();
    ...
    /**
     * Construct a <code>CreateQuoteAndQuoteItemForRequestService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateQuoteAndQuoteItemForRequestService fromOutput(Map<String, Object> mapValue) {
        CreateQuoteAndQuoteItemForRequestService service = new CreateQuoteAndQuoteItemForRequestService();
