 ...
 * Auto generated base service entity updateWorkEffortContent.
 *
 * Engine: simple
 ...
 */
public class UpdateWorkEffortContentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateWorkEffortContent";
    ...
    /**
     * Creates a new <code>UpdateWorkEffortContentService</code> instance.
     */
    public UpdateWorkEffortContentService() {
        super();
    }
     ...
     */
    public UpdateWorkEffortContentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateWorkEffortContentService</code> from the input values of the given <code>UpdateWorkEffortContentService</code>.
     * @param input a <code>UpdateWorkEffortContentService</code>
     */
    public static UpdateWorkEffortContentService fromInput(UpdateWorkEffortContentService input) {
        UpdateWorkEffortContentService service = new UpdateWorkEffortContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateWorkEffortContentService</code> from the output values of the given <code>UpdateWorkEffortContentService</code>.
     * @param output a <code>UpdateWorkEffortContentService</code>
     */
    public static UpdateWorkEffortContentService fromOutput(UpdateWorkEffortContentService output) {
        UpdateWorkEffortContentService service = new UpdateWorkEffortContentService();
    ...
    /**
     * Construct a <code>UpdateWorkEffortContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateWorkEffortContentService fromInput(Map<String, Object> mapValue) {
        UpdateWorkEffortContentService service = new UpdateWorkEffortContentService();
    ...
    /**
     * Construct a <code>UpdateWorkEffortContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateWorkEffortContentService fromOutput(Map<String, Object> mapValue) {
        UpdateWorkEffortContentService service = new UpdateWorkEffortContentService();
