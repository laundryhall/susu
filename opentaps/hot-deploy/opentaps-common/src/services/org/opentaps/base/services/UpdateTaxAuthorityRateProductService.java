 ...
 */
public class UpdateTaxAuthorityRateProductService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>UpdateTaxAuthorityRateProductService</code> instance.
     */
    public UpdateTaxAuthorityRateProductService() {
        super();
    }
     ...
     */
    public UpdateTaxAuthorityRateProductService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityRateProductService</code> from the input values of the given <code>UpdateTaxAuthorityRateProductService</code>.
     * @param input a <code>UpdateTaxAuthorityRateProductService</code>
     */
    public static UpdateTaxAuthorityRateProductService fromInput(UpdateTaxAuthorityRateProductService input) {
        UpdateTaxAuthorityRateProductService service = new UpdateTaxAuthorityRateProductService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateTaxAuthorityRateProductService</code> from the output values of the given <code>UpdateTaxAuthorityRateProductService</code>.
     * @param output a <code>UpdateTaxAuthorityRateProductService</code>
     */
    public static UpdateTaxAuthorityRateProductService fromOutput(UpdateTaxAuthorityRateProductService output) {
        UpdateTaxAuthorityRateProductService service = new UpdateTaxAuthorityRateProductService();
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityRateProductService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateTaxAuthorityRateProductService fromInput(Map<String, Object> mapValue) {
        UpdateTaxAuthorityRateProductService service = new UpdateTaxAuthorityRateProductService();
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityRateProductService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateTaxAuthorityRateProductService fromOutput(Map<String, Object> mapValue) {
        UpdateTaxAuthorityRateProductService service = new UpdateTaxAuthorityRateProductService();
