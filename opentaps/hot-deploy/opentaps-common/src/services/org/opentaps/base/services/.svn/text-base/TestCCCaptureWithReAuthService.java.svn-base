 ...
 * Auto generated base service entity testCCCaptureWithReAuth.
 *
 * Engine: java
 ...
 */
public class TestCCCaptureWithReAuthService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "testCCCaptureWithReAuth";
    ...
    /**
     * Creates a new <code>TestCCCaptureWithReAuthService</code> instance.
     */
    public TestCCCaptureWithReAuthService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>TestCCCaptureWithReAuthService</code> from the input values of the given <code>TestCCCaptureWithReAuthService</code>.
     * @param input a <code>TestCCCaptureWithReAuthService</code>
     */
    public static TestCCCaptureWithReAuthService fromInput(TestCCCaptureWithReAuthService input) {
        TestCCCaptureWithReAuthService service = new TestCCCaptureWithReAuthService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>TestCCCaptureWithReAuthService</code> from the output values of the given <code>TestCCCaptureWithReAuthService</code>.
     * @param output a <code>TestCCCaptureWithReAuthService</code>
     */
    public static TestCCCaptureWithReAuthService fromOutput(TestCCCaptureWithReAuthService output) {
        TestCCCaptureWithReAuthService service = new TestCCCaptureWithReAuthService();
    ...
    /**
     * Construct a <code>TestCCCaptureWithReAuthService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static TestCCCaptureWithReAuthService fromInput(Map<String, Object> mapValue) {
        TestCCCaptureWithReAuthService service = new TestCCCaptureWithReAuthService();
    ...
    /**
     * Construct a <code>TestCCCaptureWithReAuthService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static TestCCCaptureWithReAuthService fromOutput(Map<String, Object> mapValue) {
        TestCCCaptureWithReAuthService service = new TestCCCaptureWithReAuthService();
