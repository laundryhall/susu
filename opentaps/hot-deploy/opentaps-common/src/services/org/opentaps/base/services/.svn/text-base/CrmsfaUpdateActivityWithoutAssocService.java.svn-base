...
/**
 * Updates an Event or Task without modifying any associations. The userLogin must still have _UPDATE permissions for the associated parties,
            cases and opportunities as well as basic CRMSFA_ACT_UPDATE permission..
 * Auto generated base service entity crmsfa.updateActivityWithoutAssoc.
 *
 * Engine: java
 * Location: com.opensourcestrategies.crmsfa.activities.ActivitiesServices
 * Invoke: updateActivityWithoutAssoc
 * Defined in: hot-deploy/crmsfa/servicedef/services_activities.xml
 */
public class CrmsfaUpdateActivityWithoutAssocService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.updateActivityWithoutAssoc";
    ...
    /**
     * Creates a new <code>CrmsfaUpdateActivityWithoutAssocService</code> instance.
     */
    public CrmsfaUpdateActivityWithoutAssocService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaUpdateActivityWithoutAssocService</code> from the input values of the given <code>CrmsfaUpdateActivityWithoutAssocService</code>.
     * @param input a <code>CrmsfaUpdateActivityWithoutAssocService</code>
     */
    public static CrmsfaUpdateActivityWithoutAssocService fromInput(CrmsfaUpdateActivityWithoutAssocService input) {
        CrmsfaUpdateActivityWithoutAssocService service = new CrmsfaUpdateActivityWithoutAssocService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaUpdateActivityWithoutAssocService</code> from the output values of the given <code>CrmsfaUpdateActivityWithoutAssocService</code>.
     * @param output a <code>CrmsfaUpdateActivityWithoutAssocService</code>
     */
    public static CrmsfaUpdateActivityWithoutAssocService fromOutput(CrmsfaUpdateActivityWithoutAssocService output) {
        CrmsfaUpdateActivityWithoutAssocService service = new CrmsfaUpdateActivityWithoutAssocService();
    ...
    /**
     * Construct a <code>CrmsfaUpdateActivityWithoutAssocService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaUpdateActivityWithoutAssocService fromInput(Map<String, Object> mapValue) {
        CrmsfaUpdateActivityWithoutAssocService service = new CrmsfaUpdateActivityWithoutAssocService();
    ...
    /**
     * Construct a <code>CrmsfaUpdateActivityWithoutAssocService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaUpdateActivityWithoutAssocService fromOutput(Map<String, Object> mapValue) {
        CrmsfaUpdateActivityWithoutAssocService service = new CrmsfaUpdateActivityWithoutAssocService();
