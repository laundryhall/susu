 ...
 * Auto generated base service entity visualThemePermissionCheck.
 *
 * Engine: simple
 ...
 */
public class VisualThemePermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "visualThemePermissionCheck";
    ...
    /**
     * Creates a new <code>VisualThemePermissionCheckService</code> instance.
     */
    public VisualThemePermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>VisualThemePermissionCheckService</code> from the input values of the given <code>VisualThemePermissionCheckService</code>.
     * @param input a <code>VisualThemePermissionCheckService</code>
     */
    public static VisualThemePermissionCheckService fromInput(VisualThemePermissionCheckService input) {
        VisualThemePermissionCheckService service = new VisualThemePermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>VisualThemePermissionCheckService</code> from the output values of the given <code>VisualThemePermissionCheckService</code>.
     * @param output a <code>VisualThemePermissionCheckService</code>
     */
    public static VisualThemePermissionCheckService fromOutput(VisualThemePermissionCheckService output) {
        VisualThemePermissionCheckService service = new VisualThemePermissionCheckService();
    ...
    /**
     * Construct a <code>VisualThemePermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static VisualThemePermissionCheckService fromInput(Map<String, Object> mapValue) {
        VisualThemePermissionCheckService service = new VisualThemePermissionCheckService();
    ...
    /**
     * Construct a <code>VisualThemePermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static VisualThemePermissionCheckService fromOutput(Map<String, Object> mapValue) {
        VisualThemePermissionCheckService service = new VisualThemePermissionCheckService();
