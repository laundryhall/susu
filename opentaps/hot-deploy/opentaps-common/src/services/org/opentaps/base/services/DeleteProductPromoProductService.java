 ...
 * Auto generated base service entity deleteProductPromoProduct.
 *
 * Engine: simple
 ...
 */
public class DeleteProductPromoProductService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteProductPromoProduct";
    ...
    /**
     * Creates a new <code>DeleteProductPromoProductService</code> instance.
     */
    public DeleteProductPromoProductService() {
        super();
    }
     ...
     */
    public DeleteProductPromoProductService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductPromoProductService</code> from the input values of the given <code>DeleteProductPromoProductService</code>.
     * @param input a <code>DeleteProductPromoProductService</code>
     */
    public static DeleteProductPromoProductService fromInput(DeleteProductPromoProductService input) {
        DeleteProductPromoProductService service = new DeleteProductPromoProductService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteProductPromoProductService</code> from the output values of the given <code>DeleteProductPromoProductService</code>.
     * @param output a <code>DeleteProductPromoProductService</code>
     */
    public static DeleteProductPromoProductService fromOutput(DeleteProductPromoProductService output) {
        DeleteProductPromoProductService service = new DeleteProductPromoProductService();
    ...
    /**
     * Construct a <code>DeleteProductPromoProductService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductPromoProductService fromInput(Map<String, Object> mapValue) {
        DeleteProductPromoProductService service = new DeleteProductPromoProductService();
    ...
    /**
     * Construct a <code>DeleteProductPromoProductService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductPromoProductService fromOutput(Map<String, Object> mapValue) {
        DeleteProductPromoProductService service = new DeleteProductPromoProductService();
