...
/**
 * Create an invoice reflecting finance charges, of type INTEREST_INVOICE, with one InvoiceItem of type INV_INTRST_CHRG..
 * Auto generated base service entity financials.createInterestInvoice.
 *
 * Engine: java
 * Location: com.opensourcestrategies.financials.invoice.InvoiceServices
 * Invoke: createInterestInvoice
 * Defined in: hot-deploy/financials/servicedef/services_invoice.xml
 */
public class FinancialsCreateInterestInvoiceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "financials.createInterestInvoice";
    ...
    /**
     * Creates a new <code>FinancialsCreateInterestInvoiceService</code> instance.
     */
    public FinancialsCreateInterestInvoiceService() {
        super();
    }
     ...
     */
    public FinancialsCreateInterestInvoiceService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>FinancialsCreateInterestInvoiceService</code> from the input values of the given <code>FinancialsCreateInterestInvoiceService</code>.
     * @param input a <code>FinancialsCreateInterestInvoiceService</code>
     */
    public static FinancialsCreateInterestInvoiceService fromInput(FinancialsCreateInterestInvoiceService input) {
        FinancialsCreateInterestInvoiceService service = new FinancialsCreateInterestInvoiceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>FinancialsCreateInterestInvoiceService</code> from the output values of the given <code>FinancialsCreateInterestInvoiceService</code>.
     * @param output a <code>FinancialsCreateInterestInvoiceService</code>
     */
    public static FinancialsCreateInterestInvoiceService fromOutput(FinancialsCreateInterestInvoiceService output) {
        FinancialsCreateInterestInvoiceService service = new FinancialsCreateInterestInvoiceService();
    ...
    /**
     * Construct a <code>FinancialsCreateInterestInvoiceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static FinancialsCreateInterestInvoiceService fromInput(Map<String, Object> mapValue) {
        FinancialsCreateInterestInvoiceService service = new FinancialsCreateInterestInvoiceService();
    ...
    /**
     * Construct a <code>FinancialsCreateInterestInvoiceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static FinancialsCreateInterestInvoiceService fromOutput(Map<String, Object> mapValue) {
        FinancialsCreateInterestInvoiceService service = new FinancialsCreateInterestInvoiceService();
