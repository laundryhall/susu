...
/**
 * .
 * Auto generated base service entity createSimpleTextContentForProduct.
 *
 * Engine: simple
 ...
 */
public class CreateSimpleTextContentForProductService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createSimpleTextContentForProduct";
    ...
    /**
     * Creates a new <code>CreateSimpleTextContentForProductService</code> instance.
     */
    public CreateSimpleTextContentForProductService() {
        super();
    }
     ...
     */
    public CreateSimpleTextContentForProductService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForProductService</code> from the input values of the given <code>CreateSimpleTextContentForProductService</code>.
     * @param input a <code>CreateSimpleTextContentForProductService</code>
     */
    public static CreateSimpleTextContentForProductService fromInput(CreateSimpleTextContentForProductService input) {
        CreateSimpleTextContentForProductService service = new CreateSimpleTextContentForProductService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateSimpleTextContentForProductService</code> from the output values of the given <code>CreateSimpleTextContentForProductService</code>.
     * @param output a <code>CreateSimpleTextContentForProductService</code>
     */
    public static CreateSimpleTextContentForProductService fromOutput(CreateSimpleTextContentForProductService output) {
        CreateSimpleTextContentForProductService service = new CreateSimpleTextContentForProductService();
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForProductService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateSimpleTextContentForProductService fromInput(Map<String, Object> mapValue) {
        CreateSimpleTextContentForProductService service = new CreateSimpleTextContentForProductService();
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForProductService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateSimpleTextContentForProductService fromOutput(Map<String, Object> mapValue) {
        CreateSimpleTextContentForProductService service = new CreateSimpleTextContentForProductService();
