 ...
 * Auto generated base service entity financials.updateSentOrReceivedPayment.
 *
 * Engine: java
 * Location: com.opensourcestrategies.financials.payment.PaymentServices
 * Invoke: updateSentOrReceivedPayment
 * Defined in: hot-deploy/financials/servicedef/services_other.xml
 */
public class FinancialsUpdateSentOrReceivedPaymentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "financials.updateSentOrReceivedPayment";
    ...
    /**
     * Creates a new <code>FinancialsUpdateSentOrReceivedPaymentService</code> instance.
     */
    public FinancialsUpdateSentOrReceivedPaymentService() {
        super();
    }
     ...
     */
    public FinancialsUpdateSentOrReceivedPaymentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>FinancialsUpdateSentOrReceivedPaymentService</code> from the input values of the given <code>FinancialsUpdateSentOrReceivedPaymentService</code>.
     * @param input a <code>FinancialsUpdateSentOrReceivedPaymentService</code>
     */
    public static FinancialsUpdateSentOrReceivedPaymentService fromInput(FinancialsUpdateSentOrReceivedPaymentService input) {
        FinancialsUpdateSentOrReceivedPaymentService service = new FinancialsUpdateSentOrReceivedPaymentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>FinancialsUpdateSentOrReceivedPaymentService</code> from the output values of the given <code>FinancialsUpdateSentOrReceivedPaymentService</code>.
     * @param output a <code>FinancialsUpdateSentOrReceivedPaymentService</code>
     */
    public static FinancialsUpdateSentOrReceivedPaymentService fromOutput(FinancialsUpdateSentOrReceivedPaymentService output) {
        FinancialsUpdateSentOrReceivedPaymentService service = new FinancialsUpdateSentOrReceivedPaymentService();
    ...
    /**
     * Construct a <code>FinancialsUpdateSentOrReceivedPaymentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static FinancialsUpdateSentOrReceivedPaymentService fromInput(Map<String, Object> mapValue) {
        FinancialsUpdateSentOrReceivedPaymentService service = new FinancialsUpdateSentOrReceivedPaymentService();
    ...
    /**
     * Construct a <code>FinancialsUpdateSentOrReceivedPaymentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static FinancialsUpdateSentOrReceivedPaymentService fromOutput(Map<String, Object> mapValue) {
        FinancialsUpdateSentOrReceivedPaymentService service = new FinancialsUpdateSentOrReceivedPaymentService();
