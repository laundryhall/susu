 ...
 * Updates an Event or Task. Will create associations between the WorkEffort and the party, case and opportunity specified and erase any old
            ...
            opportunity in addition to basic CRMSFA_ACT_UPDATE permission..
 * Auto generated base service entity crmsfa.updateActivity.
 *
 * Engine: java
 * Location: com.opensourcestrategies.crmsfa.activities.ActivitiesServices
 * Invoke: updateActivity
 * Defined in: hot-deploy/crmsfa/servicedef/services_activities.xml
 */
public class CrmsfaUpdateActivityService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.updateActivity";
    ...
    /**
     * Creates a new <code>CrmsfaUpdateActivityService</code> instance.
     */
    public CrmsfaUpdateActivityService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaUpdateActivityService</code> from the input values of the given <code>CrmsfaUpdateActivityService</code>.
     * @param input a <code>CrmsfaUpdateActivityService</code>
     */
    public static CrmsfaUpdateActivityService fromInput(CrmsfaUpdateActivityService input) {
        CrmsfaUpdateActivityService service = new CrmsfaUpdateActivityService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaUpdateActivityService</code> from the output values of the given <code>CrmsfaUpdateActivityService</code>.
     * @param output a <code>CrmsfaUpdateActivityService</code>
     */
    public static CrmsfaUpdateActivityService fromOutput(CrmsfaUpdateActivityService output) {
        CrmsfaUpdateActivityService service = new CrmsfaUpdateActivityService();
    ...
    /**
     * Construct a <code>CrmsfaUpdateActivityService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>CrmsfaUpdateActivityService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaUpdateActivityService fromOutput(Map<String, Object> mapValue) {
        CrmsfaUpdateActivityService service = new CrmsfaUpdateActivityService();
