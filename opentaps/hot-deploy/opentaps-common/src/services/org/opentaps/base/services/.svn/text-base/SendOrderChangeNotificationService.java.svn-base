 ...
 * Auto generated base service entity sendOrderChangeNotification.
 *
 * Engine: java
 ...
 */
public class SendOrderChangeNotificationService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "sendOrderChangeNotification";
    ...
    /**
     * Creates a new <code>SendOrderChangeNotificationService</code> instance.
     */
    public SendOrderChangeNotificationService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>SendOrderChangeNotificationService</code> from the input values of the given <code>SendOrderChangeNotificationService</code>.
     * @param input a <code>SendOrderChangeNotificationService</code>
     */
    public static SendOrderChangeNotificationService fromInput(SendOrderChangeNotificationService input) {
        SendOrderChangeNotificationService service = new SendOrderChangeNotificationService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>SendOrderChangeNotificationService</code> from the output values of the given <code>SendOrderChangeNotificationService</code>.
     * @param output a <code>SendOrderChangeNotificationService</code>
     */
    public static SendOrderChangeNotificationService fromOutput(SendOrderChangeNotificationService output) {
        SendOrderChangeNotificationService service = new SendOrderChangeNotificationService();
    ...
    /**
     * Construct a <code>SendOrderChangeNotificationService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SendOrderChangeNotificationService fromInput(Map<String, Object> mapValue) {
        SendOrderChangeNotificationService service = new SendOrderChangeNotificationService();
    ...
    /**
     * Construct a <code>SendOrderChangeNotificationService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SendOrderChangeNotificationService fromOutput(Map<String, Object> mapValue) {
        SendOrderChangeNotificationService service = new SendOrderChangeNotificationService();
