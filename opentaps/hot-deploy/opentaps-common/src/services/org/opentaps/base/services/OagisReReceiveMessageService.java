...
/**
 * .
 * Auto generated base service entity oagisReReceiveMessage.
 *
 * Engine: java
 * Location: org.ofbiz.oagis.OagisServices
 * Invoke: oagisReReceiveMessage
 * Defined in: specialpurpose/oagis/servicedef/services.xml
 */
public class OagisReReceiveMessageService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "oagisReReceiveMessage";
    ...
    /**
     * Creates a new <code>OagisReReceiveMessageService</code> instance.
     */
    public OagisReReceiveMessageService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>OagisReReceiveMessageService</code> from the input values of the given <code>OagisReReceiveMessageService</code>.
     * @param input a <code>OagisReReceiveMessageService</code>
     */
    public static OagisReReceiveMessageService fromInput(OagisReReceiveMessageService input) {
        OagisReReceiveMessageService service = new OagisReReceiveMessageService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>OagisReReceiveMessageService</code> from the output values of the given <code>OagisReReceiveMessageService</code>.
     * @param output a <code>OagisReReceiveMessageService</code>
     */
    public static OagisReReceiveMessageService fromOutput(OagisReReceiveMessageService output) {
        OagisReReceiveMessageService service = new OagisReReceiveMessageService();
    ...
    /**
     * Construct a <code>OagisReReceiveMessageService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OagisReReceiveMessageService fromInput(Map<String, Object> mapValue) {
        OagisReReceiveMessageService service = new OagisReReceiveMessageService();
    ...
    /**
     * Construct a <code>OagisReReceiveMessageService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OagisReReceiveMessageService fromOutput(Map<String, Object> mapValue) {
        OagisReReceiveMessageService service = new OagisReReceiveMessageService();
