 ...
 * Auto generated base service entity updateExistingGlAccount.
 *
 * Engine: java
 * Location: com.opensourcestrategies.financials.configuration.ConfigurationServices
 * Invoke: updateExistingGlAccount
 * Defined in: hot-deploy/financials/servicedef/services_configuration.xml
 */
public class UpdateExistingGlAccountService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateExistingGlAccount";
    ...
    /**
     * Creates a new <code>UpdateExistingGlAccountService</code> instance.
     */
    public UpdateExistingGlAccountService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateExistingGlAccountService</code> from the input values of the given <code>UpdateExistingGlAccountService</code>.
     * @param input a <code>UpdateExistingGlAccountService</code>
     */
    public static UpdateExistingGlAccountService fromInput(UpdateExistingGlAccountService input) {
        UpdateExistingGlAccountService service = new UpdateExistingGlAccountService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateExistingGlAccountService</code> from the output values of the given <code>UpdateExistingGlAccountService</code>.
     * @param output a <code>UpdateExistingGlAccountService</code>
     */
    public static UpdateExistingGlAccountService fromOutput(UpdateExistingGlAccountService output) {
        UpdateExistingGlAccountService service = new UpdateExistingGlAccountService();
    ...
    /**
     * Construct a <code>UpdateExistingGlAccountService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>UpdateExistingGlAccountService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateExistingGlAccountService fromOutput(Map<String, Object> mapValue) {
        UpdateExistingGlAccountService service = new UpdateExistingGlAccountService();
