 ...
 * Auto generated base service entity createTaxAuthorityGlAccount.
 *
 * Engine: simple
 ...
 */
public class CreateTaxAuthorityGlAccountService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createTaxAuthorityGlAccount";
    ...
    /**
     * Creates a new <code>CreateTaxAuthorityGlAccountService</code> instance.
     */
    public CreateTaxAuthorityGlAccountService() {
        super();
    }
     ...
     */
    public CreateTaxAuthorityGlAccountService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateTaxAuthorityGlAccountService</code> from the input values of the given <code>CreateTaxAuthorityGlAccountService</code>.
     * @param input a <code>CreateTaxAuthorityGlAccountService</code>
     */
    public static CreateTaxAuthorityGlAccountService fromInput(CreateTaxAuthorityGlAccountService input) {
        CreateTaxAuthorityGlAccountService service = new CreateTaxAuthorityGlAccountService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateTaxAuthorityGlAccountService</code> from the output values of the given <code>CreateTaxAuthorityGlAccountService</code>.
     * @param output a <code>CreateTaxAuthorityGlAccountService</code>
     */
    public static CreateTaxAuthorityGlAccountService fromOutput(CreateTaxAuthorityGlAccountService output) {
        CreateTaxAuthorityGlAccountService service = new CreateTaxAuthorityGlAccountService();
    ...
    /**
     * Construct a <code>CreateTaxAuthorityGlAccountService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateTaxAuthorityGlAccountService fromInput(Map<String, Object> mapValue) {
        CreateTaxAuthorityGlAccountService service = new CreateTaxAuthorityGlAccountService();
    ...
    /**
     * Construct a <code>CreateTaxAuthorityGlAccountService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateTaxAuthorityGlAccountService fromOutput(Map<String, Object> mapValue) {
        CreateTaxAuthorityGlAccountService service = new CreateTaxAuthorityGlAccountService();
