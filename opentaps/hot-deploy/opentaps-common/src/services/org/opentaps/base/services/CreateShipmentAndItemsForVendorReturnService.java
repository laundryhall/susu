 ...
 * Auto generated base service entity createShipmentAndItemsForVendorReturn.
 *
 * Engine: simple
...
public class CreateShipmentAndItemsForVendorReturnService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>CreateShipmentAndItemsForVendorReturnService</code> instance.
     */
    ...
    */
    ...
    /**
     * Construct a <code>CreateShipmentAndItemsForVendorReturnService</code> from the input values of the given <code>CreateShipmentAndItemsForVendorReturnService</code>.
     * @param input a <code>CreateShipmentAndItemsForVendorReturnService</code>
     */
    public static CreateShipmentAndItemsForVendorReturnService fromInput(CreateShipmentAndItemsForVendorReturnService input) {
        CreateShipmentAndItemsForVendorReturnService service = new CreateShipmentAndItemsForVendorReturnService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateShipmentAndItemsForVendorReturnService</code> from the output values of the given <code>CreateShipmentAndItemsForVendorReturnService</code>.
     * @param output a <code>CreateShipmentAndItemsForVendorReturnService</code>
     */
    public static CreateShipmentAndItemsForVendorReturnService fromOutput(CreateShipmentAndItemsForVendorReturnService output) {
        CreateShipmentAndItemsForVendorReturnService service = new CreateShipmentAndItemsForVendorReturnService();
    ...
    /**
     * Construct a <code>CreateShipmentAndItemsForVendorReturnService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateShipmentAndItemsForVendorReturnService fromInput(Map<String, Object> mapValue) {
        CreateShipmentAndItemsForVendorReturnService service = new CreateShipmentAndItemsForVendorReturnService();
    ...
    /**
     * Construct a <code>CreateShipmentAndItemsForVendorReturnService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateShipmentAndItemsForVendorReturnService fromOutput(Map<String, Object> mapValue) {
        CreateShipmentAndItemsForVendorReturnService service = new CreateShipmentAndItemsForVendorReturnService();
