 ...
 * Auto generated base service entity removeAgreementProductAppl.
 *
 * Engine: simple
 ...
 */
public class RemoveAgreementProductApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "removeAgreementProductAppl";
    ...
    /**
     * Creates a new <code>RemoveAgreementProductApplService</code> instance.
     */
    public RemoveAgreementProductApplService() {
        super();
    }
     ...
     */
    public RemoveAgreementProductApplService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>RemoveAgreementProductApplService</code> from the input values of the given <code>RemoveAgreementProductApplService</code>.
     * @param input a <code>RemoveAgreementProductApplService</code>
     */
    public static RemoveAgreementProductApplService fromInput(RemoveAgreementProductApplService input) {
        RemoveAgreementProductApplService service = new RemoveAgreementProductApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>RemoveAgreementProductApplService</code> from the output values of the given <code>RemoveAgreementProductApplService</code>.
     * @param output a <code>RemoveAgreementProductApplService</code>
     */
    public static RemoveAgreementProductApplService fromOutput(RemoveAgreementProductApplService output) {
        RemoveAgreementProductApplService service = new RemoveAgreementProductApplService();
    ...
    /**
     * Construct a <code>RemoveAgreementProductApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveAgreementProductApplService fromInput(Map<String, Object> mapValue) {
        RemoveAgreementProductApplService service = new RemoveAgreementProductApplService();
    ...
    /**
     * Construct a <code>RemoveAgreementProductApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveAgreementProductApplService fromOutput(Map<String, Object> mapValue) {
        RemoveAgreementProductApplService service = new RemoveAgreementProductApplService();
