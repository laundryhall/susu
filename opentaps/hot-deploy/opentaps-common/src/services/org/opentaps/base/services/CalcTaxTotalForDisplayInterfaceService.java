 ...
 */
public class CalcTaxTotalForDisplayInterfaceService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>CalcTaxTotalForDisplayInterfaceService</code> instance.
     */
    public CalcTaxTotalForDisplayInterfaceService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CalcTaxTotalForDisplayInterfaceService</code> from the input values of the given <code>CalcTaxTotalForDisplayInterfaceService</code>.
     * @param input a <code>CalcTaxTotalForDisplayInterfaceService</code>
     */
    public static CalcTaxTotalForDisplayInterfaceService fromInput(CalcTaxTotalForDisplayInterfaceService input) {
        CalcTaxTotalForDisplayInterfaceService service = new CalcTaxTotalForDisplayInterfaceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CalcTaxTotalForDisplayInterfaceService</code> from the output values of the given <code>CalcTaxTotalForDisplayInterfaceService</code>.
     * @param output a <code>CalcTaxTotalForDisplayInterfaceService</code>
     */
    public static CalcTaxTotalForDisplayInterfaceService fromOutput(CalcTaxTotalForDisplayInterfaceService output) {
        CalcTaxTotalForDisplayInterfaceService service = new CalcTaxTotalForDisplayInterfaceService();
    ...
    /**
     * Construct a <code>CalcTaxTotalForDisplayInterfaceService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>CalcTaxTotalForDisplayInterfaceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CalcTaxTotalForDisplayInterfaceService fromOutput(Map<String, Object> mapValue) {
        CalcTaxTotalForDisplayInterfaceService service = new CalcTaxTotalForDisplayInterfaceService();
