 ...
 * Auto generated base service entity alwaysDeclineEFTProcessor.
 *
 * Engine: java
 ...
 */
public class AlwaysDeclineEFTProcessorService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "alwaysDeclineEFTProcessor";
    ...
    /**
     * Creates a new <code>AlwaysDeclineEFTProcessorService</code> instance.
     */
    public AlwaysDeclineEFTProcessorService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AlwaysDeclineEFTProcessorService</code> from the input values of the given <code>AlwaysDeclineEFTProcessorService</code>.
     * @param input a <code>AlwaysDeclineEFTProcessorService</code>
     */
    public static AlwaysDeclineEFTProcessorService fromInput(AlwaysDeclineEFTProcessorService input) {
        AlwaysDeclineEFTProcessorService service = new AlwaysDeclineEFTProcessorService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AlwaysDeclineEFTProcessorService</code> from the output values of the given <code>AlwaysDeclineEFTProcessorService</code>.
     * @param output a <code>AlwaysDeclineEFTProcessorService</code>
     */
    public static AlwaysDeclineEFTProcessorService fromOutput(AlwaysDeclineEFTProcessorService output) {
        AlwaysDeclineEFTProcessorService service = new AlwaysDeclineEFTProcessorService();
    ...
    /**
     * Construct a <code>AlwaysDeclineEFTProcessorService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AlwaysDeclineEFTProcessorService fromInput(Map<String, Object> mapValue) {
        AlwaysDeclineEFTProcessorService service = new AlwaysDeclineEFTProcessorService();
    ...
    /**
     * Construct a <code>AlwaysDeclineEFTProcessorService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AlwaysDeclineEFTProcessorService fromOutput(Map<String, Object> mapValue) {
        AlwaysDeclineEFTProcessorService service = new AlwaysDeclineEFTProcessorService();
