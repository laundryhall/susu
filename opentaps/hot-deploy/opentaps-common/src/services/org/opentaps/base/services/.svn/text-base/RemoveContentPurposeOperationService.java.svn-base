 ...
 * Auto generated base service entity removeContentPurposeOperation.
 *
 * Engine: simple
 ...
 */
public class RemoveContentPurposeOperationService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "removeContentPurposeOperation";
    ...
    /**
     * Creates a new <code>RemoveContentPurposeOperationService</code> instance.
     */
    public RemoveContentPurposeOperationService() {
        super();
    }
     ...
     */
    public RemoveContentPurposeOperationService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>RemoveContentPurposeOperationService</code> from the input values of the given <code>RemoveContentPurposeOperationService</code>.
     * @param input a <code>RemoveContentPurposeOperationService</code>
     */
    public static RemoveContentPurposeOperationService fromInput(RemoveContentPurposeOperationService input) {
        RemoveContentPurposeOperationService service = new RemoveContentPurposeOperationService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>RemoveContentPurposeOperationService</code> from the output values of the given <code>RemoveContentPurposeOperationService</code>.
     * @param output a <code>RemoveContentPurposeOperationService</code>
     */
    public static RemoveContentPurposeOperationService fromOutput(RemoveContentPurposeOperationService output) {
        RemoveContentPurposeOperationService service = new RemoveContentPurposeOperationService();
    ...
    /**
     * Construct a <code>RemoveContentPurposeOperationService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveContentPurposeOperationService fromInput(Map<String, Object> mapValue) {
        RemoveContentPurposeOperationService service = new RemoveContentPurposeOperationService();
    ...
    /**
     * Construct a <code>RemoveContentPurposeOperationService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveContentPurposeOperationService fromOutput(Map<String, Object> mapValue) {
        RemoveContentPurposeOperationService service = new RemoveContentPurposeOperationService();
