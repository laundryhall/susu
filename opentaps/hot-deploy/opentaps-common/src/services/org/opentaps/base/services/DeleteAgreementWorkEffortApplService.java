...
/**
 * Delete AgreementWorkEffortAppl.
 * Auto generated base service entity deleteAgreementWorkEffortAppl.
 *
 * Engine: simple
 ...
 */
public class DeleteAgreementWorkEffortApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteAgreementWorkEffortAppl";
    ...
    /**
     * Creates a new <code>DeleteAgreementWorkEffortApplService</code> instance.
     */
    public DeleteAgreementWorkEffortApplService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteAgreementWorkEffortApplService</code> from the input values of the given <code>DeleteAgreementWorkEffortApplService</code>.
     * @param input a <code>DeleteAgreementWorkEffortApplService</code>
     */
    public static DeleteAgreementWorkEffortApplService fromInput(DeleteAgreementWorkEffortApplService input) {
        DeleteAgreementWorkEffortApplService service = new DeleteAgreementWorkEffortApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteAgreementWorkEffortApplService</code> from the output values of the given <code>DeleteAgreementWorkEffortApplService</code>.
     * @param output a <code>DeleteAgreementWorkEffortApplService</code>
     */
    public static DeleteAgreementWorkEffortApplService fromOutput(DeleteAgreementWorkEffortApplService output) {
        DeleteAgreementWorkEffortApplService service = new DeleteAgreementWorkEffortApplService();
    ...
    /**
     * Construct a <code>DeleteAgreementWorkEffortApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteAgreementWorkEffortApplService fromInput(Map<String, Object> mapValue) {
        DeleteAgreementWorkEffortApplService service = new DeleteAgreementWorkEffortApplService();
    ...
    /**
     * Construct a <code>DeleteAgreementWorkEffortApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteAgreementWorkEffortApplService fromOutput(Map<String, Object> mapValue) {
        DeleteAgreementWorkEffortApplService service = new DeleteAgreementWorkEffortApplService();
