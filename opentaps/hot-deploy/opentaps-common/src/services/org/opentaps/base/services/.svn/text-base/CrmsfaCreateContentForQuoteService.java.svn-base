...
/**
 * Creates uploadable or simple content for Order..
 * Auto generated base service entity crmsfa.createContentForQuote.
 *
 * Engine: java
 * Location: com.opensourcestrategies.crmsfa.content.ContentServices
 * Invoke: createContentForQuote
 * Defined in: hot-deploy/crmsfa/servicedef/services_content.xml
 */
public class CrmsfaCreateContentForQuoteService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.createContentForQuote";
    ...
    /**
     * Creates a new <code>CrmsfaCreateContentForQuoteService</code> instance.
     */
    public CrmsfaCreateContentForQuoteService() {
        super();
    }
     ...
     */
    public CrmsfaCreateContentForQuoteService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForQuoteService</code> from the input values of the given <code>CrmsfaCreateContentForQuoteService</code>.
     * @param input a <code>CrmsfaCreateContentForQuoteService</code>
     */
    public static CrmsfaCreateContentForQuoteService fromInput(CrmsfaCreateContentForQuoteService input) {
        CrmsfaCreateContentForQuoteService service = new CrmsfaCreateContentForQuoteService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaCreateContentForQuoteService</code> from the output values of the given <code>CrmsfaCreateContentForQuoteService</code>.
     * @param output a <code>CrmsfaCreateContentForQuoteService</code>
     */
    public static CrmsfaCreateContentForQuoteService fromOutput(CrmsfaCreateContentForQuoteService output) {
        CrmsfaCreateContentForQuoteService service = new CrmsfaCreateContentForQuoteService();
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForQuoteService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreateContentForQuoteService fromInput(Map<String, Object> mapValue) {
        CrmsfaCreateContentForQuoteService service = new CrmsfaCreateContentForQuoteService();
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForQuoteService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateContentForQuoteService fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateContentForQuoteService service = new CrmsfaCreateContentForQuoteService();
