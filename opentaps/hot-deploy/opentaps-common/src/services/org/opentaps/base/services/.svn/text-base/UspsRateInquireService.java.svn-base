...
/**
 * .
 * Auto generated base service entity uspsRateInquire.
 *
 * Engine: java
 ...
 */
public class UspsRateInquireService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "uspsRateInquire";
    ...
    /**
     * Creates a new <code>UspsRateInquireService</code> instance.
     */
    public UspsRateInquireService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>UspsRateInquireService</code> from the input values of the given <code>UspsRateInquireService</code>.
     * @param input a <code>UspsRateInquireService</code>
     */
    public static UspsRateInquireService fromInput(UspsRateInquireService input) {
        UspsRateInquireService service = new UspsRateInquireService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UspsRateInquireService</code> from the output values of the given <code>UspsRateInquireService</code>.
     * @param output a <code>UspsRateInquireService</code>
     */
    public static UspsRateInquireService fromOutput(UspsRateInquireService output) {
        UspsRateInquireService service = new UspsRateInquireService();
    ...
    /**
     * Construct a <code>UspsRateInquireService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UspsRateInquireService fromInput(Map<String, Object> mapValue) {
        UspsRateInquireService service = new UspsRateInquireService();
    ...
    /**
     * Construct a <code>UspsRateInquireService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UspsRateInquireService fromOutput(Map<String, Object> mapValue) {
        UspsRateInquireService service = new UspsRateInquireService();
