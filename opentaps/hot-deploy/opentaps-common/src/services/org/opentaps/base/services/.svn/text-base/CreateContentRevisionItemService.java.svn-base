 ...
 * Auto generated base service entity createContentRevisionItem.
 *
 * Engine: simple
 ...
 */
public class CreateContentRevisionItemService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createContentRevisionItem";
    ...
    /**
     * Creates a new <code>CreateContentRevisionItemService</code> instance.
     */
    public CreateContentRevisionItemService() {
        super();
    }
     ...
     */
    public CreateContentRevisionItemService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateContentRevisionItemService</code> from the input values of the given <code>CreateContentRevisionItemService</code>.
     * @param input a <code>CreateContentRevisionItemService</code>
     */
    public static CreateContentRevisionItemService fromInput(CreateContentRevisionItemService input) {
        CreateContentRevisionItemService service = new CreateContentRevisionItemService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateContentRevisionItemService</code> from the output values of the given <code>CreateContentRevisionItemService</code>.
     * @param output a <code>CreateContentRevisionItemService</code>
     */
    public static CreateContentRevisionItemService fromOutput(CreateContentRevisionItemService output) {
        CreateContentRevisionItemService service = new CreateContentRevisionItemService();
    ...
    /**
     * Construct a <code>CreateContentRevisionItemService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateContentRevisionItemService fromInput(Map<String, Object> mapValue) {
        CreateContentRevisionItemService service = new CreateContentRevisionItemService();
    ...
    /**
     * Construct a <code>CreateContentRevisionItemService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateContentRevisionItemService fromOutput(Map<String, Object> mapValue) {
        CreateContentRevisionItemService service = new CreateContentRevisionItemService();
