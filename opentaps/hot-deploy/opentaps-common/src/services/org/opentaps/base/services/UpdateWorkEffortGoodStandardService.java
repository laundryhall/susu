 ...
 * 
        ...
        .
 * Auto generated base service entity updateWorkEffortGoodStandard.
 *
 * Engine: simple
 ...
 */
public class UpdateWorkEffortGoodStandardService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateWorkEffortGoodStandard";
    ...
    /**
     * Creates a new <code>UpdateWorkEffortGoodStandardService</code> instance.
     */
    public UpdateWorkEffortGoodStandardService() {
        super();
    }
     ...
     */
    public UpdateWorkEffortGoodStandardService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateWorkEffortGoodStandardService</code> from the input values of the given <code>UpdateWorkEffortGoodStandardService</code>.
     * @param input a <code>UpdateWorkEffortGoodStandardService</code>
     */
    public static UpdateWorkEffortGoodStandardService fromInput(UpdateWorkEffortGoodStandardService input) {
        UpdateWorkEffortGoodStandardService service = new UpdateWorkEffortGoodStandardService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateWorkEffortGoodStandardService</code> from the output values of the given <code>UpdateWorkEffortGoodStandardService</code>.
     * @param output a <code>UpdateWorkEffortGoodStandardService</code>
     */
    public static UpdateWorkEffortGoodStandardService fromOutput(UpdateWorkEffortGoodStandardService output) {
        UpdateWorkEffortGoodStandardService service = new UpdateWorkEffortGoodStandardService();
    ...
    /**
     * Construct a <code>UpdateWorkEffortGoodStandardService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateWorkEffortGoodStandardService fromInput(Map<String, Object> mapValue) {
        UpdateWorkEffortGoodStandardService service = new UpdateWorkEffortGoodStandardService();
    ...
    /**
     * Construct a <code>UpdateWorkEffortGoodStandardService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateWorkEffortGoodStandardService fromOutput(Map<String, Object> mapValue) {
        UpdateWorkEffortGoodStandardService service = new UpdateWorkEffortGoodStandardService();
