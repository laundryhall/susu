 ...
 * Auto generated base service entity testCCProcessorCaptureAlwaysDecline.
 *
 * Engine: java
 ...
 */
public class TestCCProcessorCaptureAlwaysDeclineService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "testCCProcessorCaptureAlwaysDecline";
    ...
    /**
     * Creates a new <code>TestCCProcessorCaptureAlwaysDeclineService</code> instance.
     */
    public TestCCProcessorCaptureAlwaysDeclineService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>TestCCProcessorCaptureAlwaysDeclineService</code> from the input values of the given <code>TestCCProcessorCaptureAlwaysDeclineService</code>.
     * @param input a <code>TestCCProcessorCaptureAlwaysDeclineService</code>
     */
    public static TestCCProcessorCaptureAlwaysDeclineService fromInput(TestCCProcessorCaptureAlwaysDeclineService input) {
        TestCCProcessorCaptureAlwaysDeclineService service = new TestCCProcessorCaptureAlwaysDeclineService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>TestCCProcessorCaptureAlwaysDeclineService</code> from the output values of the given <code>TestCCProcessorCaptureAlwaysDeclineService</code>.
     * @param output a <code>TestCCProcessorCaptureAlwaysDeclineService</code>
     */
    public static TestCCProcessorCaptureAlwaysDeclineService fromOutput(TestCCProcessorCaptureAlwaysDeclineService output) {
        TestCCProcessorCaptureAlwaysDeclineService service = new TestCCProcessorCaptureAlwaysDeclineService();
    ...
    /**
     * Construct a <code>TestCCProcessorCaptureAlwaysDeclineService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static TestCCProcessorCaptureAlwaysDeclineService fromInput(Map<String, Object> mapValue) {
        TestCCProcessorCaptureAlwaysDeclineService service = new TestCCProcessorCaptureAlwaysDeclineService();
    ...
    /**
     * Construct a <code>TestCCProcessorCaptureAlwaysDeclineService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static TestCCProcessorCaptureAlwaysDeclineService fromOutput(Map<String, Object> mapValue) {
        TestCCProcessorCaptureAlwaysDeclineService service = new TestCCProcessorCaptureAlwaysDeclineService();
