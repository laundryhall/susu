 ...
 * Auto generated base service entity persistCompDocContent.
 *
 * Engine: simple
 ...
 */
public class PersistCompDocContentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "persistCompDocContent";
    ...
    /**
     * Creates a new <code>PersistCompDocContentService</code> instance.
     */
    public PersistCompDocContentService() {
        super();
    }
     ...
     */
    public PersistCompDocContentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>PersistCompDocContentService</code> from the input values of the given <code>PersistCompDocContentService</code>.
     * @param input a <code>PersistCompDocContentService</code>
     */
    public static PersistCompDocContentService fromInput(PersistCompDocContentService input) {
        PersistCompDocContentService service = new PersistCompDocContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>PersistCompDocContentService</code> from the output values of the given <code>PersistCompDocContentService</code>.
     * @param output a <code>PersistCompDocContentService</code>
     */
    public static PersistCompDocContentService fromOutput(PersistCompDocContentService output) {
        PersistCompDocContentService service = new PersistCompDocContentService();
    ...
    /**
     * Construct a <code>PersistCompDocContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PersistCompDocContentService fromInput(Map<String, Object> mapValue) {
        PersistCompDocContentService service = new PersistCompDocContentService();
    ...
    /**
     * Construct a <code>PersistCompDocContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PersistCompDocContentService fromOutput(Map<String, Object> mapValue) {
        PersistCompDocContentService service = new PersistCompDocContentService();
