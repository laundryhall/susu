 ...
 * Auto generated base service entity deleteProductPaymentMethodType.
 *
 * Engine: simple
 ...
 */
public class DeleteProductPaymentMethodTypeService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteProductPaymentMethodType";
    ...
    /**
     * Creates a new <code>DeleteProductPaymentMethodTypeService</code> instance.
     */
    public DeleteProductPaymentMethodTypeService() {
        super();
    }
     ...
     */
    public DeleteProductPaymentMethodTypeService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductPaymentMethodTypeService</code> from the input values of the given <code>DeleteProductPaymentMethodTypeService</code>.
     * @param input a <code>DeleteProductPaymentMethodTypeService</code>
     */
    public static DeleteProductPaymentMethodTypeService fromInput(DeleteProductPaymentMethodTypeService input) {
        DeleteProductPaymentMethodTypeService service = new DeleteProductPaymentMethodTypeService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteProductPaymentMethodTypeService</code> from the output values of the given <code>DeleteProductPaymentMethodTypeService</code>.
     * @param output a <code>DeleteProductPaymentMethodTypeService</code>
     */
    public static DeleteProductPaymentMethodTypeService fromOutput(DeleteProductPaymentMethodTypeService output) {
        DeleteProductPaymentMethodTypeService service = new DeleteProductPaymentMethodTypeService();
    ...
    /**
     * Construct a <code>DeleteProductPaymentMethodTypeService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductPaymentMethodTypeService fromInput(Map<String, Object> mapValue) {
        DeleteProductPaymentMethodTypeService service = new DeleteProductPaymentMethodTypeService();
    ...
    /**
     * Construct a <code>DeleteProductPaymentMethodTypeService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductPaymentMethodTypeService fromOutput(Map<String, Object> mapValue) {
        DeleteProductPaymentMethodTypeService service = new DeleteProductPaymentMethodTypeService();
