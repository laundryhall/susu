 ...
 * Auto generated base service entity basicGeneralLedgerPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class BasicGeneralLedgerPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "basicGeneralLedgerPermissionCheck";
    ...
    /**
     * Creates a new <code>BasicGeneralLedgerPermissionCheckService</code> instance.
     */
    public BasicGeneralLedgerPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>BasicGeneralLedgerPermissionCheckService</code> from the input values of the given <code>BasicGeneralLedgerPermissionCheckService</code>.
     * @param input a <code>BasicGeneralLedgerPermissionCheckService</code>
     */
    public static BasicGeneralLedgerPermissionCheckService fromInput(BasicGeneralLedgerPermissionCheckService input) {
        BasicGeneralLedgerPermissionCheckService service = new BasicGeneralLedgerPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>BasicGeneralLedgerPermissionCheckService</code> from the output values of the given <code>BasicGeneralLedgerPermissionCheckService</code>.
     * @param output a <code>BasicGeneralLedgerPermissionCheckService</code>
     */
    public static BasicGeneralLedgerPermissionCheckService fromOutput(BasicGeneralLedgerPermissionCheckService output) {
        BasicGeneralLedgerPermissionCheckService service = new BasicGeneralLedgerPermissionCheckService();
    ...
    /**
     * Construct a <code>BasicGeneralLedgerPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static BasicGeneralLedgerPermissionCheckService fromInput(Map<String, Object> mapValue) {
        BasicGeneralLedgerPermissionCheckService service = new BasicGeneralLedgerPermissionCheckService();
    ...
    /**
     * Construct a <code>BasicGeneralLedgerPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static BasicGeneralLedgerPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        BasicGeneralLedgerPermissionCheckService service = new BasicGeneralLedgerPermissionCheckService();
