...
/**
 * Creates a CustRequestContent entry.
 * Auto generated base service entity crmsfa.createCustRequestContent.
 *
 * Engine: java
 ...
 */
public class CrmsfaCreateCustRequestContentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.createCustRequestContent";
    ...
    /**
     * Creates a new <code>CrmsfaCreateCustRequestContentService</code> instance.
     */
    public CrmsfaCreateCustRequestContentService() {
        super();
    }
     ...
     */
    public CrmsfaCreateCustRequestContentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateCustRequestContentService</code> from the input values of the given <code>CrmsfaCreateCustRequestContentService</code>.
     * @param input a <code>CrmsfaCreateCustRequestContentService</code>
     */
    public static CrmsfaCreateCustRequestContentService fromInput(CrmsfaCreateCustRequestContentService input) {
        CrmsfaCreateCustRequestContentService service = new CrmsfaCreateCustRequestContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaCreateCustRequestContentService</code> from the output values of the given <code>CrmsfaCreateCustRequestContentService</code>.
     * @param output a <code>CrmsfaCreateCustRequestContentService</code>
     */
    public static CrmsfaCreateCustRequestContentService fromOutput(CrmsfaCreateCustRequestContentService output) {
        CrmsfaCreateCustRequestContentService service = new CrmsfaCreateCustRequestContentService();
    ...
    /**
     * Construct a <code>CrmsfaCreateCustRequestContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreateCustRequestContentService fromInput(Map<String, Object> mapValue) {
        CrmsfaCreateCustRequestContentService service = new CrmsfaCreateCustRequestContentService();
    ...
    /**
     * Construct a <code>CrmsfaCreateCustRequestContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateCustRequestContentService fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateCustRequestContentService service = new CrmsfaCreateCustRequestContentService();
