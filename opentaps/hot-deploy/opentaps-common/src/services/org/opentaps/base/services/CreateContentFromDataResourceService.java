 ...
 * Auto generated base service entity createContentFromDataResource.
 *
 * Engine: simple
 ...
 */
public class CreateContentFromDataResourceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createContentFromDataResource";
    ...
    /**
     * Creates a new <code>CreateContentFromDataResourceService</code> instance.
     */
    public CreateContentFromDataResourceService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateContentFromDataResourceService</code> from the input values of the given <code>CreateContentFromDataResourceService</code>.
     * @param input a <code>CreateContentFromDataResourceService</code>
     */
    public static CreateContentFromDataResourceService fromInput(CreateContentFromDataResourceService input) {
        CreateContentFromDataResourceService service = new CreateContentFromDataResourceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateContentFromDataResourceService</code> from the output values of the given <code>CreateContentFromDataResourceService</code>.
     * @param output a <code>CreateContentFromDataResourceService</code>
     */
    public static CreateContentFromDataResourceService fromOutput(CreateContentFromDataResourceService output) {
        CreateContentFromDataResourceService service = new CreateContentFromDataResourceService();
    ...
    /**
     * Construct a <code>CreateContentFromDataResourceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateContentFromDataResourceService fromInput(Map<String, Object> mapValue) {
        CreateContentFromDataResourceService service = new CreateContentFromDataResourceService();
    ...
    /**
     * Construct a <code>CreateContentFromDataResourceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateContentFromDataResourceService fromOutput(Map<String, Object> mapValue) {
        CreateContentFromDataResourceService service = new CreateContentFromDataResourceService();
