...
/**
 * Wrapper service for OFBiz updatePayment, to ensure that the paymentMethodTypeId parameter is overridden by the
            paymentMethodTypeId of the PaymentMethod passed as a parameter..
 * Auto generated base service entity financials.updatePayment.
 *
 * Engine: java
...
public class FinancialsUpdatePaymentService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>FinancialsUpdatePaymentService</code> instance.
     */
    ...
    */
    ...
    /**
     * Construct a <code>FinancialsUpdatePaymentService</code> from the input values of the given <code>FinancialsUpdatePaymentService</code>.
     * @param input a <code>FinancialsUpdatePaymentService</code>
     */
    public static FinancialsUpdatePaymentService fromInput(FinancialsUpdatePaymentService input) {
        FinancialsUpdatePaymentService service = new FinancialsUpdatePaymentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>FinancialsUpdatePaymentService</code> from the output values of the given <code>FinancialsUpdatePaymentService</code>.
     * @param output a <code>FinancialsUpdatePaymentService</code>
     */
    public static FinancialsUpdatePaymentService fromOutput(FinancialsUpdatePaymentService output) {
        FinancialsUpdatePaymentService service = new FinancialsUpdatePaymentService();
    ...
    /**
     * Construct a <code>FinancialsUpdatePaymentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static FinancialsUpdatePaymentService fromInput(Map<String, Object> mapValue) {
        FinancialsUpdatePaymentService service = new FinancialsUpdatePaymentService();
    ...
    /**
     * Construct a <code>FinancialsUpdatePaymentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static FinancialsUpdatePaymentService fromOutput(Map<String, Object> mapValue) {
        FinancialsUpdatePaymentService service = new FinancialsUpdatePaymentService();
