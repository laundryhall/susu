 ...
 * Auto generated base service entity updateDataText.
 *
 * Engine: route
 * Location: 
 * Invoke: 
...
public class UpdateDataTextService extends ServiceWrapper {
    ...
    public static final String NAME = "updateDataText";
    ...
    /**
     * Creates a new <code>UpdateDataTextService</code> instance.
     */
    public UpdateDataTextService() {
        super();
    }
     ...
     */
    public UpdateDataTextService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateDataTextService</code> from the input values of the given <code>UpdateDataTextService</code>.
     * @param input a <code>UpdateDataTextService</code>
     */
    public static UpdateDataTextService fromInput(UpdateDataTextService input) {
        UpdateDataTextService service = new UpdateDataTextService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateDataTextService</code> from the output values of the given <code>UpdateDataTextService</code>.
     * @param output a <code>UpdateDataTextService</code>
     */
    public static UpdateDataTextService fromOutput(UpdateDataTextService output) {
        UpdateDataTextService service = new UpdateDataTextService();
    ...
    /**
     * Construct a <code>UpdateDataTextService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateDataTextService fromInput(Map<String, Object> mapValue) {
        UpdateDataTextService service = new UpdateDataTextService();
    ...
    /**
     * Construct a <code>UpdateDataTextService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateDataTextService fromOutput(Map<String, Object> mapValue) {
        UpdateDataTextService service = new UpdateDataTextService();
