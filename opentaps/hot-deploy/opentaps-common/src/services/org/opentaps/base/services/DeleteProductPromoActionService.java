 ...
 * Auto generated base service entity deleteProductPromoAction.
 *
 * Engine: simple
 ...
 */
public class DeleteProductPromoActionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteProductPromoAction";
    ...
    /**
     * Creates a new <code>DeleteProductPromoActionService</code> instance.
     */
    public DeleteProductPromoActionService() {
        super();
    }
     ...
     */
    public DeleteProductPromoActionService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductPromoActionService</code> from the input values of the given <code>DeleteProductPromoActionService</code>.
     * @param input a <code>DeleteProductPromoActionService</code>
     */
    public static DeleteProductPromoActionService fromInput(DeleteProductPromoActionService input) {
        DeleteProductPromoActionService service = new DeleteProductPromoActionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteProductPromoActionService</code> from the output values of the given <code>DeleteProductPromoActionService</code>.
     * @param output a <code>DeleteProductPromoActionService</code>
     */
    public static DeleteProductPromoActionService fromOutput(DeleteProductPromoActionService output) {
        DeleteProductPromoActionService service = new DeleteProductPromoActionService();
    ...
    /**
     * Construct a <code>DeleteProductPromoActionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductPromoActionService fromInput(Map<String, Object> mapValue) {
        DeleteProductPromoActionService service = new DeleteProductPromoActionService();
    ...
    /**
     * Construct a <code>DeleteProductPromoActionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductPromoActionService fromOutput(Map<String, Object> mapValue) {
        DeleteProductPromoActionService service = new DeleteProductPromoActionService();
