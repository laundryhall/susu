 ...
 * Auto generated base service entity createShoppingListRecurrence.
 *
 * Engine: java
 ...
 */
public class CreateShoppingListRecurrenceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createShoppingListRecurrence";
    ...
    /**
     * Creates a new <code>CreateShoppingListRecurrenceService</code> instance.
     */
    public CreateShoppingListRecurrenceService() {
        super();
    }
     ...
     */
    public CreateShoppingListRecurrenceService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateShoppingListRecurrenceService</code> from the input values of the given <code>CreateShoppingListRecurrenceService</code>.
     * @param input a <code>CreateShoppingListRecurrenceService</code>
     */
    public static CreateShoppingListRecurrenceService fromInput(CreateShoppingListRecurrenceService input) {
        CreateShoppingListRecurrenceService service = new CreateShoppingListRecurrenceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateShoppingListRecurrenceService</code> from the output values of the given <code>CreateShoppingListRecurrenceService</code>.
     * @param output a <code>CreateShoppingListRecurrenceService</code>
     */
    public static CreateShoppingListRecurrenceService fromOutput(CreateShoppingListRecurrenceService output) {
        CreateShoppingListRecurrenceService service = new CreateShoppingListRecurrenceService();
    ...
    /**
     * Construct a <code>CreateShoppingListRecurrenceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateShoppingListRecurrenceService fromInput(Map<String, Object> mapValue) {
        CreateShoppingListRecurrenceService service = new CreateShoppingListRecurrenceService();
    ...
    /**
     * Construct a <code>CreateShoppingListRecurrenceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateShoppingListRecurrenceService fromOutput(Map<String, Object> mapValue) {
        CreateShoppingListRecurrenceService service = new CreateShoppingListRecurrenceService();
