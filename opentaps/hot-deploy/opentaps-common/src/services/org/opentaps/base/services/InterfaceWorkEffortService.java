 ...
 * Auto generated base service entity interfaceWorkEffort.
 *
 * Engine: interface
 * Location: 
 * Invoke: 
...
public class InterfaceWorkEffortService extends ServiceWrapper {
    ...
    public static final String NAME = "interfaceWorkEffort";
    ...
    /**
     * Creates a new <code>InterfaceWorkEffortService</code> instance.
     */
    public InterfaceWorkEffortService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>InterfaceWorkEffortService</code> from the input values of the given <code>InterfaceWorkEffortService</code>.
     * @param input a <code>InterfaceWorkEffortService</code>
     */
    public static InterfaceWorkEffortService fromInput(InterfaceWorkEffortService input) {
        InterfaceWorkEffortService service = new InterfaceWorkEffortService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>InterfaceWorkEffortService</code> from the output values of the given <code>InterfaceWorkEffortService</code>.
     * @param output a <code>InterfaceWorkEffortService</code>
     */
    public static InterfaceWorkEffortService fromOutput(InterfaceWorkEffortService output) {
        InterfaceWorkEffortService service = new InterfaceWorkEffortService();
    ...
    /**
     * Construct a <code>InterfaceWorkEffortService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>InterfaceWorkEffortService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static InterfaceWorkEffortService fromOutput(Map<String, Object> mapValue) {
        InterfaceWorkEffortService service = new InterfaceWorkEffortService();
