 ...
 * Auto generated base service entity updateAgreementProductAppl.
 *
 * Engine: simple
 ...
 */
public class UpdateAgreementProductApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateAgreementProductAppl";
    ...
    /**
     * Creates a new <code>UpdateAgreementProductApplService</code> instance.
     */
    public UpdateAgreementProductApplService() {
        super();
    }
     ...
     */
    public UpdateAgreementProductApplService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateAgreementProductApplService</code> from the input values of the given <code>UpdateAgreementProductApplService</code>.
     * @param input a <code>UpdateAgreementProductApplService</code>
     */
    public static UpdateAgreementProductApplService fromInput(UpdateAgreementProductApplService input) {
        UpdateAgreementProductApplService service = new UpdateAgreementProductApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateAgreementProductApplService</code> from the output values of the given <code>UpdateAgreementProductApplService</code>.
     * @param output a <code>UpdateAgreementProductApplService</code>
     */
    public static UpdateAgreementProductApplService fromOutput(UpdateAgreementProductApplService output) {
        UpdateAgreementProductApplService service = new UpdateAgreementProductApplService();
    ...
    /**
     * Construct a <code>UpdateAgreementProductApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateAgreementProductApplService fromInput(Map<String, Object> mapValue) {
        UpdateAgreementProductApplService service = new UpdateAgreementProductApplService();
    ...
    /**
     * Construct a <code>UpdateAgreementProductApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateAgreementProductApplService fromOutput(Map<String, Object> mapValue) {
        UpdateAgreementProductApplService service = new UpdateAgreementProductApplService();
