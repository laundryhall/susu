 ...
 * Auto generated base service entity updateAgreementPartyApplic.
 *
 * Engine: simple
 ...
 */
public class UpdateAgreementPartyApplicService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateAgreementPartyApplic";
    ...
    /**
     * Creates a new <code>UpdateAgreementPartyApplicService</code> instance.
     */
    public UpdateAgreementPartyApplicService() {
        super();
    }
     ...
     */
    public UpdateAgreementPartyApplicService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateAgreementPartyApplicService</code> from the input values of the given <code>UpdateAgreementPartyApplicService</code>.
     * @param input a <code>UpdateAgreementPartyApplicService</code>
     */
    public static UpdateAgreementPartyApplicService fromInput(UpdateAgreementPartyApplicService input) {
        UpdateAgreementPartyApplicService service = new UpdateAgreementPartyApplicService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateAgreementPartyApplicService</code> from the output values of the given <code>UpdateAgreementPartyApplicService</code>.
     * @param output a <code>UpdateAgreementPartyApplicService</code>
     */
    public static UpdateAgreementPartyApplicService fromOutput(UpdateAgreementPartyApplicService output) {
        UpdateAgreementPartyApplicService service = new UpdateAgreementPartyApplicService();
    ...
    /**
     * Construct a <code>UpdateAgreementPartyApplicService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateAgreementPartyApplicService fromInput(Map<String, Object> mapValue) {
        UpdateAgreementPartyApplicService service = new UpdateAgreementPartyApplicService();
    ...
    /**
     * Construct a <code>UpdateAgreementPartyApplicService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateAgreementPartyApplicService fromOutput(Map<String, Object> mapValue) {
        UpdateAgreementPartyApplicService service = new UpdateAgreementPartyApplicService();
