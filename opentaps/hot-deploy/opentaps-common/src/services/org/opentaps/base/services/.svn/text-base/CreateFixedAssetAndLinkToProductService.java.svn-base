 ...
 * Auto generated base service entity createFixedAssetAndLinkToProduct.
 *
 * Engine: simple
...
public class CreateFixedAssetAndLinkToProductService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>CreateFixedAssetAndLinkToProductService</code> instance.
     */
    ...
    */
    ...
    /**
     * Construct a <code>CreateFixedAssetAndLinkToProductService</code> from the input values of the given <code>CreateFixedAssetAndLinkToProductService</code>.
     * @param input a <code>CreateFixedAssetAndLinkToProductService</code>
     */
    public static CreateFixedAssetAndLinkToProductService fromInput(CreateFixedAssetAndLinkToProductService input) {
        CreateFixedAssetAndLinkToProductService service = new CreateFixedAssetAndLinkToProductService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateFixedAssetAndLinkToProductService</code> from the output values of the given <code>CreateFixedAssetAndLinkToProductService</code>.
     * @param output a <code>CreateFixedAssetAndLinkToProductService</code>
     */
    public static CreateFixedAssetAndLinkToProductService fromOutput(CreateFixedAssetAndLinkToProductService output) {
        CreateFixedAssetAndLinkToProductService service = new CreateFixedAssetAndLinkToProductService();
    ...
    /**
     * Construct a <code>CreateFixedAssetAndLinkToProductService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFixedAssetAndLinkToProductService fromInput(Map<String, Object> mapValue) {
        CreateFixedAssetAndLinkToProductService service = new CreateFixedAssetAndLinkToProductService();
    ...
    /**
     * Construct a <code>CreateFixedAssetAndLinkToProductService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFixedAssetAndLinkToProductService fromOutput(Map<String, Object> mapValue) {
        CreateFixedAssetAndLinkToProductService service = new CreateFixedAssetAndLinkToProductService();
