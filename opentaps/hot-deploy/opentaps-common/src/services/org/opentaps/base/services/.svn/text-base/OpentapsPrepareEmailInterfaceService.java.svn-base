...
/**
 * .
 * Auto generated base service entity opentaps.prepareEmailInterface.
 *
 * Engine: interface
 * Location: 
 * Invoke: 
 ...
 */
public class OpentapsPrepareEmailInterfaceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "opentaps.prepareEmailInterface";
    ...
    /**
     * Creates a new <code>OpentapsPrepareEmailInterfaceService</code> instance.
     */
    public OpentapsPrepareEmailInterfaceService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsPrepareEmailInterfaceService</code> from the input values of the given <code>OpentapsPrepareEmailInterfaceService</code>.
     * @param input a <code>OpentapsPrepareEmailInterfaceService</code>
     */
    public static OpentapsPrepareEmailInterfaceService fromInput(OpentapsPrepareEmailInterfaceService input) {
        OpentapsPrepareEmailInterfaceService service = new OpentapsPrepareEmailInterfaceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>OpentapsPrepareEmailInterfaceService</code> from the output values of the given <code>OpentapsPrepareEmailInterfaceService</code>.
     * @param output a <code>OpentapsPrepareEmailInterfaceService</code>
     */
    public static OpentapsPrepareEmailInterfaceService fromOutput(OpentapsPrepareEmailInterfaceService output) {
        OpentapsPrepareEmailInterfaceService service = new OpentapsPrepareEmailInterfaceService();
    ...
    /**
     * Construct a <code>OpentapsPrepareEmailInterfaceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsPrepareEmailInterfaceService fromInput(Map<String, Object> mapValue) {
        OpentapsPrepareEmailInterfaceService service = new OpentapsPrepareEmailInterfaceService();
    ...
    /**
     * Construct a <code>OpentapsPrepareEmailInterfaceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsPrepareEmailInterfaceService fromOutput(Map<String, Object> mapValue) {
        OpentapsPrepareEmailInterfaceService service = new OpentapsPrepareEmailInterfaceService();
