 ...
 * Auto generated base service entity updatePartyFixedAssetAssignment.
 *
 * Engine: simple
 ...
 */
public class UpdatePartyFixedAssetAssignmentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updatePartyFixedAssetAssignment";
    ...
    /**
     * Creates a new <code>UpdatePartyFixedAssetAssignmentService</code> instance.
     */
    public UpdatePartyFixedAssetAssignmentService() {
        super();
    }
     ...
     */
    public UpdatePartyFixedAssetAssignmentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdatePartyFixedAssetAssignmentService</code> from the input values of the given <code>UpdatePartyFixedAssetAssignmentService</code>.
     * @param input a <code>UpdatePartyFixedAssetAssignmentService</code>
     */
    public static UpdatePartyFixedAssetAssignmentService fromInput(UpdatePartyFixedAssetAssignmentService input) {
        UpdatePartyFixedAssetAssignmentService service = new UpdatePartyFixedAssetAssignmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdatePartyFixedAssetAssignmentService</code> from the output values of the given <code>UpdatePartyFixedAssetAssignmentService</code>.
     * @param output a <code>UpdatePartyFixedAssetAssignmentService</code>
     */
    public static UpdatePartyFixedAssetAssignmentService fromOutput(UpdatePartyFixedAssetAssignmentService output) {
        UpdatePartyFixedAssetAssignmentService service = new UpdatePartyFixedAssetAssignmentService();
    ...
    /**
     * Construct a <code>UpdatePartyFixedAssetAssignmentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdatePartyFixedAssetAssignmentService fromInput(Map<String, Object> mapValue) {
        UpdatePartyFixedAssetAssignmentService service = new UpdatePartyFixedAssetAssignmentService();
    ...
    /**
     * Construct a <code>UpdatePartyFixedAssetAssignmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdatePartyFixedAssetAssignmentService fromOutput(Map<String, Object> mapValue) {
        UpdatePartyFixedAssetAssignmentService service = new UpdatePartyFixedAssetAssignmentService();
