 ...
 * Auto generated base service entity createContentPurposeOperation.
 *
 * Engine: simple
 ...
 */
public class CreateContentPurposeOperationService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createContentPurposeOperation";
    ...
    /**
     * Creates a new <code>CreateContentPurposeOperationService</code> instance.
     */
    public CreateContentPurposeOperationService() {
        super();
    }
     ...
     */
    public CreateContentPurposeOperationService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateContentPurposeOperationService</code> from the input values of the given <code>CreateContentPurposeOperationService</code>.
     * @param input a <code>CreateContentPurposeOperationService</code>
     */
    public static CreateContentPurposeOperationService fromInput(CreateContentPurposeOperationService input) {
        CreateContentPurposeOperationService service = new CreateContentPurposeOperationService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateContentPurposeOperationService</code> from the output values of the given <code>CreateContentPurposeOperationService</code>.
     * @param output a <code>CreateContentPurposeOperationService</code>
     */
    public static CreateContentPurposeOperationService fromOutput(CreateContentPurposeOperationService output) {
        CreateContentPurposeOperationService service = new CreateContentPurposeOperationService();
    ...
    /**
     * Construct a <code>CreateContentPurposeOperationService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateContentPurposeOperationService fromInput(Map<String, Object> mapValue) {
        CreateContentPurposeOperationService service = new CreateContentPurposeOperationService();
    ...
    /**
     * Construct a <code>CreateContentPurposeOperationService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateContentPurposeOperationService fromOutput(Map<String, Object> mapValue) {
        CreateContentPurposeOperationService service = new CreateContentPurposeOperationService();
