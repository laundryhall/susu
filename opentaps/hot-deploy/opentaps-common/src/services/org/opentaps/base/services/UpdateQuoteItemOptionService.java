 ...
 * Auto generated base service entity updateQuoteItemOption.
 *
 * Engine: java
 * Location: com.opensourcestrategies.crmsfa.quotes.QuoteServices
 * Invoke: updateQuoteItemOption
 * Defined in: hot-deploy/crmsfa/servicedef/services_quotes.xml
 */
public class UpdateQuoteItemOptionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateQuoteItemOption";
    ...
    /**
     * Creates a new <code>UpdateQuoteItemOptionService</code> instance.
     */
    public UpdateQuoteItemOptionService() {
        super();
    }
     ...
     */
    public UpdateQuoteItemOptionService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateQuoteItemOptionService</code> from the input values of the given <code>UpdateQuoteItemOptionService</code>.
     * @param input a <code>UpdateQuoteItemOptionService</code>
     */
    public static UpdateQuoteItemOptionService fromInput(UpdateQuoteItemOptionService input) {
        UpdateQuoteItemOptionService service = new UpdateQuoteItemOptionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateQuoteItemOptionService</code> from the output values of the given <code>UpdateQuoteItemOptionService</code>.
     * @param output a <code>UpdateQuoteItemOptionService</code>
     */
    public static UpdateQuoteItemOptionService fromOutput(UpdateQuoteItemOptionService output) {
        UpdateQuoteItemOptionService service = new UpdateQuoteItemOptionService();
    ...
    /**
     * Construct a <code>UpdateQuoteItemOptionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateQuoteItemOptionService fromInput(Map<String, Object> mapValue) {
        UpdateQuoteItemOptionService service = new UpdateQuoteItemOptionService();
    ...
    /**
     * Construct a <code>UpdateQuoteItemOptionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateQuoteItemOptionService fromOutput(Map<String, Object> mapValue) {
        UpdateQuoteItemOptionService service = new UpdateQuoteItemOptionService();
