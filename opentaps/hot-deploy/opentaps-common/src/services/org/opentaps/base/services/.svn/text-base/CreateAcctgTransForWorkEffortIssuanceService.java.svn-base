 ...
 * Auto generated base service entity createAcctgTransForWorkEffortIssuance.
 *
 * Engine: simple
 ...
 */
public class CreateAcctgTransForWorkEffortIssuanceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createAcctgTransForWorkEffortIssuance";
    ...
    /**
     * Creates a new <code>CreateAcctgTransForWorkEffortIssuanceService</code> instance.
     */
    public CreateAcctgTransForWorkEffortIssuanceService() {
        super();
    }
     ...
     */
    public CreateAcctgTransForWorkEffortIssuanceService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateAcctgTransForWorkEffortIssuanceService</code> from the input values of the given <code>CreateAcctgTransForWorkEffortIssuanceService</code>.
     * @param input a <code>CreateAcctgTransForWorkEffortIssuanceService</code>
     */
    public static CreateAcctgTransForWorkEffortIssuanceService fromInput(CreateAcctgTransForWorkEffortIssuanceService input) {
        CreateAcctgTransForWorkEffortIssuanceService service = new CreateAcctgTransForWorkEffortIssuanceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateAcctgTransForWorkEffortIssuanceService</code> from the output values of the given <code>CreateAcctgTransForWorkEffortIssuanceService</code>.
     * @param output a <code>CreateAcctgTransForWorkEffortIssuanceService</code>
     */
    public static CreateAcctgTransForWorkEffortIssuanceService fromOutput(CreateAcctgTransForWorkEffortIssuanceService output) {
        CreateAcctgTransForWorkEffortIssuanceService service = new CreateAcctgTransForWorkEffortIssuanceService();
    ...
    /**
     * Construct a <code>CreateAcctgTransForWorkEffortIssuanceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateAcctgTransForWorkEffortIssuanceService fromInput(Map<String, Object> mapValue) {
        CreateAcctgTransForWorkEffortIssuanceService service = new CreateAcctgTransForWorkEffortIssuanceService();
    ...
    /**
     * Construct a <code>CreateAcctgTransForWorkEffortIssuanceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateAcctgTransForWorkEffortIssuanceService fromOutput(Map<String, Object> mapValue) {
        CreateAcctgTransForWorkEffortIssuanceService service = new CreateAcctgTransForWorkEffortIssuanceService();
