 ...
 * Auto generated base service entity createFixedAssetStdCost.
 *
 * Engine: simple
 ...
 */
public class CreateFixedAssetStdCostService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createFixedAssetStdCost";
    ...
    /**
     * Creates a new <code>CreateFixedAssetStdCostService</code> instance.
     */
    public CreateFixedAssetStdCostService() {
        super();
    }
     ...
     */
    public CreateFixedAssetStdCostService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateFixedAssetStdCostService</code> from the input values of the given <code>CreateFixedAssetStdCostService</code>.
     * @param input a <code>CreateFixedAssetStdCostService</code>
     */
    public static CreateFixedAssetStdCostService fromInput(CreateFixedAssetStdCostService input) {
        CreateFixedAssetStdCostService service = new CreateFixedAssetStdCostService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateFixedAssetStdCostService</code> from the output values of the given <code>CreateFixedAssetStdCostService</code>.
     * @param output a <code>CreateFixedAssetStdCostService</code>
     */
    public static CreateFixedAssetStdCostService fromOutput(CreateFixedAssetStdCostService output) {
        CreateFixedAssetStdCostService service = new CreateFixedAssetStdCostService();
    ...
    /**
     * Construct a <code>CreateFixedAssetStdCostService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFixedAssetStdCostService fromInput(Map<String, Object> mapValue) {
        CreateFixedAssetStdCostService service = new CreateFixedAssetStdCostService();
    ...
    /**
     * Construct a <code>CreateFixedAssetStdCostService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFixedAssetStdCostService fromOutput(Map<String, Object> mapValue) {
        CreateFixedAssetStdCostService service = new CreateFixedAssetStdCostService();
