 ...
 * Auto generated base service entity pcChargeCCRefund.
 *
 * Engine: java
 ...
 */
public class PcChargeCCRefundService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "pcChargeCCRefund";
    ...
    /**
     * Creates a new <code>PcChargeCCRefundService</code> instance.
     */
    public PcChargeCCRefundService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>PcChargeCCRefundService</code> from the input values of the given <code>PcChargeCCRefundService</code>.
     * @param input a <code>PcChargeCCRefundService</code>
     */
    public static PcChargeCCRefundService fromInput(PcChargeCCRefundService input) {
        PcChargeCCRefundService service = new PcChargeCCRefundService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>PcChargeCCRefundService</code> from the output values of the given <code>PcChargeCCRefundService</code>.
     * @param output a <code>PcChargeCCRefundService</code>
     */
    public static PcChargeCCRefundService fromOutput(PcChargeCCRefundService output) {
        PcChargeCCRefundService service = new PcChargeCCRefundService();
    ...
    /**
     * Construct a <code>PcChargeCCRefundService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PcChargeCCRefundService fromInput(Map<String, Object> mapValue) {
        PcChargeCCRefundService service = new PcChargeCCRefundService();
    ...
    /**
     * Construct a <code>PcChargeCCRefundService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PcChargeCCRefundService fromOutput(Map<String, Object> mapValue) {
        PcChargeCCRefundService service = new PcChargeCCRefundService();
