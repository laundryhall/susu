 ...
 * 
        ...
        .
 * Auto generated base service entity partyRelationshipPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class PartyRelationshipPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "partyRelationshipPermissionCheck";
    ...
    /**
     * Creates a new <code>PartyRelationshipPermissionCheckService</code> instance.
     */
    public PartyRelationshipPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>PartyRelationshipPermissionCheckService</code> from the input values of the given <code>PartyRelationshipPermissionCheckService</code>.
     * @param input a <code>PartyRelationshipPermissionCheckService</code>
     */
    public static PartyRelationshipPermissionCheckService fromInput(PartyRelationshipPermissionCheckService input) {
        PartyRelationshipPermissionCheckService service = new PartyRelationshipPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>PartyRelationshipPermissionCheckService</code> from the output values of the given <code>PartyRelationshipPermissionCheckService</code>.
     * @param output a <code>PartyRelationshipPermissionCheckService</code>
     */
    public static PartyRelationshipPermissionCheckService fromOutput(PartyRelationshipPermissionCheckService output) {
        PartyRelationshipPermissionCheckService service = new PartyRelationshipPermissionCheckService();
    ...
    /**
     * Construct a <code>PartyRelationshipPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PartyRelationshipPermissionCheckService fromInput(Map<String, Object> mapValue) {
        PartyRelationshipPermissionCheckService service = new PartyRelationshipPermissionCheckService();
    ...
    /**
     * Construct a <code>PartyRelationshipPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PartyRelationshipPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        PartyRelationshipPermissionCheckService service = new PartyRelationshipPermissionCheckService();
