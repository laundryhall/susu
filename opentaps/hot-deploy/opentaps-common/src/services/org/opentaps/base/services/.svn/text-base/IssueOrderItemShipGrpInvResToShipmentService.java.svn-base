 ...
 * Auto generated base service entity issueOrderItemShipGrpInvResToShipment.
 *
 * Engine: simple
 ...
 */
public class IssueOrderItemShipGrpInvResToShipmentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "issueOrderItemShipGrpInvResToShipment";
    ...
    /**
     * Creates a new <code>IssueOrderItemShipGrpInvResToShipmentService</code> instance.
     */
    public IssueOrderItemShipGrpInvResToShipmentService() {
        super();
    }
     ...
     */
    public IssueOrderItemShipGrpInvResToShipmentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>IssueOrderItemShipGrpInvResToShipmentService</code> from the input values of the given <code>IssueOrderItemShipGrpInvResToShipmentService</code>.
     * @param input a <code>IssueOrderItemShipGrpInvResToShipmentService</code>
     */
    public static IssueOrderItemShipGrpInvResToShipmentService fromInput(IssueOrderItemShipGrpInvResToShipmentService input) {
        IssueOrderItemShipGrpInvResToShipmentService service = new IssueOrderItemShipGrpInvResToShipmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>IssueOrderItemShipGrpInvResToShipmentService</code> from the output values of the given <code>IssueOrderItemShipGrpInvResToShipmentService</code>.
     * @param output a <code>IssueOrderItemShipGrpInvResToShipmentService</code>
     */
    public static IssueOrderItemShipGrpInvResToShipmentService fromOutput(IssueOrderItemShipGrpInvResToShipmentService output) {
        IssueOrderItemShipGrpInvResToShipmentService service = new IssueOrderItemShipGrpInvResToShipmentService();
    ...
    /**
     * Construct a <code>IssueOrderItemShipGrpInvResToShipmentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static IssueOrderItemShipGrpInvResToShipmentService fromInput(Map<String, Object> mapValue) {
        IssueOrderItemShipGrpInvResToShipmentService service = new IssueOrderItemShipGrpInvResToShipmentService();
    ...
    /**
     * Construct a <code>IssueOrderItemShipGrpInvResToShipmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static IssueOrderItemShipGrpInvResToShipmentService fromOutput(Map<String, Object> mapValue) {
        IssueOrderItemShipGrpInvResToShipmentService service = new IssueOrderItemShipGrpInvResToShipmentService();
