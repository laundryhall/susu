 ...
 * Auto generated base service entity addProdCatalogToParty.
 *
 * Engine: simple
 * Location: component://product/script/org/ofbiz/product/catalog/CatalogServices.xml
 * Invoke: addProdCatalogToParty
 * Defined in: applications/product/servicedef/services.xml
 */
public class AddProdCatalogToPartyService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "addProdCatalogToParty";
    ...
    /**
     * Creates a new <code>AddProdCatalogToPartyService</code> instance.
     */
    public AddProdCatalogToPartyService() {
        super();
    }
     ...
     */
    public AddProdCatalogToPartyService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>AddProdCatalogToPartyService</code> from the input values of the given <code>AddProdCatalogToPartyService</code>.
     * @param input a <code>AddProdCatalogToPartyService</code>
     */
    public static AddProdCatalogToPartyService fromInput(AddProdCatalogToPartyService input) {
        AddProdCatalogToPartyService service = new AddProdCatalogToPartyService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AddProdCatalogToPartyService</code> from the output values of the given <code>AddProdCatalogToPartyService</code>.
     * @param output a <code>AddProdCatalogToPartyService</code>
     */
    public static AddProdCatalogToPartyService fromOutput(AddProdCatalogToPartyService output) {
        AddProdCatalogToPartyService service = new AddProdCatalogToPartyService();
    ...
    /**
     * Construct a <code>AddProdCatalogToPartyService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AddProdCatalogToPartyService fromInput(Map<String, Object> mapValue) {
        AddProdCatalogToPartyService service = new AddProdCatalogToPartyService();
    ...
    /**
     * Construct a <code>AddProdCatalogToPartyService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AddProdCatalogToPartyService fromOutput(Map<String, Object> mapValue) {
        AddProdCatalogToPartyService service = new AddProdCatalogToPartyService();
