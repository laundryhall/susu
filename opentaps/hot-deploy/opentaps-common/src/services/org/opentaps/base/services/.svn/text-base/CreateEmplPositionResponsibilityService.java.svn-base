 ...
 * Auto generated base service entity createEmplPositionResponsibility.
 *
 * Engine: simple
 * Location: component://humanres/script/org/ofbiz/humanres/HumanResServices.xml
 * Invoke: createEmplPositionResponsibility
 * Defined in: applications/humanres/servicedef/services.xml
 */
public class CreateEmplPositionResponsibilityService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createEmplPositionResponsibility";
    ...
    /**
     * Creates a new <code>CreateEmplPositionResponsibilityService</code> instance.
     */
    public CreateEmplPositionResponsibilityService() {
        super();
    }
     ...
     */
    public CreateEmplPositionResponsibilityService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateEmplPositionResponsibilityService</code> from the input values of the given <code>CreateEmplPositionResponsibilityService</code>.
     * @param input a <code>CreateEmplPositionResponsibilityService</code>
     */
    public static CreateEmplPositionResponsibilityService fromInput(CreateEmplPositionResponsibilityService input) {
        CreateEmplPositionResponsibilityService service = new CreateEmplPositionResponsibilityService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateEmplPositionResponsibilityService</code> from the output values of the given <code>CreateEmplPositionResponsibilityService</code>.
     * @param output a <code>CreateEmplPositionResponsibilityService</code>
     */
    public static CreateEmplPositionResponsibilityService fromOutput(CreateEmplPositionResponsibilityService output) {
        CreateEmplPositionResponsibilityService service = new CreateEmplPositionResponsibilityService();
    ...
    /**
     * Construct a <code>CreateEmplPositionResponsibilityService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateEmplPositionResponsibilityService fromInput(Map<String, Object> mapValue) {
        CreateEmplPositionResponsibilityService service = new CreateEmplPositionResponsibilityService();
    ...
    /**
     * Construct a <code>CreateEmplPositionResponsibilityService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateEmplPositionResponsibilityService fromOutput(Map<String, Object> mapValue) {
        CreateEmplPositionResponsibilityService service = new CreateEmplPositionResponsibilityService();
