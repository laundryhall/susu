 ...
 * Auto generated base service entity setCommunicationEventRoleStatus.
 *
 * Engine: simple
 ...
 */
public class SetCommunicationEventRoleStatusService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "setCommunicationEventRoleStatus";
    ...
    /**
     * Creates a new <code>SetCommunicationEventRoleStatusService</code> instance.
     */
    public SetCommunicationEventRoleStatusService() {
        super();
    }
     ...
     */
    public SetCommunicationEventRoleStatusService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>SetCommunicationEventRoleStatusService</code> from the input values of the given <code>SetCommunicationEventRoleStatusService</code>.
     * @param input a <code>SetCommunicationEventRoleStatusService</code>
     */
    public static SetCommunicationEventRoleStatusService fromInput(SetCommunicationEventRoleStatusService input) {
        SetCommunicationEventRoleStatusService service = new SetCommunicationEventRoleStatusService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>SetCommunicationEventRoleStatusService</code> from the output values of the given <code>SetCommunicationEventRoleStatusService</code>.
     * @param output a <code>SetCommunicationEventRoleStatusService</code>
     */
    public static SetCommunicationEventRoleStatusService fromOutput(SetCommunicationEventRoleStatusService output) {
        SetCommunicationEventRoleStatusService service = new SetCommunicationEventRoleStatusService();
    ...
    /**
     * Construct a <code>SetCommunicationEventRoleStatusService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SetCommunicationEventRoleStatusService fromInput(Map<String, Object> mapValue) {
        SetCommunicationEventRoleStatusService service = new SetCommunicationEventRoleStatusService();
    ...
    /**
     * Construct a <code>SetCommunicationEventRoleStatusService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SetCommunicationEventRoleStatusService fromOutput(Map<String, Object> mapValue) {
        SetCommunicationEventRoleStatusService service = new SetCommunicationEventRoleStatusService();
