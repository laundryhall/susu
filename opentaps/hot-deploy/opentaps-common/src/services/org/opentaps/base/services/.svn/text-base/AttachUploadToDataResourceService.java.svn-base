 ...
 * Auto generated base service entity attachUploadToDataResource.
 *
 * Engine: simple
 ...
 */
public class AttachUploadToDataResourceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "attachUploadToDataResource";
    ...
    /**
     * Creates a new <code>AttachUploadToDataResourceService</code> instance.
     */
    public AttachUploadToDataResourceService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AttachUploadToDataResourceService</code> from the input values of the given <code>AttachUploadToDataResourceService</code>.
     * @param input a <code>AttachUploadToDataResourceService</code>
     */
    public static AttachUploadToDataResourceService fromInput(AttachUploadToDataResourceService input) {
        AttachUploadToDataResourceService service = new AttachUploadToDataResourceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AttachUploadToDataResourceService</code> from the output values of the given <code>AttachUploadToDataResourceService</code>.
     * @param output a <code>AttachUploadToDataResourceService</code>
     */
    public static AttachUploadToDataResourceService fromOutput(AttachUploadToDataResourceService output) {
        AttachUploadToDataResourceService service = new AttachUploadToDataResourceService();
    ...
    /**
     * Construct a <code>AttachUploadToDataResourceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AttachUploadToDataResourceService fromInput(Map<String, Object> mapValue) {
        AttachUploadToDataResourceService service = new AttachUploadToDataResourceService();
    ...
    /**
     * Construct a <code>AttachUploadToDataResourceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AttachUploadToDataResourceService fromOutput(Map<String, Object> mapValue) {
        AttachUploadToDataResourceService service = new AttachUploadToDataResourceService();
