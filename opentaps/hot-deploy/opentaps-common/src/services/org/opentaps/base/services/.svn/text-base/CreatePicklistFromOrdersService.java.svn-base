 ...
 * Auto generated base service entity createPicklistFromOrders.
 *
 * Engine: simple
 ...
 */
public class CreatePicklistFromOrdersService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createPicklistFromOrders";
    ...
    /**
     * Creates a new <code>CreatePicklistFromOrdersService</code> instance.
     */
    public CreatePicklistFromOrdersService() {
        super();
    }
    ...
    private List outOrderHeaderList;
    private String outPicklistId;
     ...
     * @return <code>List</code>
     */
    public List getInOrderIdList() {
        return this.inOrderIdList;
    }
    /**
     * Auto generated value accessor.
     * This parameter is optional.
     ...
     * @return <code>List</code>
     */
    public List getOutOrderHeaderList() {
        return this.outOrderHeaderList;
    }
    /**
     * Auto generated value accessor.
     * This parameter is required.
     * @return <code>String</code>
     */
    public String getOutPicklistId() {
        return this.outPicklistId;
    }
    /**
     * Auto generated value accessor.
     * This parameter is optional.
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is optional.
     * @param inOrderIdList the inOrderIdList to set
    */
    public void setInOrderIdList(List inOrderIdList) {
        this.inParameters.add("orderIdList");
        this.inOrderIdList = inOrderIdList;
    }
    /**
     * Auto generated value setter.
     * This parameter is optional.
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is optional.
     * @param outOrderHeaderList the outOrderHeaderList to set
    */
    public void setOutOrderHeaderList(List outOrderHeaderList) {
        this.outParameters.add("orderHeaderList");
        this.outOrderHeaderList = outOrderHeaderList;
    }
    /**
     * Auto generated value setter.
     * This parameter is required.
     * @param outPicklistId the outPicklistId to set
    */
    public void setOutPicklistId(String outPicklistId) {
        this.outParameters.add("picklistId");
        this.outPicklistId = outPicklistId;
    }
    /**
     * Auto generated value setter.
     * This parameter is optional.
    ...
    */
    ...
    public Map<String, Object> outputMap() {
        ...
        if (outParameters.contains("orderHeaderList")) mapValue.put("orderHeaderList", getOutOrderHeaderList());
        if (outParameters.contains("picklistId")) mapValue.put("picklistId", getOutPicklistId());
    ...
    public void putAllInput(Map<String, Object> mapValue) {
        ...
        if (mapValue.containsKey("orderIdList")) setInOrderIdList((List) mapValue.get("orderIdList"));
    ...
    public void putAllOutput(Map<String, Object> mapValue) {
        ...
        if (mapValue.containsKey("orderHeaderList")) setOutOrderHeaderList((List) mapValue.get("orderHeaderList"));
        if (mapValue.containsKey("picklistId")) setOutPicklistId((String) mapValue.get("picklistId"));
    ...
    /**
     * Construct a <code>CreatePicklistFromOrdersService</code> from the input values of the given <code>CreatePicklistFromOrdersService</code>.
     * @param input a <code>CreatePicklistFromOrdersService</code>
     */
    public static CreatePicklistFromOrdersService fromInput(CreatePicklistFromOrdersService input) {
        CreatePicklistFromOrdersService service = new CreatePicklistFromOrdersService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreatePicklistFromOrdersService</code> from the output values of the given <code>CreatePicklistFromOrdersService</code>.
     * @param output a <code>CreatePicklistFromOrdersService</code>
     */
    public static CreatePicklistFromOrdersService fromOutput(CreatePicklistFromOrdersService output) {
        CreatePicklistFromOrdersService service = new CreatePicklistFromOrdersService();
    ...
    /**
     * Construct a <code>CreatePicklistFromOrdersService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePicklistFromOrdersService fromInput(Map<String, Object> mapValue) {
        CreatePicklistFromOrdersService service = new CreatePicklistFromOrdersService();
    ...
    /**
     * Construct a <code>CreatePicklistFromOrdersService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePicklistFromOrdersService fromOutput(Map<String, Object> mapValue) {
        CreatePicklistFromOrdersService service = new CreatePicklistFromOrdersService();
