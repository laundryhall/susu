 ...
 * Auto generated base service entity updateCommunicationEvent.
 *
 * Engine: simple
 ...
 */
public class UpdateCommunicationEventService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateCommunicationEvent";
    ...
    /**
     * Creates a new <code>UpdateCommunicationEventService</code> instance.
     */
    public UpdateCommunicationEventService() {
        super();
    }
     ...
     */
    public UpdateCommunicationEventService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateCommunicationEventService</code> from the input values of the given <code>UpdateCommunicationEventService</code>.
     * @param input a <code>UpdateCommunicationEventService</code>
     */
    public static UpdateCommunicationEventService fromInput(UpdateCommunicationEventService input) {
        UpdateCommunicationEventService service = new UpdateCommunicationEventService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateCommunicationEventService</code> from the output values of the given <code>UpdateCommunicationEventService</code>.
     * @param output a <code>UpdateCommunicationEventService</code>
     */
    public static UpdateCommunicationEventService fromOutput(UpdateCommunicationEventService output) {
        UpdateCommunicationEventService service = new UpdateCommunicationEventService();
    ...
    /**
     * Construct a <code>UpdateCommunicationEventService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateCommunicationEventService fromInput(Map<String, Object> mapValue) {
        UpdateCommunicationEventService service = new UpdateCommunicationEventService();
    ...
    /**
     * Construct a <code>UpdateCommunicationEventService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateCommunicationEventService fromOutput(Map<String, Object> mapValue) {
        UpdateCommunicationEventService service = new UpdateCommunicationEventService();
