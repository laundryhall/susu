...
/**
 * Upload and import a Lockbox file..
 * Auto generated base service entity financials.uploadLockboxFile.
 *
 * Engine: pojo
 * Location: org.opentaps.financials.domain.billing.lockbox.LockboxService
 * Invoke: uploadLockboxFile
 * Defined in: hot-deploy/financials/servicedef/services_other.xml
 */
public class FinancialsUploadLockboxFileService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "financials.uploadLockboxFile";
    ...
    /**
     * Creates a new <code>FinancialsUploadLockboxFileService</code> instance.
     */
    public FinancialsUploadLockboxFileService() {
        super();
    }
     ...
     */
    public FinancialsUploadLockboxFileService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>FinancialsUploadLockboxFileService</code> from the input values of the given <code>FinancialsUploadLockboxFileService</code>.
     * @param input a <code>FinancialsUploadLockboxFileService</code>
     */
    public static FinancialsUploadLockboxFileService fromInput(FinancialsUploadLockboxFileService input) {
        FinancialsUploadLockboxFileService service = new FinancialsUploadLockboxFileService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>FinancialsUploadLockboxFileService</code> from the output values of the given <code>FinancialsUploadLockboxFileService</code>.
     * @param output a <code>FinancialsUploadLockboxFileService</code>
     */
    public static FinancialsUploadLockboxFileService fromOutput(FinancialsUploadLockboxFileService output) {
        FinancialsUploadLockboxFileService service = new FinancialsUploadLockboxFileService();
    ...
    /**
     * Construct a <code>FinancialsUploadLockboxFileService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static FinancialsUploadLockboxFileService fromInput(Map<String, Object> mapValue) {
        FinancialsUploadLockboxFileService service = new FinancialsUploadLockboxFileService();
    ...
    /**
     * Construct a <code>FinancialsUploadLockboxFileService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static FinancialsUploadLockboxFileService fromOutput(Map<String, Object> mapValue) {
        FinancialsUploadLockboxFileService service = new FinancialsUploadLockboxFileService();
