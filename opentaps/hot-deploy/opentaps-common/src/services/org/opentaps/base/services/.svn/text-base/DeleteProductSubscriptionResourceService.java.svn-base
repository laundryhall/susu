 ...
 * Auto generated base service entity deleteProductSubscriptionResource.
 *
 * Engine: simple
 ...
 */
public class DeleteProductSubscriptionResourceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteProductSubscriptionResource";
    ...
    /**
     * Creates a new <code>DeleteProductSubscriptionResourceService</code> instance.
     */
    public DeleteProductSubscriptionResourceService() {
        super();
    }
     ...
     */
    public DeleteProductSubscriptionResourceService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductSubscriptionResourceService</code> from the input values of the given <code>DeleteProductSubscriptionResourceService</code>.
     * @param input a <code>DeleteProductSubscriptionResourceService</code>
     */
    public static DeleteProductSubscriptionResourceService fromInput(DeleteProductSubscriptionResourceService input) {
        DeleteProductSubscriptionResourceService service = new DeleteProductSubscriptionResourceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteProductSubscriptionResourceService</code> from the output values of the given <code>DeleteProductSubscriptionResourceService</code>.
     * @param output a <code>DeleteProductSubscriptionResourceService</code>
     */
    public static DeleteProductSubscriptionResourceService fromOutput(DeleteProductSubscriptionResourceService output) {
        DeleteProductSubscriptionResourceService service = new DeleteProductSubscriptionResourceService();
    ...
    /**
     * Construct a <code>DeleteProductSubscriptionResourceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductSubscriptionResourceService fromInput(Map<String, Object> mapValue) {
        DeleteProductSubscriptionResourceService service = new DeleteProductSubscriptionResourceService();
    ...
    /**
     * Construct a <code>DeleteProductSubscriptionResourceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductSubscriptionResourceService fromOutput(Map<String, Object> mapValue) {
        DeleteProductSubscriptionResourceService service = new DeleteProductSubscriptionResourceService();
