 ...
 * Auto generated base service entity invoiceAgreementTerm.
 *
 * Engine: java
 * Location: com.opensourcestrategies.financials.invoice.InvoiceServices
 * Invoke: invoiceAgreementTerm
 * Defined in: hot-deploy/financials/servicedef/services_invoice.xml
 */
public class InvoiceAgreementTermService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "invoiceAgreementTerm";
    ...
    /**
     * Creates a new <code>InvoiceAgreementTermService</code> instance.
     */
    public InvoiceAgreementTermService() {
        super();
    }
     ...
     */
    public InvoiceAgreementTermService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>InvoiceAgreementTermService</code> from the input values of the given <code>InvoiceAgreementTermService</code>.
     * @param input a <code>InvoiceAgreementTermService</code>
     */
    public static InvoiceAgreementTermService fromInput(InvoiceAgreementTermService input) {
        InvoiceAgreementTermService service = new InvoiceAgreementTermService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>InvoiceAgreementTermService</code> from the output values of the given <code>InvoiceAgreementTermService</code>.
     * @param output a <code>InvoiceAgreementTermService</code>
     */
    public static InvoiceAgreementTermService fromOutput(InvoiceAgreementTermService output) {
        InvoiceAgreementTermService service = new InvoiceAgreementTermService();
    ...
    /**
     * Construct a <code>InvoiceAgreementTermService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static InvoiceAgreementTermService fromInput(Map<String, Object> mapValue) {
        InvoiceAgreementTermService service = new InvoiceAgreementTermService();
    ...
    /**
     * Construct a <code>InvoiceAgreementTermService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static InvoiceAgreementTermService fromOutput(Map<String, Object> mapValue) {
        InvoiceAgreementTermService service = new InvoiceAgreementTermService();
