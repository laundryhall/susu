 ...
 * Auto generated base service entity acctgBillingAcctCheck.
 *
 * Engine: simple
...
public class AcctgBillingAcctCheckService extends ServiceWrapper {
    ...
    public static final String NAME = "acctgBillingAcctCheck";
    ...
    /**
     * Creates a new <code>AcctgBillingAcctCheckService</code> instance.
     */
    public AcctgBillingAcctCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AcctgBillingAcctCheckService</code> from the input values of the given <code>AcctgBillingAcctCheckService</code>.
     * @param input a <code>AcctgBillingAcctCheckService</code>
     */
    public static AcctgBillingAcctCheckService fromInput(AcctgBillingAcctCheckService input) {
        AcctgBillingAcctCheckService service = new AcctgBillingAcctCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AcctgBillingAcctCheckService</code> from the output values of the given <code>AcctgBillingAcctCheckService</code>.
     * @param output a <code>AcctgBillingAcctCheckService</code>
     */
    public static AcctgBillingAcctCheckService fromOutput(AcctgBillingAcctCheckService output) {
        AcctgBillingAcctCheckService service = new AcctgBillingAcctCheckService();
    ...
    /**
     * Construct a <code>AcctgBillingAcctCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AcctgBillingAcctCheckService fromInput(Map<String, Object> mapValue) {
        AcctgBillingAcctCheckService service = new AcctgBillingAcctCheckService();
    ...
    /**
     * Construct a <code>AcctgBillingAcctCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AcctgBillingAcctCheckService fromOutput(Map<String, Object> mapValue) {
        AcctgBillingAcctCheckService service = new AcctgBillingAcctCheckService();
