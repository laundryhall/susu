 ...
 * Auto generated base service entity removeContentRevisionItem.
 *
 * Engine: simple
 ...
 */
public class RemoveContentRevisionItemService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "removeContentRevisionItem";
    ...
    /**
     * Creates a new <code>RemoveContentRevisionItemService</code> instance.
     */
    public RemoveContentRevisionItemService() {
        super();
    }
     ...
     */
    public RemoveContentRevisionItemService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>RemoveContentRevisionItemService</code> from the input values of the given <code>RemoveContentRevisionItemService</code>.
     * @param input a <code>RemoveContentRevisionItemService</code>
     */
    public static RemoveContentRevisionItemService fromInput(RemoveContentRevisionItemService input) {
        RemoveContentRevisionItemService service = new RemoveContentRevisionItemService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>RemoveContentRevisionItemService</code> from the output values of the given <code>RemoveContentRevisionItemService</code>.
     * @param output a <code>RemoveContentRevisionItemService</code>
     */
    public static RemoveContentRevisionItemService fromOutput(RemoveContentRevisionItemService output) {
        RemoveContentRevisionItemService service = new RemoveContentRevisionItemService();
    ...
    /**
     * Construct a <code>RemoveContentRevisionItemService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveContentRevisionItemService fromInput(Map<String, Object> mapValue) {
        RemoveContentRevisionItemService service = new RemoveContentRevisionItemService();
    ...
    /**
     * Construct a <code>RemoveContentRevisionItemService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveContentRevisionItemService fromOutput(Map<String, Object> mapValue) {
        RemoveContentRevisionItemService service = new RemoveContentRevisionItemService();
