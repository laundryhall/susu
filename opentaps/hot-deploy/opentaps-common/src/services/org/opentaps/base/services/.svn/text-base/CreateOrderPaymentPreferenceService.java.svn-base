 ...
 * Auto generated base service entity createOrderPaymentPreference.
 *
 * Engine: java
 ...
 */
public class CreateOrderPaymentPreferenceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createOrderPaymentPreference";
    ...
    /**
     * Creates a new <code>CreateOrderPaymentPreferenceService</code> instance.
     */
    public CreateOrderPaymentPreferenceService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateOrderPaymentPreferenceService</code> from the input values of the given <code>CreateOrderPaymentPreferenceService</code>.
     * @param input a <code>CreateOrderPaymentPreferenceService</code>
     */
    public static CreateOrderPaymentPreferenceService fromInput(CreateOrderPaymentPreferenceService input) {
        CreateOrderPaymentPreferenceService service = new CreateOrderPaymentPreferenceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateOrderPaymentPreferenceService</code> from the output values of the given <code>CreateOrderPaymentPreferenceService</code>.
     * @param output a <code>CreateOrderPaymentPreferenceService</code>
     */
    public static CreateOrderPaymentPreferenceService fromOutput(CreateOrderPaymentPreferenceService output) {
        CreateOrderPaymentPreferenceService service = new CreateOrderPaymentPreferenceService();
    ...
    /**
     * Construct a <code>CreateOrderPaymentPreferenceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateOrderPaymentPreferenceService fromInput(Map<String, Object> mapValue) {
        CreateOrderPaymentPreferenceService service = new CreateOrderPaymentPreferenceService();
    ...
    /**
     * Construct a <code>CreateOrderPaymentPreferenceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateOrderPaymentPreferenceService fromOutput(Map<String, Object> mapValue) {
        CreateOrderPaymentPreferenceService service = new CreateOrderPaymentPreferenceService();
