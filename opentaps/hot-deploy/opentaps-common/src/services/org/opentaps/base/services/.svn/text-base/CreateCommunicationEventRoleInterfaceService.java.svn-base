 ...
 * Auto generated base service entity createCommunicationEventRoleInterface.
 *
 * Engine: interface
 * Location: 
 * Invoke: 
 ...
 */
public class CreateCommunicationEventRoleInterfaceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createCommunicationEventRoleInterface";
    ...
    /**
     * Creates a new <code>CreateCommunicationEventRoleInterfaceService</code> instance.
     */
    public CreateCommunicationEventRoleInterfaceService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateCommunicationEventRoleInterfaceService</code> from the input values of the given <code>CreateCommunicationEventRoleInterfaceService</code>.
     * @param input a <code>CreateCommunicationEventRoleInterfaceService</code>
     */
    public static CreateCommunicationEventRoleInterfaceService fromInput(CreateCommunicationEventRoleInterfaceService input) {
        CreateCommunicationEventRoleInterfaceService service = new CreateCommunicationEventRoleInterfaceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateCommunicationEventRoleInterfaceService</code> from the output values of the given <code>CreateCommunicationEventRoleInterfaceService</code>.
     * @param output a <code>CreateCommunicationEventRoleInterfaceService</code>
     */
    public static CreateCommunicationEventRoleInterfaceService fromOutput(CreateCommunicationEventRoleInterfaceService output) {
        CreateCommunicationEventRoleInterfaceService service = new CreateCommunicationEventRoleInterfaceService();
    ...
    /**
     * Construct a <code>CreateCommunicationEventRoleInterfaceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCommunicationEventRoleInterfaceService fromInput(Map<String, Object> mapValue) {
        CreateCommunicationEventRoleInterfaceService service = new CreateCommunicationEventRoleInterfaceService();
    ...
    /**
     * Construct a <code>CreateCommunicationEventRoleInterfaceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCommunicationEventRoleInterfaceService fromOutput(Map<String, Object> mapValue) {
        CreateCommunicationEventRoleInterfaceService service = new CreateCommunicationEventRoleInterfaceService();
