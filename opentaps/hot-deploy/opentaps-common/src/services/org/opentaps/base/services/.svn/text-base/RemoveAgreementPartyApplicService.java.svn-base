 ...
 * Auto generated base service entity removeAgreementPartyApplic.
 *
 * Engine: simple
 ...
 */
public class RemoveAgreementPartyApplicService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "removeAgreementPartyApplic";
    ...
    /**
     * Creates a new <code>RemoveAgreementPartyApplicService</code> instance.
     */
    public RemoveAgreementPartyApplicService() {
        super();
    }
     ...
     */
    public RemoveAgreementPartyApplicService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>RemoveAgreementPartyApplicService</code> from the input values of the given <code>RemoveAgreementPartyApplicService</code>.
     * @param input a <code>RemoveAgreementPartyApplicService</code>
     */
    public static RemoveAgreementPartyApplicService fromInput(RemoveAgreementPartyApplicService input) {
        RemoveAgreementPartyApplicService service = new RemoveAgreementPartyApplicService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>RemoveAgreementPartyApplicService</code> from the output values of the given <code>RemoveAgreementPartyApplicService</code>.
     * @param output a <code>RemoveAgreementPartyApplicService</code>
     */
    public static RemoveAgreementPartyApplicService fromOutput(RemoveAgreementPartyApplicService output) {
        RemoveAgreementPartyApplicService service = new RemoveAgreementPartyApplicService();
    ...
    /**
     * Construct a <code>RemoveAgreementPartyApplicService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveAgreementPartyApplicService fromInput(Map<String, Object> mapValue) {
        RemoveAgreementPartyApplicService service = new RemoveAgreementPartyApplicService();
    ...
    /**
     * Construct a <code>RemoveAgreementPartyApplicService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveAgreementPartyApplicService fromOutput(Map<String, Object> mapValue) {
        RemoveAgreementPartyApplicService service = new RemoveAgreementPartyApplicService();
