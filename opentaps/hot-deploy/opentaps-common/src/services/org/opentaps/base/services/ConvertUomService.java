 ...
 * Auto generated base service entity convertUom.
 *
 * Engine: simple
...
public class ConvertUomService extends ServiceWrapper {
    ...
    public static final String NAME = "convertUom";
    ...
    /**
     * Creates a new <code>ConvertUomService</code> instance.
     */
    public ConvertUomService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>ConvertUomService</code> from the input values of the given <code>ConvertUomService</code>.
     * @param input a <code>ConvertUomService</code>
     */
    public static ConvertUomService fromInput(ConvertUomService input) {
        ConvertUomService service = new ConvertUomService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>ConvertUomService</code> from the output values of the given <code>ConvertUomService</code>.
     * @param output a <code>ConvertUomService</code>
     */
    public static ConvertUomService fromOutput(ConvertUomService output) {
        ConvertUomService service = new ConvertUomService();
    ...
    /**
     * Construct a <code>ConvertUomService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ConvertUomService fromInput(Map<String, Object> mapValue) {
        ConvertUomService service = new ConvertUomService();
    ...
    /**
     * Construct a <code>ConvertUomService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ConvertUomService fromOutput(Map<String, Object> mapValue) {
        ConvertUomService service = new ConvertUomService();
