...
/**
 * .
 * Auto generated base service entity createSimpleNonProductSalesOrder.
 *
 * Engine: java
 ...
 */
public class CreateSimpleNonProductSalesOrderService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createSimpleNonProductSalesOrder";
    ...
    /**
     * Creates a new <code>CreateSimpleNonProductSalesOrderService</code> instance.
     */
    public CreateSimpleNonProductSalesOrderService() {
        super();
    }
     ...
     */
    public CreateSimpleNonProductSalesOrderService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateSimpleNonProductSalesOrderService</code> from the input values of the given <code>CreateSimpleNonProductSalesOrderService</code>.
     * @param input a <code>CreateSimpleNonProductSalesOrderService</code>
     */
    public static CreateSimpleNonProductSalesOrderService fromInput(CreateSimpleNonProductSalesOrderService input) {
        CreateSimpleNonProductSalesOrderService service = new CreateSimpleNonProductSalesOrderService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateSimpleNonProductSalesOrderService</code> from the output values of the given <code>CreateSimpleNonProductSalesOrderService</code>.
     * @param output a <code>CreateSimpleNonProductSalesOrderService</code>
     */
    public static CreateSimpleNonProductSalesOrderService fromOutput(CreateSimpleNonProductSalesOrderService output) {
        CreateSimpleNonProductSalesOrderService service = new CreateSimpleNonProductSalesOrderService();
    ...
    /**
     * Construct a <code>CreateSimpleNonProductSalesOrderService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateSimpleNonProductSalesOrderService fromInput(Map<String, Object> mapValue) {
        CreateSimpleNonProductSalesOrderService service = new CreateSimpleNonProductSalesOrderService();
    ...
    /**
     * Construct a <code>CreateSimpleNonProductSalesOrderService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateSimpleNonProductSalesOrderService fromOutput(Map<String, Object> mapValue) {
        CreateSimpleNonProductSalesOrderService service = new CreateSimpleNonProductSalesOrderService();
