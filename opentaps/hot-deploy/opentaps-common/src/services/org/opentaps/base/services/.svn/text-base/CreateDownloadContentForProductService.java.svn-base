...
/**
 * .
 * Auto generated base service entity createDownloadContentForProduct.
 *
 * Engine: simple
 ...
 */
public class CreateDownloadContentForProductService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createDownloadContentForProduct";
    ...
    /**
     * Creates a new <code>CreateDownloadContentForProductService</code> instance.
     */
    public CreateDownloadContentForProductService() {
        super();
    }
     ...
     */
    public CreateDownloadContentForProductService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateDownloadContentForProductService</code> from the input values of the given <code>CreateDownloadContentForProductService</code>.
     * @param input a <code>CreateDownloadContentForProductService</code>
     */
    public static CreateDownloadContentForProductService fromInput(CreateDownloadContentForProductService input) {
        CreateDownloadContentForProductService service = new CreateDownloadContentForProductService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateDownloadContentForProductService</code> from the output values of the given <code>CreateDownloadContentForProductService</code>.
     * @param output a <code>CreateDownloadContentForProductService</code>
     */
    public static CreateDownloadContentForProductService fromOutput(CreateDownloadContentForProductService output) {
        CreateDownloadContentForProductService service = new CreateDownloadContentForProductService();
    ...
    /**
     * Construct a <code>CreateDownloadContentForProductService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateDownloadContentForProductService fromInput(Map<String, Object> mapValue) {
        CreateDownloadContentForProductService service = new CreateDownloadContentForProductService();
    ...
    /**
     * Construct a <code>CreateDownloadContentForProductService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateDownloadContentForProductService fromOutput(Map<String, Object> mapValue) {
        CreateDownloadContentForProductService service = new CreateDownloadContentForProductService();
