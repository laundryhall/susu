...
/**
 * EFT Refund service for eCheck.NET using the Authorize.NET credentials..
 * Auto generated base service entity eCheckNetRefund.
 *
 * Engine: java
...
public class ECheckNetRefundService extends ServiceWrapper {
    ...
    public static final String NAME = "eCheckNetRefund";
    ...
    /**
     * Creates a new <code>ECheckNetRefundService</code> instance.
     */
    public ECheckNetRefundService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>ECheckNetRefundService</code> from the input values of the given <code>ECheckNetRefundService</code>.
     * @param input a <code>ECheckNetRefundService</code>
     */
    public static ECheckNetRefundService fromInput(ECheckNetRefundService input) {
        ECheckNetRefundService service = new ECheckNetRefundService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>ECheckNetRefundService</code> from the output values of the given <code>ECheckNetRefundService</code>.
     * @param output a <code>ECheckNetRefundService</code>
     */
    public static ECheckNetRefundService fromOutput(ECheckNetRefundService output) {
        ECheckNetRefundService service = new ECheckNetRefundService();
    ...
    /**
     * Construct a <code>ECheckNetRefundService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ECheckNetRefundService fromInput(Map<String, Object> mapValue) {
        ECheckNetRefundService service = new ECheckNetRefundService();
    ...
    /**
     * Construct a <code>ECheckNetRefundService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ECheckNetRefundService fromOutput(Map<String, Object> mapValue) {
        ECheckNetRefundService service = new ECheckNetRefundService();
