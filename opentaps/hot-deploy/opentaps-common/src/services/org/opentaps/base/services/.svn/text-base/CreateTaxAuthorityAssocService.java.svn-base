 ...
 */
public class CreateTaxAuthorityAssocService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>CreateTaxAuthorityAssocService</code> instance.
     */
    public CreateTaxAuthorityAssocService() {
        super();
    }
     ...
     */
    public CreateTaxAuthorityAssocService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateTaxAuthorityAssocService</code> from the input values of the given <code>CreateTaxAuthorityAssocService</code>.
     * @param input a <code>CreateTaxAuthorityAssocService</code>
     */
    public static CreateTaxAuthorityAssocService fromInput(CreateTaxAuthorityAssocService input) {
        CreateTaxAuthorityAssocService service = new CreateTaxAuthorityAssocService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateTaxAuthorityAssocService</code> from the output values of the given <code>CreateTaxAuthorityAssocService</code>.
     * @param output a <code>CreateTaxAuthorityAssocService</code>
     */
    public static CreateTaxAuthorityAssocService fromOutput(CreateTaxAuthorityAssocService output) {
        CreateTaxAuthorityAssocService service = new CreateTaxAuthorityAssocService();
    ...
    /**
     * Construct a <code>CreateTaxAuthorityAssocService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateTaxAuthorityAssocService fromInput(Map<String, Object> mapValue) {
        CreateTaxAuthorityAssocService service = new CreateTaxAuthorityAssocService();
    ...
    /**
     * Construct a <code>CreateTaxAuthorityAssocService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateTaxAuthorityAssocService fromOutput(Map<String, Object> mapValue) {
        CreateTaxAuthorityAssocService service = new CreateTaxAuthorityAssocService();
