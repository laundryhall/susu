 ...
 * Auto generated base service entity acctgPrefPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class AcctgPrefPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "acctgPrefPermissionCheck";
    ...
    /**
     * Creates a new <code>AcctgPrefPermissionCheckService</code> instance.
     */
    public AcctgPrefPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AcctgPrefPermissionCheckService</code> from the input values of the given <code>AcctgPrefPermissionCheckService</code>.
     * @param input a <code>AcctgPrefPermissionCheckService</code>
     */
    public static AcctgPrefPermissionCheckService fromInput(AcctgPrefPermissionCheckService input) {
        AcctgPrefPermissionCheckService service = new AcctgPrefPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AcctgPrefPermissionCheckService</code> from the output values of the given <code>AcctgPrefPermissionCheckService</code>.
     * @param output a <code>AcctgPrefPermissionCheckService</code>
     */
    public static AcctgPrefPermissionCheckService fromOutput(AcctgPrefPermissionCheckService output) {
        AcctgPrefPermissionCheckService service = new AcctgPrefPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgPrefPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AcctgPrefPermissionCheckService fromInput(Map<String, Object> mapValue) {
        AcctgPrefPermissionCheckService service = new AcctgPrefPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgPrefPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AcctgPrefPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        AcctgPrefPermissionCheckService service = new AcctgPrefPermissionCheckService();
