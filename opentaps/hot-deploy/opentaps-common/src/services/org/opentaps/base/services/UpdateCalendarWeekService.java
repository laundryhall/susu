 ...
 * Auto generated base service entity updateCalendarWeek.
 *
 * Engine: simple
...
public class UpdateCalendarWeekService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>UpdateCalendarWeekService</code> instance.
     */
    public UpdateCalendarWeekService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateCalendarWeekService</code> from the input values of the given <code>UpdateCalendarWeekService</code>.
     * @param input a <code>UpdateCalendarWeekService</code>
     */
    public static UpdateCalendarWeekService fromInput(UpdateCalendarWeekService input) {
        UpdateCalendarWeekService service = new UpdateCalendarWeekService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateCalendarWeekService</code> from the output values of the given <code>UpdateCalendarWeekService</code>.
     * @param output a <code>UpdateCalendarWeekService</code>
     */
    public static UpdateCalendarWeekService fromOutput(UpdateCalendarWeekService output) {
        UpdateCalendarWeekService service = new UpdateCalendarWeekService();
    ...
    /**
     * Construct a <code>UpdateCalendarWeekService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateCalendarWeekService fromInput(Map<String, Object> mapValue) {
        UpdateCalendarWeekService service = new UpdateCalendarWeekService();
    ...
    /**
     * Construct a <code>UpdateCalendarWeekService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateCalendarWeekService fromOutput(Map<String, Object> mapValue) {
        UpdateCalendarWeekService service = new UpdateCalendarWeekService();
