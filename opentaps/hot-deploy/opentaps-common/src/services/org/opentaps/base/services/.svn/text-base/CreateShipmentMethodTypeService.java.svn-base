 ...
 * Auto generated base service entity createShipmentMethodType.
 *
 * Engine: simple
 ...
 */
public class CreateShipmentMethodTypeService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createShipmentMethodType";
    ...
    /**
     * Creates a new <code>CreateShipmentMethodTypeService</code> instance.
     */
    public CreateShipmentMethodTypeService() {
        super();
    }
     ...
     */
    public CreateShipmentMethodTypeService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateShipmentMethodTypeService</code> from the input values of the given <code>CreateShipmentMethodTypeService</code>.
     * @param input a <code>CreateShipmentMethodTypeService</code>
     */
    public static CreateShipmentMethodTypeService fromInput(CreateShipmentMethodTypeService input) {
        CreateShipmentMethodTypeService service = new CreateShipmentMethodTypeService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateShipmentMethodTypeService</code> from the output values of the given <code>CreateShipmentMethodTypeService</code>.
     * @param output a <code>CreateShipmentMethodTypeService</code>
     */
    public static CreateShipmentMethodTypeService fromOutput(CreateShipmentMethodTypeService output) {
        CreateShipmentMethodTypeService service = new CreateShipmentMethodTypeService();
    ...
    /**
     * Construct a <code>CreateShipmentMethodTypeService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateShipmentMethodTypeService fromInput(Map<String, Object> mapValue) {
        CreateShipmentMethodTypeService service = new CreateShipmentMethodTypeService();
    ...
    /**
     * Construct a <code>CreateShipmentMethodTypeService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateShipmentMethodTypeService fromOutput(Map<String, Object> mapValue) {
        CreateShipmentMethodTypeService service = new CreateShipmentMethodTypeService();
