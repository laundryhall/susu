...
/**
 * .
 * Auto generated base service entity portalPermissionIsEmployee.
 *
 * Engine: simple
 ...
 */
public class PortalPermissionIsEmployeeService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "portalPermissionIsEmployee";
    ...
    /**
     * Creates a new <code>PortalPermissionIsEmployeeService</code> instance.
     */
    public PortalPermissionIsEmployeeService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>PortalPermissionIsEmployeeService</code> from the input values of the given <code>PortalPermissionIsEmployeeService</code>.
     * @param input a <code>PortalPermissionIsEmployeeService</code>
     */
    public static PortalPermissionIsEmployeeService fromInput(PortalPermissionIsEmployeeService input) {
        PortalPermissionIsEmployeeService service = new PortalPermissionIsEmployeeService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>PortalPermissionIsEmployeeService</code> from the output values of the given <code>PortalPermissionIsEmployeeService</code>.
     * @param output a <code>PortalPermissionIsEmployeeService</code>
     */
    public static PortalPermissionIsEmployeeService fromOutput(PortalPermissionIsEmployeeService output) {
        PortalPermissionIsEmployeeService service = new PortalPermissionIsEmployeeService();
    ...
    /**
     * Construct a <code>PortalPermissionIsEmployeeService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PortalPermissionIsEmployeeService fromInput(Map<String, Object> mapValue) {
        PortalPermissionIsEmployeeService service = new PortalPermissionIsEmployeeService();
    ...
    /**
     * Construct a <code>PortalPermissionIsEmployeeService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PortalPermissionIsEmployeeService fromOutput(Map<String, Object> mapValue) {
        PortalPermissionIsEmployeeService service = new PortalPermissionIsEmployeeService();
