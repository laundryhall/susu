 ...
 * Auto generated base service entity createCreditCardTypeGlAccount.
 *
 * Engine: simple
 ...
 */
public class CreateCreditCardTypeGlAccountService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createCreditCardTypeGlAccount";
    ...
    /**
     * Creates a new <code>CreateCreditCardTypeGlAccountService</code> instance.
     */
    public CreateCreditCardTypeGlAccountService() {
        super();
    }
     ...
     */
    public CreateCreditCardTypeGlAccountService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateCreditCardTypeGlAccountService</code> from the input values of the given <code>CreateCreditCardTypeGlAccountService</code>.
     * @param input a <code>CreateCreditCardTypeGlAccountService</code>
     */
    public static CreateCreditCardTypeGlAccountService fromInput(CreateCreditCardTypeGlAccountService input) {
        CreateCreditCardTypeGlAccountService service = new CreateCreditCardTypeGlAccountService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateCreditCardTypeGlAccountService</code> from the output values of the given <code>CreateCreditCardTypeGlAccountService</code>.
     * @param output a <code>CreateCreditCardTypeGlAccountService</code>
     */
    public static CreateCreditCardTypeGlAccountService fromOutput(CreateCreditCardTypeGlAccountService output) {
        CreateCreditCardTypeGlAccountService service = new CreateCreditCardTypeGlAccountService();
    ...
    /**
     * Construct a <code>CreateCreditCardTypeGlAccountService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCreditCardTypeGlAccountService fromInput(Map<String, Object> mapValue) {
        CreateCreditCardTypeGlAccountService service = new CreateCreditCardTypeGlAccountService();
    ...
    /**
     * Construct a <code>CreateCreditCardTypeGlAccountService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCreditCardTypeGlAccountService fromOutput(Map<String, Object> mapValue) {
        CreateCreditCardTypeGlAccountService service = new CreateCreditCardTypeGlAccountService();
