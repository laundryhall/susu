 ...
 * Auto generated base service entity deleteWorkEffortRequestItem.
 *
 * Engine: simple
 ...
 */
public class DeleteWorkEffortRequestItemService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteWorkEffortRequestItem";
    ...
    /**
     * Creates a new <code>DeleteWorkEffortRequestItemService</code> instance.
     */
    public DeleteWorkEffortRequestItemService() {
        super();
    }
     ...
     */
    public DeleteWorkEffortRequestItemService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteWorkEffortRequestItemService</code> from the input values of the given <code>DeleteWorkEffortRequestItemService</code>.
     * @param input a <code>DeleteWorkEffortRequestItemService</code>
     */
    public static DeleteWorkEffortRequestItemService fromInput(DeleteWorkEffortRequestItemService input) {
        DeleteWorkEffortRequestItemService service = new DeleteWorkEffortRequestItemService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteWorkEffortRequestItemService</code> from the output values of the given <code>DeleteWorkEffortRequestItemService</code>.
     * @param output a <code>DeleteWorkEffortRequestItemService</code>
     */
    public static DeleteWorkEffortRequestItemService fromOutput(DeleteWorkEffortRequestItemService output) {
        DeleteWorkEffortRequestItemService service = new DeleteWorkEffortRequestItemService();
    ...
    /**
     * Construct a <code>DeleteWorkEffortRequestItemService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteWorkEffortRequestItemService fromInput(Map<String, Object> mapValue) {
        DeleteWorkEffortRequestItemService service = new DeleteWorkEffortRequestItemService();
    ...
    /**
     * Construct a <code>DeleteWorkEffortRequestItemService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteWorkEffortRequestItemService fromOutput(Map<String, Object> mapValue) {
        DeleteWorkEffortRequestItemService service = new DeleteWorkEffortRequestItemService();
