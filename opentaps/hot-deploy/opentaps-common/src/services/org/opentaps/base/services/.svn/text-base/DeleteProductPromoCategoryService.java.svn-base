 ...
 * Auto generated base service entity deleteProductPromoCategory.
 *
 * Engine: simple
 ...
 */
public class DeleteProductPromoCategoryService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteProductPromoCategory";
    ...
    /**
     * Creates a new <code>DeleteProductPromoCategoryService</code> instance.
     */
    public DeleteProductPromoCategoryService() {
        super();
    }
     ...
     */
    public DeleteProductPromoCategoryService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductPromoCategoryService</code> from the input values of the given <code>DeleteProductPromoCategoryService</code>.
     * @param input a <code>DeleteProductPromoCategoryService</code>
     */
    public static DeleteProductPromoCategoryService fromInput(DeleteProductPromoCategoryService input) {
        DeleteProductPromoCategoryService service = new DeleteProductPromoCategoryService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteProductPromoCategoryService</code> from the output values of the given <code>DeleteProductPromoCategoryService</code>.
     * @param output a <code>DeleteProductPromoCategoryService</code>
     */
    public static DeleteProductPromoCategoryService fromOutput(DeleteProductPromoCategoryService output) {
        DeleteProductPromoCategoryService service = new DeleteProductPromoCategoryService();
    ...
    /**
     * Construct a <code>DeleteProductPromoCategoryService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductPromoCategoryService fromInput(Map<String, Object> mapValue) {
        DeleteProductPromoCategoryService service = new DeleteProductPromoCategoryService();
    ...
    /**
     * Construct a <code>DeleteProductPromoCategoryService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductPromoCategoryService fromOutput(Map<String, Object> mapValue) {
        DeleteProductPromoCategoryService service = new DeleteProductPromoCategoryService();
