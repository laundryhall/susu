 ...
 * Auto generated base service entity createProductStoreSurveyAppl.
 *
 * Engine: simple
 * Location: component://product/script/org/ofbiz/product/store/ProductStoreServices.xml
 * Invoke: createProductStoreSurveyAppl
 * Defined in: applications/product/servicedef/services_store.xml
 */
public class CreateProductStoreSurveyApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createProductStoreSurveyAppl";
    ...
    /**
     * Creates a new <code>CreateProductStoreSurveyApplService</code> instance.
     */
    public CreateProductStoreSurveyApplService() {
        super();
    }
     ...
     */
    public CreateProductStoreSurveyApplService(User user) {
        super(user);
    }
    ...
    private String inResultTemplate;
    private Long inSequenceNum;
    private String inSurveyApplTypeId;
    private String inSurveyId;
    private String inSurveyTemplate;
     ...
     * @return <code>String</code>
     */
    public String getInResultTemplate() {
        return this.inResultTemplate;
    }
    /**
     * Auto generated value accessor.
     * This parameter is optional.
     ...
     * @return <code>String</code>
     */
    public String getInSurveyApplTypeId() {
        return this.inSurveyApplTypeId;
    }
    /**
     * Auto generated value accessor.
     * This parameter is optional.
     ...
     * @return <code>String</code>
     */
    public String getInSurveyTemplate() {
        return this.inSurveyTemplate;
    }
    /**
     * Auto generated value accessor.
     * This parameter is optional.
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is optional.
     * @param inResultTemplate the inResultTemplate to set
    */
    public void setInResultTemplate(String inResultTemplate) {
        this.inParameters.add("resultTemplate");
        this.inResultTemplate = inResultTemplate;
    }
    /**
     * Auto generated value setter.
     * This parameter is optional.
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is optional.
     * @param inSurveyApplTypeId the inSurveyApplTypeId to set
    */
    public void setInSurveyApplTypeId(String inSurveyApplTypeId) {
        this.inParameters.add("surveyApplTypeId");
        this.inSurveyApplTypeId = inSurveyApplTypeId;
    }
    /**
     * Auto generated value setter.
     * This parameter is optional.
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is optional.
     * @param inSurveyTemplate the inSurveyTemplate to set
    */
    public void setInSurveyTemplate(String inSurveyTemplate) {
        this.inParameters.add("surveyTemplate");
        this.inSurveyTemplate = inSurveyTemplate;
    }
    /**
     * Auto generated value setter.
     * This parameter is optional.
    ...
    */
    ...
    public Map<String, Object> inputMap() {
        ...
        if (inParameters.contains("resultTemplate")) mapValue.put("resultTemplate", getInResultTemplate());
        if (inParameters.contains("sequenceNum")) mapValue.put("sequenceNum", getInSequenceNum());
        if (inParameters.contains("surveyApplTypeId")) mapValue.put("surveyApplTypeId", getInSurveyApplTypeId());
        if (inParameters.contains("surveyId")) mapValue.put("surveyId", getInSurveyId());
        if (inParameters.contains("surveyTemplate")) mapValue.put("surveyTemplate", getInSurveyTemplate());
    ...
    public void putAllInput(Map<String, Object> mapValue) {
        ...
        if (mapValue.containsKey("resultTemplate")) setInResultTemplate((String) mapValue.get("resultTemplate"));
        if (mapValue.containsKey("sequenceNum")) setInSequenceNum((Long) mapValue.get("sequenceNum"));
        if (mapValue.containsKey("surveyApplTypeId")) setInSurveyApplTypeId((String) mapValue.get("surveyApplTypeId"));
        if (mapValue.containsKey("surveyId")) setInSurveyId((String) mapValue.get("surveyId"));
        if (mapValue.containsKey("surveyTemplate")) setInSurveyTemplate((String) mapValue.get("surveyTemplate"));
    ...
    /**
     * Construct a <code>CreateProductStoreSurveyApplService</code> from the input values of the given <code>CreateProductStoreSurveyApplService</code>.
     * @param input a <code>CreateProductStoreSurveyApplService</code>
     */
    public static CreateProductStoreSurveyApplService fromInput(CreateProductStoreSurveyApplService input) {
        CreateProductStoreSurveyApplService service = new CreateProductStoreSurveyApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateProductStoreSurveyApplService</code> from the output values of the given <code>CreateProductStoreSurveyApplService</code>.
     * @param output a <code>CreateProductStoreSurveyApplService</code>
     */
    public static CreateProductStoreSurveyApplService fromOutput(CreateProductStoreSurveyApplService output) {
        CreateProductStoreSurveyApplService service = new CreateProductStoreSurveyApplService();
    ...
    /**
     * Construct a <code>CreateProductStoreSurveyApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateProductStoreSurveyApplService fromInput(Map<String, Object> mapValue) {
        CreateProductStoreSurveyApplService service = new CreateProductStoreSurveyApplService();
    ...
    /**
     * Construct a <code>CreateProductStoreSurveyApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateProductStoreSurveyApplService fromOutput(Map<String, Object> mapValue) {
        CreateProductStoreSurveyApplService service = new CreateProductStoreSurveyApplService();
