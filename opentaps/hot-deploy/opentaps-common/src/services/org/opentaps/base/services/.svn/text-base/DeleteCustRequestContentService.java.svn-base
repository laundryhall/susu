 ...
 * Auto generated base service entity deleteCustRequestContent.
 *
 * Engine: simple
 ...
 */
public class DeleteCustRequestContentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteCustRequestContent";
    ...
    /**
     * Creates a new <code>DeleteCustRequestContentService</code> instance.
     */
    public DeleteCustRequestContentService() {
        super();
    }
     ...
     */
    public DeleteCustRequestContentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteCustRequestContentService</code> from the input values of the given <code>DeleteCustRequestContentService</code>.
     * @param input a <code>DeleteCustRequestContentService</code>
     */
    public static DeleteCustRequestContentService fromInput(DeleteCustRequestContentService input) {
        DeleteCustRequestContentService service = new DeleteCustRequestContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteCustRequestContentService</code> from the output values of the given <code>DeleteCustRequestContentService</code>.
     * @param output a <code>DeleteCustRequestContentService</code>
     */
    public static DeleteCustRequestContentService fromOutput(DeleteCustRequestContentService output) {
        DeleteCustRequestContentService service = new DeleteCustRequestContentService();
    ...
    /**
     * Construct a <code>DeleteCustRequestContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteCustRequestContentService fromInput(Map<String, Object> mapValue) {
        DeleteCustRequestContentService service = new DeleteCustRequestContentService();
    ...
    /**
     * Construct a <code>DeleteCustRequestContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteCustRequestContentService fromOutput(Map<String, Object> mapValue) {
        DeleteCustRequestContentService service = new DeleteCustRequestContentService();
