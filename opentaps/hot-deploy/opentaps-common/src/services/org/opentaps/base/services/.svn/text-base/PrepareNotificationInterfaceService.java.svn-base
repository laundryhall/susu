 ...
 * Auto generated base service entity prepareNotificationInterface.
 *
 * Engine: interface
 * Location: 
 * Invoke: 
 ...
 */
public class PrepareNotificationInterfaceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "prepareNotificationInterface";
    ...
    /**
     * Creates a new <code>PrepareNotificationInterfaceService</code> instance.
     */
    public PrepareNotificationInterfaceService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>PrepareNotificationInterfaceService</code> from the input values of the given <code>PrepareNotificationInterfaceService</code>.
     * @param input a <code>PrepareNotificationInterfaceService</code>
     */
    public static PrepareNotificationInterfaceService fromInput(PrepareNotificationInterfaceService input) {
        PrepareNotificationInterfaceService service = new PrepareNotificationInterfaceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>PrepareNotificationInterfaceService</code> from the output values of the given <code>PrepareNotificationInterfaceService</code>.
     * @param output a <code>PrepareNotificationInterfaceService</code>
     */
    public static PrepareNotificationInterfaceService fromOutput(PrepareNotificationInterfaceService output) {
        PrepareNotificationInterfaceService service = new PrepareNotificationInterfaceService();
    ...
    /**
     * Construct a <code>PrepareNotificationInterfaceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PrepareNotificationInterfaceService fromInput(Map<String, Object> mapValue) {
        PrepareNotificationInterfaceService service = new PrepareNotificationInterfaceService();
    ...
    /**
     * Construct a <code>PrepareNotificationInterfaceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PrepareNotificationInterfaceService fromOutput(Map<String, Object> mapValue) {
        PrepareNotificationInterfaceService service = new PrepareNotificationInterfaceService();
