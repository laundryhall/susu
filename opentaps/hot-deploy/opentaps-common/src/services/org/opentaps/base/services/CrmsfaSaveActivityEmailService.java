 ...
 * Auto generated base service entity crmsfa.saveActivityEmail.
 *
 * Engine: java
 * Location: com.opensourcestrategies.crmsfa.activities.ActivitiesServices
 * Invoke: saveActivityEmail
 * Defined in: hot-deploy/crmsfa/servicedef/services_activities.xml
 */
public class CrmsfaSaveActivityEmailService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.saveActivityEmail";
    ...
    /**
     * Creates a new <code>CrmsfaSaveActivityEmailService</code> instance.
     */
    public CrmsfaSaveActivityEmailService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaSaveActivityEmailService</code> from the input values of the given <code>CrmsfaSaveActivityEmailService</code>.
     * @param input a <code>CrmsfaSaveActivityEmailService</code>
     */
    public static CrmsfaSaveActivityEmailService fromInput(CrmsfaSaveActivityEmailService input) {
        CrmsfaSaveActivityEmailService service = new CrmsfaSaveActivityEmailService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaSaveActivityEmailService</code> from the output values of the given <code>CrmsfaSaveActivityEmailService</code>.
     * @param output a <code>CrmsfaSaveActivityEmailService</code>
     */
    public static CrmsfaSaveActivityEmailService fromOutput(CrmsfaSaveActivityEmailService output) {
        CrmsfaSaveActivityEmailService service = new CrmsfaSaveActivityEmailService();
    ...
    /**
     * Construct a <code>CrmsfaSaveActivityEmailService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>CrmsfaSaveActivityEmailService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaSaveActivityEmailService fromOutput(Map<String, Object> mapValue) {
        CrmsfaSaveActivityEmailService service = new CrmsfaSaveActivityEmailService();
