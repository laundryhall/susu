 ...
 * Auto generated base service entity deleteFacilityContactMechPurpose.
 *
 * Engine: simple
 ...
 */
public class DeleteFacilityContactMechPurposeService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteFacilityContactMechPurpose";
    ...
    /**
     * Creates a new <code>DeleteFacilityContactMechPurposeService</code> instance.
     */
    public DeleteFacilityContactMechPurposeService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteFacilityContactMechPurposeService</code> from the input values of the given <code>DeleteFacilityContactMechPurposeService</code>.
     * @param input a <code>DeleteFacilityContactMechPurposeService</code>
     */
    public static DeleteFacilityContactMechPurposeService fromInput(DeleteFacilityContactMechPurposeService input) {
        DeleteFacilityContactMechPurposeService service = new DeleteFacilityContactMechPurposeService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteFacilityContactMechPurposeService</code> from the output values of the given <code>DeleteFacilityContactMechPurposeService</code>.
     * @param output a <code>DeleteFacilityContactMechPurposeService</code>
     */
    public static DeleteFacilityContactMechPurposeService fromOutput(DeleteFacilityContactMechPurposeService output) {
        DeleteFacilityContactMechPurposeService service = new DeleteFacilityContactMechPurposeService();
    ...
    /**
     * Construct a <code>DeleteFacilityContactMechPurposeService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteFacilityContactMechPurposeService fromInput(Map<String, Object> mapValue) {
        DeleteFacilityContactMechPurposeService service = new DeleteFacilityContactMechPurposeService();
    ...
    /**
     * Construct a <code>DeleteFacilityContactMechPurposeService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteFacilityContactMechPurposeService fromOutput(Map<String, Object> mapValue) {
        DeleteFacilityContactMechPurposeService service = new DeleteFacilityContactMechPurposeService();
