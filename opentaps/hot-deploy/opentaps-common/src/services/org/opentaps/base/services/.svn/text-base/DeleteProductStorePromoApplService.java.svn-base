 ...
 * Auto generated base service entity deleteProductStorePromoAppl.
 *
 * Engine: simple
 ...
 */
public class DeleteProductStorePromoApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteProductStorePromoAppl";
    ...
    /**
     * Creates a new <code>DeleteProductStorePromoApplService</code> instance.
     */
    public DeleteProductStorePromoApplService() {
        super();
    }
     ...
     */
    public DeleteProductStorePromoApplService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductStorePromoApplService</code> from the input values of the given <code>DeleteProductStorePromoApplService</code>.
     * @param input a <code>DeleteProductStorePromoApplService</code>
     */
    public static DeleteProductStorePromoApplService fromInput(DeleteProductStorePromoApplService input) {
        DeleteProductStorePromoApplService service = new DeleteProductStorePromoApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteProductStorePromoApplService</code> from the output values of the given <code>DeleteProductStorePromoApplService</code>.
     * @param output a <code>DeleteProductStorePromoApplService</code>
     */
    public static DeleteProductStorePromoApplService fromOutput(DeleteProductStorePromoApplService output) {
        DeleteProductStorePromoApplService service = new DeleteProductStorePromoApplService();
    ...
    /**
     * Construct a <code>DeleteProductStorePromoApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductStorePromoApplService fromInput(Map<String, Object> mapValue) {
        DeleteProductStorePromoApplService service = new DeleteProductStorePromoApplService();
    ...
    /**
     * Construct a <code>DeleteProductStorePromoApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductStorePromoApplService fromOutput(Map<String, Object> mapValue) {
        DeleteProductStorePromoApplService service = new DeleteProductStorePromoApplService();
