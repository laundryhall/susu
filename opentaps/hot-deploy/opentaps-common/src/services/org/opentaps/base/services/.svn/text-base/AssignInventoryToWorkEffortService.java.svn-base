 ...
 * Auto generated base service entity assignInventoryToWorkEffort.
 *
 * Engine: simple
 ...
 */
public class AssignInventoryToWorkEffortService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "assignInventoryToWorkEffort";
    ...
    /**
     * Creates a new <code>AssignInventoryToWorkEffortService</code> instance.
     */
    public AssignInventoryToWorkEffortService() {
        super();
    }
     ...
     */
    public AssignInventoryToWorkEffortService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>AssignInventoryToWorkEffortService</code> from the input values of the given <code>AssignInventoryToWorkEffortService</code>.
     * @param input a <code>AssignInventoryToWorkEffortService</code>
     */
    public static AssignInventoryToWorkEffortService fromInput(AssignInventoryToWorkEffortService input) {
        AssignInventoryToWorkEffortService service = new AssignInventoryToWorkEffortService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AssignInventoryToWorkEffortService</code> from the output values of the given <code>AssignInventoryToWorkEffortService</code>.
     * @param output a <code>AssignInventoryToWorkEffortService</code>
     */
    public static AssignInventoryToWorkEffortService fromOutput(AssignInventoryToWorkEffortService output) {
        AssignInventoryToWorkEffortService service = new AssignInventoryToWorkEffortService();
    ...
    /**
     * Construct a <code>AssignInventoryToWorkEffortService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AssignInventoryToWorkEffortService fromInput(Map<String, Object> mapValue) {
        AssignInventoryToWorkEffortService service = new AssignInventoryToWorkEffortService();
    ...
    /**
     * Construct a <code>AssignInventoryToWorkEffortService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AssignInventoryToWorkEffortService fromOutput(Map<String, Object> mapValue) {
        AssignInventoryToWorkEffortService service = new AssignInventoryToWorkEffortService();
