 ...
 * Auto generated base service entity upsRateEstimate.
 *
 * Engine: java
 ...
 */
public class UpsRateEstimateService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "upsRateEstimate";
    ...
    /**
     * Creates a new <code>UpsRateEstimateService</code> instance.
     */
    public UpsRateEstimateService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpsRateEstimateService</code> from the input values of the given <code>UpsRateEstimateService</code>.
     * @param input a <code>UpsRateEstimateService</code>
     */
    public static UpsRateEstimateService fromInput(UpsRateEstimateService input) {
        UpsRateEstimateService service = new UpsRateEstimateService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpsRateEstimateService</code> from the output values of the given <code>UpsRateEstimateService</code>.
     * @param output a <code>UpsRateEstimateService</code>
     */
    public static UpsRateEstimateService fromOutput(UpsRateEstimateService output) {
        UpsRateEstimateService service = new UpsRateEstimateService();
    ...
    /**
     * Construct a <code>UpsRateEstimateService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>UpsRateEstimateService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpsRateEstimateService fromOutput(Map<String, Object> mapValue) {
        UpsRateEstimateService service = new UpsRateEstimateService();
