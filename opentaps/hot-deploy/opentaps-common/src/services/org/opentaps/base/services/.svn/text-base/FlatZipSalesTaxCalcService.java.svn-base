 ...
 * Auto generated base service entity flatZipSalesTaxCalc.
 *
 * Engine: java
 ...
 */
public class FlatZipSalesTaxCalcService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "flatZipSalesTaxCalc";
    ...
    /**
     * Creates a new <code>FlatZipSalesTaxCalcService</code> instance.
     */
    public FlatZipSalesTaxCalcService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>FlatZipSalesTaxCalcService</code> from the input values of the given <code>FlatZipSalesTaxCalcService</code>.
     * @param input a <code>FlatZipSalesTaxCalcService</code>
     */
    public static FlatZipSalesTaxCalcService fromInput(FlatZipSalesTaxCalcService input) {
        FlatZipSalesTaxCalcService service = new FlatZipSalesTaxCalcService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>FlatZipSalesTaxCalcService</code> from the output values of the given <code>FlatZipSalesTaxCalcService</code>.
     * @param output a <code>FlatZipSalesTaxCalcService</code>
     */
    public static FlatZipSalesTaxCalcService fromOutput(FlatZipSalesTaxCalcService output) {
        FlatZipSalesTaxCalcService service = new FlatZipSalesTaxCalcService();
    ...
    /**
     * Construct a <code>FlatZipSalesTaxCalcService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>FlatZipSalesTaxCalcService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static FlatZipSalesTaxCalcService fromOutput(Map<String, Object> mapValue) {
        FlatZipSalesTaxCalcService service = new FlatZipSalesTaxCalcService();
