 ...
 * Auto generated base service entity createPartyClassification.
 *
 * Engine: simple
 ...
 */
public class CreatePartyClassificationService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createPartyClassification";
    ...
    /**
     * Creates a new <code>CreatePartyClassificationService</code> instance.
     */
    public CreatePartyClassificationService() {
        super();
    }
     ...
     */
    public CreatePartyClassificationService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreatePartyClassificationService</code> from the input values of the given <code>CreatePartyClassificationService</code>.
     * @param input a <code>CreatePartyClassificationService</code>
     */
    public static CreatePartyClassificationService fromInput(CreatePartyClassificationService input) {
        CreatePartyClassificationService service = new CreatePartyClassificationService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreatePartyClassificationService</code> from the output values of the given <code>CreatePartyClassificationService</code>.
     * @param output a <code>CreatePartyClassificationService</code>
     */
    public static CreatePartyClassificationService fromOutput(CreatePartyClassificationService output) {
        CreatePartyClassificationService service = new CreatePartyClassificationService();
    ...
    /**
     * Construct a <code>CreatePartyClassificationService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePartyClassificationService fromInput(Map<String, Object> mapValue) {
        CreatePartyClassificationService service = new CreatePartyClassificationService();
    ...
    /**
     * Construct a <code>CreatePartyClassificationService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePartyClassificationService fromOutput(Map<String, Object> mapValue) {
        CreatePartyClassificationService service = new CreatePartyClassificationService();
