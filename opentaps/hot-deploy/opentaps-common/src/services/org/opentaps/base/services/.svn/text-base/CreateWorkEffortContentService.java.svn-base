 ...
 * Auto generated base service entity createWorkEffortContent.
 *
 * Engine: simple
 ...
 */
public class CreateWorkEffortContentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createWorkEffortContent";
    ...
    /**
     * Creates a new <code>CreateWorkEffortContentService</code> instance.
     */
    public CreateWorkEffortContentService() {
        super();
    }
     ...
     */
    public CreateWorkEffortContentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateWorkEffortContentService</code> from the input values of the given <code>CreateWorkEffortContentService</code>.
     * @param input a <code>CreateWorkEffortContentService</code>
     */
    public static CreateWorkEffortContentService fromInput(CreateWorkEffortContentService input) {
        CreateWorkEffortContentService service = new CreateWorkEffortContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateWorkEffortContentService</code> from the output values of the given <code>CreateWorkEffortContentService</code>.
     * @param output a <code>CreateWorkEffortContentService</code>
     */
    public static CreateWorkEffortContentService fromOutput(CreateWorkEffortContentService output) {
        CreateWorkEffortContentService service = new CreateWorkEffortContentService();
    ...
    /**
     * Construct a <code>CreateWorkEffortContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateWorkEffortContentService fromInput(Map<String, Object> mapValue) {
        CreateWorkEffortContentService service = new CreateWorkEffortContentService();
    ...
    /**
     * Construct a <code>CreateWorkEffortContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateWorkEffortContentService fromOutput(Map<String, Object> mapValue) {
        CreateWorkEffortContentService service = new CreateWorkEffortContentService();
