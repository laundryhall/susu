 ...
 * Auto generated base service entity deleteSurveyMultiRespColumn.
 *
 * Engine: simple
 ...
 */
public class DeleteSurveyMultiRespColumnService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteSurveyMultiRespColumn";
    ...
    /**
     * Creates a new <code>DeleteSurveyMultiRespColumnService</code> instance.
     */
    public DeleteSurveyMultiRespColumnService() {
        super();
    }
     ...
     */
    public DeleteSurveyMultiRespColumnService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteSurveyMultiRespColumnService</code> from the input values of the given <code>DeleteSurveyMultiRespColumnService</code>.
     * @param input a <code>DeleteSurveyMultiRespColumnService</code>
     */
    public static DeleteSurveyMultiRespColumnService fromInput(DeleteSurveyMultiRespColumnService input) {
        DeleteSurveyMultiRespColumnService service = new DeleteSurveyMultiRespColumnService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteSurveyMultiRespColumnService</code> from the output values of the given <code>DeleteSurveyMultiRespColumnService</code>.
     * @param output a <code>DeleteSurveyMultiRespColumnService</code>
     */
    public static DeleteSurveyMultiRespColumnService fromOutput(DeleteSurveyMultiRespColumnService output) {
        DeleteSurveyMultiRespColumnService service = new DeleteSurveyMultiRespColumnService();
    ...
    /**
     * Construct a <code>DeleteSurveyMultiRespColumnService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteSurveyMultiRespColumnService fromInput(Map<String, Object> mapValue) {
        DeleteSurveyMultiRespColumnService service = new DeleteSurveyMultiRespColumnService();
    ...
    /**
     * Construct a <code>DeleteSurveyMultiRespColumnService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteSurveyMultiRespColumnService fromOutput(Map<String, Object> mapValue) {
        DeleteSurveyMultiRespColumnService service = new DeleteSurveyMultiRespColumnService();
