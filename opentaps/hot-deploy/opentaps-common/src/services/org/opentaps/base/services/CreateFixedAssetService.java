 ...
 * Auto generated base service entity createFixedAsset.
 *
 * Engine: simple
 ...
 */
public class CreateFixedAssetService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createFixedAsset";
    ...
    /**
     * Creates a new <code>CreateFixedAssetService</code> instance.
     */
    public CreateFixedAssetService() {
        super();
    }
     ...
     */
    public CreateFixedAssetService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateFixedAssetService</code> from the input values of the given <code>CreateFixedAssetService</code>.
     * @param input a <code>CreateFixedAssetService</code>
     */
    public static CreateFixedAssetService fromInput(CreateFixedAssetService input) {
        CreateFixedAssetService service = new CreateFixedAssetService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateFixedAssetService</code> from the output values of the given <code>CreateFixedAssetService</code>.
     * @param output a <code>CreateFixedAssetService</code>
     */
    public static CreateFixedAssetService fromOutput(CreateFixedAssetService output) {
        CreateFixedAssetService service = new CreateFixedAssetService();
    ...
    /**
     * Construct a <code>CreateFixedAssetService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFixedAssetService fromInput(Map<String, Object> mapValue) {
        CreateFixedAssetService service = new CreateFixedAssetService();
    ...
    /**
     * Construct a <code>CreateFixedAssetService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFixedAssetService fromOutput(Map<String, Object> mapValue) {
        CreateFixedAssetService service = new CreateFixedAssetService();
