 ...
 * Auto generated base service entity createFixedAssetMaintOrder.
 *
 * Engine: simple
 ...
 */
public class CreateFixedAssetMaintOrderService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createFixedAssetMaintOrder";
    ...
    /**
     * Creates a new <code>CreateFixedAssetMaintOrderService</code> instance.
     */
    public CreateFixedAssetMaintOrderService() {
        super();
    }
     ...
     */
    public CreateFixedAssetMaintOrderService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateFixedAssetMaintOrderService</code> from the input values of the given <code>CreateFixedAssetMaintOrderService</code>.
     * @param input a <code>CreateFixedAssetMaintOrderService</code>
     */
    public static CreateFixedAssetMaintOrderService fromInput(CreateFixedAssetMaintOrderService input) {
        CreateFixedAssetMaintOrderService service = new CreateFixedAssetMaintOrderService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateFixedAssetMaintOrderService</code> from the output values of the given <code>CreateFixedAssetMaintOrderService</code>.
     * @param output a <code>CreateFixedAssetMaintOrderService</code>
     */
    public static CreateFixedAssetMaintOrderService fromOutput(CreateFixedAssetMaintOrderService output) {
        CreateFixedAssetMaintOrderService service = new CreateFixedAssetMaintOrderService();
    ...
    /**
     * Construct a <code>CreateFixedAssetMaintOrderService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFixedAssetMaintOrderService fromInput(Map<String, Object> mapValue) {
        CreateFixedAssetMaintOrderService service = new CreateFixedAssetMaintOrderService();
    ...
    /**
     * Construct a <code>CreateFixedAssetMaintOrderService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFixedAssetMaintOrderService fromOutput(Map<String, Object> mapValue) {
        CreateFixedAssetMaintOrderService service = new CreateFixedAssetMaintOrderService();
