 ...
 */
public class DeleteTaxAuthorityGlAccountService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>DeleteTaxAuthorityGlAccountService</code> instance.
     */
    public DeleteTaxAuthorityGlAccountService() {
        super();
    }
     ...
     */
    public DeleteTaxAuthorityGlAccountService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityGlAccountService</code> from the input values of the given <code>DeleteTaxAuthorityGlAccountService</code>.
     * @param input a <code>DeleteTaxAuthorityGlAccountService</code>
     */
    public static DeleteTaxAuthorityGlAccountService fromInput(DeleteTaxAuthorityGlAccountService input) {
        DeleteTaxAuthorityGlAccountService service = new DeleteTaxAuthorityGlAccountService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteTaxAuthorityGlAccountService</code> from the output values of the given <code>DeleteTaxAuthorityGlAccountService</code>.
     * @param output a <code>DeleteTaxAuthorityGlAccountService</code>
     */
    public static DeleteTaxAuthorityGlAccountService fromOutput(DeleteTaxAuthorityGlAccountService output) {
        DeleteTaxAuthorityGlAccountService service = new DeleteTaxAuthorityGlAccountService();
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityGlAccountService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteTaxAuthorityGlAccountService fromInput(Map<String, Object> mapValue) {
        DeleteTaxAuthorityGlAccountService service = new DeleteTaxAuthorityGlAccountService();
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityGlAccountService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteTaxAuthorityGlAccountService fromOutput(Map<String, Object> mapValue) {
        DeleteTaxAuthorityGlAccountService service = new DeleteTaxAuthorityGlAccountService();
