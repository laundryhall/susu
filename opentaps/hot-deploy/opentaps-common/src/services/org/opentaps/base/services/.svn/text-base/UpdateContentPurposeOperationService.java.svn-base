 ...
 * Auto generated base service entity updateContentPurposeOperation.
 *
 * Engine: simple
 ...
 */
public class UpdateContentPurposeOperationService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateContentPurposeOperation";
    ...
    /**
     * Creates a new <code>UpdateContentPurposeOperationService</code> instance.
     */
    public UpdateContentPurposeOperationService() {
        super();
    }
     ...
     */
    public UpdateContentPurposeOperationService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateContentPurposeOperationService</code> from the input values of the given <code>UpdateContentPurposeOperationService</code>.
     * @param input a <code>UpdateContentPurposeOperationService</code>
     */
    public static UpdateContentPurposeOperationService fromInput(UpdateContentPurposeOperationService input) {
        UpdateContentPurposeOperationService service = new UpdateContentPurposeOperationService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateContentPurposeOperationService</code> from the output values of the given <code>UpdateContentPurposeOperationService</code>.
     * @param output a <code>UpdateContentPurposeOperationService</code>
     */
    public static UpdateContentPurposeOperationService fromOutput(UpdateContentPurposeOperationService output) {
        UpdateContentPurposeOperationService service = new UpdateContentPurposeOperationService();
    ...
    /**
     * Construct a <code>UpdateContentPurposeOperationService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateContentPurposeOperationService fromInput(Map<String, Object> mapValue) {
        UpdateContentPurposeOperationService service = new UpdateContentPurposeOperationService();
    ...
    /**
     * Construct a <code>UpdateContentPurposeOperationService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateContentPurposeOperationService fromOutput(Map<String, Object> mapValue) {
        UpdateContentPurposeOperationService service = new UpdateContentPurposeOperationService();
