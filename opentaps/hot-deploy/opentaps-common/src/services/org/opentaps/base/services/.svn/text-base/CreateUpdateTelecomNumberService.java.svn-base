 ...
 * Auto generated base service entity createUpdateTelecomNumber.
 *
 * Engine: simple
 * Location: component://party/script/org/ofbiz/party/party/PartyServices.xml
 * Invoke: createUpdateTelecomNumber
 * Defined in: applications/party/servicedef/services.xml
 */
public class CreateUpdateTelecomNumberService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createUpdateTelecomNumber";
    ...
    /**
     * Creates a new <code>CreateUpdateTelecomNumberService</code> instance.
     */
    public CreateUpdateTelecomNumberService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateUpdateTelecomNumberService</code> from the input values of the given <code>CreateUpdateTelecomNumberService</code>.
     * @param input a <code>CreateUpdateTelecomNumberService</code>
     */
    public static CreateUpdateTelecomNumberService fromInput(CreateUpdateTelecomNumberService input) {
        CreateUpdateTelecomNumberService service = new CreateUpdateTelecomNumberService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateUpdateTelecomNumberService</code> from the output values of the given <code>CreateUpdateTelecomNumberService</code>.
     * @param output a <code>CreateUpdateTelecomNumberService</code>
     */
    public static CreateUpdateTelecomNumberService fromOutput(CreateUpdateTelecomNumberService output) {
        CreateUpdateTelecomNumberService service = new CreateUpdateTelecomNumberService();
    ...
    /**
     * Construct a <code>CreateUpdateTelecomNumberService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>CreateUpdateTelecomNumberService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateUpdateTelecomNumberService fromOutput(Map<String, Object> mapValue) {
        CreateUpdateTelecomNumberService service = new CreateUpdateTelecomNumberService();
