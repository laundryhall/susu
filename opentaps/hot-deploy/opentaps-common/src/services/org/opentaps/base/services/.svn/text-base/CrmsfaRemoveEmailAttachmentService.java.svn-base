...
/**
 * Remove an email attachment by removing CommEventContentAssoc, Content and DataResource.
 * Auto generated base service entity crmsfa.removeEmailAttachment.
 *
 * Engine: group
 * Location: 
...
public class CrmsfaRemoveEmailAttachmentService extends ServiceWrapper {
    ...
    public static final String NAME = "crmsfa.removeEmailAttachment";
    ...
    /**
     * Creates a new <code>CrmsfaRemoveEmailAttachmentService</code> instance.
     */
    public CrmsfaRemoveEmailAttachmentService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaRemoveEmailAttachmentService</code> from the input values of the given <code>CrmsfaRemoveEmailAttachmentService</code>.
     * @param input a <code>CrmsfaRemoveEmailAttachmentService</code>
     */
    public static CrmsfaRemoveEmailAttachmentService fromInput(CrmsfaRemoveEmailAttachmentService input) {
        CrmsfaRemoveEmailAttachmentService service = new CrmsfaRemoveEmailAttachmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaRemoveEmailAttachmentService</code> from the output values of the given <code>CrmsfaRemoveEmailAttachmentService</code>.
     * @param output a <code>CrmsfaRemoveEmailAttachmentService</code>
     */
    public static CrmsfaRemoveEmailAttachmentService fromOutput(CrmsfaRemoveEmailAttachmentService output) {
        CrmsfaRemoveEmailAttachmentService service = new CrmsfaRemoveEmailAttachmentService();
    ...
    /**
     * Construct a <code>CrmsfaRemoveEmailAttachmentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaRemoveEmailAttachmentService fromInput(Map<String, Object> mapValue) {
        CrmsfaRemoveEmailAttachmentService service = new CrmsfaRemoveEmailAttachmentService();
    ...
    /**
     * Construct a <code>CrmsfaRemoveEmailAttachmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaRemoveEmailAttachmentService fromOutput(Map<String, Object> mapValue) {
        CrmsfaRemoveEmailAttachmentService service = new CrmsfaRemoveEmailAttachmentService();
