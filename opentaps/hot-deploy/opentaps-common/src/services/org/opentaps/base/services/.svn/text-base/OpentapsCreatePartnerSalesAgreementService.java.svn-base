...
/**
 * Creates a PARTNER_SALES_AGR agreement from the Partne to the Contact, Account or Lead.
            The userLogin will need CRMSFA_PARTNER_UPDATE permission on this partner..
 * Auto generated base service entity opentaps.createPartnerSalesAgreement.
 *
 * Engine: java
...
public class OpentapsCreatePartnerSalesAgreementService extends ServiceWrapper {
    ...
    public static final String NAME = "opentaps.createPartnerSalesAgreement";
    ...
    /**
     * Creates a new <code>OpentapsCreatePartnerSalesAgreementService</code> instance.
     */
    public OpentapsCreatePartnerSalesAgreementService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsCreatePartnerSalesAgreementService</code> from the input values of the given <code>OpentapsCreatePartnerSalesAgreementService</code>.
     * @param input a <code>OpentapsCreatePartnerSalesAgreementService</code>
     */
    public static OpentapsCreatePartnerSalesAgreementService fromInput(OpentapsCreatePartnerSalesAgreementService input) {
        OpentapsCreatePartnerSalesAgreementService service = new OpentapsCreatePartnerSalesAgreementService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>OpentapsCreatePartnerSalesAgreementService</code> from the output values of the given <code>OpentapsCreatePartnerSalesAgreementService</code>.
     * @param output a <code>OpentapsCreatePartnerSalesAgreementService</code>
     */
    public static OpentapsCreatePartnerSalesAgreementService fromOutput(OpentapsCreatePartnerSalesAgreementService output) {
        OpentapsCreatePartnerSalesAgreementService service = new OpentapsCreatePartnerSalesAgreementService();
    ...
    /**
     * Construct a <code>OpentapsCreatePartnerSalesAgreementService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsCreatePartnerSalesAgreementService fromInput(Map<String, Object> mapValue) {
        OpentapsCreatePartnerSalesAgreementService service = new OpentapsCreatePartnerSalesAgreementService();
    ...
    /**
     * Construct a <code>OpentapsCreatePartnerSalesAgreementService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsCreatePartnerSalesAgreementService fromOutput(Map<String, Object> mapValue) {
        OpentapsCreatePartnerSalesAgreementService service = new OpentapsCreatePartnerSalesAgreementService();
