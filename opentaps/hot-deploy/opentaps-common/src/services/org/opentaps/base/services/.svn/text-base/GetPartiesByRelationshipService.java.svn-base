 ...
 * Auto generated base service entity getPartiesByRelationship.
 *
 * Engine: simple
...
public class GetPartiesByRelationshipService extends ServiceWrapper {
    ...
    public static final String NAME = "getPartiesByRelationship";
    ...
    /**
     * Creates a new <code>GetPartiesByRelationshipService</code> instance.
     */
    public GetPartiesByRelationshipService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>GetPartiesByRelationshipService</code> from the input values of the given <code>GetPartiesByRelationshipService</code>.
     * @param input a <code>GetPartiesByRelationshipService</code>
     */
    public static GetPartiesByRelationshipService fromInput(GetPartiesByRelationshipService input) {
        GetPartiesByRelationshipService service = new GetPartiesByRelationshipService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>GetPartiesByRelationshipService</code> from the output values of the given <code>GetPartiesByRelationshipService</code>.
     * @param output a <code>GetPartiesByRelationshipService</code>
     */
    public static GetPartiesByRelationshipService fromOutput(GetPartiesByRelationshipService output) {
        GetPartiesByRelationshipService service = new GetPartiesByRelationshipService();
    ...
    /**
     * Construct a <code>GetPartiesByRelationshipService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetPartiesByRelationshipService fromInput(Map<String, Object> mapValue) {
        GetPartiesByRelationshipService service = new GetPartiesByRelationshipService();
    ...
    /**
     * Construct a <code>GetPartiesByRelationshipService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetPartiesByRelationshipService fromOutput(Map<String, Object> mapValue) {
        GetPartiesByRelationshipService service = new GetPartiesByRelationshipService();
