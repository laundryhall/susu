 ...
 * Auto generated base service entity getSubSubContentWithPermCheck.
 *
 * Engine: simple
 ...
 */
public class GetSubSubContentWithPermCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "getSubSubContentWithPermCheck";
    ...
    public static enum In {
        ...
        mapKey("mapKey"),
        subContentAssocTypeId("subContentAssocTypeId"),
        subMapKey("subMapKey"),
        timeZone("timeZone"),
        useCache("useCache"),
        userLogin("userLogin");
    ...
    public static enum Out {
        ...
        subSubContentList("subSubContentList"),
    ...
    /**
     * Creates a new <code>GetSubSubContentWithPermCheckService</code> instance.
     */
    public GetSubSubContentWithPermCheckService() {
        super();
    }
     ...
     */
    public GetSubSubContentWithPermCheckService(User user) {
        super(user);
    }
    ...
    private String inSubContentAssocTypeId;
    private String inSubMapKey;
    ...
    private List outSubSubContentList;
     ...
     * @return <code>String</code>
     */
    public String getInSubContentAssocTypeId() {
        return this.inSubContentAssocTypeId;
    }
    /**
     * Auto generated value accessor.
     * This parameter is optional.
     * @return <code>String</code>
     */
    public String getInSubMapKey() {
        return this.inSubMapKey;
    }
    /**
     * Auto generated value accessor.
     * This parameter is optional.
     ...
     * @return <code>List</code>
     */
    public List getOutSubSubContentList() {
        return this.outSubSubContentList;
    }
    /**
     * Auto generated value accessor.
     * This parameter is optional.
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is optional.
     * @param inSubContentAssocTypeId the inSubContentAssocTypeId to set
    */
    public void setInSubContentAssocTypeId(String inSubContentAssocTypeId) {
        this.inParameters.add("subContentAssocTypeId");
        this.inSubContentAssocTypeId = inSubContentAssocTypeId;
    }
    /**
     * Auto generated value setter.
     * This parameter is optional.
     * @param inSubMapKey the inSubMapKey to set
    */
    public void setInSubMapKey(String inSubMapKey) {
        this.inParameters.add("subMapKey");
        this.inSubMapKey = inSubMapKey;
    }
    /**
     * Auto generated value setter.
     * This parameter is optional.
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is optional.
     * @param outSubSubContentList the outSubSubContentList to set
    */
    public void setOutSubSubContentList(List outSubSubContentList) {
        this.outParameters.add("subSubContentList");
        this.outSubSubContentList = outSubSubContentList;
    }
    /**
     * Auto generated value setter.
     * This parameter is optional.
    ...
    */
    ...
    public Map<String, Object> inputMap() {
        ...
        if (inParameters.contains("subContentAssocTypeId")) mapValue.put("subContentAssocTypeId", getInSubContentAssocTypeId());
        if (inParameters.contains("subMapKey")) mapValue.put("subMapKey", getInSubMapKey());
    ...
    public Map<String, Object> outputMap() {
        ...
        if (outParameters.contains("subSubContentList")) mapValue.put("subSubContentList", getOutSubSubContentList());
    ...
    public void putAllInput(Map<String, Object> mapValue) {
        ...
        if (mapValue.containsKey("subContentAssocTypeId")) setInSubContentAssocTypeId((String) mapValue.get("subContentAssocTypeId"));
        if (mapValue.containsKey("subMapKey")) setInSubMapKey((String) mapValue.get("subMapKey"));
    ...
    public void putAllOutput(Map<String, Object> mapValue) {
        ...
        if (mapValue.containsKey("subSubContentList")) setOutSubSubContentList((List) mapValue.get("subSubContentList"));
    ...
    /**
     * Construct a <code>GetSubSubContentWithPermCheckService</code> from the input values of the given <code>GetSubSubContentWithPermCheckService</code>.
     * @param input a <code>GetSubSubContentWithPermCheckService</code>
     */
    public static GetSubSubContentWithPermCheckService fromInput(GetSubSubContentWithPermCheckService input) {
        GetSubSubContentWithPermCheckService service = new GetSubSubContentWithPermCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>GetSubSubContentWithPermCheckService</code> from the output values of the given <code>GetSubSubContentWithPermCheckService</code>.
     * @param output a <code>GetSubSubContentWithPermCheckService</code>
     */
    public static GetSubSubContentWithPermCheckService fromOutput(GetSubSubContentWithPermCheckService output) {
        GetSubSubContentWithPermCheckService service = new GetSubSubContentWithPermCheckService();
    ...
    /**
     * Construct a <code>GetSubSubContentWithPermCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetSubSubContentWithPermCheckService fromInput(Map<String, Object> mapValue) {
        GetSubSubContentWithPermCheckService service = new GetSubSubContentWithPermCheckService();
    ...
    /**
     * Construct a <code>GetSubSubContentWithPermCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetSubSubContentWithPermCheckService fromOutput(Map<String, Object> mapValue) {
        GetSubSubContentWithPermCheckService service = new GetSubSubContentWithPermCheckService();
