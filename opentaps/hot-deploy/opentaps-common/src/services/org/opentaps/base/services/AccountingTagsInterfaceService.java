 ...
 * Auto generated base service entity accountingTagsInterface.
 *
 * Engine: interface
 * Location: 
 * Invoke: 
 ...
 */
public class AccountingTagsInterfaceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "accountingTagsInterface";
    ...
    /**
     * Creates a new <code>AccountingTagsInterfaceService</code> instance.
     */
    public AccountingTagsInterfaceService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AccountingTagsInterfaceService</code> from the input values of the given <code>AccountingTagsInterfaceService</code>.
     * @param input a <code>AccountingTagsInterfaceService</code>
     */
    public static AccountingTagsInterfaceService fromInput(AccountingTagsInterfaceService input) {
        AccountingTagsInterfaceService service = new AccountingTagsInterfaceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AccountingTagsInterfaceService</code> from the output values of the given <code>AccountingTagsInterfaceService</code>.
     * @param output a <code>AccountingTagsInterfaceService</code>
     */
    public static AccountingTagsInterfaceService fromOutput(AccountingTagsInterfaceService output) {
        AccountingTagsInterfaceService service = new AccountingTagsInterfaceService();
    ...
    /**
     * Construct a <code>AccountingTagsInterfaceService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>AccountingTagsInterfaceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AccountingTagsInterfaceService fromOutput(Map<String, Object> mapValue) {
        AccountingTagsInterfaceService service = new AccountingTagsInterfaceService();
