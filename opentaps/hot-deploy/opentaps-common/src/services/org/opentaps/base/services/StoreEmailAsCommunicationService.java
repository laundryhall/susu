...
/**
 * Store email as a communication event with the status COM_COMPLETE and current timestamp as datetimeStarted and datetimeEnded.
            The communication event will be from the party of the userLogin to the party of the partyId parameter.
            It is meant to run a SECA after a sendMail to record outgoing emails..
 * Auto generated base service entity storeEmailAsCommunication.
 *
 * Engine: java
 * Location: org.ofbiz.party.communication.CommunicationEventServices
 * Invoke: storeEmailAsCommunication
 * Defined in: applications/party/servicedef/services.xml
 */
public class StoreEmailAsCommunicationService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "storeEmailAsCommunication";
    ...
    /**
     * Creates a new <code>StoreEmailAsCommunicationService</code> instance.
     */
    public StoreEmailAsCommunicationService() {
        super();
    }
     ...
     */
    public StoreEmailAsCommunicationService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>StoreEmailAsCommunicationService</code> from the input values of the given <code>StoreEmailAsCommunicationService</code>.
     * @param input a <code>StoreEmailAsCommunicationService</code>
     */
    public static StoreEmailAsCommunicationService fromInput(StoreEmailAsCommunicationService input) {
        StoreEmailAsCommunicationService service = new StoreEmailAsCommunicationService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>StoreEmailAsCommunicationService</code> from the output values of the given <code>StoreEmailAsCommunicationService</code>.
     * @param output a <code>StoreEmailAsCommunicationService</code>
     */
    public static StoreEmailAsCommunicationService fromOutput(StoreEmailAsCommunicationService output) {
        StoreEmailAsCommunicationService service = new StoreEmailAsCommunicationService();
    ...
    /**
     * Construct a <code>StoreEmailAsCommunicationService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static StoreEmailAsCommunicationService fromInput(Map<String, Object> mapValue) {
        StoreEmailAsCommunicationService service = new StoreEmailAsCommunicationService();
    ...
    /**
     * Construct a <code>StoreEmailAsCommunicationService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static StoreEmailAsCommunicationService fromOutput(Map<String, Object> mapValue) {
        StoreEmailAsCommunicationService service = new StoreEmailAsCommunicationService();
