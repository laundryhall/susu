 ...
 * Auto generated base service entity updateContentSubscription.
 *
 * Engine: java
 ...
 */
public class UpdateContentSubscriptionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateContentSubscription";
    ...
    /**
     * Creates a new <code>UpdateContentSubscriptionService</code> instance.
     */
    public UpdateContentSubscriptionService() {
        super();
    }
     ...
     */
    public UpdateContentSubscriptionService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateContentSubscriptionService</code> from the input values of the given <code>UpdateContentSubscriptionService</code>.
     * @param input a <code>UpdateContentSubscriptionService</code>
     */
    public static UpdateContentSubscriptionService fromInput(UpdateContentSubscriptionService input) {
        UpdateContentSubscriptionService service = new UpdateContentSubscriptionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateContentSubscriptionService</code> from the output values of the given <code>UpdateContentSubscriptionService</code>.
     * @param output a <code>UpdateContentSubscriptionService</code>
     */
    public static UpdateContentSubscriptionService fromOutput(UpdateContentSubscriptionService output) {
        UpdateContentSubscriptionService service = new UpdateContentSubscriptionService();
    ...
    /**
     * Construct a <code>UpdateContentSubscriptionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateContentSubscriptionService fromInput(Map<String, Object> mapValue) {
        UpdateContentSubscriptionService service = new UpdateContentSubscriptionService();
    ...
    /**
     * Construct a <code>UpdateContentSubscriptionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateContentSubscriptionService fromOutput(Map<String, Object> mapValue) {
        UpdateContentSubscriptionService service = new UpdateContentSubscriptionService();
