 ...
 * Auto generated base service entity updateFacilityEmailAddress.
 *
 * Engine: simple
 ...
 */
public class UpdateFacilityEmailAddressService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateFacilityEmailAddress";
    ...
    /**
     * Creates a new <code>UpdateFacilityEmailAddressService</code> instance.
     */
    public UpdateFacilityEmailAddressService() {
        super();
    }
     ...
     */
    public UpdateFacilityEmailAddressService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateFacilityEmailAddressService</code> from the input values of the given <code>UpdateFacilityEmailAddressService</code>.
     * @param input a <code>UpdateFacilityEmailAddressService</code>
     */
    public static UpdateFacilityEmailAddressService fromInput(UpdateFacilityEmailAddressService input) {
        UpdateFacilityEmailAddressService service = new UpdateFacilityEmailAddressService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateFacilityEmailAddressService</code> from the output values of the given <code>UpdateFacilityEmailAddressService</code>.
     * @param output a <code>UpdateFacilityEmailAddressService</code>
     */
    public static UpdateFacilityEmailAddressService fromOutput(UpdateFacilityEmailAddressService output) {
        UpdateFacilityEmailAddressService service = new UpdateFacilityEmailAddressService();
    ...
    /**
     * Construct a <code>UpdateFacilityEmailAddressService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateFacilityEmailAddressService fromInput(Map<String, Object> mapValue) {
        UpdateFacilityEmailAddressService service = new UpdateFacilityEmailAddressService();
    ...
    /**
     * Construct a <code>UpdateFacilityEmailAddressService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateFacilityEmailAddressService fromOutput(Map<String, Object> mapValue) {
        UpdateFacilityEmailAddressService service = new UpdateFacilityEmailAddressService();
