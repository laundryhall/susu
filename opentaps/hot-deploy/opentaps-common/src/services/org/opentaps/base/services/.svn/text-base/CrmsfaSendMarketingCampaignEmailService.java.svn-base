 ...
 * Auto generated base service entity crmsfa.sendMarketingCampaignEmail.
 *
 * Engine: java
 * Location: com.opensourcestrategies.crmsfa.marketing.MarketingCampaignServices
 * Invoke: sendMarketingCampaignEmail
 * Defined in: hot-deploy/crmsfa/servicedef/services_marketing.xml
 */
public class CrmsfaSendMarketingCampaignEmailService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.sendMarketingCampaignEmail";
    ...
    /**
     * Creates a new <code>CrmsfaSendMarketingCampaignEmailService</code> instance.
     */
    public CrmsfaSendMarketingCampaignEmailService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaSendMarketingCampaignEmailService</code> from the input values of the given <code>CrmsfaSendMarketingCampaignEmailService</code>.
     * @param input a <code>CrmsfaSendMarketingCampaignEmailService</code>
     */
    public static CrmsfaSendMarketingCampaignEmailService fromInput(CrmsfaSendMarketingCampaignEmailService input) {
        CrmsfaSendMarketingCampaignEmailService service = new CrmsfaSendMarketingCampaignEmailService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaSendMarketingCampaignEmailService</code> from the output values of the given <code>CrmsfaSendMarketingCampaignEmailService</code>.
     * @param output a <code>CrmsfaSendMarketingCampaignEmailService</code>
     */
    public static CrmsfaSendMarketingCampaignEmailService fromOutput(CrmsfaSendMarketingCampaignEmailService output) {
        CrmsfaSendMarketingCampaignEmailService service = new CrmsfaSendMarketingCampaignEmailService();
    ...
    /**
     * Construct a <code>CrmsfaSendMarketingCampaignEmailService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>CrmsfaSendMarketingCampaignEmailService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaSendMarketingCampaignEmailService fromOutput(Map<String, Object> mapValue) {
        CrmsfaSendMarketingCampaignEmailService service = new CrmsfaSendMarketingCampaignEmailService();
