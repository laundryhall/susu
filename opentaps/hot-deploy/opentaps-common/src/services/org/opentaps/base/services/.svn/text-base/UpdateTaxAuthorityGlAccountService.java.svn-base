 ...
 * Auto generated base service entity updateTaxAuthorityGlAccount.
 *
 * Engine: simple
 ...
 */
public class UpdateTaxAuthorityGlAccountService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateTaxAuthorityGlAccount";
    ...
    /**
     * Creates a new <code>UpdateTaxAuthorityGlAccountService</code> instance.
     */
    public UpdateTaxAuthorityGlAccountService() {
        super();
    }
     ...
     */
    public UpdateTaxAuthorityGlAccountService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityGlAccountService</code> from the input values of the given <code>UpdateTaxAuthorityGlAccountService</code>.
     * @param input a <code>UpdateTaxAuthorityGlAccountService</code>
     */
    public static UpdateTaxAuthorityGlAccountService fromInput(UpdateTaxAuthorityGlAccountService input) {
        UpdateTaxAuthorityGlAccountService service = new UpdateTaxAuthorityGlAccountService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateTaxAuthorityGlAccountService</code> from the output values of the given <code>UpdateTaxAuthorityGlAccountService</code>.
     * @param output a <code>UpdateTaxAuthorityGlAccountService</code>
     */
    public static UpdateTaxAuthorityGlAccountService fromOutput(UpdateTaxAuthorityGlAccountService output) {
        UpdateTaxAuthorityGlAccountService service = new UpdateTaxAuthorityGlAccountService();
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityGlAccountService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateTaxAuthorityGlAccountService fromInput(Map<String, Object> mapValue) {
        UpdateTaxAuthorityGlAccountService service = new UpdateTaxAuthorityGlAccountService();
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityGlAccountService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateTaxAuthorityGlAccountService fromOutput(Map<String, Object> mapValue) {
        UpdateTaxAuthorityGlAccountService service = new UpdateTaxAuthorityGlAccountService();
