 ...
 * Auto generated base service entity updateCommunicationEventRole.
 *
 * Engine: simple
 ...
 */
public class UpdateCommunicationEventRoleService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateCommunicationEventRole";
    ...
    /**
     * Creates a new <code>UpdateCommunicationEventRoleService</code> instance.
     */
    public UpdateCommunicationEventRoleService() {
        super();
    }
     ...
     */
    public UpdateCommunicationEventRoleService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateCommunicationEventRoleService</code> from the input values of the given <code>UpdateCommunicationEventRoleService</code>.
     * @param input a <code>UpdateCommunicationEventRoleService</code>
     */
    public static UpdateCommunicationEventRoleService fromInput(UpdateCommunicationEventRoleService input) {
        UpdateCommunicationEventRoleService service = new UpdateCommunicationEventRoleService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateCommunicationEventRoleService</code> from the output values of the given <code>UpdateCommunicationEventRoleService</code>.
     * @param output a <code>UpdateCommunicationEventRoleService</code>
     */
    public static UpdateCommunicationEventRoleService fromOutput(UpdateCommunicationEventRoleService output) {
        UpdateCommunicationEventRoleService service = new UpdateCommunicationEventRoleService();
    ...
    /**
     * Construct a <code>UpdateCommunicationEventRoleService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateCommunicationEventRoleService fromInput(Map<String, Object> mapValue) {
        UpdateCommunicationEventRoleService service = new UpdateCommunicationEventRoleService();
    ...
    /**
     * Construct a <code>UpdateCommunicationEventRoleService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateCommunicationEventRoleService fromOutput(Map<String, Object> mapValue) {
        UpdateCommunicationEventRoleService service = new UpdateCommunicationEventRoleService();
