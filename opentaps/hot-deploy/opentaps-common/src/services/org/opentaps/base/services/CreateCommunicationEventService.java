 ...
 * Auto generated base service entity createCommunicationEvent.
 *
 * Engine: simple
 ...
 */
public class CreateCommunicationEventService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createCommunicationEvent";
    ...
    /**
     * Creates a new <code>CreateCommunicationEventService</code> instance.
     */
    public CreateCommunicationEventService() {
        super();
    }
     ...
     */
    public CreateCommunicationEventService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateCommunicationEventService</code> from the input values of the given <code>CreateCommunicationEventService</code>.
     * @param input a <code>CreateCommunicationEventService</code>
     */
    public static CreateCommunicationEventService fromInput(CreateCommunicationEventService input) {
        CreateCommunicationEventService service = new CreateCommunicationEventService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateCommunicationEventService</code> from the output values of the given <code>CreateCommunicationEventService</code>.
     * @param output a <code>CreateCommunicationEventService</code>
     */
    public static CreateCommunicationEventService fromOutput(CreateCommunicationEventService output) {
        CreateCommunicationEventService service = new CreateCommunicationEventService();
    ...
    /**
     * Construct a <code>CreateCommunicationEventService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCommunicationEventService fromInput(Map<String, Object> mapValue) {
        CreateCommunicationEventService service = new CreateCommunicationEventService();
    ...
    /**
     * Construct a <code>CreateCommunicationEventService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCommunicationEventService fromOutput(Map<String, Object> mapValue) {
        CreateCommunicationEventService service = new CreateCommunicationEventService();
