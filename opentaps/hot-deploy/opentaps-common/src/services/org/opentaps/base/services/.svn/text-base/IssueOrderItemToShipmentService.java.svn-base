 ...
 * Auto generated base service entity issueOrderItemToShipment.
 *
 * Engine: simple
 ...
 */
public class IssueOrderItemToShipmentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "issueOrderItemToShipment";
    ...
    /**
     * Creates a new <code>IssueOrderItemToShipmentService</code> instance.
     */
    public IssueOrderItemToShipmentService() {
        super();
    }
     ...
     */
    public IssueOrderItemToShipmentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>IssueOrderItemToShipmentService</code> from the input values of the given <code>IssueOrderItemToShipmentService</code>.
     * @param input a <code>IssueOrderItemToShipmentService</code>
     */
    public static IssueOrderItemToShipmentService fromInput(IssueOrderItemToShipmentService input) {
        IssueOrderItemToShipmentService service = new IssueOrderItemToShipmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>IssueOrderItemToShipmentService</code> from the output values of the given <code>IssueOrderItemToShipmentService</code>.
     * @param output a <code>IssueOrderItemToShipmentService</code>
     */
    public static IssueOrderItemToShipmentService fromOutput(IssueOrderItemToShipmentService output) {
        IssueOrderItemToShipmentService service = new IssueOrderItemToShipmentService();
    ...
    /**
     * Construct a <code>IssueOrderItemToShipmentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static IssueOrderItemToShipmentService fromInput(Map<String, Object> mapValue) {
        IssueOrderItemToShipmentService service = new IssueOrderItemToShipmentService();
    ...
    /**
     * Construct a <code>IssueOrderItemToShipmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static IssueOrderItemToShipmentService fromOutput(Map<String, Object> mapValue) {
        IssueOrderItemToShipmentService service = new IssueOrderItemToShipmentService();
