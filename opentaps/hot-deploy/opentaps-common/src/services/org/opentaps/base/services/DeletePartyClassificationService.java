 ...
 * Auto generated base service entity deletePartyClassification.
 *
 * Engine: simple
 ...
 */
public class DeletePartyClassificationService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deletePartyClassification";
    ...
    /**
     * Creates a new <code>DeletePartyClassificationService</code> instance.
     */
    public DeletePartyClassificationService() {
        super();
    }
     ...
     */
    public DeletePartyClassificationService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeletePartyClassificationService</code> from the input values of the given <code>DeletePartyClassificationService</code>.
     * @param input a <code>DeletePartyClassificationService</code>
     */
    public static DeletePartyClassificationService fromInput(DeletePartyClassificationService input) {
        DeletePartyClassificationService service = new DeletePartyClassificationService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeletePartyClassificationService</code> from the output values of the given <code>DeletePartyClassificationService</code>.
     * @param output a <code>DeletePartyClassificationService</code>
     */
    public static DeletePartyClassificationService fromOutput(DeletePartyClassificationService output) {
        DeletePartyClassificationService service = new DeletePartyClassificationService();
    ...
    /**
     * Construct a <code>DeletePartyClassificationService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeletePartyClassificationService fromInput(Map<String, Object> mapValue) {
        DeletePartyClassificationService service = new DeletePartyClassificationService();
    ...
    /**
     * Construct a <code>DeletePartyClassificationService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeletePartyClassificationService fromOutput(Map<String, Object> mapValue) {
        DeletePartyClassificationService service = new DeletePartyClassificationService();
