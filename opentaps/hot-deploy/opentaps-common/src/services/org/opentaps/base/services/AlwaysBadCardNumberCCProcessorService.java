 ...
 * Auto generated base service entity alwaysBadCardNumberCCProcessor.
 *
 * Engine: java
 ...
 */
public class AlwaysBadCardNumberCCProcessorService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "alwaysBadCardNumberCCProcessor";
    ...
    /**
     * Creates a new <code>AlwaysBadCardNumberCCProcessorService</code> instance.
     */
    public AlwaysBadCardNumberCCProcessorService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AlwaysBadCardNumberCCProcessorService</code> from the input values of the given <code>AlwaysBadCardNumberCCProcessorService</code>.
     * @param input a <code>AlwaysBadCardNumberCCProcessorService</code>
     */
    public static AlwaysBadCardNumberCCProcessorService fromInput(AlwaysBadCardNumberCCProcessorService input) {
        AlwaysBadCardNumberCCProcessorService service = new AlwaysBadCardNumberCCProcessorService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AlwaysBadCardNumberCCProcessorService</code> from the output values of the given <code>AlwaysBadCardNumberCCProcessorService</code>.
     * @param output a <code>AlwaysBadCardNumberCCProcessorService</code>
     */
    public static AlwaysBadCardNumberCCProcessorService fromOutput(AlwaysBadCardNumberCCProcessorService output) {
        AlwaysBadCardNumberCCProcessorService service = new AlwaysBadCardNumberCCProcessorService();
    ...
    /**
     * Construct a <code>AlwaysBadCardNumberCCProcessorService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AlwaysBadCardNumberCCProcessorService fromInput(Map<String, Object> mapValue) {
        AlwaysBadCardNumberCCProcessorService service = new AlwaysBadCardNumberCCProcessorService();
    ...
    /**
     * Construct a <code>AlwaysBadCardNumberCCProcessorService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AlwaysBadCardNumberCCProcessorService fromOutput(Map<String, Object> mapValue) {
        AlwaysBadCardNumberCCProcessorService service = new AlwaysBadCardNumberCCProcessorService();
