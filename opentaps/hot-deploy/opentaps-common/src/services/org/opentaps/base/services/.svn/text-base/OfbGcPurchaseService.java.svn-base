 ...
 * Auto generated base service entity ofbGcPurchase.
 *
 * Engine: java
 ...
 */
public class OfbGcPurchaseService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "ofbGcPurchase";
    ...
    /**
     * Creates a new <code>OfbGcPurchaseService</code> instance.
     */
    public OfbGcPurchaseService() {
        super();
    }
     ...
     */
    public OfbGcPurchaseService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>OfbGcPurchaseService</code> from the input values of the given <code>OfbGcPurchaseService</code>.
     * @param input a <code>OfbGcPurchaseService</code>
     */
    public static OfbGcPurchaseService fromInput(OfbGcPurchaseService input) {
        OfbGcPurchaseService service = new OfbGcPurchaseService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>OfbGcPurchaseService</code> from the output values of the given <code>OfbGcPurchaseService</code>.
     * @param output a <code>OfbGcPurchaseService</code>
     */
    public static OfbGcPurchaseService fromOutput(OfbGcPurchaseService output) {
        OfbGcPurchaseService service = new OfbGcPurchaseService();
    ...
    /**
     * Construct a <code>OfbGcPurchaseService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OfbGcPurchaseService fromInput(Map<String, Object> mapValue) {
        OfbGcPurchaseService service = new OfbGcPurchaseService();
    ...
    /**
     * Construct a <code>OfbGcPurchaseService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OfbGcPurchaseService fromOutput(Map<String, Object> mapValue) {
        OfbGcPurchaseService service = new OfbGcPurchaseService();
