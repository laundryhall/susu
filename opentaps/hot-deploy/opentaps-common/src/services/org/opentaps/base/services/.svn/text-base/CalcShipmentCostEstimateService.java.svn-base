 ...
 * Auto generated base service entity calcShipmentCostEstimate.
 *
 * Engine: java
 ...
 */
public class CalcShipmentCostEstimateService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "calcShipmentCostEstimate";
    ...
    /**
     * Creates a new <code>CalcShipmentCostEstimateService</code> instance.
     */
    public CalcShipmentCostEstimateService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CalcShipmentCostEstimateService</code> from the input values of the given <code>CalcShipmentCostEstimateService</code>.
     * @param input a <code>CalcShipmentCostEstimateService</code>
     */
    public static CalcShipmentCostEstimateService fromInput(CalcShipmentCostEstimateService input) {
        CalcShipmentCostEstimateService service = new CalcShipmentCostEstimateService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CalcShipmentCostEstimateService</code> from the output values of the given <code>CalcShipmentCostEstimateService</code>.
     * @param output a <code>CalcShipmentCostEstimateService</code>
     */
    public static CalcShipmentCostEstimateService fromOutput(CalcShipmentCostEstimateService output) {
        CalcShipmentCostEstimateService service = new CalcShipmentCostEstimateService();
    ...
    /**
     * Construct a <code>CalcShipmentCostEstimateService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>CalcShipmentCostEstimateService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CalcShipmentCostEstimateService fromOutput(Map<String, Object> mapValue) {
        CalcShipmentCostEstimateService service = new CalcShipmentCostEstimateService();
