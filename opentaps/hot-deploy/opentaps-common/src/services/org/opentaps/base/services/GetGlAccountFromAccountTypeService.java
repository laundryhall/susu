 ...
 * Auto generated base service entity getGlAccountFromAccountType.
 *
 * Engine: simple
 ...
 */
public class GetGlAccountFromAccountTypeService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "getGlAccountFromAccountType";
    ...
    /**
     * Creates a new <code>GetGlAccountFromAccountTypeService</code> instance.
     */
    public GetGlAccountFromAccountTypeService() {
        super();
    }
     ...
     */
    public GetGlAccountFromAccountTypeService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>GetGlAccountFromAccountTypeService</code> from the input values of the given <code>GetGlAccountFromAccountTypeService</code>.
     * @param input a <code>GetGlAccountFromAccountTypeService</code>
     */
    public static GetGlAccountFromAccountTypeService fromInput(GetGlAccountFromAccountTypeService input) {
        GetGlAccountFromAccountTypeService service = new GetGlAccountFromAccountTypeService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>GetGlAccountFromAccountTypeService</code> from the output values of the given <code>GetGlAccountFromAccountTypeService</code>.
     * @param output a <code>GetGlAccountFromAccountTypeService</code>
     */
    public static GetGlAccountFromAccountTypeService fromOutput(GetGlAccountFromAccountTypeService output) {
        GetGlAccountFromAccountTypeService service = new GetGlAccountFromAccountTypeService();
    ...
    /**
     * Construct a <code>GetGlAccountFromAccountTypeService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetGlAccountFromAccountTypeService fromInput(Map<String, Object> mapValue) {
        GetGlAccountFromAccountTypeService service = new GetGlAccountFromAccountTypeService();
    ...
    /**
     * Construct a <code>GetGlAccountFromAccountTypeService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetGlAccountFromAccountTypeService fromOutput(Map<String, Object> mapValue) {
        GetGlAccountFromAccountTypeService service = new GetGlAccountFromAccountTypeService();
