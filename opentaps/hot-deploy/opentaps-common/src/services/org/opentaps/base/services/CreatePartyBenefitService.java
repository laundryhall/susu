 ...
 * Auto generated base service entity createPartyBenefit.
 *
 * Engine: simple
 * Location: component://humanres/script/org/ofbiz/humanres/HumanResServices.xml
 * Invoke: createPartyBenefit
 * Defined in: applications/humanres/servicedef/services.xml
 */
public class CreatePartyBenefitService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createPartyBenefit";
    ...
    /**
     * Creates a new <code>CreatePartyBenefitService</code> instance.
     */
    public CreatePartyBenefitService() {
        super();
    }
     ...
     */
    public CreatePartyBenefitService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreatePartyBenefitService</code> from the input values of the given <code>CreatePartyBenefitService</code>.
     * @param input a <code>CreatePartyBenefitService</code>
     */
    public static CreatePartyBenefitService fromInput(CreatePartyBenefitService input) {
        CreatePartyBenefitService service = new CreatePartyBenefitService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreatePartyBenefitService</code> from the output values of the given <code>CreatePartyBenefitService</code>.
     * @param output a <code>CreatePartyBenefitService</code>
     */
    public static CreatePartyBenefitService fromOutput(CreatePartyBenefitService output) {
        CreatePartyBenefitService service = new CreatePartyBenefitService();
    ...
    /**
     * Construct a <code>CreatePartyBenefitService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePartyBenefitService fromInput(Map<String, Object> mapValue) {
        CreatePartyBenefitService service = new CreatePartyBenefitService();
    ...
    /**
     * Construct a <code>CreatePartyBenefitService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePartyBenefitService fromOutput(Map<String, Object> mapValue) {
        CreatePartyBenefitService service = new CreatePartyBenefitService();
