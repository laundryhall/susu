 ...
 * Auto generated base service entity createProductPaymentMethodType.
 *
 * Engine: simple
 ...
 */
public class CreateProductPaymentMethodTypeService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createProductPaymentMethodType";
    ...
    /**
     * Creates a new <code>CreateProductPaymentMethodTypeService</code> instance.
     */
    public CreateProductPaymentMethodTypeService() {
        super();
    }
     ...
     */
    public CreateProductPaymentMethodTypeService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateProductPaymentMethodTypeService</code> from the input values of the given <code>CreateProductPaymentMethodTypeService</code>.
     * @param input a <code>CreateProductPaymentMethodTypeService</code>
     */
    public static CreateProductPaymentMethodTypeService fromInput(CreateProductPaymentMethodTypeService input) {
        CreateProductPaymentMethodTypeService service = new CreateProductPaymentMethodTypeService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateProductPaymentMethodTypeService</code> from the output values of the given <code>CreateProductPaymentMethodTypeService</code>.
     * @param output a <code>CreateProductPaymentMethodTypeService</code>
     */
    public static CreateProductPaymentMethodTypeService fromOutput(CreateProductPaymentMethodTypeService output) {
        CreateProductPaymentMethodTypeService service = new CreateProductPaymentMethodTypeService();
    ...
    /**
     * Construct a <code>CreateProductPaymentMethodTypeService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateProductPaymentMethodTypeService fromInput(Map<String, Object> mapValue) {
        CreateProductPaymentMethodTypeService service = new CreateProductPaymentMethodTypeService();
    ...
    /**
     * Construct a <code>CreateProductPaymentMethodTypeService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateProductPaymentMethodTypeService fromOutput(Map<String, Object> mapValue) {
        CreateProductPaymentMethodTypeService service = new CreateProductPaymentMethodTypeService();
