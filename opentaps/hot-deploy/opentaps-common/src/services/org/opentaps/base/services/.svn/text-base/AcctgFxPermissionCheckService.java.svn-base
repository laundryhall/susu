 ...
 * Auto generated base service entity acctgFxPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class AcctgFxPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "acctgFxPermissionCheck";
    ...
    /**
     * Creates a new <code>AcctgFxPermissionCheckService</code> instance.
     */
    public AcctgFxPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AcctgFxPermissionCheckService</code> from the input values of the given <code>AcctgFxPermissionCheckService</code>.
     * @param input a <code>AcctgFxPermissionCheckService</code>
     */
    public static AcctgFxPermissionCheckService fromInput(AcctgFxPermissionCheckService input) {
        AcctgFxPermissionCheckService service = new AcctgFxPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AcctgFxPermissionCheckService</code> from the output values of the given <code>AcctgFxPermissionCheckService</code>.
     * @param output a <code>AcctgFxPermissionCheckService</code>
     */
    public static AcctgFxPermissionCheckService fromOutput(AcctgFxPermissionCheckService output) {
        AcctgFxPermissionCheckService service = new AcctgFxPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgFxPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AcctgFxPermissionCheckService fromInput(Map<String, Object> mapValue) {
        AcctgFxPermissionCheckService service = new AcctgFxPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgFxPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AcctgFxPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        AcctgFxPermissionCheckService service = new AcctgFxPermissionCheckService();
