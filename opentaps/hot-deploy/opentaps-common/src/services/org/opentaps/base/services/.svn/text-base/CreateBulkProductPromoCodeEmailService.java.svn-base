 ...
 * Auto generated base service entity createBulkProductPromoCodeEmail.
 *
 * Engine: java
...
public class CreateBulkProductPromoCodeEmailService extends ServiceWrapper {
    ...
    public static final String NAME = "createBulkProductPromoCodeEmail";
    ...
    /**
     * Creates a new <code>CreateBulkProductPromoCodeEmailService</code> instance.
     */
    public CreateBulkProductPromoCodeEmailService() {
        super();
    }
     ...
     */
    public CreateBulkProductPromoCodeEmailService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateBulkProductPromoCodeEmailService</code> from the input values of the given <code>CreateBulkProductPromoCodeEmailService</code>.
     * @param input a <code>CreateBulkProductPromoCodeEmailService</code>
     */
    public static CreateBulkProductPromoCodeEmailService fromInput(CreateBulkProductPromoCodeEmailService input) {
        CreateBulkProductPromoCodeEmailService service = new CreateBulkProductPromoCodeEmailService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateBulkProductPromoCodeEmailService</code> from the output values of the given <code>CreateBulkProductPromoCodeEmailService</code>.
     * @param output a <code>CreateBulkProductPromoCodeEmailService</code>
     */
    public static CreateBulkProductPromoCodeEmailService fromOutput(CreateBulkProductPromoCodeEmailService output) {
        CreateBulkProductPromoCodeEmailService service = new CreateBulkProductPromoCodeEmailService();
    ...
    /**
     * Construct a <code>CreateBulkProductPromoCodeEmailService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateBulkProductPromoCodeEmailService fromInput(Map<String, Object> mapValue) {
        CreateBulkProductPromoCodeEmailService service = new CreateBulkProductPromoCodeEmailService();
    ...
    /**
     * Construct a <code>CreateBulkProductPromoCodeEmailService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateBulkProductPromoCodeEmailService fromOutput(Map<String, Object> mapValue) {
        CreateBulkProductPromoCodeEmailService service = new CreateBulkProductPromoCodeEmailService();
