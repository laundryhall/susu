...
/**
 * Update a Content.
 * Auto generated base service entity updateContent.
 *
 * Engine: simple
...
public class UpdateContentService extends ServiceWrapper {
    ...
    public static final String NAME = "updateContent";
    ...
    /**
     * Creates a new <code>UpdateContentService</code> instance.
     */
     ...
     */
    public UpdateContentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateContentService</code> from the input values of the given <code>UpdateContentService</code>.
     * @param input a <code>UpdateContentService</code>
     */
    public static UpdateContentService fromInput(UpdateContentService input) {
        UpdateContentService service = new UpdateContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateContentService</code> from the output values of the given <code>UpdateContentService</code>.
     * @param output a <code>UpdateContentService</code>
     */
    public static UpdateContentService fromOutput(UpdateContentService output) {
        UpdateContentService service = new UpdateContentService();
    ...
    /**
     * Construct a <code>UpdateContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateContentService fromInput(Map<String, Object> mapValue) {
        UpdateContentService service = new UpdateContentService();
    ...
    /**
     * Construct a <code>UpdateContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateContentService fromOutput(Map<String, Object> mapValue) {
        UpdateContentService service = new UpdateContentService();
