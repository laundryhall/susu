 ...
 * 
        ...
        .
 * Auto generated base service entity crmsfa.updatePartyTaxAuthInfo.
 *
 * Engine: java
 ...
 */
public class CrmsfaUpdatePartyTaxAuthInfoService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.updatePartyTaxAuthInfo";
    ...
    /**
     * Creates a new <code>CrmsfaUpdatePartyTaxAuthInfoService</code> instance.
     */
    public CrmsfaUpdatePartyTaxAuthInfoService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaUpdatePartyTaxAuthInfoService</code> from the input values of the given <code>CrmsfaUpdatePartyTaxAuthInfoService</code>.
     * @param input a <code>CrmsfaUpdatePartyTaxAuthInfoService</code>
     */
    public static CrmsfaUpdatePartyTaxAuthInfoService fromInput(CrmsfaUpdatePartyTaxAuthInfoService input) {
        CrmsfaUpdatePartyTaxAuthInfoService service = new CrmsfaUpdatePartyTaxAuthInfoService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaUpdatePartyTaxAuthInfoService</code> from the output values of the given <code>CrmsfaUpdatePartyTaxAuthInfoService</code>.
     * @param output a <code>CrmsfaUpdatePartyTaxAuthInfoService</code>
     */
    public static CrmsfaUpdatePartyTaxAuthInfoService fromOutput(CrmsfaUpdatePartyTaxAuthInfoService output) {
        CrmsfaUpdatePartyTaxAuthInfoService service = new CrmsfaUpdatePartyTaxAuthInfoService();
    ...
    /**
     * Construct a <code>CrmsfaUpdatePartyTaxAuthInfoService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaUpdatePartyTaxAuthInfoService fromInput(Map<String, Object> mapValue) {
        CrmsfaUpdatePartyTaxAuthInfoService service = new CrmsfaUpdatePartyTaxAuthInfoService();
    ...
    /**
     * Construct a <code>CrmsfaUpdatePartyTaxAuthInfoService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaUpdatePartyTaxAuthInfoService fromOutput(Map<String, Object> mapValue) {
        CrmsfaUpdatePartyTaxAuthInfoService service = new CrmsfaUpdatePartyTaxAuthInfoService();
