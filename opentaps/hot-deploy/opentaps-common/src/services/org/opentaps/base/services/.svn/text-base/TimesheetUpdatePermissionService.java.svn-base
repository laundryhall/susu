...
/**
 * .
 * Auto generated base service entity timesheetUpdatePermission.
 *
 * Engine: simple
 ...
 */
public class TimesheetUpdatePermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "timesheetUpdatePermission";
    ...
    /**
     * Creates a new <code>TimesheetUpdatePermissionService</code> instance.
     */
    public TimesheetUpdatePermissionService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>TimesheetUpdatePermissionService</code> from the input values of the given <code>TimesheetUpdatePermissionService</code>.
     * @param input a <code>TimesheetUpdatePermissionService</code>
     */
    public static TimesheetUpdatePermissionService fromInput(TimesheetUpdatePermissionService input) {
        TimesheetUpdatePermissionService service = new TimesheetUpdatePermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>TimesheetUpdatePermissionService</code> from the output values of the given <code>TimesheetUpdatePermissionService</code>.
     * @param output a <code>TimesheetUpdatePermissionService</code>
     */
    public static TimesheetUpdatePermissionService fromOutput(TimesheetUpdatePermissionService output) {
        TimesheetUpdatePermissionService service = new TimesheetUpdatePermissionService();
    ...
    /**
     * Construct a <code>TimesheetUpdatePermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static TimesheetUpdatePermissionService fromInput(Map<String, Object> mapValue) {
        TimesheetUpdatePermissionService service = new TimesheetUpdatePermissionService();
    ...
    /**
     * Construct a <code>TimesheetUpdatePermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static TimesheetUpdatePermissionService fromOutput(Map<String, Object> mapValue) {
        TimesheetUpdatePermissionService service = new TimesheetUpdatePermissionService();
