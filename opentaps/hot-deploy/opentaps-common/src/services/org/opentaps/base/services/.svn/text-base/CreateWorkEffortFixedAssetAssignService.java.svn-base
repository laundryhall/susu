 ...
 * Auto generated base service entity createWorkEffortFixedAssetAssign.
 *
 * Engine: simple
 ...
 */
public class CreateWorkEffortFixedAssetAssignService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createWorkEffortFixedAssetAssign";
    ...
    /**
     * Creates a new <code>CreateWorkEffortFixedAssetAssignService</code> instance.
     */
    public CreateWorkEffortFixedAssetAssignService() {
        super();
    }
     ...
     */
    public CreateWorkEffortFixedAssetAssignService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateWorkEffortFixedAssetAssignService</code> from the input values of the given <code>CreateWorkEffortFixedAssetAssignService</code>.
     * @param input a <code>CreateWorkEffortFixedAssetAssignService</code>
     */
    public static CreateWorkEffortFixedAssetAssignService fromInput(CreateWorkEffortFixedAssetAssignService input) {
        CreateWorkEffortFixedAssetAssignService service = new CreateWorkEffortFixedAssetAssignService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateWorkEffortFixedAssetAssignService</code> from the output values of the given <code>CreateWorkEffortFixedAssetAssignService</code>.
     * @param output a <code>CreateWorkEffortFixedAssetAssignService</code>
     */
    public static CreateWorkEffortFixedAssetAssignService fromOutput(CreateWorkEffortFixedAssetAssignService output) {
        CreateWorkEffortFixedAssetAssignService service = new CreateWorkEffortFixedAssetAssignService();
    ...
    /**
     * Construct a <code>CreateWorkEffortFixedAssetAssignService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateWorkEffortFixedAssetAssignService fromInput(Map<String, Object> mapValue) {
        CreateWorkEffortFixedAssetAssignService service = new CreateWorkEffortFixedAssetAssignService();
    ...
    /**
     * Construct a <code>CreateWorkEffortFixedAssetAssignService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateWorkEffortFixedAssetAssignService fromOutput(Map<String, Object> mapValue) {
        CreateWorkEffortFixedAssetAssignService service = new CreateWorkEffortFixedAssetAssignService();
