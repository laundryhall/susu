 ...
 * Auto generated base service entity updateInvoiceAndBillingAddress.
 *
 * Engine: java
 * Location: com.opensourcestrategies.financials.invoice.InvoiceServices
 * Invoke: updateInvoiceAndBillingAddress
...
public class UpdateInvoiceAndBillingAddressService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>UpdateInvoiceAndBillingAddressService</code> instance.
     */
    ...
    */
    ...
    /**
     * Construct a <code>UpdateInvoiceAndBillingAddressService</code> from the input values of the given <code>UpdateInvoiceAndBillingAddressService</code>.
     * @param input a <code>UpdateInvoiceAndBillingAddressService</code>
     */
    public static UpdateInvoiceAndBillingAddressService fromInput(UpdateInvoiceAndBillingAddressService input) {
        UpdateInvoiceAndBillingAddressService service = new UpdateInvoiceAndBillingAddressService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateInvoiceAndBillingAddressService</code> from the output values of the given <code>UpdateInvoiceAndBillingAddressService</code>.
     * @param output a <code>UpdateInvoiceAndBillingAddressService</code>
     */
    public static UpdateInvoiceAndBillingAddressService fromOutput(UpdateInvoiceAndBillingAddressService output) {
        UpdateInvoiceAndBillingAddressService service = new UpdateInvoiceAndBillingAddressService();
    ...
    /**
     * Construct a <code>UpdateInvoiceAndBillingAddressService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateInvoiceAndBillingAddressService fromInput(Map<String, Object> mapValue) {
        UpdateInvoiceAndBillingAddressService service = new UpdateInvoiceAndBillingAddressService();
    ...
    /**
     * Construct a <code>UpdateInvoiceAndBillingAddressService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateInvoiceAndBillingAddressService fromOutput(Map<String, Object> mapValue) {
        UpdateInvoiceAndBillingAddressService service = new UpdateInvoiceAndBillingAddressService();
