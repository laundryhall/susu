 ...
 * Auto generated base service entity createAgreementProductAppl.
 *
 * Engine: simple
 ...
 */
public class CreateAgreementProductApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createAgreementProductAppl";
    ...
    /**
     * Creates a new <code>CreateAgreementProductApplService</code> instance.
     */
    public CreateAgreementProductApplService() {
        super();
    }
     ...
     */
    public CreateAgreementProductApplService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateAgreementProductApplService</code> from the input values of the given <code>CreateAgreementProductApplService</code>.
     * @param input a <code>CreateAgreementProductApplService</code>
     */
    public static CreateAgreementProductApplService fromInput(CreateAgreementProductApplService input) {
        CreateAgreementProductApplService service = new CreateAgreementProductApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateAgreementProductApplService</code> from the output values of the given <code>CreateAgreementProductApplService</code>.
     * @param output a <code>CreateAgreementProductApplService</code>
     */
    public static CreateAgreementProductApplService fromOutput(CreateAgreementProductApplService output) {
        CreateAgreementProductApplService service = new CreateAgreementProductApplService();
    ...
    /**
     * Construct a <code>CreateAgreementProductApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateAgreementProductApplService fromInput(Map<String, Object> mapValue) {
        CreateAgreementProductApplService service = new CreateAgreementProductApplService();
    ...
    /**
     * Construct a <code>CreateAgreementProductApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateAgreementProductApplService fromOutput(Map<String, Object> mapValue) {
        CreateAgreementProductApplService service = new CreateAgreementProductApplService();
