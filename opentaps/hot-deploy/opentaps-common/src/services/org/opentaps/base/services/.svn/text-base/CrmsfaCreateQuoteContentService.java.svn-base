...
/**
 * Creates a QuoteContent entry.
 * Auto generated base service entity crmsfa.createQuoteContent.
 *
 * Engine: java
 ...
 */
public class CrmsfaCreateQuoteContentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.createQuoteContent";
    ...
    /**
     * Creates a new <code>CrmsfaCreateQuoteContentService</code> instance.
     */
    public CrmsfaCreateQuoteContentService() {
        super();
    }
     ...
     */
    public CrmsfaCreateQuoteContentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateQuoteContentService</code> from the input values of the given <code>CrmsfaCreateQuoteContentService</code>.
     * @param input a <code>CrmsfaCreateQuoteContentService</code>
     */
    public static CrmsfaCreateQuoteContentService fromInput(CrmsfaCreateQuoteContentService input) {
        CrmsfaCreateQuoteContentService service = new CrmsfaCreateQuoteContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaCreateQuoteContentService</code> from the output values of the given <code>CrmsfaCreateQuoteContentService</code>.
     * @param output a <code>CrmsfaCreateQuoteContentService</code>
     */
    public static CrmsfaCreateQuoteContentService fromOutput(CrmsfaCreateQuoteContentService output) {
        CrmsfaCreateQuoteContentService service = new CrmsfaCreateQuoteContentService();
    ...
    /**
     * Construct a <code>CrmsfaCreateQuoteContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreateQuoteContentService fromInput(Map<String, Object> mapValue) {
        CrmsfaCreateQuoteContentService service = new CrmsfaCreateQuoteContentService();
    ...
    /**
     * Construct a <code>CrmsfaCreateQuoteContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateQuoteContentService fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateQuoteContentService service = new CrmsfaCreateQuoteContentService();
