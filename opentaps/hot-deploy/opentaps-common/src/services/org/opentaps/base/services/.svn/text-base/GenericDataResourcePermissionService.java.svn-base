 ...
 * Auto generated base service entity genericDataResourcePermission.
 *
 * Engine: simple
 ...
 */
public class GenericDataResourcePermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "genericDataResourcePermission";
    ...
    /**
     * Creates a new <code>GenericDataResourcePermissionService</code> instance.
     */
    public GenericDataResourcePermissionService() {
        super();
    }
     ...
     */
    public GenericDataResourcePermissionService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>GenericDataResourcePermissionService</code> from the input values of the given <code>GenericDataResourcePermissionService</code>.
     * @param input a <code>GenericDataResourcePermissionService</code>
     */
    public static GenericDataResourcePermissionService fromInput(GenericDataResourcePermissionService input) {
        GenericDataResourcePermissionService service = new GenericDataResourcePermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>GenericDataResourcePermissionService</code> from the output values of the given <code>GenericDataResourcePermissionService</code>.
     * @param output a <code>GenericDataResourcePermissionService</code>
     */
    public static GenericDataResourcePermissionService fromOutput(GenericDataResourcePermissionService output) {
        GenericDataResourcePermissionService service = new GenericDataResourcePermissionService();
    ...
    /**
     * Construct a <code>GenericDataResourcePermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GenericDataResourcePermissionService fromInput(Map<String, Object> mapValue) {
        GenericDataResourcePermissionService service = new GenericDataResourcePermissionService();
    ...
    /**
     * Construct a <code>GenericDataResourcePermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GenericDataResourcePermissionService fromOutput(Map<String, Object> mapValue) {
        GenericDataResourcePermissionService service = new GenericDataResourcePermissionService();
