 ...
 * Auto generated base service entity alwaysDeclineGCProcessor.
 *
 * Engine: java
 ...
 */
public class AlwaysDeclineGCProcessorService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "alwaysDeclineGCProcessor";
    ...
    /**
     * Creates a new <code>AlwaysDeclineGCProcessorService</code> instance.
     */
    public AlwaysDeclineGCProcessorService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AlwaysDeclineGCProcessorService</code> from the input values of the given <code>AlwaysDeclineGCProcessorService</code>.
     * @param input a <code>AlwaysDeclineGCProcessorService</code>
     */
    public static AlwaysDeclineGCProcessorService fromInput(AlwaysDeclineGCProcessorService input) {
        AlwaysDeclineGCProcessorService service = new AlwaysDeclineGCProcessorService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AlwaysDeclineGCProcessorService</code> from the output values of the given <code>AlwaysDeclineGCProcessorService</code>.
     * @param output a <code>AlwaysDeclineGCProcessorService</code>
     */
    public static AlwaysDeclineGCProcessorService fromOutput(AlwaysDeclineGCProcessorService output) {
        AlwaysDeclineGCProcessorService service = new AlwaysDeclineGCProcessorService();
    ...
    /**
     * Construct a <code>AlwaysDeclineGCProcessorService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AlwaysDeclineGCProcessorService fromInput(Map<String, Object> mapValue) {
        AlwaysDeclineGCProcessorService service = new AlwaysDeclineGCProcessorService();
    ...
    /**
     * Construct a <code>AlwaysDeclineGCProcessorService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AlwaysDeclineGCProcessorService fromOutput(Map<String, Object> mapValue) {
        AlwaysDeclineGCProcessorService service = new AlwaysDeclineGCProcessorService();
