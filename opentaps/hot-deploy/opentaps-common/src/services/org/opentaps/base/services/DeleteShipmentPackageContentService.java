 ...
 * Auto generated base service entity deleteShipmentPackageContent.
 *
 * Engine: simple
 ...
 */
public class DeleteShipmentPackageContentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteShipmentPackageContent";
    ...
    /**
     * Creates a new <code>DeleteShipmentPackageContentService</code> instance.
     */
    public DeleteShipmentPackageContentService() {
        super();
    }
     ...
     */
    public DeleteShipmentPackageContentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteShipmentPackageContentService</code> from the input values of the given <code>DeleteShipmentPackageContentService</code>.
     * @param input a <code>DeleteShipmentPackageContentService</code>
     */
    public static DeleteShipmentPackageContentService fromInput(DeleteShipmentPackageContentService input) {
        DeleteShipmentPackageContentService service = new DeleteShipmentPackageContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteShipmentPackageContentService</code> from the output values of the given <code>DeleteShipmentPackageContentService</code>.
     * @param output a <code>DeleteShipmentPackageContentService</code>
     */
    public static DeleteShipmentPackageContentService fromOutput(DeleteShipmentPackageContentService output) {
        DeleteShipmentPackageContentService service = new DeleteShipmentPackageContentService();
    ...
    /**
     * Construct a <code>DeleteShipmentPackageContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteShipmentPackageContentService fromInput(Map<String, Object> mapValue) {
        DeleteShipmentPackageContentService service = new DeleteShipmentPackageContentService();
    ...
    /**
     * Construct a <code>DeleteShipmentPackageContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteShipmentPackageContentService fromOutput(Map<String, Object> mapValue) {
        DeleteShipmentPackageContentService service = new DeleteShipmentPackageContentService();
