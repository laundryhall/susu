 ...
 */
public class MakeShoppingListFromOrderService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>MakeShoppingListFromOrderService</code> instance.
     */
    public MakeShoppingListFromOrderService() {
        super();
    }
     ...
     */
    public MakeShoppingListFromOrderService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>MakeShoppingListFromOrderService</code> from the input values of the given <code>MakeShoppingListFromOrderService</code>.
     * @param input a <code>MakeShoppingListFromOrderService</code>
     */
    public static MakeShoppingListFromOrderService fromInput(MakeShoppingListFromOrderService input) {
        MakeShoppingListFromOrderService service = new MakeShoppingListFromOrderService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>MakeShoppingListFromOrderService</code> from the output values of the given <code>MakeShoppingListFromOrderService</code>.
     * @param output a <code>MakeShoppingListFromOrderService</code>
     */
    public static MakeShoppingListFromOrderService fromOutput(MakeShoppingListFromOrderService output) {
        MakeShoppingListFromOrderService service = new MakeShoppingListFromOrderService();
    ...
    /**
     * Construct a <code>MakeShoppingListFromOrderService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static MakeShoppingListFromOrderService fromInput(Map<String, Object> mapValue) {
        MakeShoppingListFromOrderService service = new MakeShoppingListFromOrderService();
    ...
    /**
     * Construct a <code>MakeShoppingListFromOrderService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static MakeShoppingListFromOrderService fromOutput(Map<String, Object> mapValue) {
        MakeShoppingListFromOrderService service = new MakeShoppingListFromOrderService();
