...
/**
 * .
 * Auto generated base service entity createSimpleTextContentForCategory.
 *
 * Engine: simple
 ...
 */
public class CreateSimpleTextContentForCategoryService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createSimpleTextContentForCategory";
    ...
    /**
     * Creates a new <code>CreateSimpleTextContentForCategoryService</code> instance.
     */
    public CreateSimpleTextContentForCategoryService() {
        super();
    }
     ...
     */
    public CreateSimpleTextContentForCategoryService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForCategoryService</code> from the input values of the given <code>CreateSimpleTextContentForCategoryService</code>.
     * @param input a <code>CreateSimpleTextContentForCategoryService</code>
     */
    public static CreateSimpleTextContentForCategoryService fromInput(CreateSimpleTextContentForCategoryService input) {
        CreateSimpleTextContentForCategoryService service = new CreateSimpleTextContentForCategoryService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateSimpleTextContentForCategoryService</code> from the output values of the given <code>CreateSimpleTextContentForCategoryService</code>.
     * @param output a <code>CreateSimpleTextContentForCategoryService</code>
     */
    public static CreateSimpleTextContentForCategoryService fromOutput(CreateSimpleTextContentForCategoryService output) {
        CreateSimpleTextContentForCategoryService service = new CreateSimpleTextContentForCategoryService();
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForCategoryService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateSimpleTextContentForCategoryService fromInput(Map<String, Object> mapValue) {
        CreateSimpleTextContentForCategoryService service = new CreateSimpleTextContentForCategoryService();
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForCategoryService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateSimpleTextContentForCategoryService fromOutput(Map<String, Object> mapValue) {
        CreateSimpleTextContentForCategoryService service = new CreateSimpleTextContentForCategoryService();
