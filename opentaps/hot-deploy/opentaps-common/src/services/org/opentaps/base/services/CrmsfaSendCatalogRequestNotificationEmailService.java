...
/**
 * Notify requester if catalog is sent by mail.
 * Auto generated base service entity crmsfa.sendCatalogRequestNotificationEmail.
 *
 * Engine: java
 * Location: com.opensourcestrategies.crmsfa.common.NotificationServices
 * Invoke: sendCatalogRequestNotificationEmail
 * Defined in: hot-deploy/crmsfa/servicedef/services_leads.xml
 */
public class CrmsfaSendCatalogRequestNotificationEmailService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.sendCatalogRequestNotificationEmail";
    ...
    /**
     * Creates a new <code>CrmsfaSendCatalogRequestNotificationEmailService</code> instance.
     */
    public CrmsfaSendCatalogRequestNotificationEmailService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaSendCatalogRequestNotificationEmailService</code> from the input values of the given <code>CrmsfaSendCatalogRequestNotificationEmailService</code>.
     * @param input a <code>CrmsfaSendCatalogRequestNotificationEmailService</code>
     */
    public static CrmsfaSendCatalogRequestNotificationEmailService fromInput(CrmsfaSendCatalogRequestNotificationEmailService input) {
        CrmsfaSendCatalogRequestNotificationEmailService service = new CrmsfaSendCatalogRequestNotificationEmailService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaSendCatalogRequestNotificationEmailService</code> from the output values of the given <code>CrmsfaSendCatalogRequestNotificationEmailService</code>.
     * @param output a <code>CrmsfaSendCatalogRequestNotificationEmailService</code>
     */
    public static CrmsfaSendCatalogRequestNotificationEmailService fromOutput(CrmsfaSendCatalogRequestNotificationEmailService output) {
        CrmsfaSendCatalogRequestNotificationEmailService service = new CrmsfaSendCatalogRequestNotificationEmailService();
    ...
    /**
     * Construct a <code>CrmsfaSendCatalogRequestNotificationEmailService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaSendCatalogRequestNotificationEmailService fromInput(Map<String, Object> mapValue) {
        CrmsfaSendCatalogRequestNotificationEmailService service = new CrmsfaSendCatalogRequestNotificationEmailService();
    ...
    /**
     * Construct a <code>CrmsfaSendCatalogRequestNotificationEmailService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaSendCatalogRequestNotificationEmailService fromOutput(Map<String, Object> mapValue) {
        CrmsfaSendCatalogRequestNotificationEmailService service = new CrmsfaSendCatalogRequestNotificationEmailService();
