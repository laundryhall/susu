 ...
 * Auto generated base service entity updateTaxAuthorityAssoc.
 *
 * Engine: simple
 ...
 */
public class UpdateTaxAuthorityAssocService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateTaxAuthorityAssoc";
    ...
    /**
     * Creates a new <code>UpdateTaxAuthorityAssocService</code> instance.
     */
    public UpdateTaxAuthorityAssocService() {
        super();
    }
     ...
     */
    public UpdateTaxAuthorityAssocService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityAssocService</code> from the input values of the given <code>UpdateTaxAuthorityAssocService</code>.
     * @param input a <code>UpdateTaxAuthorityAssocService</code>
     */
    public static UpdateTaxAuthorityAssocService fromInput(UpdateTaxAuthorityAssocService input) {
        UpdateTaxAuthorityAssocService service = new UpdateTaxAuthorityAssocService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateTaxAuthorityAssocService</code> from the output values of the given <code>UpdateTaxAuthorityAssocService</code>.
     * @param output a <code>UpdateTaxAuthorityAssocService</code>
     */
    public static UpdateTaxAuthorityAssocService fromOutput(UpdateTaxAuthorityAssocService output) {
        UpdateTaxAuthorityAssocService service = new UpdateTaxAuthorityAssocService();
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityAssocService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateTaxAuthorityAssocService fromInput(Map<String, Object> mapValue) {
        UpdateTaxAuthorityAssocService service = new UpdateTaxAuthorityAssocService();
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityAssocService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateTaxAuthorityAssocService fromOutput(Map<String, Object> mapValue) {
        UpdateTaxAuthorityAssocService service = new UpdateTaxAuthorityAssocService();
