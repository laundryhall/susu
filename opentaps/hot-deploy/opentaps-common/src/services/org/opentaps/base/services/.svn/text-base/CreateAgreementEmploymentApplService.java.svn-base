 ...
 * Auto generated base service entity createAgreementEmploymentAppl.
 *
 * Engine: simple
 * Location: component://humanres/script/org/ofbiz/humanres/HumanResServices.xml
 * Invoke: createAgreementEmploymentAppl
 * Defined in: applications/humanres/servicedef/services.xml
 */
public class CreateAgreementEmploymentApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createAgreementEmploymentAppl";
    ...
    /**
     * Creates a new <code>CreateAgreementEmploymentApplService</code> instance.
     */
    public CreateAgreementEmploymentApplService() {
        super();
    }
     ...
     */
    public CreateAgreementEmploymentApplService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateAgreementEmploymentApplService</code> from the input values of the given <code>CreateAgreementEmploymentApplService</code>.
     * @param input a <code>CreateAgreementEmploymentApplService</code>
     */
    public static CreateAgreementEmploymentApplService fromInput(CreateAgreementEmploymentApplService input) {
        CreateAgreementEmploymentApplService service = new CreateAgreementEmploymentApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateAgreementEmploymentApplService</code> from the output values of the given <code>CreateAgreementEmploymentApplService</code>.
     * @param output a <code>CreateAgreementEmploymentApplService</code>
     */
    public static CreateAgreementEmploymentApplService fromOutput(CreateAgreementEmploymentApplService output) {
        CreateAgreementEmploymentApplService service = new CreateAgreementEmploymentApplService();
    ...
    /**
     * Construct a <code>CreateAgreementEmploymentApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateAgreementEmploymentApplService fromInput(Map<String, Object> mapValue) {
        CreateAgreementEmploymentApplService service = new CreateAgreementEmploymentApplService();
    ...
    /**
     * Construct a <code>CreateAgreementEmploymentApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateAgreementEmploymentApplService fromOutput(Map<String, Object> mapValue) {
        CreateAgreementEmploymentApplService service = new CreateAgreementEmploymentApplService();
