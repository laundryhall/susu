...
/**
 * Process incoming Show Shipment message.
 * Auto generated base service entity oagisReceiveShowShipment.
 *
 * Engine: java
 * Location: org.ofbiz.oagis.OagisShipmentServices
 * Invoke: oagisReceiveShowShipment
 * Defined in: specialpurpose/oagis/servicedef/services.xml
 */
public class OagisReceiveShowShipmentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "oagisReceiveShowShipment";
    ...
    /**
     * Creates a new <code>OagisReceiveShowShipmentService</code> instance.
     */
    public OagisReceiveShowShipmentService() {
        super();
    }
     ...
     */
    public OagisReceiveShowShipmentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>OagisReceiveShowShipmentService</code> from the input values of the given <code>OagisReceiveShowShipmentService</code>.
     * @param input a <code>OagisReceiveShowShipmentService</code>
     */
    public static OagisReceiveShowShipmentService fromInput(OagisReceiveShowShipmentService input) {
        OagisReceiveShowShipmentService service = new OagisReceiveShowShipmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>OagisReceiveShowShipmentService</code> from the output values of the given <code>OagisReceiveShowShipmentService</code>.
     * @param output a <code>OagisReceiveShowShipmentService</code>
     */
    public static OagisReceiveShowShipmentService fromOutput(OagisReceiveShowShipmentService output) {
        OagisReceiveShowShipmentService service = new OagisReceiveShowShipmentService();
    ...
    /**
     * Construct a <code>OagisReceiveShowShipmentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OagisReceiveShowShipmentService fromInput(Map<String, Object> mapValue) {
        OagisReceiveShowShipmentService service = new OagisReceiveShowShipmentService();
    ...
    /**
     * Construct a <code>OagisReceiveShowShipmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OagisReceiveShowShipmentService fromOutput(Map<String, Object> mapValue) {
        OagisReceiveShowShipmentService service = new OagisReceiveShowShipmentService();
