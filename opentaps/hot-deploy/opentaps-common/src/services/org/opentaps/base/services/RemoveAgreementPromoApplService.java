 ...
 * Auto generated base service entity removeAgreementPromoAppl.
 *
 * Engine: simple
 ...
 */
public class RemoveAgreementPromoApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "removeAgreementPromoAppl";
    ...
    /**
     * Creates a new <code>RemoveAgreementPromoApplService</code> instance.
     */
    public RemoveAgreementPromoApplService() {
        super();
    }
     ...
     */
    public RemoveAgreementPromoApplService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>RemoveAgreementPromoApplService</code> from the input values of the given <code>RemoveAgreementPromoApplService</code>.
     * @param input a <code>RemoveAgreementPromoApplService</code>
     */
    public static RemoveAgreementPromoApplService fromInput(RemoveAgreementPromoApplService input) {
        RemoveAgreementPromoApplService service = new RemoveAgreementPromoApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>RemoveAgreementPromoApplService</code> from the output values of the given <code>RemoveAgreementPromoApplService</code>.
     * @param output a <code>RemoveAgreementPromoApplService</code>
     */
    public static RemoveAgreementPromoApplService fromOutput(RemoveAgreementPromoApplService output) {
        RemoveAgreementPromoApplService service = new RemoveAgreementPromoApplService();
    ...
    /**
     * Construct a <code>RemoveAgreementPromoApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveAgreementPromoApplService fromInput(Map<String, Object> mapValue) {
        RemoveAgreementPromoApplService service = new RemoveAgreementPromoApplService();
    ...
    /**
     * Construct a <code>RemoveAgreementPromoApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveAgreementPromoApplService fromOutput(Map<String, Object> mapValue) {
        RemoveAgreementPromoApplService service = new RemoveAgreementPromoApplService();
