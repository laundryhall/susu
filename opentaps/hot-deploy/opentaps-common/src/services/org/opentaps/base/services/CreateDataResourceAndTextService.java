 ...
 * Auto generated base service entity createDataResourceAndText.
 *
 * Engine: java
 ...
 */
public class CreateDataResourceAndTextService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createDataResourceAndText";
    ...
    /**
     * Creates a new <code>CreateDataResourceAndTextService</code> instance.
     */
    public CreateDataResourceAndTextService() {
        super();
    }
     ...
     */
    public CreateDataResourceAndTextService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateDataResourceAndTextService</code> from the input values of the given <code>CreateDataResourceAndTextService</code>.
     * @param input a <code>CreateDataResourceAndTextService</code>
     */
    public static CreateDataResourceAndTextService fromInput(CreateDataResourceAndTextService input) {
        CreateDataResourceAndTextService service = new CreateDataResourceAndTextService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateDataResourceAndTextService</code> from the output values of the given <code>CreateDataResourceAndTextService</code>.
     * @param output a <code>CreateDataResourceAndTextService</code>
     */
    public static CreateDataResourceAndTextService fromOutput(CreateDataResourceAndTextService output) {
        CreateDataResourceAndTextService service = new CreateDataResourceAndTextService();
    ...
    /**
     * Construct a <code>CreateDataResourceAndTextService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateDataResourceAndTextService fromInput(Map<String, Object> mapValue) {
        CreateDataResourceAndTextService service = new CreateDataResourceAndTextService();
    ...
    /**
     * Construct a <code>CreateDataResourceAndTextService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateDataResourceAndTextService fromOutput(Map<String, Object> mapValue) {
        CreateDataResourceAndTextService service = new CreateDataResourceAndTextService();
