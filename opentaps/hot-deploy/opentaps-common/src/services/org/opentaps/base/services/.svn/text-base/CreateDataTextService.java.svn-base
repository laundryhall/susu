 ...
 * Auto generated base service entity createDataText.
 *
 * Engine: route
 * Location: 
 * Invoke: 
 ...
 */
public class CreateDataTextService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createDataText";
    ...
    /**
     * Creates a new <code>CreateDataTextService</code> instance.
     */
    public CreateDataTextService() {
        super();
    }
     ...
     */
    public CreateDataTextService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateDataTextService</code> from the input values of the given <code>CreateDataTextService</code>.
     * @param input a <code>CreateDataTextService</code>
     */
    public static CreateDataTextService fromInput(CreateDataTextService input) {
        CreateDataTextService service = new CreateDataTextService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateDataTextService</code> from the output values of the given <code>CreateDataTextService</code>.
     * @param output a <code>CreateDataTextService</code>
     */
    public static CreateDataTextService fromOutput(CreateDataTextService output) {
        CreateDataTextService service = new CreateDataTextService();
    ...
    /**
     * Construct a <code>CreateDataTextService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateDataTextService fromInput(Map<String, Object> mapValue) {
        CreateDataTextService service = new CreateDataTextService();
    ...
    /**
     * Construct a <code>CreateDataTextService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateDataTextService fromOutput(Map<String, Object> mapValue) {
        CreateDataTextService service = new CreateDataTextService();
