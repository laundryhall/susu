 ...
 * Auto generated base service entity clearCommerceCCCapture.
 *
 * Engine: java
 ...
 */
public class ClearCommerceCCCaptureService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "clearCommerceCCCapture";
    ...
    /**
     * Creates a new <code>ClearCommerceCCCaptureService</code> instance.
     */
    public ClearCommerceCCCaptureService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>ClearCommerceCCCaptureService</code> from the input values of the given <code>ClearCommerceCCCaptureService</code>.
     * @param input a <code>ClearCommerceCCCaptureService</code>
     */
    public static ClearCommerceCCCaptureService fromInput(ClearCommerceCCCaptureService input) {
        ClearCommerceCCCaptureService service = new ClearCommerceCCCaptureService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>ClearCommerceCCCaptureService</code> from the output values of the given <code>ClearCommerceCCCaptureService</code>.
     * @param output a <code>ClearCommerceCCCaptureService</code>
     */
    public static ClearCommerceCCCaptureService fromOutput(ClearCommerceCCCaptureService output) {
        ClearCommerceCCCaptureService service = new ClearCommerceCCCaptureService();
    ...
    /**
     * Construct a <code>ClearCommerceCCCaptureService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ClearCommerceCCCaptureService fromInput(Map<String, Object> mapValue) {
        ClearCommerceCCCaptureService service = new ClearCommerceCCCaptureService();
    ...
    /**
     * Construct a <code>ClearCommerceCCCaptureService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ClearCommerceCCCaptureService fromOutput(Map<String, Object> mapValue) {
        ClearCommerceCCCaptureService service = new ClearCommerceCCCaptureService();
