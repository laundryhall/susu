...
/**
 * gets a Map of glAccount and tags -> sum of transactions for all income statement accounts (REVENUE, EXPENSE, INCOME) 
            over a period of dates for an organization..
 * Auto generated base service entity getIncomeStatementAccountSumsByTagByDate.
 *
 * Engine: java
 * Location: com.opensourcestrategies.financials.financials.FinancialServices
 * Invoke: getIncomeStatementAccountSumsByTagByDate
 * Defined in: hot-deploy/financials/servicedef/services_financials.xml
 */
public class GetIncomeStatementAccountSumsByTagByDateService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "getIncomeStatementAccountSumsByTagByDate";
    ...
    /**
     * Creates a new <code>GetIncomeStatementAccountSumsByTagByDateService</code> instance.
     */
    public GetIncomeStatementAccountSumsByTagByDateService() {
        super();
    }
     ...
     */
    public GetIncomeStatementAccountSumsByTagByDateService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>GetIncomeStatementAccountSumsByTagByDateService</code> from the input values of the given <code>GetIncomeStatementAccountSumsByTagByDateService</code>.
     * @param input a <code>GetIncomeStatementAccountSumsByTagByDateService</code>
     */
    public static GetIncomeStatementAccountSumsByTagByDateService fromInput(GetIncomeStatementAccountSumsByTagByDateService input) {
        GetIncomeStatementAccountSumsByTagByDateService service = new GetIncomeStatementAccountSumsByTagByDateService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>GetIncomeStatementAccountSumsByTagByDateService</code> from the output values of the given <code>GetIncomeStatementAccountSumsByTagByDateService</code>.
     * @param output a <code>GetIncomeStatementAccountSumsByTagByDateService</code>
     */
    public static GetIncomeStatementAccountSumsByTagByDateService fromOutput(GetIncomeStatementAccountSumsByTagByDateService output) {
        GetIncomeStatementAccountSumsByTagByDateService service = new GetIncomeStatementAccountSumsByTagByDateService();
    ...
    /**
     * Construct a <code>GetIncomeStatementAccountSumsByTagByDateService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetIncomeStatementAccountSumsByTagByDateService fromInput(Map<String, Object> mapValue) {
        GetIncomeStatementAccountSumsByTagByDateService service = new GetIncomeStatementAccountSumsByTagByDateService();
    ...
    /**
     * Construct a <code>GetIncomeStatementAccountSumsByTagByDateService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetIncomeStatementAccountSumsByTagByDateService fromOutput(Map<String, Object> mapValue) {
        GetIncomeStatementAccountSumsByTagByDateService service = new GetIncomeStatementAccountSumsByTagByDateService();
