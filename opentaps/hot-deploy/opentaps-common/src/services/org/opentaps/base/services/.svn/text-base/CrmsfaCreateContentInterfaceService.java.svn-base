...
/**
 * .
 * Auto generated base service entity crmsfa.createContentInterface.
 *
 * Engine: interface
 * Location: 
 * Invoke: 
 ...
 */
public class CrmsfaCreateContentInterfaceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.createContentInterface";
    ...
    /**
     * Creates a new <code>CrmsfaCreateContentInterfaceService</code> instance.
     */
    public CrmsfaCreateContentInterfaceService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateContentInterfaceService</code> from the input values of the given <code>CrmsfaCreateContentInterfaceService</code>.
     * @param input a <code>CrmsfaCreateContentInterfaceService</code>
     */
    public static CrmsfaCreateContentInterfaceService fromInput(CrmsfaCreateContentInterfaceService input) {
        CrmsfaCreateContentInterfaceService service = new CrmsfaCreateContentInterfaceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaCreateContentInterfaceService</code> from the output values of the given <code>CrmsfaCreateContentInterfaceService</code>.
     * @param output a <code>CrmsfaCreateContentInterfaceService</code>
     */
    public static CrmsfaCreateContentInterfaceService fromOutput(CrmsfaCreateContentInterfaceService output) {
        CrmsfaCreateContentInterfaceService service = new CrmsfaCreateContentInterfaceService();
    ...
    /**
     * Construct a <code>CrmsfaCreateContentInterfaceService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>CrmsfaCreateContentInterfaceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateContentInterfaceService fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateContentInterfaceService service = new CrmsfaCreateContentInterfaceService();
