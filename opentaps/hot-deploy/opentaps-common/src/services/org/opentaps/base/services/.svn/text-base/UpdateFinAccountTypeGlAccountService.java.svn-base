 ...
 * Auto generated base service entity updateFinAccountTypeGlAccount.
 *
 * Engine: simple
 ...
 */
public class UpdateFinAccountTypeGlAccountService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateFinAccountTypeGlAccount";
    ...
    /**
     * Creates a new <code>UpdateFinAccountTypeGlAccountService</code> instance.
     */
    public UpdateFinAccountTypeGlAccountService() {
        super();
    }
     ...
     */
    public UpdateFinAccountTypeGlAccountService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateFinAccountTypeGlAccountService</code> from the input values of the given <code>UpdateFinAccountTypeGlAccountService</code>.
     * @param input a <code>UpdateFinAccountTypeGlAccountService</code>
     */
    public static UpdateFinAccountTypeGlAccountService fromInput(UpdateFinAccountTypeGlAccountService input) {
        UpdateFinAccountTypeGlAccountService service = new UpdateFinAccountTypeGlAccountService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateFinAccountTypeGlAccountService</code> from the output values of the given <code>UpdateFinAccountTypeGlAccountService</code>.
     * @param output a <code>UpdateFinAccountTypeGlAccountService</code>
     */
    public static UpdateFinAccountTypeGlAccountService fromOutput(UpdateFinAccountTypeGlAccountService output) {
        UpdateFinAccountTypeGlAccountService service = new UpdateFinAccountTypeGlAccountService();
    ...
    /**
     * Construct a <code>UpdateFinAccountTypeGlAccountService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateFinAccountTypeGlAccountService fromInput(Map<String, Object> mapValue) {
        UpdateFinAccountTypeGlAccountService service = new UpdateFinAccountTypeGlAccountService();
    ...
    /**
     * Construct a <code>UpdateFinAccountTypeGlAccountService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateFinAccountTypeGlAccountService fromOutput(Map<String, Object> mapValue) {
        UpdateFinAccountTypeGlAccountService service = new UpdateFinAccountTypeGlAccountService();
