 ...
 * Auto generated base service entity updateContactMechAndPurposes.
 *
 * Engine: simple
 ...
 */
public class UpdateContactMechAndPurposesService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateContactMechAndPurposes";
    ...
    /**
     * Creates a new <code>UpdateContactMechAndPurposesService</code> instance.
     */
    public UpdateContactMechAndPurposesService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateContactMechAndPurposesService</code> from the input values of the given <code>UpdateContactMechAndPurposesService</code>.
     * @param input a <code>UpdateContactMechAndPurposesService</code>
     */
    public static UpdateContactMechAndPurposesService fromInput(UpdateContactMechAndPurposesService input) {
        UpdateContactMechAndPurposesService service = new UpdateContactMechAndPurposesService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateContactMechAndPurposesService</code> from the output values of the given <code>UpdateContactMechAndPurposesService</code>.
     * @param output a <code>UpdateContactMechAndPurposesService</code>
     */
    public static UpdateContactMechAndPurposesService fromOutput(UpdateContactMechAndPurposesService output) {
        UpdateContactMechAndPurposesService service = new UpdateContactMechAndPurposesService();
    ...
    /**
     * Construct a <code>UpdateContactMechAndPurposesService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>UpdateContactMechAndPurposesService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateContactMechAndPurposesService fromOutput(Map<String, Object> mapValue) {
        UpdateContactMechAndPurposesService service = new UpdateContactMechAndPurposesService();
