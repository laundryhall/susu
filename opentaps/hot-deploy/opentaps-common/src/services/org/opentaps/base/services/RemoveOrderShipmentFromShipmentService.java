 ...
 * Auto generated base service entity removeOrderShipmentFromShipment.
 *
 * Engine: simple
 ...
 */
public class RemoveOrderShipmentFromShipmentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "removeOrderShipmentFromShipment";
    ...
    /**
     * Creates a new <code>RemoveOrderShipmentFromShipmentService</code> instance.
     */
    public RemoveOrderShipmentFromShipmentService() {
        super();
    }
     ...
     */
    public RemoveOrderShipmentFromShipmentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>RemoveOrderShipmentFromShipmentService</code> from the input values of the given <code>RemoveOrderShipmentFromShipmentService</code>.
     * @param input a <code>RemoveOrderShipmentFromShipmentService</code>
     */
    public static RemoveOrderShipmentFromShipmentService fromInput(RemoveOrderShipmentFromShipmentService input) {
        RemoveOrderShipmentFromShipmentService service = new RemoveOrderShipmentFromShipmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>RemoveOrderShipmentFromShipmentService</code> from the output values of the given <code>RemoveOrderShipmentFromShipmentService</code>.
     * @param output a <code>RemoveOrderShipmentFromShipmentService</code>
     */
    public static RemoveOrderShipmentFromShipmentService fromOutput(RemoveOrderShipmentFromShipmentService output) {
        RemoveOrderShipmentFromShipmentService service = new RemoveOrderShipmentFromShipmentService();
    ...
    /**
     * Construct a <code>RemoveOrderShipmentFromShipmentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveOrderShipmentFromShipmentService fromInput(Map<String, Object> mapValue) {
        RemoveOrderShipmentFromShipmentService service = new RemoveOrderShipmentFromShipmentService();
    ...
    /**
     * Construct a <code>RemoveOrderShipmentFromShipmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveOrderShipmentFromShipmentService fromOutput(Map<String, Object> mapValue) {
        RemoveOrderShipmentFromShipmentService service = new RemoveOrderShipmentFromShipmentService();
