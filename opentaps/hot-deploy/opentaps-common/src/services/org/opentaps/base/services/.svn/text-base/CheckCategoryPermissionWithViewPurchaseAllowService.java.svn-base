...
/**
 * .
 * Auto generated base service entity checkCategoryPermissionWithViewPurchaseAllow.
 *
 * Engine: simple
 ...
 */
public class CheckCategoryPermissionWithViewPurchaseAllowService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "checkCategoryPermissionWithViewPurchaseAllow";
    ...
    /**
     * Creates a new <code>CheckCategoryPermissionWithViewPurchaseAllowService</code> instance.
     */
    public CheckCategoryPermissionWithViewPurchaseAllowService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CheckCategoryPermissionWithViewPurchaseAllowService</code> from the input values of the given <code>CheckCategoryPermissionWithViewPurchaseAllowService</code>.
     * @param input a <code>CheckCategoryPermissionWithViewPurchaseAllowService</code>
     */
    public static CheckCategoryPermissionWithViewPurchaseAllowService fromInput(CheckCategoryPermissionWithViewPurchaseAllowService input) {
        CheckCategoryPermissionWithViewPurchaseAllowService service = new CheckCategoryPermissionWithViewPurchaseAllowService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CheckCategoryPermissionWithViewPurchaseAllowService</code> from the output values of the given <code>CheckCategoryPermissionWithViewPurchaseAllowService</code>.
     * @param output a <code>CheckCategoryPermissionWithViewPurchaseAllowService</code>
     */
    public static CheckCategoryPermissionWithViewPurchaseAllowService fromOutput(CheckCategoryPermissionWithViewPurchaseAllowService output) {
        CheckCategoryPermissionWithViewPurchaseAllowService service = new CheckCategoryPermissionWithViewPurchaseAllowService();
    ...
    /**
     * Construct a <code>CheckCategoryPermissionWithViewPurchaseAllowService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CheckCategoryPermissionWithViewPurchaseAllowService fromInput(Map<String, Object> mapValue) {
        CheckCategoryPermissionWithViewPurchaseAllowService service = new CheckCategoryPermissionWithViewPurchaseAllowService();
    ...
    /**
     * Construct a <code>CheckCategoryPermissionWithViewPurchaseAllowService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CheckCategoryPermissionWithViewPurchaseAllowService fromOutput(Map<String, Object> mapValue) {
        CheckCategoryPermissionWithViewPurchaseAllowService service = new CheckCategoryPermissionWithViewPurchaseAllowService();
