...
/**
 * .
 * Auto generated base service entity exampleGenericPermission.
 *
 * Engine: simple
 ...
 */
public class ExampleGenericPermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "exampleGenericPermission";
    ...
    /**
     * Creates a new <code>ExampleGenericPermissionService</code> instance.
     */
    public ExampleGenericPermissionService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>ExampleGenericPermissionService</code> from the input values of the given <code>ExampleGenericPermissionService</code>.
     * @param input a <code>ExampleGenericPermissionService</code>
     */
    public static ExampleGenericPermissionService fromInput(ExampleGenericPermissionService input) {
        ExampleGenericPermissionService service = new ExampleGenericPermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>ExampleGenericPermissionService</code> from the output values of the given <code>ExampleGenericPermissionService</code>.
     * @param output a <code>ExampleGenericPermissionService</code>
     */
    public static ExampleGenericPermissionService fromOutput(ExampleGenericPermissionService output) {
        ExampleGenericPermissionService service = new ExampleGenericPermissionService();
    ...
    /**
     * Construct a <code>ExampleGenericPermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ExampleGenericPermissionService fromInput(Map<String, Object> mapValue) {
        ExampleGenericPermissionService service = new ExampleGenericPermissionService();
    ...
    /**
     * Construct a <code>ExampleGenericPermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ExampleGenericPermissionService fromOutput(Map<String, Object> mapValue) {
        ExampleGenericPermissionService service = new ExampleGenericPermissionService();
