 ...
 * Auto generated base service entity acctgInvoicePermissionCheck.
 *
 * Engine: simple
 ...
 */
public class AcctgInvoicePermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "acctgInvoicePermissionCheck";
    ...
    /**
     * Creates a new <code>AcctgInvoicePermissionCheckService</code> instance.
     */
    public AcctgInvoicePermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AcctgInvoicePermissionCheckService</code> from the input values of the given <code>AcctgInvoicePermissionCheckService</code>.
     * @param input a <code>AcctgInvoicePermissionCheckService</code>
     */
    public static AcctgInvoicePermissionCheckService fromInput(AcctgInvoicePermissionCheckService input) {
        AcctgInvoicePermissionCheckService service = new AcctgInvoicePermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AcctgInvoicePermissionCheckService</code> from the output values of the given <code>AcctgInvoicePermissionCheckService</code>.
     * @param output a <code>AcctgInvoicePermissionCheckService</code>
     */
    public static AcctgInvoicePermissionCheckService fromOutput(AcctgInvoicePermissionCheckService output) {
        AcctgInvoicePermissionCheckService service = new AcctgInvoicePermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgInvoicePermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AcctgInvoicePermissionCheckService fromInput(Map<String, Object> mapValue) {
        AcctgInvoicePermissionCheckService service = new AcctgInvoicePermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgInvoicePermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AcctgInvoicePermissionCheckService fromOutput(Map<String, Object> mapValue) {
        AcctgInvoicePermissionCheckService service = new AcctgInvoicePermissionCheckService();
