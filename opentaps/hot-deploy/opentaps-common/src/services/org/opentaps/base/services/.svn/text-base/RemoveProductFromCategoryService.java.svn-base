 ...
 * Auto generated base service entity removeProductFromCategory.
 *
 * Engine: simple
 ...
 */
public class RemoveProductFromCategoryService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "removeProductFromCategory";
    ...
    /**
     * Creates a new <code>RemoveProductFromCategoryService</code> instance.
     */
    public RemoveProductFromCategoryService() {
        super();
    }
     ...
     */
    public RemoveProductFromCategoryService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>RemoveProductFromCategoryService</code> from the input values of the given <code>RemoveProductFromCategoryService</code>.
     * @param input a <code>RemoveProductFromCategoryService</code>
     */
    public static RemoveProductFromCategoryService fromInput(RemoveProductFromCategoryService input) {
        RemoveProductFromCategoryService service = new RemoveProductFromCategoryService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>RemoveProductFromCategoryService</code> from the output values of the given <code>RemoveProductFromCategoryService</code>.
     * @param output a <code>RemoveProductFromCategoryService</code>
     */
    public static RemoveProductFromCategoryService fromOutput(RemoveProductFromCategoryService output) {
        RemoveProductFromCategoryService service = new RemoveProductFromCategoryService();
    ...
    /**
     * Construct a <code>RemoveProductFromCategoryService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveProductFromCategoryService fromInput(Map<String, Object> mapValue) {
        RemoveProductFromCategoryService service = new RemoveProductFromCategoryService();
    ...
    /**
     * Construct a <code>RemoveProductFromCategoryService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveProductFromCategoryService fromOutput(Map<String, Object> mapValue) {
        RemoveProductFromCategoryService service = new RemoveProductFromCategoryService();
