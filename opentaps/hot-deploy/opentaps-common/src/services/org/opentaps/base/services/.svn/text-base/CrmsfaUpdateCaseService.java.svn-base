...
/**
 * Updates a Case. Requires CRMSFA_CASE_UPDATE on any of the accounts or contacts associated with case..
 * Auto generated base service entity crmsfa.updateCase.
 *
 * Engine: java
 ...
 */
public class CrmsfaUpdateCaseService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.updateCase";
    ...
    /**
     * Creates a new <code>CrmsfaUpdateCaseService</code> instance.
     */
    public CrmsfaUpdateCaseService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaUpdateCaseService</code> from the input values of the given <code>CrmsfaUpdateCaseService</code>.
     * @param input a <code>CrmsfaUpdateCaseService</code>
     */
    public static CrmsfaUpdateCaseService fromInput(CrmsfaUpdateCaseService input) {
        CrmsfaUpdateCaseService service = new CrmsfaUpdateCaseService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaUpdateCaseService</code> from the output values of the given <code>CrmsfaUpdateCaseService</code>.
     * @param output a <code>CrmsfaUpdateCaseService</code>
     */
    public static CrmsfaUpdateCaseService fromOutput(CrmsfaUpdateCaseService output) {
        CrmsfaUpdateCaseService service = new CrmsfaUpdateCaseService();
    ...
    /**
     * Construct a <code>CrmsfaUpdateCaseService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaUpdateCaseService fromInput(Map<String, Object> mapValue) {
        CrmsfaUpdateCaseService service = new CrmsfaUpdateCaseService();
    ...
    /**
     * Construct a <code>CrmsfaUpdateCaseService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaUpdateCaseService fromOutput(Map<String, Object> mapValue) {
        CrmsfaUpdateCaseService service = new CrmsfaUpdateCaseService();
