...
/**
 * Process incoming ConfirmBod.
 * Auto generated base service entity oagisReceiveConfirmBod.
 *
 * Engine: java
 * Location: org.ofbiz.oagis.OagisServices
 * Invoke: oagisReceiveConfirmBod
 * Defined in: specialpurpose/oagis/servicedef/services.xml
 */
public class OagisReceiveConfirmBodService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "oagisReceiveConfirmBod";
    ...
    /**
     * Creates a new <code>OagisReceiveConfirmBodService</code> instance.
     */
    public OagisReceiveConfirmBodService() {
        super();
    }
     ...
     */
    public OagisReceiveConfirmBodService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>OagisReceiveConfirmBodService</code> from the input values of the given <code>OagisReceiveConfirmBodService</code>.
     * @param input a <code>OagisReceiveConfirmBodService</code>
     */
    public static OagisReceiveConfirmBodService fromInput(OagisReceiveConfirmBodService input) {
        OagisReceiveConfirmBodService service = new OagisReceiveConfirmBodService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>OagisReceiveConfirmBodService</code> from the output values of the given <code>OagisReceiveConfirmBodService</code>.
     * @param output a <code>OagisReceiveConfirmBodService</code>
     */
    public static OagisReceiveConfirmBodService fromOutput(OagisReceiveConfirmBodService output) {
        OagisReceiveConfirmBodService service = new OagisReceiveConfirmBodService();
    ...
    /**
     * Construct a <code>OagisReceiveConfirmBodService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OagisReceiveConfirmBodService fromInput(Map<String, Object> mapValue) {
        OagisReceiveConfirmBodService service = new OagisReceiveConfirmBodService();
    ...
    /**
     * Construct a <code>OagisReceiveConfirmBodService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OagisReceiveConfirmBodService fromOutput(Map<String, Object> mapValue) {
        OagisReceiveConfirmBodService service = new OagisReceiveConfirmBodService();
