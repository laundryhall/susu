 ...
 * Auto generated base service entity createReturnAdjustment.
 *
 * Engine: java
 ...
 */
public class CreateReturnAdjustmentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createReturnAdjustment";
    ...
    /**
     * Creates a new <code>CreateReturnAdjustmentService</code> instance.
     */
    public CreateReturnAdjustmentService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateReturnAdjustmentService</code> from the input values of the given <code>CreateReturnAdjustmentService</code>.
     * @param input a <code>CreateReturnAdjustmentService</code>
     */
    public static CreateReturnAdjustmentService fromInput(CreateReturnAdjustmentService input) {
        CreateReturnAdjustmentService service = new CreateReturnAdjustmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateReturnAdjustmentService</code> from the output values of the given <code>CreateReturnAdjustmentService</code>.
     * @param output a <code>CreateReturnAdjustmentService</code>
     */
    public static CreateReturnAdjustmentService fromOutput(CreateReturnAdjustmentService output) {
        CreateReturnAdjustmentService service = new CreateReturnAdjustmentService();
    ...
    /**
     * Construct a <code>CreateReturnAdjustmentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateReturnAdjustmentService fromInput(Map<String, Object> mapValue) {
        CreateReturnAdjustmentService service = new CreateReturnAdjustmentService();
    ...
    /**
     * Construct a <code>CreateReturnAdjustmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateReturnAdjustmentService fromOutput(Map<String, Object> mapValue) {
        CreateReturnAdjustmentService service = new CreateReturnAdjustmentService();
