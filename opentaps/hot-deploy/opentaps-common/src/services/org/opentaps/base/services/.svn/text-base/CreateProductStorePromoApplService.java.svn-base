 ...
 * Auto generated base service entity createProductStorePromoAppl.
 *
 * Engine: simple
 ...
 */
public class CreateProductStorePromoApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createProductStorePromoAppl";
    ...
    /**
     * Creates a new <code>CreateProductStorePromoApplService</code> instance.
     */
    public CreateProductStorePromoApplService() {
        super();
    }
     ...
     */
    public CreateProductStorePromoApplService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateProductStorePromoApplService</code> from the input values of the given <code>CreateProductStorePromoApplService</code>.
     * @param input a <code>CreateProductStorePromoApplService</code>
     */
    public static CreateProductStorePromoApplService fromInput(CreateProductStorePromoApplService input) {
        CreateProductStorePromoApplService service = new CreateProductStorePromoApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateProductStorePromoApplService</code> from the output values of the given <code>CreateProductStorePromoApplService</code>.
     * @param output a <code>CreateProductStorePromoApplService</code>
     */
    public static CreateProductStorePromoApplService fromOutput(CreateProductStorePromoApplService output) {
        CreateProductStorePromoApplService service = new CreateProductStorePromoApplService();
    ...
    /**
     * Construct a <code>CreateProductStorePromoApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateProductStorePromoApplService fromInput(Map<String, Object> mapValue) {
        CreateProductStorePromoApplService service = new CreateProductStorePromoApplService();
    ...
    /**
     * Construct a <code>CreateProductStorePromoApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateProductStorePromoApplService fromOutput(Map<String, Object> mapValue) {
        CreateProductStorePromoApplService service = new CreateProductStorePromoApplService();
