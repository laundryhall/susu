 ...
 * Auto generated base service entity createCommunicationEventRoleWithoutPermission.
 *
 * Engine: simple
 ...
 */
public class CreateCommunicationEventRoleWithoutPermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createCommunicationEventRoleWithoutPermission";
    ...
    /**
     * Creates a new <code>CreateCommunicationEventRoleWithoutPermissionService</code> instance.
     */
    public CreateCommunicationEventRoleWithoutPermissionService() {
        super();
    }
     ...
     */
    public CreateCommunicationEventRoleWithoutPermissionService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateCommunicationEventRoleWithoutPermissionService</code> from the input values of the given <code>CreateCommunicationEventRoleWithoutPermissionService</code>.
     * @param input a <code>CreateCommunicationEventRoleWithoutPermissionService</code>
     */
    public static CreateCommunicationEventRoleWithoutPermissionService fromInput(CreateCommunicationEventRoleWithoutPermissionService input) {
        CreateCommunicationEventRoleWithoutPermissionService service = new CreateCommunicationEventRoleWithoutPermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateCommunicationEventRoleWithoutPermissionService</code> from the output values of the given <code>CreateCommunicationEventRoleWithoutPermissionService</code>.
     * @param output a <code>CreateCommunicationEventRoleWithoutPermissionService</code>
     */
    public static CreateCommunicationEventRoleWithoutPermissionService fromOutput(CreateCommunicationEventRoleWithoutPermissionService output) {
        CreateCommunicationEventRoleWithoutPermissionService service = new CreateCommunicationEventRoleWithoutPermissionService();
    ...
    /**
     * Construct a <code>CreateCommunicationEventRoleWithoutPermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCommunicationEventRoleWithoutPermissionService fromInput(Map<String, Object> mapValue) {
        CreateCommunicationEventRoleWithoutPermissionService service = new CreateCommunicationEventRoleWithoutPermissionService();
    ...
    /**
     * Construct a <code>CreateCommunicationEventRoleWithoutPermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCommunicationEventRoleWithoutPermissionService fromOutput(Map<String, Object> mapValue) {
        CreateCommunicationEventRoleWithoutPermissionService service = new CreateCommunicationEventRoleWithoutPermissionService();
