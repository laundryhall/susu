 ...
 * Auto generated base service entity updateContentRevisionItem.
 *
 * Engine: simple
 ...
 */
public class UpdateContentRevisionItemService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateContentRevisionItem";
    ...
    /**
     * Creates a new <code>UpdateContentRevisionItemService</code> instance.
     */
    public UpdateContentRevisionItemService() {
        super();
    }
     ...
     */
    public UpdateContentRevisionItemService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateContentRevisionItemService</code> from the input values of the given <code>UpdateContentRevisionItemService</code>.
     * @param input a <code>UpdateContentRevisionItemService</code>
     */
    public static UpdateContentRevisionItemService fromInput(UpdateContentRevisionItemService input) {
        UpdateContentRevisionItemService service = new UpdateContentRevisionItemService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateContentRevisionItemService</code> from the output values of the given <code>UpdateContentRevisionItemService</code>.
     * @param output a <code>UpdateContentRevisionItemService</code>
     */
    public static UpdateContentRevisionItemService fromOutput(UpdateContentRevisionItemService output) {
        UpdateContentRevisionItemService service = new UpdateContentRevisionItemService();
    ...
    /**
     * Construct a <code>UpdateContentRevisionItemService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateContentRevisionItemService fromInput(Map<String, Object> mapValue) {
        UpdateContentRevisionItemService service = new UpdateContentRevisionItemService();
    ...
    /**
     * Construct a <code>UpdateContentRevisionItemService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateContentRevisionItemService fromOutput(Map<String, Object> mapValue) {
        UpdateContentRevisionItemService service = new UpdateContentRevisionItemService();
