...
/**
 * .
 * Auto generated base service entity createDownloadContent.
 *
 * Engine: simple
 ...
 */
public class CreateDownloadContentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createDownloadContent";
    ...
    /**
     * Creates a new <code>CreateDownloadContentService</code> instance.
     */
    public CreateDownloadContentService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateDownloadContentService</code> from the input values of the given <code>CreateDownloadContentService</code>.
     * @param input a <code>CreateDownloadContentService</code>
     */
    public static CreateDownloadContentService fromInput(CreateDownloadContentService input) {
        CreateDownloadContentService service = new CreateDownloadContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateDownloadContentService</code> from the output values of the given <code>CreateDownloadContentService</code>.
     * @param output a <code>CreateDownloadContentService</code>
     */
    public static CreateDownloadContentService fromOutput(CreateDownloadContentService output) {
        CreateDownloadContentService service = new CreateDownloadContentService();
    ...
    /**
     * Construct a <code>CreateDownloadContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateDownloadContentService fromInput(Map<String, Object> mapValue) {
        CreateDownloadContentService service = new CreateDownloadContentService();
    ...
    /**
     * Construct a <code>CreateDownloadContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateDownloadContentService fromOutput(Map<String, Object> mapValue) {
        CreateDownloadContentService service = new CreateDownloadContentService();
