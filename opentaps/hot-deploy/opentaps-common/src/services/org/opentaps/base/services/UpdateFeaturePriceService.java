 ...
 * Auto generated base service entity updateFeaturePrice.
 *
 * Engine: simple
 * Location: component://product/script/org/ofbiz/product/feature/ProductFeatureServices.xml
 * Invoke: updateFeaturePrice
 * Defined in: applications/product/servicedef/services_feature.xml
 */
public class UpdateFeaturePriceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateFeaturePrice";
    ...
    /**
     * Creates a new <code>UpdateFeaturePriceService</code> instance.
     */
    public UpdateFeaturePriceService() {
        super();
    }
     ...
     */
    public UpdateFeaturePriceService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateFeaturePriceService</code> from the input values of the given <code>UpdateFeaturePriceService</code>.
     * @param input a <code>UpdateFeaturePriceService</code>
     */
    public static UpdateFeaturePriceService fromInput(UpdateFeaturePriceService input) {
        UpdateFeaturePriceService service = new UpdateFeaturePriceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateFeaturePriceService</code> from the output values of the given <code>UpdateFeaturePriceService</code>.
     * @param output a <code>UpdateFeaturePriceService</code>
     */
    public static UpdateFeaturePriceService fromOutput(UpdateFeaturePriceService output) {
        UpdateFeaturePriceService service = new UpdateFeaturePriceService();
    ...
    /**
     * Construct a <code>UpdateFeaturePriceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateFeaturePriceService fromInput(Map<String, Object> mapValue) {
        UpdateFeaturePriceService service = new UpdateFeaturePriceService();
    ...
    /**
     * Construct a <code>UpdateFeaturePriceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateFeaturePriceService fromOutput(Map<String, Object> mapValue) {
        UpdateFeaturePriceService service = new UpdateFeaturePriceService();
