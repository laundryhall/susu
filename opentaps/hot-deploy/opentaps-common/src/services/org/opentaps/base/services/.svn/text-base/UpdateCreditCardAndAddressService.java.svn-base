 ...
 * Auto generated base service entity updateCreditCardAndAddress.
 *
 * Engine: group
 ...
 */
public class UpdateCreditCardAndAddressService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateCreditCardAndAddress";
    ...
    /**
     * Creates a new <code>UpdateCreditCardAndAddressService</code> instance.
     */
    public UpdateCreditCardAndAddressService() {
        super();
    }
     ...
     */
    public UpdateCreditCardAndAddressService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateCreditCardAndAddressService</code> from the input values of the given <code>UpdateCreditCardAndAddressService</code>.
     * @param input a <code>UpdateCreditCardAndAddressService</code>
     */
    public static UpdateCreditCardAndAddressService fromInput(UpdateCreditCardAndAddressService input) {
        UpdateCreditCardAndAddressService service = new UpdateCreditCardAndAddressService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateCreditCardAndAddressService</code> from the output values of the given <code>UpdateCreditCardAndAddressService</code>.
     * @param output a <code>UpdateCreditCardAndAddressService</code>
     */
    public static UpdateCreditCardAndAddressService fromOutput(UpdateCreditCardAndAddressService output) {
        UpdateCreditCardAndAddressService service = new UpdateCreditCardAndAddressService();
    ...
    /**
     * Construct a <code>UpdateCreditCardAndAddressService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateCreditCardAndAddressService fromInput(Map<String, Object> mapValue) {
        UpdateCreditCardAndAddressService service = new UpdateCreditCardAndAddressService();
    ...
    /**
     * Construct a <code>UpdateCreditCardAndAddressService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateCreditCardAndAddressService fromOutput(Map<String, Object> mapValue) {
        UpdateCreditCardAndAddressService service = new UpdateCreditCardAndAddressService();
