 ...
 * Auto generated base service entity uploadWorkEffortContentFile.
 *
 * Engine: group
 * Location: 
 * Invoke: _uploadWorkEffortContentFile.group
 * Defined in: applications/workeffort/servicedef/services.xml
 */
public class UploadWorkEffortContentFileService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "uploadWorkEffortContentFile";
    ...
    /**
     * Creates a new <code>UploadWorkEffortContentFileService</code> instance.
     */
    public UploadWorkEffortContentFileService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>UploadWorkEffortContentFileService</code> from the input values of the given <code>UploadWorkEffortContentFileService</code>.
     * @param input a <code>UploadWorkEffortContentFileService</code>
     */
    public static UploadWorkEffortContentFileService fromInput(UploadWorkEffortContentFileService input) {
        UploadWorkEffortContentFileService service = new UploadWorkEffortContentFileService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UploadWorkEffortContentFileService</code> from the output values of the given <code>UploadWorkEffortContentFileService</code>.
     * @param output a <code>UploadWorkEffortContentFileService</code>
     */
    public static UploadWorkEffortContentFileService fromOutput(UploadWorkEffortContentFileService output) {
        UploadWorkEffortContentFileService service = new UploadWorkEffortContentFileService();
    ...
    /**
     * Construct a <code>UploadWorkEffortContentFileService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>UploadWorkEffortContentFileService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UploadWorkEffortContentFileService fromOutput(Map<String, Object> mapValue) {
        UploadWorkEffortContentFileService service = new UploadWorkEffortContentFileService();
