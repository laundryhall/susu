 ...
 * Auto generated base service entity sendMail.
 *
 * Engine: java
...
public class SendMailService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>SendMailService</code> instance.
     */
    ...
    */
    ...
    /**
     * Construct a <code>SendMailService</code> from the input values of the given <code>SendMailService</code>.
     * @param input a <code>SendMailService</code>
     */
    public static SendMailService fromInput(SendMailService input) {
        SendMailService service = new SendMailService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>SendMailService</code> from the output values of the given <code>SendMailService</code>.
     * @param output a <code>SendMailService</code>
     */
    public static SendMailService fromOutput(SendMailService output) {
        SendMailService service = new SendMailService();
    ...
    /**
     * Construct a <code>SendMailService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SendMailService fromInput(Map<String, Object> mapValue) {
        SendMailService service = new SendMailService();
    ...
    /**
     * Construct a <code>SendMailService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SendMailService fromOutput(Map<String, Object> mapValue) {
        SendMailService service = new SendMailService();
