 ...
 */
public class ReserveProductInventoryByContainerService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>ReserveProductInventoryByContainerService</code> instance.
     */
    public ReserveProductInventoryByContainerService() {
        super();
    }
     ...
     */
    public ReserveProductInventoryByContainerService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>ReserveProductInventoryByContainerService</code> from the input values of the given <code>ReserveProductInventoryByContainerService</code>.
     * @param input a <code>ReserveProductInventoryByContainerService</code>
     */
    public static ReserveProductInventoryByContainerService fromInput(ReserveProductInventoryByContainerService input) {
        ReserveProductInventoryByContainerService service = new ReserveProductInventoryByContainerService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>ReserveProductInventoryByContainerService</code> from the output values of the given <code>ReserveProductInventoryByContainerService</code>.
     * @param output a <code>ReserveProductInventoryByContainerService</code>
     */
    public static ReserveProductInventoryByContainerService fromOutput(ReserveProductInventoryByContainerService output) {
        ReserveProductInventoryByContainerService service = new ReserveProductInventoryByContainerService();
    ...
    /**
     * Construct a <code>ReserveProductInventoryByContainerService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ReserveProductInventoryByContainerService fromInput(Map<String, Object> mapValue) {
        ReserveProductInventoryByContainerService service = new ReserveProductInventoryByContainerService();
    ...
    /**
     * Construct a <code>ReserveProductInventoryByContainerService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ReserveProductInventoryByContainerService fromOutput(Map<String, Object> mapValue) {
        ReserveProductInventoryByContainerService service = new ReserveProductInventoryByContainerService();
