 ...
 * Calculates net income (of ACTUAL gl fiscal type) since last closed accounting period or, if none exists, since earliest accounting period.
            Optionally, use periodTypeId to get net income since last closed accounting period of this type..
 * Auto generated base service entity getActualNetIncomeSinceLastClosing.
 *
 * Engine: java
...
public class GetActualNetIncomeSinceLastClosingService extends ServiceWrapper {
    ...
    public static final String NAME = "getActualNetIncomeSinceLastClosing";
    ...
    /**
     * Creates a new <code>GetActualNetIncomeSinceLastClosingService</code> instance.
     */
    public GetActualNetIncomeSinceLastClosingService() {
        super();
    }
     ...
     */
    public GetActualNetIncomeSinceLastClosingService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>GetActualNetIncomeSinceLastClosingService</code> from the input values of the given <code>GetActualNetIncomeSinceLastClosingService</code>.
     * @param input a <code>GetActualNetIncomeSinceLastClosingService</code>
     */
    public static GetActualNetIncomeSinceLastClosingService fromInput(GetActualNetIncomeSinceLastClosingService input) {
        GetActualNetIncomeSinceLastClosingService service = new GetActualNetIncomeSinceLastClosingService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>GetActualNetIncomeSinceLastClosingService</code> from the output values of the given <code>GetActualNetIncomeSinceLastClosingService</code>.
     * @param output a <code>GetActualNetIncomeSinceLastClosingService</code>
     */
    public static GetActualNetIncomeSinceLastClosingService fromOutput(GetActualNetIncomeSinceLastClosingService output) {
        GetActualNetIncomeSinceLastClosingService service = new GetActualNetIncomeSinceLastClosingService();
    ...
    /**
     * Construct a <code>GetActualNetIncomeSinceLastClosingService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetActualNetIncomeSinceLastClosingService fromInput(Map<String, Object> mapValue) {
        GetActualNetIncomeSinceLastClosingService service = new GetActualNetIncomeSinceLastClosingService();
    ...
    /**
     * Construct a <code>GetActualNetIncomeSinceLastClosingService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetActualNetIncomeSinceLastClosingService fromOutput(Map<String, Object> mapValue) {
        GetActualNetIncomeSinceLastClosingService service = new GetActualNetIncomeSinceLastClosingService();
