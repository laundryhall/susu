...
/**
 * Creates a SalesOpportunityContent entry.
 * Auto generated base service entity crmsfa.createSalesOpportunityContent.
 *
 * Engine: java
 * Location: com.opensourcestrategies.crmsfa.content.ContentServices
 * Invoke: createSalesOpportunityContent
 * Defined in: hot-deploy/crmsfa/servicedef/services_content.xml
 */
public class CrmsfaCreateSalesOpportunityContentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.createSalesOpportunityContent";
    ...
    /**
     * Creates a new <code>CrmsfaCreateSalesOpportunityContentService</code> instance.
     */
    public CrmsfaCreateSalesOpportunityContentService() {
        super();
    }
     ...
     */
    public CrmsfaCreateSalesOpportunityContentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateSalesOpportunityContentService</code> from the input values of the given <code>CrmsfaCreateSalesOpportunityContentService</code>.
     * @param input a <code>CrmsfaCreateSalesOpportunityContentService</code>
     */
    public static CrmsfaCreateSalesOpportunityContentService fromInput(CrmsfaCreateSalesOpportunityContentService input) {
        CrmsfaCreateSalesOpportunityContentService service = new CrmsfaCreateSalesOpportunityContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaCreateSalesOpportunityContentService</code> from the output values of the given <code>CrmsfaCreateSalesOpportunityContentService</code>.
     * @param output a <code>CrmsfaCreateSalesOpportunityContentService</code>
     */
    public static CrmsfaCreateSalesOpportunityContentService fromOutput(CrmsfaCreateSalesOpportunityContentService output) {
        CrmsfaCreateSalesOpportunityContentService service = new CrmsfaCreateSalesOpportunityContentService();
    ...
    /**
     * Construct a <code>CrmsfaCreateSalesOpportunityContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreateSalesOpportunityContentService fromInput(Map<String, Object> mapValue) {
        CrmsfaCreateSalesOpportunityContentService service = new CrmsfaCreateSalesOpportunityContentService();
    ...
    /**
     * Construct a <code>CrmsfaCreateSalesOpportunityContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateSalesOpportunityContentService fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateSalesOpportunityContentService service = new CrmsfaCreateSalesOpportunityContentService();
