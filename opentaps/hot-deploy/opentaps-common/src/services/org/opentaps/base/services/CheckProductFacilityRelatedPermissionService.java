 ...
 * Auto generated base service entity checkProductFacilityRelatedPermission.
 *
 * Engine: simple
 ...
 */
public class CheckProductFacilityRelatedPermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "checkProductFacilityRelatedPermission";
    ...
    /**
     * Creates a new <code>CheckProductFacilityRelatedPermissionService</code> instance.
     */
    public CheckProductFacilityRelatedPermissionService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CheckProductFacilityRelatedPermissionService</code> from the input values of the given <code>CheckProductFacilityRelatedPermissionService</code>.
     * @param input a <code>CheckProductFacilityRelatedPermissionService</code>
     */
    public static CheckProductFacilityRelatedPermissionService fromInput(CheckProductFacilityRelatedPermissionService input) {
        CheckProductFacilityRelatedPermissionService service = new CheckProductFacilityRelatedPermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CheckProductFacilityRelatedPermissionService</code> from the output values of the given <code>CheckProductFacilityRelatedPermissionService</code>.
     * @param output a <code>CheckProductFacilityRelatedPermissionService</code>
     */
    public static CheckProductFacilityRelatedPermissionService fromOutput(CheckProductFacilityRelatedPermissionService output) {
        CheckProductFacilityRelatedPermissionService service = new CheckProductFacilityRelatedPermissionService();
    ...
    /**
     * Construct a <code>CheckProductFacilityRelatedPermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CheckProductFacilityRelatedPermissionService fromInput(Map<String, Object> mapValue) {
        CheckProductFacilityRelatedPermissionService service = new CheckProductFacilityRelatedPermissionService();
    ...
    /**
     * Construct a <code>CheckProductFacilityRelatedPermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CheckProductFacilityRelatedPermissionService fromOutput(Map<String, Object> mapValue) {
        CheckProductFacilityRelatedPermissionService service = new CheckProductFacilityRelatedPermissionService();
