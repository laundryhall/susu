...
/**
 * .
 * Auto generated base service entity workEffortManagerPermission.
 *
 * Engine: simple
 ...
 */
public class WorkEffortManagerPermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "workEffortManagerPermission";
    ...
    /**
     * Creates a new <code>WorkEffortManagerPermissionService</code> instance.
     */
    public WorkEffortManagerPermissionService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>WorkEffortManagerPermissionService</code> from the input values of the given <code>WorkEffortManagerPermissionService</code>.
     * @param input a <code>WorkEffortManagerPermissionService</code>
     */
    public static WorkEffortManagerPermissionService fromInput(WorkEffortManagerPermissionService input) {
        WorkEffortManagerPermissionService service = new WorkEffortManagerPermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>WorkEffortManagerPermissionService</code> from the output values of the given <code>WorkEffortManagerPermissionService</code>.
     * @param output a <code>WorkEffortManagerPermissionService</code>
     */
    public static WorkEffortManagerPermissionService fromOutput(WorkEffortManagerPermissionService output) {
        WorkEffortManagerPermissionService service = new WorkEffortManagerPermissionService();
    ...
    /**
     * Construct a <code>WorkEffortManagerPermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static WorkEffortManagerPermissionService fromInput(Map<String, Object> mapValue) {
        WorkEffortManagerPermissionService service = new WorkEffortManagerPermissionService();
    ...
    /**
     * Construct a <code>WorkEffortManagerPermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static WorkEffortManagerPermissionService fromOutput(Map<String, Object> mapValue) {
        WorkEffortManagerPermissionService service = new WorkEffortManagerPermissionService();
