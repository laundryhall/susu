...
/**
 * Updates a Facility association from the facilityId to the facilityIdTo.  User must have WRHS_FACILITY_ASSOC permission on both facilities..
 * Auto generated base service entity updateFacilityAssoc.
 *
 * Engine: java
...
public class UpdateFacilityAssocService extends ServiceWrapper {
    ...
    public static final String NAME = "updateFacilityAssoc";
    ...
    /**
     * Creates a new <code>UpdateFacilityAssocService</code> instance.
     */
    public UpdateFacilityAssocService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateFacilityAssocService</code> from the input values of the given <code>UpdateFacilityAssocService</code>.
     * @param input a <code>UpdateFacilityAssocService</code>
     */
    public static UpdateFacilityAssocService fromInput(UpdateFacilityAssocService input) {
        UpdateFacilityAssocService service = new UpdateFacilityAssocService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateFacilityAssocService</code> from the output values of the given <code>UpdateFacilityAssocService</code>.
     * @param output a <code>UpdateFacilityAssocService</code>
     */
    public static UpdateFacilityAssocService fromOutput(UpdateFacilityAssocService output) {
        UpdateFacilityAssocService service = new UpdateFacilityAssocService();
    ...
    /**
     * Construct a <code>UpdateFacilityAssocService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateFacilityAssocService fromInput(Map<String, Object> mapValue) {
        UpdateFacilityAssocService service = new UpdateFacilityAssocService();
    ...
    /**
     * Construct a <code>UpdateFacilityAssocService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateFacilityAssocService fromOutput(Map<String, Object> mapValue) {
        UpdateFacilityAssocService service = new UpdateFacilityAssocService();
