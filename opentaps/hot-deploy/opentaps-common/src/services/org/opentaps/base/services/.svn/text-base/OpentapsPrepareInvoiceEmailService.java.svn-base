...
/**
 * Send an email to someone in the system. Associate a completed Invoice and a completed CommunicationEvent. 
            To send a saved email, pass in the communicationEventId and the InvoiceId of the saved data.
            No security at the moment..
 * Auto generated base service entity opentaps.prepareInvoiceEmail.
 *
 * Engine: java
 * Location: org.opentaps.common.content.EmailServices
 * Invoke: prepareInvoiceEmail
 * Defined in: hot-deploy/opentaps-common/servicedef/services_email.xml
 */
public class OpentapsPrepareInvoiceEmailService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "opentaps.prepareInvoiceEmail";
    ...
    /**
     * Creates a new <code>OpentapsPrepareInvoiceEmailService</code> instance.
     */
    public OpentapsPrepareInvoiceEmailService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsPrepareInvoiceEmailService</code> from the input values of the given <code>OpentapsPrepareInvoiceEmailService</code>.
     * @param input a <code>OpentapsPrepareInvoiceEmailService</code>
     */
    public static OpentapsPrepareInvoiceEmailService fromInput(OpentapsPrepareInvoiceEmailService input) {
        OpentapsPrepareInvoiceEmailService service = new OpentapsPrepareInvoiceEmailService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>OpentapsPrepareInvoiceEmailService</code> from the output values of the given <code>OpentapsPrepareInvoiceEmailService</code>.
     * @param output a <code>OpentapsPrepareInvoiceEmailService</code>
     */
    public static OpentapsPrepareInvoiceEmailService fromOutput(OpentapsPrepareInvoiceEmailService output) {
        OpentapsPrepareInvoiceEmailService service = new OpentapsPrepareInvoiceEmailService();
    ...
    /**
     * Construct a <code>OpentapsPrepareInvoiceEmailService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsPrepareInvoiceEmailService fromInput(Map<String, Object> mapValue) {
        OpentapsPrepareInvoiceEmailService service = new OpentapsPrepareInvoiceEmailService();
    ...
    /**
     * Construct a <code>OpentapsPrepareInvoiceEmailService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsPrepareInvoiceEmailService fromOutput(Map<String, Object> mapValue) {
        OpentapsPrepareInvoiceEmailService service = new OpentapsPrepareInvoiceEmailService();
