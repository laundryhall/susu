 ...
 * Auto generated base service entity createPartyTelecomNumber.
 *
 * Engine: simple
 ...
 */
public class CreatePartyTelecomNumberService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createPartyTelecomNumber";
    ...
    /**
     * Creates a new <code>CreatePartyTelecomNumberService</code> instance.
     */
    public CreatePartyTelecomNumberService() {
        super();
    }
     ...
     */
    public CreatePartyTelecomNumberService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreatePartyTelecomNumberService</code> from the input values of the given <code>CreatePartyTelecomNumberService</code>.
     * @param input a <code>CreatePartyTelecomNumberService</code>
     */
    public static CreatePartyTelecomNumberService fromInput(CreatePartyTelecomNumberService input) {
        CreatePartyTelecomNumberService service = new CreatePartyTelecomNumberService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreatePartyTelecomNumberService</code> from the output values of the given <code>CreatePartyTelecomNumberService</code>.
     * @param output a <code>CreatePartyTelecomNumberService</code>
     */
    public static CreatePartyTelecomNumberService fromOutput(CreatePartyTelecomNumberService output) {
        CreatePartyTelecomNumberService service = new CreatePartyTelecomNumberService();
    ...
    /**
     * Construct a <code>CreatePartyTelecomNumberService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePartyTelecomNumberService fromInput(Map<String, Object> mapValue) {
        CreatePartyTelecomNumberService service = new CreatePartyTelecomNumberService();
    ...
    /**
     * Construct a <code>CreatePartyTelecomNumberService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePartyTelecomNumberService fromOutput(Map<String, Object> mapValue) {
        CreatePartyTelecomNumberService service = new CreatePartyTelecomNumberService();
