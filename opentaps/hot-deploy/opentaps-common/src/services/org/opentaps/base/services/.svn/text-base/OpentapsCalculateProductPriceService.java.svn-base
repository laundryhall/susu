...
public class OpentapsCalculateProductPriceService extends ServiceWrapper {
    ...
    private BigDecimal outMinAdvPrice;
     ...
     * @return <code>BigDecimal</code>
     */
    public BigDecimal getOutMinAdvPrice() {
    ...
    */
    public void setOutMinAdvPrice(BigDecimal outMinAdvPrice) {
    ...
    */
    ...
    public void putAllOutput(Map<String, Object> mapValue) {
        ...
        if (mapValue.containsKey("minAdvPrice")) setOutMinAdvPrice((BigDecimal) mapValue.get("minAdvPrice"));
