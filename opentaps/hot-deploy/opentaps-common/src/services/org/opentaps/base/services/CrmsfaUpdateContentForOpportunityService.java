...
/**
 * Updates uploadable or simple content for Opportunities..
 * Auto generated base service entity crmsfa.updateContentForOpportunity.
 *
 * Engine: java
 * Location: com.opensourcestrategies.crmsfa.content.ContentServices
 * Invoke: updateContentForOpportunity
 * Defined in: hot-deploy/crmsfa/servicedef/services_content.xml
 */
public class CrmsfaUpdateContentForOpportunityService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.updateContentForOpportunity";
    ...
    /**
     * Creates a new <code>CrmsfaUpdateContentForOpportunityService</code> instance.
     */
    public CrmsfaUpdateContentForOpportunityService() {
        super();
    }
     ...
     */
    public CrmsfaUpdateContentForOpportunityService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaUpdateContentForOpportunityService</code> from the input values of the given <code>CrmsfaUpdateContentForOpportunityService</code>.
     * @param input a <code>CrmsfaUpdateContentForOpportunityService</code>
     */
    public static CrmsfaUpdateContentForOpportunityService fromInput(CrmsfaUpdateContentForOpportunityService input) {
        CrmsfaUpdateContentForOpportunityService service = new CrmsfaUpdateContentForOpportunityService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaUpdateContentForOpportunityService</code> from the output values of the given <code>CrmsfaUpdateContentForOpportunityService</code>.
     * @param output a <code>CrmsfaUpdateContentForOpportunityService</code>
     */
    public static CrmsfaUpdateContentForOpportunityService fromOutput(CrmsfaUpdateContentForOpportunityService output) {
        CrmsfaUpdateContentForOpportunityService service = new CrmsfaUpdateContentForOpportunityService();
    ...
    /**
     * Construct a <code>CrmsfaUpdateContentForOpportunityService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaUpdateContentForOpportunityService fromInput(Map<String, Object> mapValue) {
        CrmsfaUpdateContentForOpportunityService service = new CrmsfaUpdateContentForOpportunityService();
    ...
    /**
     * Construct a <code>CrmsfaUpdateContentForOpportunityService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaUpdateContentForOpportunityService fromOutput(Map<String, Object> mapValue) {
        CrmsfaUpdateContentForOpportunityService service = new CrmsfaUpdateContentForOpportunityService();
