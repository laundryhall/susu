 ...
 * Auto generated base service entity acctgCommissionPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class AcctgCommissionPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "acctgCommissionPermissionCheck";
    ...
    /**
     * Creates a new <code>AcctgCommissionPermissionCheckService</code> instance.
     */
    public AcctgCommissionPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AcctgCommissionPermissionCheckService</code> from the input values of the given <code>AcctgCommissionPermissionCheckService</code>.
     * @param input a <code>AcctgCommissionPermissionCheckService</code>
     */
    public static AcctgCommissionPermissionCheckService fromInput(AcctgCommissionPermissionCheckService input) {
        AcctgCommissionPermissionCheckService service = new AcctgCommissionPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AcctgCommissionPermissionCheckService</code> from the output values of the given <code>AcctgCommissionPermissionCheckService</code>.
     * @param output a <code>AcctgCommissionPermissionCheckService</code>
     */
    public static AcctgCommissionPermissionCheckService fromOutput(AcctgCommissionPermissionCheckService output) {
        AcctgCommissionPermissionCheckService service = new AcctgCommissionPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgCommissionPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AcctgCommissionPermissionCheckService fromInput(Map<String, Object> mapValue) {
        AcctgCommissionPermissionCheckService service = new AcctgCommissionPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgCommissionPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AcctgCommissionPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        AcctgCommissionPermissionCheckService service = new AcctgCommissionPermissionCheckService();
