 ...
 * 
        ...
        .
 * Auto generated base service entity resetOrgGlAccountBalances.
 *
 * Engine: java
 * Location: com.opensourcestrategies.financials.ledger.LedgerServices
 * Invoke: resetOrgGlAccountBalances
 * Defined in: hot-deploy/financials/servicedef/services_ledger_ext.xml
 */
public class ResetOrgGlAccountBalancesService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "resetOrgGlAccountBalances";
    ...
    /**
     * Creates a new <code>ResetOrgGlAccountBalancesService</code> instance.
     */
    public ResetOrgGlAccountBalancesService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>ResetOrgGlAccountBalancesService</code> from the input values of the given <code>ResetOrgGlAccountBalancesService</code>.
     * @param input a <code>ResetOrgGlAccountBalancesService</code>
     */
    public static ResetOrgGlAccountBalancesService fromInput(ResetOrgGlAccountBalancesService input) {
        ResetOrgGlAccountBalancesService service = new ResetOrgGlAccountBalancesService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>ResetOrgGlAccountBalancesService</code> from the output values of the given <code>ResetOrgGlAccountBalancesService</code>.
     * @param output a <code>ResetOrgGlAccountBalancesService</code>
     */
    public static ResetOrgGlAccountBalancesService fromOutput(ResetOrgGlAccountBalancesService output) {
        ResetOrgGlAccountBalancesService service = new ResetOrgGlAccountBalancesService();
    ...
    /**
     * Construct a <code>ResetOrgGlAccountBalancesService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ResetOrgGlAccountBalancesService fromInput(Map<String, Object> mapValue) {
        ResetOrgGlAccountBalancesService service = new ResetOrgGlAccountBalancesService();
    ...
    /**
     * Construct a <code>ResetOrgGlAccountBalancesService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ResetOrgGlAccountBalancesService fromOutput(Map<String, Object> mapValue) {
        ResetOrgGlAccountBalancesService service = new ResetOrgGlAccountBalancesService();
