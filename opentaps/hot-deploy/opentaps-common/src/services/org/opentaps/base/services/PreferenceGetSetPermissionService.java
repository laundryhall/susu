 ...
 * Auto generated base service entity preferenceGetSetPermission.
 *
 * Engine: java
 ...
 */
public class PreferenceGetSetPermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "preferenceGetSetPermission";
    ...
    /**
     * Creates a new <code>PreferenceGetSetPermissionService</code> instance.
     */
    public PreferenceGetSetPermissionService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>PreferenceGetSetPermissionService</code> from the input values of the given <code>PreferenceGetSetPermissionService</code>.
     * @param input a <code>PreferenceGetSetPermissionService</code>
     */
    public static PreferenceGetSetPermissionService fromInput(PreferenceGetSetPermissionService input) {
        PreferenceGetSetPermissionService service = new PreferenceGetSetPermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>PreferenceGetSetPermissionService</code> from the output values of the given <code>PreferenceGetSetPermissionService</code>.
     * @param output a <code>PreferenceGetSetPermissionService</code>
     */
    public static PreferenceGetSetPermissionService fromOutput(PreferenceGetSetPermissionService output) {
        PreferenceGetSetPermissionService service = new PreferenceGetSetPermissionService();
    ...
    /**
     * Construct a <code>PreferenceGetSetPermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PreferenceGetSetPermissionService fromInput(Map<String, Object> mapValue) {
        PreferenceGetSetPermissionService service = new PreferenceGetSetPermissionService();
    ...
    /**
     * Construct a <code>PreferenceGetSetPermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PreferenceGetSetPermissionService fromOutput(Map<String, Object> mapValue) {
        PreferenceGetSetPermissionService service = new PreferenceGetSetPermissionService();
