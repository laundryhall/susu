 ...
 * Auto generated base service entity updateWorkEffortTextContent.
 *
 * Engine: group
 * Location: 
...
public class UpdateWorkEffortTextContentService extends ServiceWrapper {
    ...
    public static final String NAME = "updateWorkEffortTextContent";
    ...
    /**
     * Creates a new <code>UpdateWorkEffortTextContentService</code> instance.
     */
    public UpdateWorkEffortTextContentService() {
        super();
    }
     ...
     */
    public UpdateWorkEffortTextContentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateWorkEffortTextContentService</code> from the input values of the given <code>UpdateWorkEffortTextContentService</code>.
     * @param input a <code>UpdateWorkEffortTextContentService</code>
     */
    public static UpdateWorkEffortTextContentService fromInput(UpdateWorkEffortTextContentService input) {
        UpdateWorkEffortTextContentService service = new UpdateWorkEffortTextContentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateWorkEffortTextContentService</code> from the output values of the given <code>UpdateWorkEffortTextContentService</code>.
     * @param output a <code>UpdateWorkEffortTextContentService</code>
     */
    public static UpdateWorkEffortTextContentService fromOutput(UpdateWorkEffortTextContentService output) {
        UpdateWorkEffortTextContentService service = new UpdateWorkEffortTextContentService();
    ...
    /**
     * Construct a <code>UpdateWorkEffortTextContentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateWorkEffortTextContentService fromInput(Map<String, Object> mapValue) {
        UpdateWorkEffortTextContentService service = new UpdateWorkEffortTextContentService();
    ...
    /**
     * Construct a <code>UpdateWorkEffortTextContentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateWorkEffortTextContentService fromOutput(Map<String, Object> mapValue) {
        UpdateWorkEffortTextContentService service = new UpdateWorkEffortTextContentService();
