 ...
 * Auto generated base service entity removeCommEventContentAssoc.
 *
 * Engine: simple
 ...
 */
public class RemoveCommEventContentAssocService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "removeCommEventContentAssoc";
    ...
    /**
     * Creates a new <code>RemoveCommEventContentAssocService</code> instance.
     */
    public RemoveCommEventContentAssocService() {
        super();
    }
     ...
     */
    public RemoveCommEventContentAssocService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>RemoveCommEventContentAssocService</code> from the input values of the given <code>RemoveCommEventContentAssocService</code>.
     * @param input a <code>RemoveCommEventContentAssocService</code>
     */
    public static RemoveCommEventContentAssocService fromInput(RemoveCommEventContentAssocService input) {
        RemoveCommEventContentAssocService service = new RemoveCommEventContentAssocService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>RemoveCommEventContentAssocService</code> from the output values of the given <code>RemoveCommEventContentAssocService</code>.
     * @param output a <code>RemoveCommEventContentAssocService</code>
     */
    public static RemoveCommEventContentAssocService fromOutput(RemoveCommEventContentAssocService output) {
        RemoveCommEventContentAssocService service = new RemoveCommEventContentAssocService();
    ...
    /**
     * Construct a <code>RemoveCommEventContentAssocService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveCommEventContentAssocService fromInput(Map<String, Object> mapValue) {
        RemoveCommEventContentAssocService service = new RemoveCommEventContentAssocService();
    ...
    /**
     * Construct a <code>RemoveCommEventContentAssocService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveCommEventContentAssocService fromOutput(Map<String, Object> mapValue) {
        RemoveCommEventContentAssocService service = new RemoveCommEventContentAssocService();
