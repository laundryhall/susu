 ...
 * Auto generated base service entity deleteTaxAuthorityAssoc.
 *
 * Engine: simple
 ...
 */
public class DeleteTaxAuthorityAssocService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteTaxAuthorityAssoc";
    ...
    /**
     * Creates a new <code>DeleteTaxAuthorityAssocService</code> instance.
     */
    public DeleteTaxAuthorityAssocService() {
        super();
    }
     ...
     */
    public DeleteTaxAuthorityAssocService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityAssocService</code> from the input values of the given <code>DeleteTaxAuthorityAssocService</code>.
     * @param input a <code>DeleteTaxAuthorityAssocService</code>
     */
    public static DeleteTaxAuthorityAssocService fromInput(DeleteTaxAuthorityAssocService input) {
        DeleteTaxAuthorityAssocService service = new DeleteTaxAuthorityAssocService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteTaxAuthorityAssocService</code> from the output values of the given <code>DeleteTaxAuthorityAssocService</code>.
     * @param output a <code>DeleteTaxAuthorityAssocService</code>
     */
    public static DeleteTaxAuthorityAssocService fromOutput(DeleteTaxAuthorityAssocService output) {
        DeleteTaxAuthorityAssocService service = new DeleteTaxAuthorityAssocService();
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityAssocService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteTaxAuthorityAssocService fromInput(Map<String, Object> mapValue) {
        DeleteTaxAuthorityAssocService service = new DeleteTaxAuthorityAssocService();
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityAssocService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteTaxAuthorityAssocService fromOutput(Map<String, Object> mapValue) {
        DeleteTaxAuthorityAssocService service = new DeleteTaxAuthorityAssocService();
