 ...
 * Auto generated base service entity clearCommerceCCRelease.
 *
 * Engine: java
 ...
 */
public class ClearCommerceCCReleaseService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "clearCommerceCCRelease";
    ...
    /**
     * Creates a new <code>ClearCommerceCCReleaseService</code> instance.
     */
    public ClearCommerceCCReleaseService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>ClearCommerceCCReleaseService</code> from the input values of the given <code>ClearCommerceCCReleaseService</code>.
     * @param input a <code>ClearCommerceCCReleaseService</code>
     */
    public static ClearCommerceCCReleaseService fromInput(ClearCommerceCCReleaseService input) {
        ClearCommerceCCReleaseService service = new ClearCommerceCCReleaseService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>ClearCommerceCCReleaseService</code> from the output values of the given <code>ClearCommerceCCReleaseService</code>.
     * @param output a <code>ClearCommerceCCReleaseService</code>
     */
    public static ClearCommerceCCReleaseService fromOutput(ClearCommerceCCReleaseService output) {
        ClearCommerceCCReleaseService service = new ClearCommerceCCReleaseService();
    ...
    /**
     * Construct a <code>ClearCommerceCCReleaseService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ClearCommerceCCReleaseService fromInput(Map<String, Object> mapValue) {
        ClearCommerceCCReleaseService service = new ClearCommerceCCReleaseService();
    ...
    /**
     * Construct a <code>ClearCommerceCCReleaseService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ClearCommerceCCReleaseService fromOutput(Map<String, Object> mapValue) {
        ClearCommerceCCReleaseService service = new ClearCommerceCCReleaseService();
