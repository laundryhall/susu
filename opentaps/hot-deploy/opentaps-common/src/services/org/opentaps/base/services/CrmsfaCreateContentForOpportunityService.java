...
/**
 * Creates uploadable or simple content for Opportunities..
 * Auto generated base service entity crmsfa.createContentForOpportunity.
 *
 * Engine: java
 * Location: com.opensourcestrategies.crmsfa.content.ContentServices
 * Invoke: createContentForOpportunity
 * Defined in: hot-deploy/crmsfa/servicedef/services_content.xml
 */
public class CrmsfaCreateContentForOpportunityService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.createContentForOpportunity";
    ...
    /**
     * Creates a new <code>CrmsfaCreateContentForOpportunityService</code> instance.
     */
    public CrmsfaCreateContentForOpportunityService() {
        super();
    }
     ...
     */
    public CrmsfaCreateContentForOpportunityService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForOpportunityService</code> from the input values of the given <code>CrmsfaCreateContentForOpportunityService</code>.
     * @param input a <code>CrmsfaCreateContentForOpportunityService</code>
     */
    public static CrmsfaCreateContentForOpportunityService fromInput(CrmsfaCreateContentForOpportunityService input) {
        CrmsfaCreateContentForOpportunityService service = new CrmsfaCreateContentForOpportunityService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaCreateContentForOpportunityService</code> from the output values of the given <code>CrmsfaCreateContentForOpportunityService</code>.
     * @param output a <code>CrmsfaCreateContentForOpportunityService</code>
     */
    public static CrmsfaCreateContentForOpportunityService fromOutput(CrmsfaCreateContentForOpportunityService output) {
        CrmsfaCreateContentForOpportunityService service = new CrmsfaCreateContentForOpportunityService();
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForOpportunityService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreateContentForOpportunityService fromInput(Map<String, Object> mapValue) {
        CrmsfaCreateContentForOpportunityService service = new CrmsfaCreateContentForOpportunityService();
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForOpportunityService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateContentForOpportunityService fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateContentForOpportunityService service = new CrmsfaCreateContentForOpportunityService();
