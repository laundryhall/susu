 ...
 * Auto generated base service entity linkPhysicalGiftCard.
 *
 * Engine: java
 ...
 */
public class LinkPhysicalGiftCardService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "linkPhysicalGiftCard";
    ...
    /**
     * Creates a new <code>LinkPhysicalGiftCardService</code> instance.
     */
    public LinkPhysicalGiftCardService() {
        super();
    }
    ...
    private String inPhysicalCard;
    private String inPhysicalPin;
    private TimeZone inTimeZone;
    private GenericValue inUserLogin;
    private String inVirtualCard;
    private String inVirtualPin;
     ...
     * @return <code>String</code>
     */
    public String getInPhysicalCard() {
        return this.inPhysicalCard;
    }
    /**
     * Auto generated value accessor.
     * This parameter is required.
     * @return <code>String</code>
     */
    public String getInPhysicalPin() {
        return this.inPhysicalPin;
    }
    /**
     * Auto generated value accessor.
     * This parameter is optional.
     ...
     * @return <code>String</code>
     */
    public String getInVirtualCard() {
        return this.inVirtualCard;
    }
    /**
     * Auto generated value accessor.
     * This parameter is required.
     * @return <code>String</code>
     */
    public String getInVirtualPin() {
        return this.inVirtualPin;
    }
    /**
     * Auto generated value accessor.
     * This parameter is required.
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is required.
     * @param inPhysicalCard the inPhysicalCard to set
    */
    public void setInPhysicalCard(String inPhysicalCard) {
        this.inParameters.add("physicalCard");
        this.inPhysicalCard = inPhysicalCard;
    }
    /**
     * Auto generated value setter.
     * This parameter is required.
     * @param inPhysicalPin the inPhysicalPin to set
    */
    public void setInPhysicalPin(String inPhysicalPin) {
        this.inParameters.add("physicalPin");
        this.inPhysicalPin = inPhysicalPin;
    }
    /**
     * Auto generated value setter.
     * This parameter is optional.
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is required.
     * @param inVirtualCard the inVirtualCard to set
    */
    public void setInVirtualCard(String inVirtualCard) {
        this.inParameters.add("virtualCard");
        this.inVirtualCard = inVirtualCard;
    }
    /**
     * Auto generated value setter.
     * This parameter is required.
     * @param inVirtualPin the inVirtualPin to set
    */
    public void setInVirtualPin(String inVirtualPin) {
        this.inParameters.add("virtualPin");
        this.inVirtualPin = inVirtualPin;
    }
    /**
     * Auto generated value setter.
     * This parameter is required.
    ...
    */
    ...
    public Map<String, Object> inputMap() {
        ...
        if (inParameters.contains("physicalCard")) mapValue.put("physicalCard", getInPhysicalCard());
        if (inParameters.contains("physicalPin")) mapValue.put("physicalPin", getInPhysicalPin());
        if (inParameters.contains("timeZone")) mapValue.put("timeZone", getInTimeZone());
        if (inParameters.contains("userLogin")) mapValue.put("userLogin", getInUserLogin());
        if (inParameters.contains("virtualCard")) mapValue.put("virtualCard", getInVirtualCard());
        if (inParameters.contains("virtualPin")) mapValue.put("virtualPin", getInVirtualPin());
    ...
    public void putAllInput(Map<String, Object> mapValue) {
        ...
        if (mapValue.containsKey("physicalCard")) setInPhysicalCard((String) mapValue.get("physicalCard"));
        if (mapValue.containsKey("physicalPin")) setInPhysicalPin((String) mapValue.get("physicalPin"));
        if (mapValue.containsKey("timeZone")) setInTimeZone((TimeZone) mapValue.get("timeZone"));
        if (mapValue.containsKey("userLogin")) setInUserLogin((GenericValue) mapValue.get("userLogin"));
        if (mapValue.containsKey("virtualCard")) setInVirtualCard((String) mapValue.get("virtualCard"));
        if (mapValue.containsKey("virtualPin")) setInVirtualPin((String) mapValue.get("virtualPin"));
    }
    ...
    /**
     * Construct a <code>LinkPhysicalGiftCardService</code> from the input values of the given <code>LinkPhysicalGiftCardService</code>.
     * @param input a <code>LinkPhysicalGiftCardService</code>
     */
    public static LinkPhysicalGiftCardService fromInput(LinkPhysicalGiftCardService input) {
        LinkPhysicalGiftCardService service = new LinkPhysicalGiftCardService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>LinkPhysicalGiftCardService</code> from the output values of the given <code>LinkPhysicalGiftCardService</code>.
     * @param output a <code>LinkPhysicalGiftCardService</code>
     */
    public static LinkPhysicalGiftCardService fromOutput(LinkPhysicalGiftCardService output) {
        LinkPhysicalGiftCardService service = new LinkPhysicalGiftCardService();
    ...
    /**
     * Construct a <code>LinkPhysicalGiftCardService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static LinkPhysicalGiftCardService fromInput(Map<String, Object> mapValue) {
        LinkPhysicalGiftCardService service = new LinkPhysicalGiftCardService();
    ...
    /**
     * Construct a <code>LinkPhysicalGiftCardService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static LinkPhysicalGiftCardService fromOutput(Map<String, Object> mapValue) {
        LinkPhysicalGiftCardService service = new LinkPhysicalGiftCardService();
