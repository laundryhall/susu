 ...
 * Auto generated base service entity createReturnItemShipment.
 *
 * Engine: simple
 ...
 */
public class CreateReturnItemShipmentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createReturnItemShipment";
    ...
    /**
     * Creates a new <code>CreateReturnItemShipmentService</code> instance.
     */
    public CreateReturnItemShipmentService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateReturnItemShipmentService</code> from the input values of the given <code>CreateReturnItemShipmentService</code>.
     * @param input a <code>CreateReturnItemShipmentService</code>
     */
    public static CreateReturnItemShipmentService fromInput(CreateReturnItemShipmentService input) {
        CreateReturnItemShipmentService service = new CreateReturnItemShipmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateReturnItemShipmentService</code> from the output values of the given <code>CreateReturnItemShipmentService</code>.
     * @param output a <code>CreateReturnItemShipmentService</code>
     */
    public static CreateReturnItemShipmentService fromOutput(CreateReturnItemShipmentService output) {
        CreateReturnItemShipmentService service = new CreateReturnItemShipmentService();
    ...
    /**
     * Construct a <code>CreateReturnItemShipmentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateReturnItemShipmentService fromInput(Map<String, Object> mapValue) {
        CreateReturnItemShipmentService service = new CreateReturnItemShipmentService();
    ...
    /**
     * Construct a <code>CreateReturnItemShipmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateReturnItemShipmentService fromOutput(Map<String, Object> mapValue) {
        CreateReturnItemShipmentService service = new CreateReturnItemShipmentService();
