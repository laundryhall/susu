...
/**
 * updates an Account, which is a combination of Party, PartyGroup, Person, and PartySupplementalData. 
            The userLogin will need CRMSFA_ACCOUNT_UPDATE permission on this account..
 * Auto generated base service entity crmsfa.updateAccount.
 *
 * Engine: java
 ...
 */
public class CrmsfaUpdateAccountService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.updateAccount";
    ...
    /**
     * Creates a new <code>CrmsfaUpdateAccountService</code> instance.
     */
    public CrmsfaUpdateAccountService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaUpdateAccountService</code> from the input values of the given <code>CrmsfaUpdateAccountService</code>.
     * @param input a <code>CrmsfaUpdateAccountService</code>
     */
    public static CrmsfaUpdateAccountService fromInput(CrmsfaUpdateAccountService input) {
        CrmsfaUpdateAccountService service = new CrmsfaUpdateAccountService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaUpdateAccountService</code> from the output values of the given <code>CrmsfaUpdateAccountService</code>.
     * @param output a <code>CrmsfaUpdateAccountService</code>
     */
    public static CrmsfaUpdateAccountService fromOutput(CrmsfaUpdateAccountService output) {
        CrmsfaUpdateAccountService service = new CrmsfaUpdateAccountService();
    ...
    /**
     * Construct a <code>CrmsfaUpdateAccountService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaUpdateAccountService fromInput(Map<String, Object> mapValue) {
        CrmsfaUpdateAccountService service = new CrmsfaUpdateAccountService();
    ...
    /**
     * Construct a <code>CrmsfaUpdateAccountService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaUpdateAccountService fromOutput(Map<String, Object> mapValue) {
        CrmsfaUpdateAccountService service = new CrmsfaUpdateAccountService();
