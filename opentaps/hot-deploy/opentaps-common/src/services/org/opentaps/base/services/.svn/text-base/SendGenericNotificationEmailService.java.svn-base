 ...
 * Auto generated base service entity sendGenericNotificationEmail.
 *
 * Engine: java
 ...
 */
public class SendGenericNotificationEmailService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "sendGenericNotificationEmail";
    ...
    /**
     * Creates a new <code>SendGenericNotificationEmailService</code> instance.
     */
    public SendGenericNotificationEmailService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>SendGenericNotificationEmailService</code> from the input values of the given <code>SendGenericNotificationEmailService</code>.
     * @param input a <code>SendGenericNotificationEmailService</code>
     */
    public static SendGenericNotificationEmailService fromInput(SendGenericNotificationEmailService input) {
        SendGenericNotificationEmailService service = new SendGenericNotificationEmailService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>SendGenericNotificationEmailService</code> from the output values of the given <code>SendGenericNotificationEmailService</code>.
     * @param output a <code>SendGenericNotificationEmailService</code>
     */
    public static SendGenericNotificationEmailService fromOutput(SendGenericNotificationEmailService output) {
        SendGenericNotificationEmailService service = new SendGenericNotificationEmailService();
    ...
    /**
     * Construct a <code>SendGenericNotificationEmailService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SendGenericNotificationEmailService fromInput(Map<String, Object> mapValue) {
        SendGenericNotificationEmailService service = new SendGenericNotificationEmailService();
    ...
    /**
     * Construct a <code>SendGenericNotificationEmailService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SendGenericNotificationEmailService fromOutput(Map<String, Object> mapValue) {
        SendGenericNotificationEmailService service = new SendGenericNotificationEmailService();
