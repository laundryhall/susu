 ...
 * Auto generated base service entity createGiftCertificate.
 *
 * Engine: java
 ...
 */
public class CreateGiftCertificateService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createGiftCertificate";
    ...
    /**
     * Creates a new <code>CreateGiftCertificateService</code> instance.
     */
    public CreateGiftCertificateService() {
        super();
    }
     ...
     */
    public CreateGiftCertificateService(User user) {
        super(user);
    }

    private String inCurrency;
    private BigDecimal inInitialAmount;
    ...
    private BigDecimal outInitialAmount;
    private Locale outLocale;
    private String outPinNumber;
     ...
     */
    public BigDecimal getInInitialAmount() {
     ...
     * @return <code>BigDecimal</code>
     */
    public BigDecimal getOutInitialAmount() {
        return this.outInitialAmount;
    }
    /**
     * Auto generated value accessor.
     * This parameter is optional.
     ...
     * @return <code>String</code>
     */
    public String getOutPinNumber() {
        return this.outPinNumber;
    }
    /**
     * Auto generated value accessor.
     * This parameter is required.
    ...
    */
    public void setInInitialAmount(BigDecimal inInitialAmount) {
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is required.
     * @param outCardNumber the outCardNumber to set
    */
    public void setOutCardNumber(String outCardNumber) {
        this.outParameters.add("cardNumber");
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is required.
     * @param outInitialAmount the outInitialAmount to set
    */
    public void setOutInitialAmount(BigDecimal outInitialAmount) {
        this.outParameters.add("initialAmount");
        this.outInitialAmount = outInitialAmount;
    }
    /**
     * Auto generated value setter.
     * This parameter is optional.
    ...
    */
     ...
     * Auto generated value setter.
     * This parameter is optional.
     * @param outPinNumber the outPinNumber to set
    */
    public void setOutPinNumber(String outPinNumber) {
        this.outParameters.add("pinNumber");
        this.outPinNumber = outPinNumber;
    }
    /**
     * Auto generated value setter.
     * This parameter is required.
    ...
    */
    ...
    public Map<String, Object> outputMap() {
        Map<String, Object> mapValue = new FastMap<String, Object>();
        if (outParameters.contains("cardNumber")) mapValue.put("cardNumber", getOutCardNumber());
        if (outParameters.contains("errorMessage")) mapValue.put("errorMessage", getOutErrorMessage());
        if (outParameters.contains("errorMessageList")) mapValue.put("errorMessageList", getOutErrorMessageList());
        if (outParameters.contains("initialAmount")) mapValue.put("initialAmount", getOutInitialAmount());
        if (outParameters.contains("locale")) mapValue.put("locale", getOutLocale());
        if (outParameters.contains("pinNumber")) mapValue.put("pinNumber", getOutPinNumber());
    ...
    public void putAllInput(Map<String, Object> mapValue) {
        ...
        if (mapValue.containsKey("initialAmount")) setInInitialAmount((BigDecimal) mapValue.get("initialAmount"));
    ...
    public void putAllOutput(Map<String, Object> mapValue) {
        if (mapValue.containsKey("cardNumber")) setOutCardNumber((String) mapValue.get("cardNumber"));
        if (mapValue.containsKey("errorMessage")) setOutErrorMessage((String) mapValue.get("errorMessage"));
        if (mapValue.containsKey("errorMessageList")) setOutErrorMessageList((List) mapValue.get("errorMessageList"));
        if (mapValue.containsKey("initialAmount")) setOutInitialAmount((BigDecimal) mapValue.get("initialAmount"));
        if (mapValue.containsKey("locale")) setOutLocale((Locale) mapValue.get("locale"));
        if (mapValue.containsKey("pinNumber")) setOutPinNumber((String) mapValue.get("pinNumber"));
    ...
    /**
     * Construct a <code>CreateGiftCertificateService</code> from the input values of the given <code>CreateGiftCertificateService</code>.
     * @param input a <code>CreateGiftCertificateService</code>
     */
    public static CreateGiftCertificateService fromInput(CreateGiftCertificateService input) {
        CreateGiftCertificateService service = new CreateGiftCertificateService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateGiftCertificateService</code> from the output values of the given <code>CreateGiftCertificateService</code>.
     * @param output a <code>CreateGiftCertificateService</code>
     */
    public static CreateGiftCertificateService fromOutput(CreateGiftCertificateService output) {
        CreateGiftCertificateService service = new CreateGiftCertificateService();
    ...
    /**
     * Construct a <code>CreateGiftCertificateService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateGiftCertificateService fromInput(Map<String, Object> mapValue) {
        CreateGiftCertificateService service = new CreateGiftCertificateService();
    ...
    /**
     * Construct a <code>CreateGiftCertificateService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateGiftCertificateService fromOutput(Map<String, Object> mapValue) {
        CreateGiftCertificateService service = new CreateGiftCertificateService();
