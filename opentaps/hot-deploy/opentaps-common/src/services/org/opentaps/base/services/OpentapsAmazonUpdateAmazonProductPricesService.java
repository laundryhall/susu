 ...
 * Auto generated base service entity opentaps.amazon.updateAmazonProductPrices.
 *
 * Engine: java
...
public class OpentapsAmazonUpdateAmazonProductPricesService extends ServiceWrapper {
    ...
    public static final String NAME = "opentaps.amazon.updateAmazonProductPrices";
    ...
    /**
     * Creates a new <code>OpentapsAmazonUpdateAmazonProductPricesService</code> instance.
     */
    public OpentapsAmazonUpdateAmazonProductPricesService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsAmazonUpdateAmazonProductPricesService</code> from the input values of the given <code>OpentapsAmazonUpdateAmazonProductPricesService</code>.
     * @param input a <code>OpentapsAmazonUpdateAmazonProductPricesService</code>
     */
    public static OpentapsAmazonUpdateAmazonProductPricesService fromInput(OpentapsAmazonUpdateAmazonProductPricesService input) {
        OpentapsAmazonUpdateAmazonProductPricesService service = new OpentapsAmazonUpdateAmazonProductPricesService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>OpentapsAmazonUpdateAmazonProductPricesService</code> from the output values of the given <code>OpentapsAmazonUpdateAmazonProductPricesService</code>.
     * @param output a <code>OpentapsAmazonUpdateAmazonProductPricesService</code>
     */
    public static OpentapsAmazonUpdateAmazonProductPricesService fromOutput(OpentapsAmazonUpdateAmazonProductPricesService output) {
        OpentapsAmazonUpdateAmazonProductPricesService service = new OpentapsAmazonUpdateAmazonProductPricesService();
    ...
    /**
     * Construct a <code>OpentapsAmazonUpdateAmazonProductPricesService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsAmazonUpdateAmazonProductPricesService fromInput(Map<String, Object> mapValue) {
        OpentapsAmazonUpdateAmazonProductPricesService service = new OpentapsAmazonUpdateAmazonProductPricesService();
    ...
    /**
     * Construct a <code>OpentapsAmazonUpdateAmazonProductPricesService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsAmazonUpdateAmazonProductPricesService fromOutput(Map<String, Object> mapValue) {
        OpentapsAmazonUpdateAmazonProductPricesService service = new OpentapsAmazonUpdateAmazonProductPricesService();
