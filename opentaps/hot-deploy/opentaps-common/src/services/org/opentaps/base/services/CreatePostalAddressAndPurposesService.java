 ...
 * Auto generated base service entity createPostalAddressAndPurposes.
 *
 * Engine: simple
 ...
 */
public class CreatePostalAddressAndPurposesService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createPostalAddressAndPurposes";
    ...
    /**
     * Creates a new <code>CreatePostalAddressAndPurposesService</code> instance.
     */
    public CreatePostalAddressAndPurposesService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreatePostalAddressAndPurposesService</code> from the input values of the given <code>CreatePostalAddressAndPurposesService</code>.
     * @param input a <code>CreatePostalAddressAndPurposesService</code>
     */
    public static CreatePostalAddressAndPurposesService fromInput(CreatePostalAddressAndPurposesService input) {
        CreatePostalAddressAndPurposesService service = new CreatePostalAddressAndPurposesService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreatePostalAddressAndPurposesService</code> from the output values of the given <code>CreatePostalAddressAndPurposesService</code>.
     * @param output a <code>CreatePostalAddressAndPurposesService</code>
     */
    public static CreatePostalAddressAndPurposesService fromOutput(CreatePostalAddressAndPurposesService output) {
        CreatePostalAddressAndPurposesService service = new CreatePostalAddressAndPurposesService();
    ...
    /**
     * Construct a <code>CreatePostalAddressAndPurposesService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePostalAddressAndPurposesService fromInput(Map<String, Object> mapValue) {
        CreatePostalAddressAndPurposesService service = new CreatePostalAddressAndPurposesService();
    ...
    /**
     * Construct a <code>CreatePostalAddressAndPurposesService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePostalAddressAndPurposesService fromOutput(Map<String, Object> mapValue) {
        CreatePostalAddressAndPurposesService service = new CreatePostalAddressAndPurposesService();
