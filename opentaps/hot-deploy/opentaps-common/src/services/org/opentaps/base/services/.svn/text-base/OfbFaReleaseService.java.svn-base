 ...
 * Auto generated base service entity ofbFaRelease.
 *
 * Engine: java
 ...
 */
public class OfbFaReleaseService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "ofbFaRelease";
    ...
    /**
     * Creates a new <code>OfbFaReleaseService</code> instance.
     */
    public OfbFaReleaseService() {
        super();
    }
     ...
     */
    public OfbFaReleaseService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>OfbFaReleaseService</code> from the input values of the given <code>OfbFaReleaseService</code>.
     * @param input a <code>OfbFaReleaseService</code>
     */
    public static OfbFaReleaseService fromInput(OfbFaReleaseService input) {
        OfbFaReleaseService service = new OfbFaReleaseService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>OfbFaReleaseService</code> from the output values of the given <code>OfbFaReleaseService</code>.
     * @param output a <code>OfbFaReleaseService</code>
     */
    public static OfbFaReleaseService fromOutput(OfbFaReleaseService output) {
        OfbFaReleaseService service = new OfbFaReleaseService();
    ...
    /**
     * Construct a <code>OfbFaReleaseService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OfbFaReleaseService fromInput(Map<String, Object> mapValue) {
        OfbFaReleaseService service = new OfbFaReleaseService();
    ...
    /**
     * Construct a <code>OfbFaReleaseService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OfbFaReleaseService fromOutput(Map<String, Object> mapValue) {
        OfbFaReleaseService service = new OfbFaReleaseService();
