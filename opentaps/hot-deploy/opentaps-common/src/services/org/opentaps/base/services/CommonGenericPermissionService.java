...
/**
 * .
 * Auto generated base service entity commonGenericPermission.
 *
 * Engine: simple
 ...
 */
public class CommonGenericPermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "commonGenericPermission";
    ...
    /**
     * Creates a new <code>CommonGenericPermissionService</code> instance.
     */
    public CommonGenericPermissionService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CommonGenericPermissionService</code> from the input values of the given <code>CommonGenericPermissionService</code>.
     * @param input a <code>CommonGenericPermissionService</code>
     */
    public static CommonGenericPermissionService fromInput(CommonGenericPermissionService input) {
        CommonGenericPermissionService service = new CommonGenericPermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CommonGenericPermissionService</code> from the output values of the given <code>CommonGenericPermissionService</code>.
     * @param output a <code>CommonGenericPermissionService</code>
     */
    public static CommonGenericPermissionService fromOutput(CommonGenericPermissionService output) {
        CommonGenericPermissionService service = new CommonGenericPermissionService();
    ...
    /**
     * Construct a <code>CommonGenericPermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CommonGenericPermissionService fromInput(Map<String, Object> mapValue) {
        CommonGenericPermissionService service = new CommonGenericPermissionService();
    ...
    /**
     * Construct a <code>CommonGenericPermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CommonGenericPermissionService fromOutput(Map<String, Object> mapValue) {
        CommonGenericPermissionService service = new CommonGenericPermissionService();
