 ...
 * Auto generated base service entity pcChargeCCRelease.
 *
 * Engine: java
 * Location: org.ofbiz.accounting.thirdparty.gosoftware.PcChargeServices
 * Invoke: ccRelease
 * Defined in: applications/accounting/servicedef/services_pccharge.xml
 */
public class PcChargeCCReleaseService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "pcChargeCCRelease";
    ...
    /**
     * Creates a new <code>PcChargeCCReleaseService</code> instance.
     */
    public PcChargeCCReleaseService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>PcChargeCCReleaseService</code> from the input values of the given <code>PcChargeCCReleaseService</code>.
     * @param input a <code>PcChargeCCReleaseService</code>
     */
    public static PcChargeCCReleaseService fromInput(PcChargeCCReleaseService input) {
        PcChargeCCReleaseService service = new PcChargeCCReleaseService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>PcChargeCCReleaseService</code> from the output values of the given <code>PcChargeCCReleaseService</code>.
     * @param output a <code>PcChargeCCReleaseService</code>
     */
    public static PcChargeCCReleaseService fromOutput(PcChargeCCReleaseService output) {
        PcChargeCCReleaseService service = new PcChargeCCReleaseService();
    ...
    /**
     * Construct a <code>PcChargeCCReleaseService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PcChargeCCReleaseService fromInput(Map<String, Object> mapValue) {
        PcChargeCCReleaseService service = new PcChargeCCReleaseService();
    ...
    /**
     * Construct a <code>PcChargeCCReleaseService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PcChargeCCReleaseService fromOutput(Map<String, Object> mapValue) {
        PcChargeCCReleaseService service = new PcChargeCCReleaseService();
