...
/**
 * .
 * Auto generated base service entity crmsfa.emailInterface.
 *
 * Engine: interface
 * Location: 
 * Invoke: 
 ...
 */
public class CrmsfaEmailInterfaceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.emailInterface";
    ...
    /**
     * Creates a new <code>CrmsfaEmailInterfaceService</code> instance.
     */
    public CrmsfaEmailInterfaceService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaEmailInterfaceService</code> from the input values of the given <code>CrmsfaEmailInterfaceService</code>.
     * @param input a <code>CrmsfaEmailInterfaceService</code>
     */
    public static CrmsfaEmailInterfaceService fromInput(CrmsfaEmailInterfaceService input) {
        CrmsfaEmailInterfaceService service = new CrmsfaEmailInterfaceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaEmailInterfaceService</code> from the output values of the given <code>CrmsfaEmailInterfaceService</code>.
     * @param output a <code>CrmsfaEmailInterfaceService</code>
     */
    public static CrmsfaEmailInterfaceService fromOutput(CrmsfaEmailInterfaceService output) {
        CrmsfaEmailInterfaceService service = new CrmsfaEmailInterfaceService();
    ...
    /**
     * Construct a <code>CrmsfaEmailInterfaceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaEmailInterfaceService fromInput(Map<String, Object> mapValue) {
        CrmsfaEmailInterfaceService service = new CrmsfaEmailInterfaceService();
    ...
    /**
     * Construct a <code>CrmsfaEmailInterfaceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaEmailInterfaceService fromOutput(Map<String, Object> mapValue) {
        CrmsfaEmailInterfaceService service = new CrmsfaEmailInterfaceService();
