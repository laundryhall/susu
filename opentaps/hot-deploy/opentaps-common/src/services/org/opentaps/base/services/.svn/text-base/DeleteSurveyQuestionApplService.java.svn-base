 ...
 * Auto generated base service entity deleteSurveyQuestionAppl.
 *
 * Engine: simple
 ...
 */
public class DeleteSurveyQuestionApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteSurveyQuestionAppl";
    ...
    /**
     * Creates a new <code>DeleteSurveyQuestionApplService</code> instance.
     */
    public DeleteSurveyQuestionApplService() {
        super();
    }
     ...
     */
    public DeleteSurveyQuestionApplService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteSurveyQuestionApplService</code> from the input values of the given <code>DeleteSurveyQuestionApplService</code>.
     * @param input a <code>DeleteSurveyQuestionApplService</code>
     */
    public static DeleteSurveyQuestionApplService fromInput(DeleteSurveyQuestionApplService input) {
        DeleteSurveyQuestionApplService service = new DeleteSurveyQuestionApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteSurveyQuestionApplService</code> from the output values of the given <code>DeleteSurveyQuestionApplService</code>.
     * @param output a <code>DeleteSurveyQuestionApplService</code>
     */
    public static DeleteSurveyQuestionApplService fromOutput(DeleteSurveyQuestionApplService output) {
        DeleteSurveyQuestionApplService service = new DeleteSurveyQuestionApplService();
    ...
    /**
     * Construct a <code>DeleteSurveyQuestionApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteSurveyQuestionApplService fromInput(Map<String, Object> mapValue) {
        DeleteSurveyQuestionApplService service = new DeleteSurveyQuestionApplService();
    ...
    /**
     * Construct a <code>DeleteSurveyQuestionApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteSurveyQuestionApplService fromOutput(Map<String, Object> mapValue) {
        DeleteSurveyQuestionApplService service = new DeleteSurveyQuestionApplService();
