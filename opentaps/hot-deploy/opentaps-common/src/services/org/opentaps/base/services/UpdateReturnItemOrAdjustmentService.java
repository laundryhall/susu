 ...
 * Auto generated base service entity updateReturnItemOrAdjustment.
 *
 * Engine: java
 ...
 */
public class UpdateReturnItemOrAdjustmentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateReturnItemOrAdjustment";
    ...
    /**
     * Creates a new <code>UpdateReturnItemOrAdjustmentService</code> instance.
     */
    public UpdateReturnItemOrAdjustmentService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateReturnItemOrAdjustmentService</code> from the input values of the given <code>UpdateReturnItemOrAdjustmentService</code>.
     * @param input a <code>UpdateReturnItemOrAdjustmentService</code>
     */
    public static UpdateReturnItemOrAdjustmentService fromInput(UpdateReturnItemOrAdjustmentService input) {
        UpdateReturnItemOrAdjustmentService service = new UpdateReturnItemOrAdjustmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateReturnItemOrAdjustmentService</code> from the output values of the given <code>UpdateReturnItemOrAdjustmentService</code>.
     * @param output a <code>UpdateReturnItemOrAdjustmentService</code>
     */
    public static UpdateReturnItemOrAdjustmentService fromOutput(UpdateReturnItemOrAdjustmentService output) {
        UpdateReturnItemOrAdjustmentService service = new UpdateReturnItemOrAdjustmentService();
    ...
    /**
     * Construct a <code>UpdateReturnItemOrAdjustmentService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>UpdateReturnItemOrAdjustmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateReturnItemOrAdjustmentService fromOutput(Map<String, Object> mapValue) {
        UpdateReturnItemOrAdjustmentService service = new UpdateReturnItemOrAdjustmentService();
