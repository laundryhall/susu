 ...
 * Auto generated base service entity createInvoiceContactMech.
 *
 * Engine: simple
 ...
 */
public class CreateInvoiceContactMechService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createInvoiceContactMech";
    ...
    /**
     * Creates a new <code>CreateInvoiceContactMechService</code> instance.
     */
    public CreateInvoiceContactMechService() {
        super();
    }
     ...
     */
    public CreateInvoiceContactMechService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateInvoiceContactMechService</code> from the input values of the given <code>CreateInvoiceContactMechService</code>.
     * @param input a <code>CreateInvoiceContactMechService</code>
     */
    public static CreateInvoiceContactMechService fromInput(CreateInvoiceContactMechService input) {
        CreateInvoiceContactMechService service = new CreateInvoiceContactMechService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateInvoiceContactMechService</code> from the output values of the given <code>CreateInvoiceContactMechService</code>.
     * @param output a <code>CreateInvoiceContactMechService</code>
     */
    public static CreateInvoiceContactMechService fromOutput(CreateInvoiceContactMechService output) {
        CreateInvoiceContactMechService service = new CreateInvoiceContactMechService();
    ...
    /**
     * Construct a <code>CreateInvoiceContactMechService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateInvoiceContactMechService fromInput(Map<String, Object> mapValue) {
        CreateInvoiceContactMechService service = new CreateInvoiceContactMechService();
    ...
    /**
     * Construct a <code>CreateInvoiceContactMechService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateInvoiceContactMechService fromOutput(Map<String, Object> mapValue) {
        CreateInvoiceContactMechService service = new CreateInvoiceContactMechService();
