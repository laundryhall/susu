 ...
 * Auto generated base service entity createPartyPostalAddress.
 *
 * Engine: simple
 ...
 */
public class CreatePartyPostalAddressService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createPartyPostalAddress";
    ...
    /**
     * Creates a new <code>CreatePartyPostalAddressService</code> instance.
     */
    public CreatePartyPostalAddressService() {
        super();
    }
     ...
     */
    public CreatePartyPostalAddressService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreatePartyPostalAddressService</code> from the input values of the given <code>CreatePartyPostalAddressService</code>.
     * @param input a <code>CreatePartyPostalAddressService</code>
     */
    public static CreatePartyPostalAddressService fromInput(CreatePartyPostalAddressService input) {
        CreatePartyPostalAddressService service = new CreatePartyPostalAddressService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreatePartyPostalAddressService</code> from the output values of the given <code>CreatePartyPostalAddressService</code>.
     * @param output a <code>CreatePartyPostalAddressService</code>
     */
    public static CreatePartyPostalAddressService fromOutput(CreatePartyPostalAddressService output) {
        CreatePartyPostalAddressService service = new CreatePartyPostalAddressService();
    ...
    /**
     * Construct a <code>CreatePartyPostalAddressService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePartyPostalAddressService fromInput(Map<String, Object> mapValue) {
        CreatePartyPostalAddressService service = new CreatePartyPostalAddressService();
    ...
    /**
     * Construct a <code>CreatePartyPostalAddressService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePartyPostalAddressService fromOutput(Map<String, Object> mapValue) {
        CreatePartyPostalAddressService service = new CreatePartyPostalAddressService();
