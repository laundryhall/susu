 ...
 * Auto generated base service entity deleteTaxAuthorityCategory.
 *
 * Engine: simple
 ...
 */
public class DeleteTaxAuthorityCategoryService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteTaxAuthorityCategory";
    ...
    /**
     * Creates a new <code>DeleteTaxAuthorityCategoryService</code> instance.
     */
    public DeleteTaxAuthorityCategoryService() {
        super();
    }
     ...
     */
    public DeleteTaxAuthorityCategoryService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityCategoryService</code> from the input values of the given <code>DeleteTaxAuthorityCategoryService</code>.
     * @param input a <code>DeleteTaxAuthorityCategoryService</code>
     */
    public static DeleteTaxAuthorityCategoryService fromInput(DeleteTaxAuthorityCategoryService input) {
        DeleteTaxAuthorityCategoryService service = new DeleteTaxAuthorityCategoryService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteTaxAuthorityCategoryService</code> from the output values of the given <code>DeleteTaxAuthorityCategoryService</code>.
     * @param output a <code>DeleteTaxAuthorityCategoryService</code>
     */
    public static DeleteTaxAuthorityCategoryService fromOutput(DeleteTaxAuthorityCategoryService output) {
        DeleteTaxAuthorityCategoryService service = new DeleteTaxAuthorityCategoryService();
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityCategoryService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteTaxAuthorityCategoryService fromInput(Map<String, Object> mapValue) {
        DeleteTaxAuthorityCategoryService service = new DeleteTaxAuthorityCategoryService();
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityCategoryService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteTaxAuthorityCategoryService fromOutput(Map<String, Object> mapValue) {
        DeleteTaxAuthorityCategoryService service = new DeleteTaxAuthorityCategoryService();
