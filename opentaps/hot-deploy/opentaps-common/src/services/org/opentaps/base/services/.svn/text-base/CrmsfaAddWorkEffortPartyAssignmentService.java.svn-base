 ...
 * Add a participant with role CAL_ATTENDEE to an event or activity. Requires _UPDATE permission on all associated parties, cases, and
            opportunities..
 * Auto generated base service entity crmsfa.addWorkEffortPartyAssignment.
 *
 * Engine: java
...
public class CrmsfaAddWorkEffortPartyAssignmentService extends ServiceWrapper {
    ...
    public static final String NAME = "crmsfa.addWorkEffortPartyAssignment";
    ...
    /**
     * Creates a new <code>CrmsfaAddWorkEffortPartyAssignmentService</code> instance.
     */
    public CrmsfaAddWorkEffortPartyAssignmentService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaAddWorkEffortPartyAssignmentService</code> from the input values of the given <code>CrmsfaAddWorkEffortPartyAssignmentService</code>.
     * @param input a <code>CrmsfaAddWorkEffortPartyAssignmentService</code>
     */
    public static CrmsfaAddWorkEffortPartyAssignmentService fromInput(CrmsfaAddWorkEffortPartyAssignmentService input) {
        CrmsfaAddWorkEffortPartyAssignmentService service = new CrmsfaAddWorkEffortPartyAssignmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaAddWorkEffortPartyAssignmentService</code> from the output values of the given <code>CrmsfaAddWorkEffortPartyAssignmentService</code>.
     * @param output a <code>CrmsfaAddWorkEffortPartyAssignmentService</code>
     */
    public static CrmsfaAddWorkEffortPartyAssignmentService fromOutput(CrmsfaAddWorkEffortPartyAssignmentService output) {
        CrmsfaAddWorkEffortPartyAssignmentService service = new CrmsfaAddWorkEffortPartyAssignmentService();
    ...
    /**
     * Construct a <code>CrmsfaAddWorkEffortPartyAssignmentService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>CrmsfaAddWorkEffortPartyAssignmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaAddWorkEffortPartyAssignmentService fromOutput(Map<String, Object> mapValue) {
        CrmsfaAddWorkEffortPartyAssignmentService service = new CrmsfaAddWorkEffortPartyAssignmentService();
