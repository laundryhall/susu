...
/**
 * updates a Supplier, which is a combination of Party, PartyGroup, and PartySupplementalData.  The userLogin will need PRCH_SPLR_UPDATE permission on this account..
 * Auto generated base service entity purchasing.updateSupplier.
 *
 * Engine: java
 * Location: org.opentaps.purchasing.supplier.SupplierServices
 * Invoke: updateSupplier
 * Defined in: hot-deploy/purchasing/servicedef/services.xml
 */
public class PurchasingUpdateSupplierService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "purchasing.updateSupplier";
    ...
    /**
     * Creates a new <code>PurchasingUpdateSupplierService</code> instance.
     */
    public PurchasingUpdateSupplierService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>PurchasingUpdateSupplierService</code> from the input values of the given <code>PurchasingUpdateSupplierService</code>.
     * @param input a <code>PurchasingUpdateSupplierService</code>
     */
    public static PurchasingUpdateSupplierService fromInput(PurchasingUpdateSupplierService input) {
        PurchasingUpdateSupplierService service = new PurchasingUpdateSupplierService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>PurchasingUpdateSupplierService</code> from the output values of the given <code>PurchasingUpdateSupplierService</code>.
     * @param output a <code>PurchasingUpdateSupplierService</code>
     */
    public static PurchasingUpdateSupplierService fromOutput(PurchasingUpdateSupplierService output) {
        PurchasingUpdateSupplierService service = new PurchasingUpdateSupplierService();
    ...
    /**
     * Construct a <code>PurchasingUpdateSupplierService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PurchasingUpdateSupplierService fromInput(Map<String, Object> mapValue) {
        PurchasingUpdateSupplierService service = new PurchasingUpdateSupplierService();
    ...
    /**
     * Construct a <code>PurchasingUpdateSupplierService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PurchasingUpdateSupplierService fromOutput(Map<String, Object> mapValue) {
        PurchasingUpdateSupplierService service = new PurchasingUpdateSupplierService();
