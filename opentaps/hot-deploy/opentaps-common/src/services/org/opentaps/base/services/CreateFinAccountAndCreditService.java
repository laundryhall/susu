...
/**
 * .
 * Auto generated base service entity createFinAccountAndCredit.
 *
 * Engine: java
 ...
 */
public class CreateFinAccountAndCreditService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createFinAccountAndCredit";
    ...
    /**
     * Creates a new <code>CreateFinAccountAndCreditService</code> instance.
     */
    public CreateFinAccountAndCreditService() {
        super();
    }
     ...
     */
    public CreateFinAccountAndCreditService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateFinAccountAndCreditService</code> from the input values of the given <code>CreateFinAccountAndCreditService</code>.
     * @param input a <code>CreateFinAccountAndCreditService</code>
     */
    public static CreateFinAccountAndCreditService fromInput(CreateFinAccountAndCreditService input) {
        CreateFinAccountAndCreditService service = new CreateFinAccountAndCreditService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateFinAccountAndCreditService</code> from the output values of the given <code>CreateFinAccountAndCreditService</code>.
     * @param output a <code>CreateFinAccountAndCreditService</code>
     */
    public static CreateFinAccountAndCreditService fromOutput(CreateFinAccountAndCreditService output) {
        CreateFinAccountAndCreditService service = new CreateFinAccountAndCreditService();
    ...
    /**
     * Construct a <code>CreateFinAccountAndCreditService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFinAccountAndCreditService fromInput(Map<String, Object> mapValue) {
        CreateFinAccountAndCreditService service = new CreateFinAccountAndCreditService();
    ...
    /**
     * Construct a <code>CreateFinAccountAndCreditService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFinAccountAndCreditService fromOutput(Map<String, Object> mapValue) {
        CreateFinAccountAndCreditService service = new CreateFinAccountAndCreditService();
