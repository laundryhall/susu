 ...
 * 
        ...
        .
 * Auto generated base service entity custRequestPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class CustRequestPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "custRequestPermissionCheck";
    ...
    /**
     * Creates a new <code>CustRequestPermissionCheckService</code> instance.
     */
    public CustRequestPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CustRequestPermissionCheckService</code> from the input values of the given <code>CustRequestPermissionCheckService</code>.
     * @param input a <code>CustRequestPermissionCheckService</code>
     */
    public static CustRequestPermissionCheckService fromInput(CustRequestPermissionCheckService input) {
        CustRequestPermissionCheckService service = new CustRequestPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CustRequestPermissionCheckService</code> from the output values of the given <code>CustRequestPermissionCheckService</code>.
     * @param output a <code>CustRequestPermissionCheckService</code>
     */
    public static CustRequestPermissionCheckService fromOutput(CustRequestPermissionCheckService output) {
        CustRequestPermissionCheckService service = new CustRequestPermissionCheckService();
    ...
    /**
     * Construct a <code>CustRequestPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CustRequestPermissionCheckService fromInput(Map<String, Object> mapValue) {
        CustRequestPermissionCheckService service = new CustRequestPermissionCheckService();
    ...
    /**
     * Construct a <code>CustRequestPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CustRequestPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        CustRequestPermissionCheckService service = new CustRequestPermissionCheckService();
