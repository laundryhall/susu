 ...
 */
public class UpdateProductSubscriptionResourceService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>UpdateProductSubscriptionResourceService</code> instance.
     */
    public UpdateProductSubscriptionResourceService() {
        super();
    }
     ...
     */
    public UpdateProductSubscriptionResourceService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateProductSubscriptionResourceService</code> from the input values of the given <code>UpdateProductSubscriptionResourceService</code>.
     * @param input a <code>UpdateProductSubscriptionResourceService</code>
     */
    public static UpdateProductSubscriptionResourceService fromInput(UpdateProductSubscriptionResourceService input) {
        UpdateProductSubscriptionResourceService service = new UpdateProductSubscriptionResourceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateProductSubscriptionResourceService</code> from the output values of the given <code>UpdateProductSubscriptionResourceService</code>.
     * @param output a <code>UpdateProductSubscriptionResourceService</code>
     */
    public static UpdateProductSubscriptionResourceService fromOutput(UpdateProductSubscriptionResourceService output) {
        UpdateProductSubscriptionResourceService service = new UpdateProductSubscriptionResourceService();
    ...
    /**
     * Construct a <code>UpdateProductSubscriptionResourceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateProductSubscriptionResourceService fromInput(Map<String, Object> mapValue) {
        UpdateProductSubscriptionResourceService service = new UpdateProductSubscriptionResourceService();
    ...
    /**
     * Construct a <code>UpdateProductSubscriptionResourceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateProductSubscriptionResourceService fromOutput(Map<String, Object> mapValue) {
        UpdateProductSubscriptionResourceService service = new UpdateProductSubscriptionResourceService();
