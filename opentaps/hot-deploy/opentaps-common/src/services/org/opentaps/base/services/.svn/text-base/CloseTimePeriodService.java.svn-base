 ...
 * 
        ...
        .
 * Auto generated base service entity closeTimePeriod.
 *
 * Engine: java
 * Location: com.opensourcestrategies.financials.ledger.LedgerServices
 * Invoke: closeTimePeriod
 * Defined in: hot-deploy/financials/servicedef/services_ledger_ext.xml
 */
public class CloseTimePeriodService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "closeTimePeriod";
    ...
    /**
     * Creates a new <code>CloseTimePeriodService</code> instance.
     */
    public CloseTimePeriodService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CloseTimePeriodService</code> from the input values of the given <code>CloseTimePeriodService</code>.
     * @param input a <code>CloseTimePeriodService</code>
     */
    public static CloseTimePeriodService fromInput(CloseTimePeriodService input) {
        CloseTimePeriodService service = new CloseTimePeriodService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CloseTimePeriodService</code> from the output values of the given <code>CloseTimePeriodService</code>.
     * @param output a <code>CloseTimePeriodService</code>
     */
    public static CloseTimePeriodService fromOutput(CloseTimePeriodService output) {
        CloseTimePeriodService service = new CloseTimePeriodService();
    ...
    /**
     * Construct a <code>CloseTimePeriodService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CloseTimePeriodService fromInput(Map<String, Object> mapValue) {
        CloseTimePeriodService service = new CloseTimePeriodService();
    ...
    /**
     * Construct a <code>CloseTimePeriodService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CloseTimePeriodService fromOutput(Map<String, Object> mapValue) {
        CloseTimePeriodService service = new CloseTimePeriodService();
