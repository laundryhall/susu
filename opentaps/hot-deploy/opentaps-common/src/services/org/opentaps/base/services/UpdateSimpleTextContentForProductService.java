...
/**
 * .
 * Auto generated base service entity updateSimpleTextContentForProduct.
 *
 * Engine: simple
 ...
 */
public class UpdateSimpleTextContentForProductService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateSimpleTextContentForProduct";
    ...
    /**
     * Creates a new <code>UpdateSimpleTextContentForProductService</code> instance.
     */
    public UpdateSimpleTextContentForProductService() {
        super();
    }
     ...
     */
    public UpdateSimpleTextContentForProductService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateSimpleTextContentForProductService</code> from the input values of the given <code>UpdateSimpleTextContentForProductService</code>.
     * @param input a <code>UpdateSimpleTextContentForProductService</code>
     */
    public static UpdateSimpleTextContentForProductService fromInput(UpdateSimpleTextContentForProductService input) {
        UpdateSimpleTextContentForProductService service = new UpdateSimpleTextContentForProductService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateSimpleTextContentForProductService</code> from the output values of the given <code>UpdateSimpleTextContentForProductService</code>.
     * @param output a <code>UpdateSimpleTextContentForProductService</code>
     */
    public static UpdateSimpleTextContentForProductService fromOutput(UpdateSimpleTextContentForProductService output) {
        UpdateSimpleTextContentForProductService service = new UpdateSimpleTextContentForProductService();
    ...
    /**
     * Construct a <code>UpdateSimpleTextContentForProductService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateSimpleTextContentForProductService fromInput(Map<String, Object> mapValue) {
        UpdateSimpleTextContentForProductService service = new UpdateSimpleTextContentForProductService();
    ...
    /**
     * Construct a <code>UpdateSimpleTextContentForProductService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateSimpleTextContentForProductService fromOutput(Map<String, Object> mapValue) {
        UpdateSimpleTextContentForProductService service = new UpdateSimpleTextContentForProductService();
