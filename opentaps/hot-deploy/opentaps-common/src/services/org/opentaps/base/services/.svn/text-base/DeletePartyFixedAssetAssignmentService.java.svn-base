 ...
 * Auto generated base service entity deletePartyFixedAssetAssignment.
 *
 * Engine: simple
 ...
 */
public class DeletePartyFixedAssetAssignmentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deletePartyFixedAssetAssignment";
    ...
    /**
     * Creates a new <code>DeletePartyFixedAssetAssignmentService</code> instance.
     */
    public DeletePartyFixedAssetAssignmentService() {
        super();
    }
     ...
     */
    public DeletePartyFixedAssetAssignmentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeletePartyFixedAssetAssignmentService</code> from the input values of the given <code>DeletePartyFixedAssetAssignmentService</code>.
     * @param input a <code>DeletePartyFixedAssetAssignmentService</code>
     */
    public static DeletePartyFixedAssetAssignmentService fromInput(DeletePartyFixedAssetAssignmentService input) {
        DeletePartyFixedAssetAssignmentService service = new DeletePartyFixedAssetAssignmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeletePartyFixedAssetAssignmentService</code> from the output values of the given <code>DeletePartyFixedAssetAssignmentService</code>.
     * @param output a <code>DeletePartyFixedAssetAssignmentService</code>
     */
    public static DeletePartyFixedAssetAssignmentService fromOutput(DeletePartyFixedAssetAssignmentService output) {
        DeletePartyFixedAssetAssignmentService service = new DeletePartyFixedAssetAssignmentService();
    ...
    /**
     * Construct a <code>DeletePartyFixedAssetAssignmentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeletePartyFixedAssetAssignmentService fromInput(Map<String, Object> mapValue) {
        DeletePartyFixedAssetAssignmentService service = new DeletePartyFixedAssetAssignmentService();
    ...
    /**
     * Construct a <code>DeletePartyFixedAssetAssignmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeletePartyFixedAssetAssignmentService fromOutput(Map<String, Object> mapValue) {
        DeletePartyFixedAssetAssignmentService service = new DeletePartyFixedAssetAssignmentService();
