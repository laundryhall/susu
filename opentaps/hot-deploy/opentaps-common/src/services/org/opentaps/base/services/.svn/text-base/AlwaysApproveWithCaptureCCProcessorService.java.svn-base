 ...
 * Auto generated base service entity alwaysApproveWithCaptureCCProcessor.
 *
 * Engine: java
 ...
 */
public class AlwaysApproveWithCaptureCCProcessorService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "alwaysApproveWithCaptureCCProcessor";
    ...
    /**
     * Creates a new <code>AlwaysApproveWithCaptureCCProcessorService</code> instance.
     */
    public AlwaysApproveWithCaptureCCProcessorService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AlwaysApproveWithCaptureCCProcessorService</code> from the input values of the given <code>AlwaysApproveWithCaptureCCProcessorService</code>.
     * @param input a <code>AlwaysApproveWithCaptureCCProcessorService</code>
     */
    public static AlwaysApproveWithCaptureCCProcessorService fromInput(AlwaysApproveWithCaptureCCProcessorService input) {
        AlwaysApproveWithCaptureCCProcessorService service = new AlwaysApproveWithCaptureCCProcessorService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AlwaysApproveWithCaptureCCProcessorService</code> from the output values of the given <code>AlwaysApproveWithCaptureCCProcessorService</code>.
     * @param output a <code>AlwaysApproveWithCaptureCCProcessorService</code>
     */
    public static AlwaysApproveWithCaptureCCProcessorService fromOutput(AlwaysApproveWithCaptureCCProcessorService output) {
        AlwaysApproveWithCaptureCCProcessorService service = new AlwaysApproveWithCaptureCCProcessorService();
    ...
    /**
     * Construct a <code>AlwaysApproveWithCaptureCCProcessorService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AlwaysApproveWithCaptureCCProcessorService fromInput(Map<String, Object> mapValue) {
        AlwaysApproveWithCaptureCCProcessorService service = new AlwaysApproveWithCaptureCCProcessorService();
    ...
    /**
     * Construct a <code>AlwaysApproveWithCaptureCCProcessorService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AlwaysApproveWithCaptureCCProcessorService fromOutput(Map<String, Object> mapValue) {
        AlwaysApproveWithCaptureCCProcessorService service = new AlwaysApproveWithCaptureCCProcessorService();
