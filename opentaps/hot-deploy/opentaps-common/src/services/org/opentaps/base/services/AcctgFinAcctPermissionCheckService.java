 ...
 * Auto generated base service entity acctgFinAcctPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class AcctgFinAcctPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "acctgFinAcctPermissionCheck";
    ...
    /**
     * Creates a new <code>AcctgFinAcctPermissionCheckService</code> instance.
     */
    public AcctgFinAcctPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>AcctgFinAcctPermissionCheckService</code> from the input values of the given <code>AcctgFinAcctPermissionCheckService</code>.
     * @param input a <code>AcctgFinAcctPermissionCheckService</code>
     */
    public static AcctgFinAcctPermissionCheckService fromInput(AcctgFinAcctPermissionCheckService input) {
        AcctgFinAcctPermissionCheckService service = new AcctgFinAcctPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AcctgFinAcctPermissionCheckService</code> from the output values of the given <code>AcctgFinAcctPermissionCheckService</code>.
     * @param output a <code>AcctgFinAcctPermissionCheckService</code>
     */
    public static AcctgFinAcctPermissionCheckService fromOutput(AcctgFinAcctPermissionCheckService output) {
        AcctgFinAcctPermissionCheckService service = new AcctgFinAcctPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgFinAcctPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AcctgFinAcctPermissionCheckService fromInput(Map<String, Object> mapValue) {
        AcctgFinAcctPermissionCheckService service = new AcctgFinAcctPermissionCheckService();
    ...
    /**
     * Construct a <code>AcctgFinAcctPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AcctgFinAcctPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        AcctgFinAcctPermissionCheckService service = new AcctgFinAcctPermissionCheckService();
