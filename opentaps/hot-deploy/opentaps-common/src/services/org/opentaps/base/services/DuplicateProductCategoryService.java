 ...
 */
public class DuplicateProductCategoryService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>DuplicateProductCategoryService</code> instance.
     */
    public DuplicateProductCategoryService() {
        super();
    }
     ...
     */
    public DuplicateProductCategoryService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DuplicateProductCategoryService</code> from the input values of the given <code>DuplicateProductCategoryService</code>.
     * @param input a <code>DuplicateProductCategoryService</code>
     */
    public static DuplicateProductCategoryService fromInput(DuplicateProductCategoryService input) {
        DuplicateProductCategoryService service = new DuplicateProductCategoryService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DuplicateProductCategoryService</code> from the output values of the given <code>DuplicateProductCategoryService</code>.
     * @param output a <code>DuplicateProductCategoryService</code>
     */
    public static DuplicateProductCategoryService fromOutput(DuplicateProductCategoryService output) {
        DuplicateProductCategoryService service = new DuplicateProductCategoryService();
    ...
    /**
     * Construct a <code>DuplicateProductCategoryService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DuplicateProductCategoryService fromInput(Map<String, Object> mapValue) {
        DuplicateProductCategoryService service = new DuplicateProductCategoryService();
    ...
    /**
     * Construct a <code>DuplicateProductCategoryService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DuplicateProductCategoryService fromOutput(Map<String, Object> mapValue) {
        DuplicateProductCategoryService service = new DuplicateProductCategoryService();
