 ...
 * Auto generated base service entity createPaymentAndApplication.
 *
 * Engine: simple
 ...
 */
public class CreatePaymentAndApplicationService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createPaymentAndApplication";
    ...
    /**
     * Creates a new <code>CreatePaymentAndApplicationService</code> instance.
     */
    public CreatePaymentAndApplicationService() {
        super();
    }
     ...
     */
    public CreatePaymentAndApplicationService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreatePaymentAndApplicationService</code> from the input values of the given <code>CreatePaymentAndApplicationService</code>.
     * @param input a <code>CreatePaymentAndApplicationService</code>
     */
    public static CreatePaymentAndApplicationService fromInput(CreatePaymentAndApplicationService input) {
        CreatePaymentAndApplicationService service = new CreatePaymentAndApplicationService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreatePaymentAndApplicationService</code> from the output values of the given <code>CreatePaymentAndApplicationService</code>.
     * @param output a <code>CreatePaymentAndApplicationService</code>
     */
    public static CreatePaymentAndApplicationService fromOutput(CreatePaymentAndApplicationService output) {
        CreatePaymentAndApplicationService service = new CreatePaymentAndApplicationService();
    ...
    /**
     * Construct a <code>CreatePaymentAndApplicationService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePaymentAndApplicationService fromInput(Map<String, Object> mapValue) {
        CreatePaymentAndApplicationService service = new CreatePaymentAndApplicationService();
    ...
    /**
     * Construct a <code>CreatePaymentAndApplicationService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePaymentAndApplicationService fromOutput(Map<String, Object> mapValue) {
        CreatePaymentAndApplicationService service = new CreatePaymentAndApplicationService();
