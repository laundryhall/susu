 ...
 * Auto generated base service entity deletePartyBenefit.
 *
 * Engine: simple
 * Location: component://humanres/script/org/ofbiz/humanres/HumanResServices.xml
 * Invoke: deletePartyBenefit
 * Defined in: applications/humanres/servicedef/services.xml
 */
public class DeletePartyBenefitService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deletePartyBenefit";
    ...
    /**
     * Creates a new <code>DeletePartyBenefitService</code> instance.
     */
    public DeletePartyBenefitService() {
        super();
    }
     ...
     */
    public DeletePartyBenefitService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeletePartyBenefitService</code> from the input values of the given <code>DeletePartyBenefitService</code>.
     * @param input a <code>DeletePartyBenefitService</code>
     */
    public static DeletePartyBenefitService fromInput(DeletePartyBenefitService input) {
        DeletePartyBenefitService service = new DeletePartyBenefitService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeletePartyBenefitService</code> from the output values of the given <code>DeletePartyBenefitService</code>.
     * @param output a <code>DeletePartyBenefitService</code>
     */
    public static DeletePartyBenefitService fromOutput(DeletePartyBenefitService output) {
        DeletePartyBenefitService service = new DeletePartyBenefitService();
    ...
    /**
     * Construct a <code>DeletePartyBenefitService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeletePartyBenefitService fromInput(Map<String, Object> mapValue) {
        DeletePartyBenefitService service = new DeletePartyBenefitService();
    ...
    /**
     * Construct a <code>DeletePartyBenefitService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeletePartyBenefitService fromOutput(Map<String, Object> mapValue) {
        DeletePartyBenefitService service = new DeletePartyBenefitService();
