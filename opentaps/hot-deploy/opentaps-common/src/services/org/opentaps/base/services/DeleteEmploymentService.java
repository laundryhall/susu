 ...
 * Auto generated base service entity deleteEmployment.
 *
 * Engine: simple
 * Location: component://humanres/script/org/ofbiz/humanres/HumanResServices.xml
 * Invoke: deleteEmployment
 * Defined in: applications/humanres/servicedef/services.xml
 */
public class DeleteEmploymentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteEmployment";
    ...
    /**
     * Creates a new <code>DeleteEmploymentService</code> instance.
     */
    public DeleteEmploymentService() {
        super();
    }
     ...
     */
    public DeleteEmploymentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteEmploymentService</code> from the input values of the given <code>DeleteEmploymentService</code>.
     * @param input a <code>DeleteEmploymentService</code>
     */
    public static DeleteEmploymentService fromInput(DeleteEmploymentService input) {
        DeleteEmploymentService service = new DeleteEmploymentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteEmploymentService</code> from the output values of the given <code>DeleteEmploymentService</code>.
     * @param output a <code>DeleteEmploymentService</code>
     */
    public static DeleteEmploymentService fromOutput(DeleteEmploymentService output) {
        DeleteEmploymentService service = new DeleteEmploymentService();
    ...
    /**
     * Construct a <code>DeleteEmploymentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteEmploymentService fromInput(Map<String, Object> mapValue) {
        DeleteEmploymentService service = new DeleteEmploymentService();
    ...
    /**
     * Construct a <code>DeleteEmploymentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteEmploymentService fromOutput(Map<String, Object> mapValue) {
        DeleteEmploymentService service = new DeleteEmploymentService();
