...
/**
 * Create an GlAccountTypeDefault.
 * Auto generated base service entity createGlAccountTypeDefault.
 *
 * Engine: simple
 * Location: com/opensourcestrategies/financials/configuration/ConfigurationServices.xml
 * Invoke: createGlAccountTypeDefault
 * Defined in: hot-deploy/financials/servicedef/services_configuration.xml
 */
public class CreateGlAccountTypeDefaultService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createGlAccountTypeDefault";
    ...
    /**
     * Creates a new <code>CreateGlAccountTypeDefaultService</code> instance.
     */
    public CreateGlAccountTypeDefaultService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateGlAccountTypeDefaultService</code> from the input values of the given <code>CreateGlAccountTypeDefaultService</code>.
     * @param input a <code>CreateGlAccountTypeDefaultService</code>
     */
    public static CreateGlAccountTypeDefaultService fromInput(CreateGlAccountTypeDefaultService input) {
        CreateGlAccountTypeDefaultService service = new CreateGlAccountTypeDefaultService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateGlAccountTypeDefaultService</code> from the output values of the given <code>CreateGlAccountTypeDefaultService</code>.
     * @param output a <code>CreateGlAccountTypeDefaultService</code>
     */
    public static CreateGlAccountTypeDefaultService fromOutput(CreateGlAccountTypeDefaultService output) {
        CreateGlAccountTypeDefaultService service = new CreateGlAccountTypeDefaultService();
    ...
    /**
     * Construct a <code>CreateGlAccountTypeDefaultService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateGlAccountTypeDefaultService fromInput(Map<String, Object> mapValue) {
        CreateGlAccountTypeDefaultService service = new CreateGlAccountTypeDefaultService();
    ...
    /**
     * Construct a <code>CreateGlAccountTypeDefaultService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateGlAccountTypeDefaultService fromOutput(Map<String, Object> mapValue) {
        CreateGlAccountTypeDefaultService service = new CreateGlAccountTypeDefaultService();
