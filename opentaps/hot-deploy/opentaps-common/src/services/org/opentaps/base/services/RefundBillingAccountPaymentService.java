 ...
 * Auto generated base service entity refundBillingAccountPayment.
 *
 * Engine: java
 ...
 */
public class RefundBillingAccountPaymentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "refundBillingAccountPayment";
    ...
    /**
     * Creates a new <code>RefundBillingAccountPaymentService</code> instance.
     */
    public RefundBillingAccountPaymentService() {
        super();
    }
     ...
     */
    public RefundBillingAccountPaymentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>RefundBillingAccountPaymentService</code> from the input values of the given <code>RefundBillingAccountPaymentService</code>.
     * @param input a <code>RefundBillingAccountPaymentService</code>
     */
    public static RefundBillingAccountPaymentService fromInput(RefundBillingAccountPaymentService input) {
        RefundBillingAccountPaymentService service = new RefundBillingAccountPaymentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>RefundBillingAccountPaymentService</code> from the output values of the given <code>RefundBillingAccountPaymentService</code>.
     * @param output a <code>RefundBillingAccountPaymentService</code>
     */
    public static RefundBillingAccountPaymentService fromOutput(RefundBillingAccountPaymentService output) {
        RefundBillingAccountPaymentService service = new RefundBillingAccountPaymentService();
    ...
    /**
     * Construct a <code>RefundBillingAccountPaymentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RefundBillingAccountPaymentService fromInput(Map<String, Object> mapValue) {
        RefundBillingAccountPaymentService service = new RefundBillingAccountPaymentService();
    ...
    /**
     * Construct a <code>RefundBillingAccountPaymentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RefundBillingAccountPaymentService fromOutput(Map<String, Object> mapValue) {
        RefundBillingAccountPaymentService service = new RefundBillingAccountPaymentService();
