 ...
 * Auto generated base service entity entityMaintPermCheck.
 *
 * Engine: java
 ...
 */
public class EntityMaintPermCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "entityMaintPermCheck";
    ...
    /**
     * Creates a new <code>EntityMaintPermCheckService</code> instance.
     */
    public EntityMaintPermCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>EntityMaintPermCheckService</code> from the input values of the given <code>EntityMaintPermCheckService</code>.
     * @param input a <code>EntityMaintPermCheckService</code>
     */
    public static EntityMaintPermCheckService fromInput(EntityMaintPermCheckService input) {
        EntityMaintPermCheckService service = new EntityMaintPermCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>EntityMaintPermCheckService</code> from the output values of the given <code>EntityMaintPermCheckService</code>.
     * @param output a <code>EntityMaintPermCheckService</code>
     */
    public static EntityMaintPermCheckService fromOutput(EntityMaintPermCheckService output) {
        EntityMaintPermCheckService service = new EntityMaintPermCheckService();
    ...
    /**
     * Construct a <code>EntityMaintPermCheckService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>EntityMaintPermCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static EntityMaintPermCheckService fromOutput(Map<String, Object> mapValue) {
        EntityMaintPermCheckService service = new EntityMaintPermCheckService();
