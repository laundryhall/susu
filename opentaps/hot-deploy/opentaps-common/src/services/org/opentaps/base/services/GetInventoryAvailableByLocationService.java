 ...
 * Auto generated base service entity getInventoryAvailableByLocation.
 *
 * Engine: simple
 ...
 */
public class GetInventoryAvailableByLocationService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "getInventoryAvailableByLocation";
    ...
    /**
     * Creates a new <code>GetInventoryAvailableByLocationService</code> instance.
     */
    public GetInventoryAvailableByLocationService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>GetInventoryAvailableByLocationService</code> from the input values of the given <code>GetInventoryAvailableByLocationService</code>.
     * @param input a <code>GetInventoryAvailableByLocationService</code>
     */
    public static GetInventoryAvailableByLocationService fromInput(GetInventoryAvailableByLocationService input) {
        GetInventoryAvailableByLocationService service = new GetInventoryAvailableByLocationService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>GetInventoryAvailableByLocationService</code> from the output values of the given <code>GetInventoryAvailableByLocationService</code>.
     * @param output a <code>GetInventoryAvailableByLocationService</code>
     */
    public static GetInventoryAvailableByLocationService fromOutput(GetInventoryAvailableByLocationService output) {
        GetInventoryAvailableByLocationService service = new GetInventoryAvailableByLocationService();
    ...
    /**
     * Construct a <code>GetInventoryAvailableByLocationService</code> from the given input <code>Map</code>.
    ...
    /**
     * Construct a <code>GetInventoryAvailableByLocationService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetInventoryAvailableByLocationService fromOutput(Map<String, Object> mapValue) {
        GetInventoryAvailableByLocationService service = new GetInventoryAvailableByLocationService();
