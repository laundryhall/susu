...
/**
 * .
 * Auto generated base service entity productGenericPermission.
 *
 * Engine: simple
 ...
 */
public class ProductGenericPermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "productGenericPermission";
    ...
    /**
     * Creates a new <code>ProductGenericPermissionService</code> instance.
     */
    public ProductGenericPermissionService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>ProductGenericPermissionService</code> from the input values of the given <code>ProductGenericPermissionService</code>.
     * @param input a <code>ProductGenericPermissionService</code>
     */
    public static ProductGenericPermissionService fromInput(ProductGenericPermissionService input) {
        ProductGenericPermissionService service = new ProductGenericPermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>ProductGenericPermissionService</code> from the output values of the given <code>ProductGenericPermissionService</code>.
     * @param output a <code>ProductGenericPermissionService</code>
     */
    public static ProductGenericPermissionService fromOutput(ProductGenericPermissionService output) {
        ProductGenericPermissionService service = new ProductGenericPermissionService();
    ...
    /**
     * Construct a <code>ProductGenericPermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ProductGenericPermissionService fromInput(Map<String, Object> mapValue) {
        ProductGenericPermissionService service = new ProductGenericPermissionService();
    ...
    /**
     * Construct a <code>ProductGenericPermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ProductGenericPermissionService fromOutput(Map<String, Object> mapValue) {
        ProductGenericPermissionService service = new ProductGenericPermissionService();
