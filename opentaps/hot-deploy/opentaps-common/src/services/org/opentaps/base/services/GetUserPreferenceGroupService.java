 ...
 * Auto generated base service entity getUserPreferenceGroup.
 *
 * Engine: java
 ...
 */
public class GetUserPreferenceGroupService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "getUserPreferenceGroup";
    ...
    /**
     * Creates a new <code>GetUserPreferenceGroupService</code> instance.
     */
    public GetUserPreferenceGroupService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>GetUserPreferenceGroupService</code> from the input values of the given <code>GetUserPreferenceGroupService</code>.
     * @param input a <code>GetUserPreferenceGroupService</code>
     */
    public static GetUserPreferenceGroupService fromInput(GetUserPreferenceGroupService input) {
        GetUserPreferenceGroupService service = new GetUserPreferenceGroupService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>GetUserPreferenceGroupService</code> from the output values of the given <code>GetUserPreferenceGroupService</code>.
     * @param output a <code>GetUserPreferenceGroupService</code>
     */
    public static GetUserPreferenceGroupService fromOutput(GetUserPreferenceGroupService output) {
        GetUserPreferenceGroupService service = new GetUserPreferenceGroupService();
    ...
    /**
     * Construct a <code>GetUserPreferenceGroupService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetUserPreferenceGroupService fromInput(Map<String, Object> mapValue) {
        GetUserPreferenceGroupService service = new GetUserPreferenceGroupService();
    ...
    /**
     * Construct a <code>GetUserPreferenceGroupService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetUserPreferenceGroupService fromOutput(Map<String, Object> mapValue) {
        GetUserPreferenceGroupService service = new GetUserPreferenceGroupService();
