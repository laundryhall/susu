 ...
 * Auto generated base service entity createOrderHeaderWorkEffort.
 *
 * Engine: simple
 ...
 */
public class CreateOrderHeaderWorkEffortService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createOrderHeaderWorkEffort";
    ...
    /**
     * Creates a new <code>CreateOrderHeaderWorkEffortService</code> instance.
     */
    public CreateOrderHeaderWorkEffortService() {
        super();
    }
     ...
     */
    public CreateOrderHeaderWorkEffortService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateOrderHeaderWorkEffortService</code> from the input values of the given <code>CreateOrderHeaderWorkEffortService</code>.
     * @param input a <code>CreateOrderHeaderWorkEffortService</code>
     */
    public static CreateOrderHeaderWorkEffortService fromInput(CreateOrderHeaderWorkEffortService input) {
        CreateOrderHeaderWorkEffortService service = new CreateOrderHeaderWorkEffortService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateOrderHeaderWorkEffortService</code> from the output values of the given <code>CreateOrderHeaderWorkEffortService</code>.
     * @param output a <code>CreateOrderHeaderWorkEffortService</code>
     */
    public static CreateOrderHeaderWorkEffortService fromOutput(CreateOrderHeaderWorkEffortService output) {
        CreateOrderHeaderWorkEffortService service = new CreateOrderHeaderWorkEffortService();
    ...
    /**
     * Construct a <code>CreateOrderHeaderWorkEffortService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateOrderHeaderWorkEffortService fromInput(Map<String, Object> mapValue) {
        CreateOrderHeaderWorkEffortService service = new CreateOrderHeaderWorkEffortService();
    ...
    /**
     * Construct a <code>CreateOrderHeaderWorkEffortService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateOrderHeaderWorkEffortService fromOutput(Map<String, Object> mapValue) {
        CreateOrderHeaderWorkEffortService service = new CreateOrderHeaderWorkEffortService();
