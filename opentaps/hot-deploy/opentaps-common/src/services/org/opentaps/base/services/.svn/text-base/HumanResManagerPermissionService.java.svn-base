...
/**
 * .
 * Auto generated base service entity humanResManagerPermission.
 *
 * Engine: simple
 ...
 */
public class HumanResManagerPermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "humanResManagerPermission";
    ...
    /**
     * Creates a new <code>HumanResManagerPermissionService</code> instance.
     */
    public HumanResManagerPermissionService() {
        super();
    }
     ...
     */
    public HumanResManagerPermissionService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>HumanResManagerPermissionService</code> from the input values of the given <code>HumanResManagerPermissionService</code>.
     * @param input a <code>HumanResManagerPermissionService</code>
     */
    public static HumanResManagerPermissionService fromInput(HumanResManagerPermissionService input) {
        HumanResManagerPermissionService service = new HumanResManagerPermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>HumanResManagerPermissionService</code> from the output values of the given <code>HumanResManagerPermissionService</code>.
     * @param output a <code>HumanResManagerPermissionService</code>
     */
    public static HumanResManagerPermissionService fromOutput(HumanResManagerPermissionService output) {
        HumanResManagerPermissionService service = new HumanResManagerPermissionService();
    ...
    /**
     * Construct a <code>HumanResManagerPermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static HumanResManagerPermissionService fromInput(Map<String, Object> mapValue) {
        HumanResManagerPermissionService service = new HumanResManagerPermissionService();
    ...
    /**
     * Construct a <code>HumanResManagerPermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static HumanResManagerPermissionService fromOutput(Map<String, Object> mapValue) {
        HumanResManagerPermissionService service = new HumanResManagerPermissionService();
