 ...
 */
public class AddProductionRunRoutingTaskService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>AddProductionRunRoutingTaskService</code> instance.
     */
    public AddProductionRunRoutingTaskService() {
        super();
    }
     ...
     */
    public AddProductionRunRoutingTaskService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>AddProductionRunRoutingTaskService</code> from the input values of the given <code>AddProductionRunRoutingTaskService</code>.
     * @param input a <code>AddProductionRunRoutingTaskService</code>
     */
    public static AddProductionRunRoutingTaskService fromInput(AddProductionRunRoutingTaskService input) {
        AddProductionRunRoutingTaskService service = new AddProductionRunRoutingTaskService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>AddProductionRunRoutingTaskService</code> from the output values of the given <code>AddProductionRunRoutingTaskService</code>.
     * @param output a <code>AddProductionRunRoutingTaskService</code>
     */
    public static AddProductionRunRoutingTaskService fromOutput(AddProductionRunRoutingTaskService output) {
        AddProductionRunRoutingTaskService service = new AddProductionRunRoutingTaskService();
    ...
    /**
     * Construct a <code>AddProductionRunRoutingTaskService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AddProductionRunRoutingTaskService fromInput(Map<String, Object> mapValue) {
        AddProductionRunRoutingTaskService service = new AddProductionRunRoutingTaskService();
    ...
    /**
     * Construct a <code>AddProductionRunRoutingTaskService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AddProductionRunRoutingTaskService fromOutput(Map<String, Object> mapValue) {
        AddProductionRunRoutingTaskService service = new AddProductionRunRoutingTaskService();
