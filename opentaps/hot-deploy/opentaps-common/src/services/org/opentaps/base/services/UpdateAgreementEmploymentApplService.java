 ...
 * Auto generated base service entity updateAgreementEmploymentAppl.
 *
 * Engine: simple
 * Location: component://humanres/script/org/ofbiz/humanres/HumanResServices.xml
 * Invoke: updateAgreementEmploymentAppl
 * Defined in: applications/humanres/servicedef/services.xml
 */
public class UpdateAgreementEmploymentApplService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updateAgreementEmploymentAppl";
    ...
    /**
     * Creates a new <code>UpdateAgreementEmploymentApplService</code> instance.
     */
    public UpdateAgreementEmploymentApplService() {
        super();
    }
     ...
     */
    public UpdateAgreementEmploymentApplService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdateAgreementEmploymentApplService</code> from the input values of the given <code>UpdateAgreementEmploymentApplService</code>.
     * @param input a <code>UpdateAgreementEmploymentApplService</code>
     */
    public static UpdateAgreementEmploymentApplService fromInput(UpdateAgreementEmploymentApplService input) {
        UpdateAgreementEmploymentApplService service = new UpdateAgreementEmploymentApplService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdateAgreementEmploymentApplService</code> from the output values of the given <code>UpdateAgreementEmploymentApplService</code>.
     * @param output a <code>UpdateAgreementEmploymentApplService</code>
     */
    public static UpdateAgreementEmploymentApplService fromOutput(UpdateAgreementEmploymentApplService output) {
        UpdateAgreementEmploymentApplService service = new UpdateAgreementEmploymentApplService();
    ...
    /**
     * Construct a <code>UpdateAgreementEmploymentApplService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateAgreementEmploymentApplService fromInput(Map<String, Object> mapValue) {
        UpdateAgreementEmploymentApplService service = new UpdateAgreementEmploymentApplService();
    ...
    /**
     * Construct a <code>UpdateAgreementEmploymentApplService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateAgreementEmploymentApplService fromOutput(Map<String, Object> mapValue) {
        UpdateAgreementEmploymentApplService service = new UpdateAgreementEmploymentApplService();
