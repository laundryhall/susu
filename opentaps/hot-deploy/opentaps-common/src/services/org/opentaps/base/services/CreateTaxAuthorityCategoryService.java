 ...
 * Auto generated base service entity createTaxAuthorityCategory.
 *
 * Engine: simple
 ...
 */
public class CreateTaxAuthorityCategoryService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createTaxAuthorityCategory";
    ...
    /**
     * Creates a new <code>CreateTaxAuthorityCategoryService</code> instance.
     */
    public CreateTaxAuthorityCategoryService() {
        super();
    }
     ...
     */
    public CreateTaxAuthorityCategoryService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateTaxAuthorityCategoryService</code> from the input values of the given <code>CreateTaxAuthorityCategoryService</code>.
     * @param input a <code>CreateTaxAuthorityCategoryService</code>
     */
    public static CreateTaxAuthorityCategoryService fromInput(CreateTaxAuthorityCategoryService input) {
        CreateTaxAuthorityCategoryService service = new CreateTaxAuthorityCategoryService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateTaxAuthorityCategoryService</code> from the output values of the given <code>CreateTaxAuthorityCategoryService</code>.
     * @param output a <code>CreateTaxAuthorityCategoryService</code>
     */
    public static CreateTaxAuthorityCategoryService fromOutput(CreateTaxAuthorityCategoryService output) {
        CreateTaxAuthorityCategoryService service = new CreateTaxAuthorityCategoryService();
    ...
    /**
     * Construct a <code>CreateTaxAuthorityCategoryService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateTaxAuthorityCategoryService fromInput(Map<String, Object> mapValue) {
        CreateTaxAuthorityCategoryService service = new CreateTaxAuthorityCategoryService();
    ...
    /**
     * Construct a <code>CreateTaxAuthorityCategoryService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateTaxAuthorityCategoryService fromOutput(Map<String, Object> mapValue) {
        CreateTaxAuthorityCategoryService service = new CreateTaxAuthorityCategoryService();
