 ...
 * Auto generated base service entity opentaps.preparePurchasingOrderEmail.
 *
 * Engine: java
...
public class OpentapsPreparePurchasingOrderEmailService extends ServiceWrapper {
    ...
    public static final String NAME = "opentaps.preparePurchasingOrderEmail";
    ...
    /**
     * Creates a new <code>OpentapsPreparePurchasingOrderEmailService</code> instance.
     */
    public OpentapsPreparePurchasingOrderEmailService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsPreparePurchasingOrderEmailService</code> from the input values of the given <code>OpentapsPreparePurchasingOrderEmailService</code>.
     * @param input a <code>OpentapsPreparePurchasingOrderEmailService</code>
     */
    public static OpentapsPreparePurchasingOrderEmailService fromInput(OpentapsPreparePurchasingOrderEmailService input) {
        OpentapsPreparePurchasingOrderEmailService service = new OpentapsPreparePurchasingOrderEmailService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>OpentapsPreparePurchasingOrderEmailService</code> from the output values of the given <code>OpentapsPreparePurchasingOrderEmailService</code>.
     * @param output a <code>OpentapsPreparePurchasingOrderEmailService</code>
     */
    public static OpentapsPreparePurchasingOrderEmailService fromOutput(OpentapsPreparePurchasingOrderEmailService output) {
        OpentapsPreparePurchasingOrderEmailService service = new OpentapsPreparePurchasingOrderEmailService();
    ...
    /**
     * Construct a <code>OpentapsPreparePurchasingOrderEmailService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsPreparePurchasingOrderEmailService fromInput(Map<String, Object> mapValue) {
        OpentapsPreparePurchasingOrderEmailService service = new OpentapsPreparePurchasingOrderEmailService();
    ...
    /**
     * Construct a <code>OpentapsPreparePurchasingOrderEmailService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsPreparePurchasingOrderEmailService fromOutput(Map<String, Object> mapValue) {
        OpentapsPreparePurchasingOrderEmailService service = new OpentapsPreparePurchasingOrderEmailService();
