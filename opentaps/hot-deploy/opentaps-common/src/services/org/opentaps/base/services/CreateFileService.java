...
/**
 * Create a File.
 * Auto generated base service entity createFile.
 *
 * Engine: java
 ...
 */
public class CreateFileService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>CreateFileService</code> instance.
     */
     ...
     */
    public CreateFileService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateFileService</code> from the input values of the given <code>CreateFileService</code>.
     * @param input a <code>CreateFileService</code>
     */
    public static CreateFileService fromInput(CreateFileService input) {
        CreateFileService service = new CreateFileService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateFileService</code> from the output values of the given <code>CreateFileService</code>.
     * @param output a <code>CreateFileService</code>
     */
    public static CreateFileService fromOutput(CreateFileService output) {
        CreateFileService service = new CreateFileService();
    ...
    /**
     * Construct a <code>CreateFileService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFileService fromInput(Map<String, Object> mapValue) {
        CreateFileService service = new CreateFileService();
    ...
    /**
     * Construct a <code>CreateFileService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFileService fromOutput(Map<String, Object> mapValue) {
        CreateFileService service = new CreateFileService();
