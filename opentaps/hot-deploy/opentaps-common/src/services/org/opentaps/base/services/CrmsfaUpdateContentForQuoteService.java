...
/**
 * Updates uploadable or simple content for order..
 * Auto generated base service entity crmsfa.updateContentForQuote.
 *
 * Engine: java
 * Location: com.opensourcestrategies.crmsfa.content.ContentServices
 * Invoke: updateContentForQuote
 * Defined in: hot-deploy/crmsfa/servicedef/services_content.xml
 */
public class CrmsfaUpdateContentForQuoteService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.updateContentForQuote";
    ...
    /**
     * Creates a new <code>CrmsfaUpdateContentForQuoteService</code> instance.
     */
    public CrmsfaUpdateContentForQuoteService() {
        super();
    }
     ...
     */
    public CrmsfaUpdateContentForQuoteService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaUpdateContentForQuoteService</code> from the input values of the given <code>CrmsfaUpdateContentForQuoteService</code>.
     * @param input a <code>CrmsfaUpdateContentForQuoteService</code>
     */
    public static CrmsfaUpdateContentForQuoteService fromInput(CrmsfaUpdateContentForQuoteService input) {
        CrmsfaUpdateContentForQuoteService service = new CrmsfaUpdateContentForQuoteService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaUpdateContentForQuoteService</code> from the output values of the given <code>CrmsfaUpdateContentForQuoteService</code>.
     * @param output a <code>CrmsfaUpdateContentForQuoteService</code>
     */
    public static CrmsfaUpdateContentForQuoteService fromOutput(CrmsfaUpdateContentForQuoteService output) {
        CrmsfaUpdateContentForQuoteService service = new CrmsfaUpdateContentForQuoteService();
    ...
    /**
     * Construct a <code>CrmsfaUpdateContentForQuoteService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaUpdateContentForQuoteService fromInput(Map<String, Object> mapValue) {
        CrmsfaUpdateContentForQuoteService service = new CrmsfaUpdateContentForQuoteService();
    ...
    /**
     * Construct a <code>CrmsfaUpdateContentForQuoteService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaUpdateContentForQuoteService fromOutput(Map<String, Object> mapValue) {
        CrmsfaUpdateContentForQuoteService service = new CrmsfaUpdateContentForQuoteService();
