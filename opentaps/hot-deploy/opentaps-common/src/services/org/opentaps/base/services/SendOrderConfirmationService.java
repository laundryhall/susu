 ...
 * Auto generated base service entity sendOrderConfirmation.
 *
 * Engine: java
 ...
 */
public class SendOrderConfirmationService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "sendOrderConfirmation";
    ...
    /**
     * Creates a new <code>SendOrderConfirmationService</code> instance.
     */
    public SendOrderConfirmationService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>SendOrderConfirmationService</code> from the input values of the given <code>SendOrderConfirmationService</code>.
     * @param input a <code>SendOrderConfirmationService</code>
     */
    public static SendOrderConfirmationService fromInput(SendOrderConfirmationService input) {
        SendOrderConfirmationService service = new SendOrderConfirmationService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>SendOrderConfirmationService</code> from the output values of the given <code>SendOrderConfirmationService</code>.
     * @param output a <code>SendOrderConfirmationService</code>
     */
    public static SendOrderConfirmationService fromOutput(SendOrderConfirmationService output) {
        SendOrderConfirmationService service = new SendOrderConfirmationService();
    ...
    /**
     * Construct a <code>SendOrderConfirmationService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SendOrderConfirmationService fromInput(Map<String, Object> mapValue) {
        SendOrderConfirmationService service = new SendOrderConfirmationService();
    ...
    /**
     * Construct a <code>SendOrderConfirmationService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SendOrderConfirmationService fromOutput(Map<String, Object> mapValue) {
        SendOrderConfirmationService service = new SendOrderConfirmationService();
