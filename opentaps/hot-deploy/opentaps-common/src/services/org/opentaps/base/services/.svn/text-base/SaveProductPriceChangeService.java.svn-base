 ...
 */
public class SaveProductPriceChangeService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>SaveProductPriceChangeService</code> instance.
     */
    public SaveProductPriceChangeService() {
        super();
    }
     ...
     */
    public SaveProductPriceChangeService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>SaveProductPriceChangeService</code> from the input values of the given <code>SaveProductPriceChangeService</code>.
     * @param input a <code>SaveProductPriceChangeService</code>
     */
    public static SaveProductPriceChangeService fromInput(SaveProductPriceChangeService input) {
        SaveProductPriceChangeService service = new SaveProductPriceChangeService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>SaveProductPriceChangeService</code> from the output values of the given <code>SaveProductPriceChangeService</code>.
     * @param output a <code>SaveProductPriceChangeService</code>
     */
    public static SaveProductPriceChangeService fromOutput(SaveProductPriceChangeService output) {
        SaveProductPriceChangeService service = new SaveProductPriceChangeService();
    ...
    /**
     * Construct a <code>SaveProductPriceChangeService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SaveProductPriceChangeService fromInput(Map<String, Object> mapValue) {
        SaveProductPriceChangeService service = new SaveProductPriceChangeService();
    ...
    /**
     * Construct a <code>SaveProductPriceChangeService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SaveProductPriceChangeService fromOutput(Map<String, Object> mapValue) {
        SaveProductPriceChangeService service = new SaveProductPriceChangeService();
