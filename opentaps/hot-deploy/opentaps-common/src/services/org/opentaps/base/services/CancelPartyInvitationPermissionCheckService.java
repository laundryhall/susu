 ...
 * 
        ...
        .
 * Auto generated base service entity cancelPartyInvitationPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class CancelPartyInvitationPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "cancelPartyInvitationPermissionCheck";
    ...
    /**
     * Creates a new <code>CancelPartyInvitationPermissionCheckService</code> instance.
     */
    public CancelPartyInvitationPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>CancelPartyInvitationPermissionCheckService</code> from the input values of the given <code>CancelPartyInvitationPermissionCheckService</code>.
     * @param input a <code>CancelPartyInvitationPermissionCheckService</code>
     */
    public static CancelPartyInvitationPermissionCheckService fromInput(CancelPartyInvitationPermissionCheckService input) {
        CancelPartyInvitationPermissionCheckService service = new CancelPartyInvitationPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CancelPartyInvitationPermissionCheckService</code> from the output values of the given <code>CancelPartyInvitationPermissionCheckService</code>.
     * @param output a <code>CancelPartyInvitationPermissionCheckService</code>
     */
    public static CancelPartyInvitationPermissionCheckService fromOutput(CancelPartyInvitationPermissionCheckService output) {
        CancelPartyInvitationPermissionCheckService service = new CancelPartyInvitationPermissionCheckService();
    ...
    /**
     * Construct a <code>CancelPartyInvitationPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CancelPartyInvitationPermissionCheckService fromInput(Map<String, Object> mapValue) {
        CancelPartyInvitationPermissionCheckService service = new CancelPartyInvitationPermissionCheckService();
    ...
    /**
     * Construct a <code>CancelPartyInvitationPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CancelPartyInvitationPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        CancelPartyInvitationPermissionCheckService service = new CancelPartyInvitationPermissionCheckService();
