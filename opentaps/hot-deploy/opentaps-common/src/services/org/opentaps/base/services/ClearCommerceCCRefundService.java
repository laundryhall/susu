 ...
 * Auto generated base service entity clearCommerceCCRefund.
 *
 * Engine: java
 ...
 */
public class ClearCommerceCCRefundService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "clearCommerceCCRefund";
    ...
    /**
     * Creates a new <code>ClearCommerceCCRefundService</code> instance.
     */
    public ClearCommerceCCRefundService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>ClearCommerceCCRefundService</code> from the input values of the given <code>ClearCommerceCCRefundService</code>.
     * @param input a <code>ClearCommerceCCRefundService</code>
     */
    public static ClearCommerceCCRefundService fromInput(ClearCommerceCCRefundService input) {
        ClearCommerceCCRefundService service = new ClearCommerceCCRefundService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>ClearCommerceCCRefundService</code> from the output values of the given <code>ClearCommerceCCRefundService</code>.
     * @param output a <code>ClearCommerceCCRefundService</code>
     */
    public static ClearCommerceCCRefundService fromOutput(ClearCommerceCCRefundService output) {
        ClearCommerceCCRefundService service = new ClearCommerceCCRefundService();
    ...
    /**
     * Construct a <code>ClearCommerceCCRefundService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ClearCommerceCCRefundService fromInput(Map<String, Object> mapValue) {
        ClearCommerceCCRefundService service = new ClearCommerceCCRefundService();
    ...
    /**
     * Construct a <code>ClearCommerceCCRefundService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ClearCommerceCCRefundService fromOutput(Map<String, Object> mapValue) {
        ClearCommerceCCRefundService service = new ClearCommerceCCRefundService();
