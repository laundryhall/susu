 ...
 * Auto generated base service entity createAgreementPartyApplic.
 *
 * Engine: simple
 ...
 */
public class CreateAgreementPartyApplicService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createAgreementPartyApplic";
    ...
    /**
     * Creates a new <code>CreateAgreementPartyApplicService</code> instance.
     */
    public CreateAgreementPartyApplicService() {
        super();
    }
     ...
     */
    public CreateAgreementPartyApplicService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateAgreementPartyApplicService</code> from the input values of the given <code>CreateAgreementPartyApplicService</code>.
     * @param input a <code>CreateAgreementPartyApplicService</code>
     */
    public static CreateAgreementPartyApplicService fromInput(CreateAgreementPartyApplicService input) {
        CreateAgreementPartyApplicService service = new CreateAgreementPartyApplicService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateAgreementPartyApplicService</code> from the output values of the given <code>CreateAgreementPartyApplicService</code>.
     * @param output a <code>CreateAgreementPartyApplicService</code>
     */
    public static CreateAgreementPartyApplicService fromOutput(CreateAgreementPartyApplicService output) {
        CreateAgreementPartyApplicService service = new CreateAgreementPartyApplicService();
    ...
    /**
     * Construct a <code>CreateAgreementPartyApplicService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateAgreementPartyApplicService fromInput(Map<String, Object> mapValue) {
        CreateAgreementPartyApplicService service = new CreateAgreementPartyApplicService();
    ...
    /**
     * Construct a <code>CreateAgreementPartyApplicService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateAgreementPartyApplicService fromOutput(Map<String, Object> mapValue) {
        CreateAgreementPartyApplicService service = new CreateAgreementPartyApplicService();
