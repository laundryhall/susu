 ...
 * Auto generated base service entity deletePartyToWorkEffortAssignment.
 *
 * Engine: simple
 ...
 */
public class DeletePartyToWorkEffortAssignmentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deletePartyToWorkEffortAssignment";
    ...
    /**
     * Creates a new <code>DeletePartyToWorkEffortAssignmentService</code> instance.
     */
    public DeletePartyToWorkEffortAssignmentService() {
        super();
    }
     ...
     */
    public DeletePartyToWorkEffortAssignmentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeletePartyToWorkEffortAssignmentService</code> from the input values of the given <code>DeletePartyToWorkEffortAssignmentService</code>.
     * @param input a <code>DeletePartyToWorkEffortAssignmentService</code>
     */
    public static DeletePartyToWorkEffortAssignmentService fromInput(DeletePartyToWorkEffortAssignmentService input) {
        DeletePartyToWorkEffortAssignmentService service = new DeletePartyToWorkEffortAssignmentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeletePartyToWorkEffortAssignmentService</code> from the output values of the given <code>DeletePartyToWorkEffortAssignmentService</code>.
     * @param output a <code>DeletePartyToWorkEffortAssignmentService</code>
     */
    public static DeletePartyToWorkEffortAssignmentService fromOutput(DeletePartyToWorkEffortAssignmentService output) {
        DeletePartyToWorkEffortAssignmentService service = new DeletePartyToWorkEffortAssignmentService();
    ...
    /**
     * Construct a <code>DeletePartyToWorkEffortAssignmentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeletePartyToWorkEffortAssignmentService fromInput(Map<String, Object> mapValue) {
        DeletePartyToWorkEffortAssignmentService service = new DeletePartyToWorkEffortAssignmentService();
    ...
    /**
     * Construct a <code>DeletePartyToWorkEffortAssignmentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeletePartyToWorkEffortAssignmentService fromOutput(Map<String, Object> mapValue) {
        DeletePartyToWorkEffortAssignmentService service = new DeletePartyToWorkEffortAssignmentService();
