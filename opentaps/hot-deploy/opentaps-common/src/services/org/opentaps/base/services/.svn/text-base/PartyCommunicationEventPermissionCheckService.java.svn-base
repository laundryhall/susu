 ...
 * Auto generated base service entity partyCommunicationEventPermissionCheck.
 *
 * Engine: simple
 ...
 */
public class PartyCommunicationEventPermissionCheckService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "partyCommunicationEventPermissionCheck";
    ...
    /**
     * Creates a new <code>PartyCommunicationEventPermissionCheckService</code> instance.
     */
    public PartyCommunicationEventPermissionCheckService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>PartyCommunicationEventPermissionCheckService</code> from the input values of the given <code>PartyCommunicationEventPermissionCheckService</code>.
     * @param input a <code>PartyCommunicationEventPermissionCheckService</code>
     */
    public static PartyCommunicationEventPermissionCheckService fromInput(PartyCommunicationEventPermissionCheckService input) {
        PartyCommunicationEventPermissionCheckService service = new PartyCommunicationEventPermissionCheckService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>PartyCommunicationEventPermissionCheckService</code> from the output values of the given <code>PartyCommunicationEventPermissionCheckService</code>.
     * @param output a <code>PartyCommunicationEventPermissionCheckService</code>
     */
    public static PartyCommunicationEventPermissionCheckService fromOutput(PartyCommunicationEventPermissionCheckService output) {
        PartyCommunicationEventPermissionCheckService service = new PartyCommunicationEventPermissionCheckService();
    ...
    /**
     * Construct a <code>PartyCommunicationEventPermissionCheckService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PartyCommunicationEventPermissionCheckService fromInput(Map<String, Object> mapValue) {
        PartyCommunicationEventPermissionCheckService service = new PartyCommunicationEventPermissionCheckService();
    ...
    /**
     * Construct a <code>PartyCommunicationEventPermissionCheckService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PartyCommunicationEventPermissionCheckService fromOutput(Map<String, Object> mapValue) {
        PartyCommunicationEventPermissionCheckService service = new PartyCommunicationEventPermissionCheckService();
