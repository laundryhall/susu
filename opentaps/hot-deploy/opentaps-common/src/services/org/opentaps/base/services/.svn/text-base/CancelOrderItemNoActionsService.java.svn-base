 ...
 * Auto generated base service entity cancelOrderItemNoActions.
 *
 * Engine: java
 ...
 */
public class CancelOrderItemNoActionsService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "cancelOrderItemNoActions";
    ...
    /**
     * Creates a new <code>CancelOrderItemNoActionsService</code> instance.
     */
    public CancelOrderItemNoActionsService() {
        super();
    }
     ...
     */
    public CancelOrderItemNoActionsService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CancelOrderItemNoActionsService</code> from the input values of the given <code>CancelOrderItemNoActionsService</code>.
     * @param input a <code>CancelOrderItemNoActionsService</code>
     */
    public static CancelOrderItemNoActionsService fromInput(CancelOrderItemNoActionsService input) {
        CancelOrderItemNoActionsService service = new CancelOrderItemNoActionsService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CancelOrderItemNoActionsService</code> from the output values of the given <code>CancelOrderItemNoActionsService</code>.
     * @param output a <code>CancelOrderItemNoActionsService</code>
     */
    public static CancelOrderItemNoActionsService fromOutput(CancelOrderItemNoActionsService output) {
        CancelOrderItemNoActionsService service = new CancelOrderItemNoActionsService();
    ...
    /**
     * Construct a <code>CancelOrderItemNoActionsService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CancelOrderItemNoActionsService fromInput(Map<String, Object> mapValue) {
        CancelOrderItemNoActionsService service = new CancelOrderItemNoActionsService();
    ...
    /**
     * Construct a <code>CancelOrderItemNoActionsService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CancelOrderItemNoActionsService fromOutput(Map<String, Object> mapValue) {
        CancelOrderItemNoActionsService service = new CancelOrderItemNoActionsService();
