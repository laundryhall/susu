...
/**
 * Sends a subscription request to FedEx to get the rate, which is required for Fedex Ship Manager Direct as shipping credential.
 ...
 * Auto generated base service entity opentaps.fedexRateRequest.
 *
 * Engine: java
...
public class OpentapsFedexRateRequestService extends ServiceWrapper {
    ...
    public static final String NAME = "opentaps.fedexRateRequest";
    ...
    /**
     * Creates a new <code>OpentapsFedexRateRequestService</code> instance.
     */
    public OpentapsFedexRateRequestService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsFedexRateRequestService</code> from the input values of the given <code>OpentapsFedexRateRequestService</code>.
     * @param input a <code>OpentapsFedexRateRequestService</code>
     */
    public static OpentapsFedexRateRequestService fromInput(OpentapsFedexRateRequestService input) {
        OpentapsFedexRateRequestService service = new OpentapsFedexRateRequestService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>OpentapsFedexRateRequestService</code> from the output values of the given <code>OpentapsFedexRateRequestService</code>.
     * @param output a <code>OpentapsFedexRateRequestService</code>
     */
    public static OpentapsFedexRateRequestService fromOutput(OpentapsFedexRateRequestService output) {
        OpentapsFedexRateRequestService service = new OpentapsFedexRateRequestService();
    ...
    /**
     * Construct a <code>OpentapsFedexRateRequestService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsFedexRateRequestService fromInput(Map<String, Object> mapValue) {
        OpentapsFedexRateRequestService service = new OpentapsFedexRateRequestService();
    ...
    /**
     * Construct a <code>OpentapsFedexRateRequestService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsFedexRateRequestService fromOutput(Map<String, Object> mapValue) {
        OpentapsFedexRateRequestService service = new OpentapsFedexRateRequestService();
