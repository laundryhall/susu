...
/**
 * .
 * Auto generated base service entity deleteProductStoreVendorPayment.
 *
 * Engine: simple
 * Location: component://product/script/org/ofbiz/product/store/ProductStoreServices.xml
 * Invoke: deleteProductStoreVendorPayment
 * Defined in: applications/product/servicedef/services_store.xml
 */
public class DeleteProductStoreVendorPaymentService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "deleteProductStoreVendorPayment";
    ...
    /**
     * Creates a new <code>DeleteProductStoreVendorPaymentService</code> instance.
     */
    public DeleteProductStoreVendorPaymentService() {
        super();
    }
     ...
     */
    public DeleteProductStoreVendorPaymentService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductStoreVendorPaymentService</code> from the input values of the given <code>DeleteProductStoreVendorPaymentService</code>.
     * @param input a <code>DeleteProductStoreVendorPaymentService</code>
     */
    public static DeleteProductStoreVendorPaymentService fromInput(DeleteProductStoreVendorPaymentService input) {
        DeleteProductStoreVendorPaymentService service = new DeleteProductStoreVendorPaymentService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>DeleteProductStoreVendorPaymentService</code> from the output values of the given <code>DeleteProductStoreVendorPaymentService</code>.
     * @param output a <code>DeleteProductStoreVendorPaymentService</code>
     */
    public static DeleteProductStoreVendorPaymentService fromOutput(DeleteProductStoreVendorPaymentService output) {
        DeleteProductStoreVendorPaymentService service = new DeleteProductStoreVendorPaymentService();
    ...
    /**
     * Construct a <code>DeleteProductStoreVendorPaymentService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductStoreVendorPaymentService fromInput(Map<String, Object> mapValue) {
        DeleteProductStoreVendorPaymentService service = new DeleteProductStoreVendorPaymentService();
    ...
    /**
     * Construct a <code>DeleteProductStoreVendorPaymentService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductStoreVendorPaymentService fromOutput(Map<String, Object> mapValue) {
        DeleteProductStoreVendorPaymentService service = new DeleteProductStoreVendorPaymentService();
