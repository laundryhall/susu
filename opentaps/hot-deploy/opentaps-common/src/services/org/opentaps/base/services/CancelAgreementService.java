...
/**
 * Cancel an Agreement.
 * Auto generated base service entity cancelAgreement.
 *
 * Engine: simple
 * Location: component://accounting/script/org/ofbiz/accounting/agreement/AgreementServices.xml
 * Invoke: cancelAgreement
 * Defined in: applications/accounting/servicedef/services_agreement.xml
 */
public class CancelAgreementService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "cancelAgreement";
    ...
    /**
     * Creates a new <code>CancelAgreementService</code> instance.
     */
    public CancelAgreementService() {
        super();
    }
     ...
     */
    public CancelAgreementService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CancelAgreementService</code> from the input values of the given <code>CancelAgreementService</code>.
     * @param input a <code>CancelAgreementService</code>
     */
    public static CancelAgreementService fromInput(CancelAgreementService input) {
        CancelAgreementService service = new CancelAgreementService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CancelAgreementService</code> from the output values of the given <code>CancelAgreementService</code>.
     * @param output a <code>CancelAgreementService</code>
     */
    public static CancelAgreementService fromOutput(CancelAgreementService output) {
        CancelAgreementService service = new CancelAgreementService();
    ...
    /**
     * Construct a <code>CancelAgreementService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CancelAgreementService fromInput(Map<String, Object> mapValue) {
        CancelAgreementService service = new CancelAgreementService();
    ...
    /**
     * Construct a <code>CancelAgreementService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CancelAgreementService fromOutput(Map<String, Object> mapValue) {
        CancelAgreementService service = new CancelAgreementService();
