...
/**
 * gets a Map of glAccount -> sum of transactions for all income statement accounts (REVENUE, EXPENSE, INCOME) 
            over a period of dates for an organization..
 * Auto generated base service entity getIncomeStatementAccountSumsByDate.
 *
 * Engine: java
 * Location: com.opensourcestrategies.financials.financials.FinancialServices
 * Invoke: getIncomeStatementAccountSumsByDate
 * Defined in: hot-deploy/financials/servicedef/services_financials.xml
 */
public class GetIncomeStatementAccountSumsByDateService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "getIncomeStatementAccountSumsByDate";
    ...
    /**
     * Creates a new <code>GetIncomeStatementAccountSumsByDateService</code> instance.
     */
    public GetIncomeStatementAccountSumsByDateService() {
        super();
    }
     ...
     */
    public GetIncomeStatementAccountSumsByDateService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>GetIncomeStatementAccountSumsByDateService</code> from the input values of the given <code>GetIncomeStatementAccountSumsByDateService</code>.
     * @param input a <code>GetIncomeStatementAccountSumsByDateService</code>
     */
    public static GetIncomeStatementAccountSumsByDateService fromInput(GetIncomeStatementAccountSumsByDateService input) {
        GetIncomeStatementAccountSumsByDateService service = new GetIncomeStatementAccountSumsByDateService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>GetIncomeStatementAccountSumsByDateService</code> from the output values of the given <code>GetIncomeStatementAccountSumsByDateService</code>.
     * @param output a <code>GetIncomeStatementAccountSumsByDateService</code>
     */
    public static GetIncomeStatementAccountSumsByDateService fromOutput(GetIncomeStatementAccountSumsByDateService output) {
        GetIncomeStatementAccountSumsByDateService service = new GetIncomeStatementAccountSumsByDateService();
    ...
    /**
     * Construct a <code>GetIncomeStatementAccountSumsByDateService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetIncomeStatementAccountSumsByDateService fromInput(Map<String, Object> mapValue) {
        GetIncomeStatementAccountSumsByDateService service = new GetIncomeStatementAccountSumsByDateService();
    ...
    /**
     * Construct a <code>GetIncomeStatementAccountSumsByDateService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetIncomeStatementAccountSumsByDateService fromOutput(Map<String, Object> mapValue) {
        GetIncomeStatementAccountSumsByDateService service = new GetIncomeStatementAccountSumsByDateService();
