 ...
 * Auto generated base service entity updatePartyClassification.
 *
 * Engine: simple
 ...
 */
public class UpdatePartyClassificationService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "updatePartyClassification";
    ...
    /**
     * Creates a new <code>UpdatePartyClassificationService</code> instance.
     */
    public UpdatePartyClassificationService() {
        super();
    }
     ...
     */
    public UpdatePartyClassificationService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>UpdatePartyClassificationService</code> from the input values of the given <code>UpdatePartyClassificationService</code>.
     * @param input a <code>UpdatePartyClassificationService</code>
     */
    public static UpdatePartyClassificationService fromInput(UpdatePartyClassificationService input) {
        UpdatePartyClassificationService service = new UpdatePartyClassificationService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>UpdatePartyClassificationService</code> from the output values of the given <code>UpdatePartyClassificationService</code>.
     * @param output a <code>UpdatePartyClassificationService</code>
     */
    public static UpdatePartyClassificationService fromOutput(UpdatePartyClassificationService output) {
        UpdatePartyClassificationService service = new UpdatePartyClassificationService();
    ...
    /**
     * Construct a <code>UpdatePartyClassificationService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdatePartyClassificationService fromInput(Map<String, Object> mapValue) {
        UpdatePartyClassificationService service = new UpdatePartyClassificationService();
    ...
    /**
     * Construct a <code>UpdatePartyClassificationService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdatePartyClassificationService fromOutput(Map<String, Object> mapValue) {
        UpdatePartyClassificationService service = new UpdatePartyClassificationService();
