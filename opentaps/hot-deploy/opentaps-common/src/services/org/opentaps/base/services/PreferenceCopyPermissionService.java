 ...
 * Auto generated base service entity preferenceCopyPermission.
 *
 * Engine: java
 ...
 */
public class PreferenceCopyPermissionService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "preferenceCopyPermission";
    ...
    /**
     * Creates a new <code>PreferenceCopyPermissionService</code> instance.
     */
    public PreferenceCopyPermissionService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>PreferenceCopyPermissionService</code> from the input values of the given <code>PreferenceCopyPermissionService</code>.
     * @param input a <code>PreferenceCopyPermissionService</code>
     */
    public static PreferenceCopyPermissionService fromInput(PreferenceCopyPermissionService input) {
        PreferenceCopyPermissionService service = new PreferenceCopyPermissionService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>PreferenceCopyPermissionService</code> from the output values of the given <code>PreferenceCopyPermissionService</code>.
     * @param output a <code>PreferenceCopyPermissionService</code>
     */
    public static PreferenceCopyPermissionService fromOutput(PreferenceCopyPermissionService output) {
        PreferenceCopyPermissionService service = new PreferenceCopyPermissionService();
    ...
    /**
     * Construct a <code>PreferenceCopyPermissionService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PreferenceCopyPermissionService fromInput(Map<String, Object> mapValue) {
        PreferenceCopyPermissionService service = new PreferenceCopyPermissionService();
    ...
    /**
     * Construct a <code>PreferenceCopyPermissionService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PreferenceCopyPermissionService fromOutput(Map<String, Object> mapValue) {
        PreferenceCopyPermissionService service = new PreferenceCopyPermissionService();
