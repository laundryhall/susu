 ...
 * 
        ...
        .
 * Auto generated base service entity postProductionRunCostVarianceToGl.
 *
 * Engine: pojo
...
public class PostProductionRunCostVarianceToGlService extends ServiceWrapper {
    ...
    public static final String NAME = "postProductionRunCostVarianceToGl";
    ...
    /**
     * Creates a new <code>PostProductionRunCostVarianceToGlService</code> instance.
     */
    public PostProductionRunCostVarianceToGlService() {
        super();
    }
    ...
    */
    ...
    /**
     * Construct a <code>PostProductionRunCostVarianceToGlService</code> from the input values of the given <code>PostProductionRunCostVarianceToGlService</code>.
     * @param input a <code>PostProductionRunCostVarianceToGlService</code>
     */
    public static PostProductionRunCostVarianceToGlService fromInput(PostProductionRunCostVarianceToGlService input) {
        PostProductionRunCostVarianceToGlService service = new PostProductionRunCostVarianceToGlService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>PostProductionRunCostVarianceToGlService</code> from the output values of the given <code>PostProductionRunCostVarianceToGlService</code>.
     * @param output a <code>PostProductionRunCostVarianceToGlService</code>
     */
    public static PostProductionRunCostVarianceToGlService fromOutput(PostProductionRunCostVarianceToGlService output) {
        PostProductionRunCostVarianceToGlService service = new PostProductionRunCostVarianceToGlService();
    ...
    /**
     * Construct a <code>PostProductionRunCostVarianceToGlService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PostProductionRunCostVarianceToGlService fromInput(Map<String, Object> mapValue) {
        PostProductionRunCostVarianceToGlService service = new PostProductionRunCostVarianceToGlService();
    ...
    /**
     * Construct a <code>PostProductionRunCostVarianceToGlService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PostProductionRunCostVarianceToGlService fromOutput(Map<String, Object> mapValue) {
        PostProductionRunCostVarianceToGlService service = new PostProductionRunCostVarianceToGlService();
