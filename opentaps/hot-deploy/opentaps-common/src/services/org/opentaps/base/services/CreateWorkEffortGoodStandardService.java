 ...
 */
public class CreateWorkEffortGoodStandardService extends ServiceWrapper {
    ...
    /**
     * Creates a new <code>CreateWorkEffortGoodStandardService</code> instance.
     */
    public CreateWorkEffortGoodStandardService() {
        super();
    }
     ...
     */
    public CreateWorkEffortGoodStandardService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateWorkEffortGoodStandardService</code> from the input values of the given <code>CreateWorkEffortGoodStandardService</code>.
     * @param input a <code>CreateWorkEffortGoodStandardService</code>
     */
    public static CreateWorkEffortGoodStandardService fromInput(CreateWorkEffortGoodStandardService input) {
        CreateWorkEffortGoodStandardService service = new CreateWorkEffortGoodStandardService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateWorkEffortGoodStandardService</code> from the output values of the given <code>CreateWorkEffortGoodStandardService</code>.
     * @param output a <code>CreateWorkEffortGoodStandardService</code>
     */
    public static CreateWorkEffortGoodStandardService fromOutput(CreateWorkEffortGoodStandardService output) {
        CreateWorkEffortGoodStandardService service = new CreateWorkEffortGoodStandardService();
    ...
    /**
     * Construct a <code>CreateWorkEffortGoodStandardService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateWorkEffortGoodStandardService fromInput(Map<String, Object> mapValue) {
        CreateWorkEffortGoodStandardService service = new CreateWorkEffortGoodStandardService();
    ...
    /**
     * Construct a <code>CreateWorkEffortGoodStandardService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateWorkEffortGoodStandardService fromOutput(Map<String, Object> mapValue) {
        CreateWorkEffortGoodStandardService service = new CreateWorkEffortGoodStandardService();
