 ...
 * Auto generated base service entity createFeaturePrice.
 *
 * Engine: simple
 * Location: component://product/script/org/ofbiz/product/feature/ProductFeatureServices.xml
 * Invoke: createFeaturePrice
 * Defined in: applications/product/servicedef/services_feature.xml
 */
public class CreateFeaturePriceService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "createFeaturePrice";
    ...
    /**
     * Creates a new <code>CreateFeaturePriceService</code> instance.
     */
    public CreateFeaturePriceService() {
        super();
    }
     ...
     */
    public CreateFeaturePriceService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CreateFeaturePriceService</code> from the input values of the given <code>CreateFeaturePriceService</code>.
     * @param input a <code>CreateFeaturePriceService</code>
     */
    public static CreateFeaturePriceService fromInput(CreateFeaturePriceService input) {
        CreateFeaturePriceService service = new CreateFeaturePriceService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CreateFeaturePriceService</code> from the output values of the given <code>CreateFeaturePriceService</code>.
     * @param output a <code>CreateFeaturePriceService</code>
     */
    public static CreateFeaturePriceService fromOutput(CreateFeaturePriceService output) {
        CreateFeaturePriceService service = new CreateFeaturePriceService();
    ...
    /**
     * Construct a <code>CreateFeaturePriceService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFeaturePriceService fromInput(Map<String, Object> mapValue) {
        CreateFeaturePriceService service = new CreateFeaturePriceService();
    ...
    /**
     * Construct a <code>CreateFeaturePriceService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFeaturePriceService fromOutput(Map<String, Object> mapValue) {
        CreateFeaturePriceService service = new CreateFeaturePriceService();
