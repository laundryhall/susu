 ...
 * Auto generated base service entity crmsfa.createContentForOrder.
 *
 * Engine: java
 * Location: com.opensourcestrategies.crmsfa.content.ContentServices
 * Invoke: createContentForOrder
 * Defined in: hot-deploy/crmsfa/servicedef/services_content.xml
 */
public class CrmsfaCreateContentForOrderService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "crmsfa.createContentForOrder";
    ...
    /**
     * Creates a new <code>CrmsfaCreateContentForOrderService</code> instance.
     */
    public CrmsfaCreateContentForOrderService() {
        super();
    }
     ...
     */
    public CrmsfaCreateContentForOrderService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForOrderService</code> from the input values of the given <code>CrmsfaCreateContentForOrderService</code>.
     * @param input a <code>CrmsfaCreateContentForOrderService</code>
     */
    public static CrmsfaCreateContentForOrderService fromInput(CrmsfaCreateContentForOrderService input) {
        CrmsfaCreateContentForOrderService service = new CrmsfaCreateContentForOrderService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CrmsfaCreateContentForOrderService</code> from the output values of the given <code>CrmsfaCreateContentForOrderService</code>.
     * @param output a <code>CrmsfaCreateContentForOrderService</code>
     */
    public static CrmsfaCreateContentForOrderService fromOutput(CrmsfaCreateContentForOrderService output) {
        CrmsfaCreateContentForOrderService service = new CrmsfaCreateContentForOrderService();
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForOrderService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreateContentForOrderService fromInput(Map<String, Object> mapValue) {
        CrmsfaCreateContentForOrderService service = new CrmsfaCreateContentForOrderService();
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForOrderService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateContentForOrderService fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateContentForOrderService service = new CrmsfaCreateContentForOrderService();
