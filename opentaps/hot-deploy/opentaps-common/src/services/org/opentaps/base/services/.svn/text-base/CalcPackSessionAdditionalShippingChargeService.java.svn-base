 ...
 * Auto generated base service entity calcPackSessionAdditionalShippingCharge.
 *
 * Engine: java
 ...
 */
public class CalcPackSessionAdditionalShippingChargeService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "calcPackSessionAdditionalShippingCharge";
    ...
    /**
     * Creates a new <code>CalcPackSessionAdditionalShippingChargeService</code> instance.
     */
    public CalcPackSessionAdditionalShippingChargeService() {
        super();
    }
     ...
     */
    public CalcPackSessionAdditionalShippingChargeService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>CalcPackSessionAdditionalShippingChargeService</code> from the input values of the given <code>CalcPackSessionAdditionalShippingChargeService</code>.
     * @param input a <code>CalcPackSessionAdditionalShippingChargeService</code>
     */
    public static CalcPackSessionAdditionalShippingChargeService fromInput(CalcPackSessionAdditionalShippingChargeService input) {
        CalcPackSessionAdditionalShippingChargeService service = new CalcPackSessionAdditionalShippingChargeService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>CalcPackSessionAdditionalShippingChargeService</code> from the output values of the given <code>CalcPackSessionAdditionalShippingChargeService</code>.
     * @param output a <code>CalcPackSessionAdditionalShippingChargeService</code>
     */
    public static CalcPackSessionAdditionalShippingChargeService fromOutput(CalcPackSessionAdditionalShippingChargeService output) {
        CalcPackSessionAdditionalShippingChargeService service = new CalcPackSessionAdditionalShippingChargeService();
    ...
    /**
     * Construct a <code>CalcPackSessionAdditionalShippingChargeService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CalcPackSessionAdditionalShippingChargeService fromInput(Map<String, Object> mapValue) {
        CalcPackSessionAdditionalShippingChargeService service = new CalcPackSessionAdditionalShippingChargeService();
    ...
    /**
     * Construct a <code>CalcPackSessionAdditionalShippingChargeService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CalcPackSessionAdditionalShippingChargeService fromOutput(Map<String, Object> mapValue) {
        CalcPackSessionAdditionalShippingChargeService service = new CalcPackSessionAdditionalShippingChargeService();
