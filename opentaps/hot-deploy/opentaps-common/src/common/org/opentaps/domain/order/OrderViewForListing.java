...
public class OrderViewForListing extends Entity {
     ...
     */
    public static OrderViewForListing makeOrderView(EntityInterface clone, GenericDelegator delegator, TimeZone timeZone, Locale locale) throws RepositoryException {
     ...
     * @throws RepositoryException if an error occurs
     */
    public static List<OrderViewForListing> makeOrderView(List<? extends EntityInterface> clones, GenericDelegator delegator, TimeZone timeZone, Locale locale) throws RepositoryException {
