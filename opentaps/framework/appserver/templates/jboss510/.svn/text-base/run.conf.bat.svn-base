...
set "JAVA_OPTS=-Xmx768m -XX:PermSize=768m -XX:PermSize=768m -Dofbiz.home=@ofbizHome@"

rem # Reduce the RMI GCs to once per hour for Sun JVMs.
set "JAVA_OPTS=%JAVA_OPTS% -Dsun.rmi.dgc.client.gcInterval=3600000 -Dsun.rmi.dgc.server.gcInterval=3600000 -Dorg.jboss.logging.Log4jService.catchSystemOut=false"
