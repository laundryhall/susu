			...
			<div style = "margin-left:auto;margin-right:auto;border-width:0px;border-color:red;border-style:solid;">
				...
				<div style = "width:33%;float:left;">
					<table style = "border:0px solid red;padding:0px;">
						<tr>
							<td>
									<img src="http://suosuo.herokuapp.com/css/images/piggy-bank.svg" style = "width:20%;height:100px;" class="ui-li-icon ui-corner-none">
				...
				<br>
				<a href="#" onclick = "window.location.hash = 'save'" style = "color:black;font-size:30px" >SAVE TODAY</a>
			</div><!-- /grid-b -->
			<!--
			<div>
				<br>
